...
describe('editor/layers/basemap-content-views/basemap-select-view-view', function () {
  ...
  it('should render properly', function () {
    expect(this.view._filteredBasemaps.length).toBe(2);
    expect(this.view.$('.Mosaic-item').length).toBe(2);
  });

  it('should update select if selectedSourceVal changes', function () {
    expect(this.view._filteredBasemaps.length).toBe(2);
    expect(this.view.$('.Mosaic-item').length).toBe(2);

    this.view._selectedSourceVal = 'Stamen';
    this.view.render();
debugger;
    expect(this.view._filteredBasemaps.length).toBe(1);
