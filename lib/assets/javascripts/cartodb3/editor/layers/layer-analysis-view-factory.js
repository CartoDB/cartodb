...
/**
 * @param {Object} analysisDefinitionCollection
 */
var LayerAnalysisViewFactory = function (analysisDefinitionCollection) {
  this._analysisDefinitionCollection = analysisDefinitionCollection;
};
...
LayerAnalysisViewFactory.prototype.createView = function (id, layerDefinitionModel) {
  ...
  var m = this._analysisDefinitionCollection.getNodeModel(id);
