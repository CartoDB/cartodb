...
module.exports = CoreView.extend({
  ...
  _showContextMenu: function (ev) {
    ...
    if (!this._tableViewModel.isDisabled()) {
      if (!this.model.isCartoDBIDColumn()) {
        menuItems = menuItems.concat([
          {
            ...
            val: 'change',
            action: this._changeColumnType.bind(this)
          }
        ]);
      }
        ...
        menuItems.push(
          {
            ...
            val: 'delete',
            destructive: true,
            action: this._removeColumn.bind(this)
          }
        );
      }
    }
  ...
  _changeColumnType: function (mdl) {
    var self = this;
    var isTypeChangeDestructive = QueryColumnModel.isTypeChangeDestructive(this.model.get('type'), mdl.get('type'));
