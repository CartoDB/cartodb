...
describe('cdb.admin.Organization', function() {
  ...
  describe('.grantables', function() {
    it('should return a grantables object', function() {
      expect(this.organization.grantables).toBeDefined();
      expect(this.organization.grantables.organization).toEqual(this.organization);
    });
  });
...
describe('cdb.admin.Organization.Users', function() {
  ...
  it("should parse results properly", function() {
    ...
    expect(this.orgUsers.total_count).toBe(1);
  });
