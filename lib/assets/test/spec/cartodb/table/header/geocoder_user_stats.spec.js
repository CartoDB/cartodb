describe("geocoder user stats", function() {
  ...
  it("should render properly user stats", function() {
    ...
    expect(view.$('p').html()).toBe('You have <strong>4000 geocoding credits available</strong>. Depending on your data you might run out of credits and you will be charged $1.5/1,000 extra geocoding credits.')
  })
  ...
  it("should change text and progress class element when doesn't have more rows available to geocode full table", function() {
    ...
    expect(view.$('div.progress > span.used').hasClass('warning')).toBeTruthy();
    expect(view.$('div.progress > span.used').hasClass('danger')).toBeFalsy();
    expect(view.$('p').html()).toBe('You have <strong>2 geocoding credits available</strong>. Depending on your data you might run out of credits and you will be charged $1.5/1,000 extra geocoding credits.')
  })
