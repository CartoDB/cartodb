...
const { getSourceNode } = require('builder/helpers/utils');
...
module.exports = CoreView.extend({
  ...
  _exportLayer: function () {
    var nodeDefModel = this.model.getAnalysisDefinitionNodeModel();
    const sourceNode = getSourceNode(nodeDefModel);
    ...
    this._modals.create(function (modalModel) {
      return new ModalExportDataView({
        ...
        queryGeometryModel,
        querySchemaModel,
        sourceNodeHasCustomQuery: sourceNode && sourceNode.isCustomQueryApplied(),
