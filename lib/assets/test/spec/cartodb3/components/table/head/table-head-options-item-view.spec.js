var TableHeadOptionsItemView = require('cartodb3/components/table/head/table-head-options-item-view');
var tableHeadOptionsItemTemplate = require('cartodb3/components/table/head/table-head-options-item.tpl');
