...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function () {
    ...
    this.vendorScriptsView = new VendorScriptsView({
      config: this.data.config,
      assetsVersion: this.data.assetsVersion,
      user: this.currentUser,
      hubspotFormEnabled: true
    });
    ...
    this.$vendorScriptsView = this.vendorScriptsView.render().$el;
    ...
    this.$app.append(this.$publicFooterView);
    this.$el.append(this.$vendorScriptsView);
