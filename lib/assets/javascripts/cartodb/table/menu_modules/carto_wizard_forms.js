...
var color_ramp_polyline = {
  ...
  form: {
    'color_ramp': { type: 'select', value: 'bbg_amber', 
        extra:['bbg_amber', 'bbg_purple', 'bbg_black', 'bbg_green', 'bbg_blue'] },
    'line-opacity': { type: 'opacity', value: 0.8 }
  }
};
...
var bubble_form_polygon = JSON.parse(JSON.stringify(bubble_form));
bubble_form_polygon[4].form['marker-line-width'].value = 1.0;
bubble_form_polygon[4].form['marker-line-opacity'].value = 1.0;
