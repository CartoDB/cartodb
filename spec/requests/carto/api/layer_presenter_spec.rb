...
describe Carto::Api::LayerPresenter do
  ...
  let(:tested_klass) { Carto::Api::LayerPresenter }
  let(:model_klass) { Carto::Layer }
  ...
  describe 'to_vizjson_v3() specific behaviour' do
    ...
    it 'does not output visualization_user_name, as Torque can generate Maps API url with the datasource' do
      ...
      describe 'category' do
        ...
        describe 'polygon geometry type' do
          ...
          it 'sets "none" as default blending' do
            @options['style_properties']['properties']['blending'].should eq 'none'
          end
