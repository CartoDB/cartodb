...
cdb.admin.OverlaysDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _getMapViewCenterCoordinates: function() {

    var height = this.mapView.$el.height();
    var width  = this.mapView.$el.width();

    return this.mapView.pixelToLatLon([width/2, height/2])
  ...
  _addAnnotationOverlay: function() {
    ...
    var centerCoordinates = this._getMapViewCenterCoordinates();

    var defaultOptions = {
      pLeft: "50",
      pTop: "50",
      latlng: [centerCoordinates.lat, centerCoordinates.lng],
      landscapeDirection: "left",
      portraitDirection:  "top",
      text: "I'm an **annotation overlay**",
      rendered_text: "I'm a <strong>annotation overlay</strong>" // Rendered version of the markdown text
    };
