...
var analysisGeoreferencePlaceholderView = ViewFactory.createByTemplate(analysisPlaceholderTemplate);
var analysisPlaceholderView = ViewFactory.createByTemplate(analysisGeoreferencePlaceholderTemplate);
...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    if (this._hasError()) {
      ...
      if (this._layerDefinitionModel.canBeGeoreferenced() && !this._formModel()) {
        this._renderScrollView(analysisGeoreferencePlaceholderView);
      } else if (this._analysisFormsCollection.isEmpty()) {
        this._renderScrollView(analysisPlaceholderView);
        this._renderTooltip();
      } else {
        this._renderScrollView(this._createListView());
  ...
  _renderScrollView: function (contentView) {
