...
cdb.admin.ActionsMenu = cdb.admin.RightMenu.extend({
    ...
    setDataLayer: function(dataLayer) {
      ...
      var infowindow = new cdb.admin.mod.InfoWindow({
       ...
       this.bind("end_narrow", this.filters._loadScroll, this); // load the scroll when the panel is open
       sql.bind('queryApplied', this.filters.removeFilters, this.filters);
