  ...
  _initCollections: function (basemaps) {
        ...
        this._basemapsCollection.add({
          ...
          template: function () {
            return mosaicThumbnail({
              backgroundImage: self._basemapsCollection.getThumbnailImage(urlTemplate, subdomains)
            });
          }
        });
      }, this);
    ...
    this._customBaselayersCollection.each(function (mdl) {
      ...
      this._basemapsCollection.add({
        ...
        template: function () {
          return mosaicThumbnail({
            backgroundImage: self._basemapsCollection.getThumbnailImage(urlTemplate)
          });
        }
      });
    }, this);
