...
describe('AnalysisNotificationErrorMessageHandler.extractErrorMessage', function () {
  ...
  xit('should replace', function () {
    ...
    expect(AnalysisNotificationErrorMessageHandler.extractErrorMessage(analysisDefinitionNodeModel)).toEqual('notifications.analysis.failed: Test');
  });
});
