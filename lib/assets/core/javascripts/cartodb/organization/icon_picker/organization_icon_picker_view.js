...
var ImagePickerView = require('./icon_picker_dialog/icon_picker_dialog_view');
...
module.exports = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    this._maxIcons = 23;
    this.template = cdb.templates.getTemplate('organization/icon_picker/organization_icon_picker');
