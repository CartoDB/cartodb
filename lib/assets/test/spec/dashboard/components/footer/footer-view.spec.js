...
describe('dashboard/components/footer/footer-view', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(view.$el.html()).toContain('<li class="Footer-listItem CDB-Text CDB-Size-medium"><a href="https://carto.com/learn/guides/">Guides</a></li>');
  ...
  describe('is hosted', function () {
    it('should render properly', function () {
      ...
      expect(view.$el.html()).not.toContain('<li class="Footer-listItem CDB-Text CDB-Size-medium"><a href="https://carto.com/learn/guides/">Guides</a></li>');
    });
  });
