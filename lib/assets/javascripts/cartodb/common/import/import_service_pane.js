  ...
  cdb.admin.ImportServicePane = cdb.admin.ImportPane.extend({
    ...
    initialize: function() {
      ...
      this.template = cdb.templates.getTemplate(this.options.template || 'common/views/import/import_service');
    ...
    _selectFile: function(m) {
      this._changeModel('chosen', m.get(this.options.filename_field));
    },
