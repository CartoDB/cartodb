cdb.admin.overlays.Image = cdb.admin.overlays.Text.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_click", "_close", "_onDblClick", "_onChangeMode", "_onKeyDown", "_onLoadSuccess", "_onLoadError");
    ...
    this.form_data = [{
      ...
      name: 'Width',
      form: {
        'box-width':  { type: 'simple_number', value: 300, min: 50, max: 2000, inc: 10, disable_triggering: false },
      }
