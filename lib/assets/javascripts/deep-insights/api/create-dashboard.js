...
var createDashboard = function (selector, vizJSON, opts, callback) {
  ...
  _addAggregationToCartoDBLayers.call(this, vizJSON);
...
var _addAggregationToCartoDBLayers = function (vizJSON) {
  var LAYER_TYPE = 'CartoDB';
  var aggregation = new LayerAggregationModel();

  vizJSON.layers.forEach(function (layer) {
    if (layer.type === LAYER_TYPE) {
      layer.aggregation = aggregation.toJSON();
    }
  });
};
