...
module.exports = CoreView.extend({
  ...
  _addInputView: function (key, view, container) {
    var obj = '_' + view;
  ...
  _addNameView: function () {
    this._addInputView('name', 'nameInput', this.$('.js-name-field'));
  },

  _addSourceView: function () {
    this._addInputView('source', 'sourceInput', this.$('.js-source-field'));
  },

  _addAttributionView: function () {
    this._addInputView('attributions', 'attributionInput', this.$('.js-attributions-field'));
  },
