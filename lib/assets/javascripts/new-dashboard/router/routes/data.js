...
const routes = [
    ...
    children: [
      {
        ...
        children: [
          {
            path: 'new-connection',
            name: 'connections-new-connection',
          ...
          },
          {
            ...
            name: 'connections-new-connection-connector',
            meta: {
              title: () => 'Your connections | CARTO'
            }
          },
          {
            path: 'edit/:id',
            component: EditConnectionPage,
            name: 'connections-edit-connection',
            meta: {
              title: () => 'Your connections | CARTO'
            }
          },
          {
            ...
            name: 'connections-delete-connection',
            meta: {
              title: () => 'Your connections | CARTO'
            }
          },
  ...
  // {
  //   path: '/datasets/connections/new/:connector',
  //   component: EditConnectionPage,
  //   meta: {
  //     title: () => 'Your connections | CARTO'
  //   }
  ...
  // },
  // {
  //   path: '/datasets/connections/delete/:id',
  //   component: DeleteConnectionPage,
  //   meta: {
  //     title: () => 'Your connections | CARTO'
  //   }
  // },
  // {
  //   path: '/datasets/connections/:id/dataset',
  //   component: DatasetsConnectionPage,
  //   meta: {
  //     title: () => 'Your connections | CARTO'
  //   }
