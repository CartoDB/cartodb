describe("geocoder user stats", function() {
  ...
  it("should render properly user stats", function() {
    ...
    expect(view.$('p').text()).toBe('You have 4000 geocoding credits available. Depending on your data you might run out of credits and you will be charged $1.5/1,000 extra geocoding credits. New rows added to this table will be geocoded automatically.')
  ...
  it("should change used class when user is close to the limits", function() {
    ...
    expect(view.$('div.progress > span.used').hasClass('danger')).toBeFalsy();
    expect(view.$('p').text()).toBe('You have 500 geocoding credits available. Depending on your data you might run out of credits, if so consider upgrading to a higher plan. New rows added to this table will be geocoded automatically.')
  })
  ...
  it("should change text and progress class element when doesn't have more rows available", function() {
    ...
    expect(view.$('div.progress > span.used').hasClass('warning')).toBeFalsy();
    expect(view.$('div.progress > span.used').hasClass('danger')).toBeTruthy();
    expect(view.$('p').html()).toBe('You don\'t have more geocoding credits this month. <strong>From now on you will be charged $1.5/1,000 rows</strong>. <strong>New rows added to this table will be geocoded automatically.</strong>')
  });
  ...
  it("should change progress class element when user doesn't have more rows available and text for upgrading", function() {
    ...
    expect(view.$('div.progress > span.used').hasClass('warning')).toBeTruthy();
    expect(view.$('div.progress > span.used').hasClass('danger')).toBeFalsy();
    expect(view.$('p').text()).toBe('You have 2 geocoding credits available. Depending on your data you might run out of credits, if so consider upgrading to a higher plan. New rows added to this table will be geocoded automatically.')
  })
  ...
  it("should change text and progress class element when doesn't have more rows available to geocode full table", function() {
    ...
    expect(view.$('div.progress > span.used').hasClass('warning')).toBeTruthy();
    expect(view.$('div.progress > span.used').hasClass('danger')).toBeFalsy();
    expect(view.$('p').text()).toBe('You have 2 geocoding credits available. Depending on your data you might run out of credits and you will be charged $1.5/1,000 extra geocoding credits. New rows added to this table will be geocoded automatically.')
  })
