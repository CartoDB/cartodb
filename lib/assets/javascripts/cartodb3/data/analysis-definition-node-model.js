...
var GeometryModel = require('./geometry-model');
...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this.geometryModel = new GeometryModel({simple_geom: this.get('simple_geom')}, modelOpts);

    this.listenTo(this.geometryModel, 'change:val', this._onGeometryValChanged);
  },
  ...
  isValidAsInputForType: function (analysisType) {
    ...
    var geometry = this.geometryModel.get('simple_geom');
    return geometry
  ...
  _onGeometryValChanged: function (m, val) {
    this.set('simple_geom', val, {silent: true});
  }
