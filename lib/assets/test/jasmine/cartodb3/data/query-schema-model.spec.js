...
describe('data/query-schema-model', function () {
  ...
  it('should not have any geometry initially', function () {
    expect(this.model.get('raw_geom')).toBeUndefined();
    expect(this.model.simpleGeometry()).not.toEqual(jasmine.any(String));
  });
    ...
    describe('when fetch', function () {
      ...
      describe('when request succeeds', function () {
        ...
        it('should setup raw geom', function () {
          expect(this.model.get('raw_geom')).toEqual(jasmine.any(String));
          expect(this.model.simpleGeometry()).toEqual(jasmine.any(String));
        });
      });
