...
var GeometryModel = require('./data/geometry-model');
...
var query = layerModel.get('sql') || 'SELECT * FROM ' + Utils.safeTableNameQuoting(tableModel.getUnquotedName());
var geometryModel = new GeometryModel({
  query: query,
  ready: true
}, {
  configModel: configModel
