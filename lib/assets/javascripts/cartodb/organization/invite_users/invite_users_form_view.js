...
module.exports = cdb.core.View.extend({
  ...
  _signInEnabledMessage: function() {
    ...
    signInMessage.addClass("FlashMessage--success").find($(".FlashMessage-content")).html("<p class='FlashMessage-info max-width'>You have enabled the sign in page successfully!</p>");
