...
module.exports = cdb.core.View.extend({
  ...
  render: function() {
    ...
    var d = {
      ...
      visParentId: this.model.get('visualization_parent_id'),
  ...
  _renderMapThumbnail: function() {
    var visParentId = this.model.get('visualization_parent_id');
    var self = this;
    ...
    img.src = cdb.config.prefixUrl() + '/api/v2/viz/' + visParentId + '/' + this._SIZE.width + '/' + this._SIZE.height + '.png';
  },
