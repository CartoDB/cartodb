...
describe('dashboard/data/permission-model', function () {
  let model, user1, user2, org, owner;
  ...
  describe('access', function () {
    ...
    describe('when given a user w/o own access but is member of group with read access', function () {
      beforeEach(function () {
        const userGroupsCollection = new UserGroupsCollection([], { configModel });
        userGroupsCollection.add(this.groupA);

        user1.setGroups(userGroupsCollection);
      });
