...
var STYLE_MAP = {
  ...
  'simple': {
    tooltipTranslationKey: 'editor.style.tooltips.simple',
  ...
  'squares': {
    tooltipTranslationKey: 'editor.style.tooltips.squares',
  ...
  'hexabins': {
    tooltipTranslationKey: 'editor.style.tooltips.hexabins',
  ...
  'regions': {
    tooltipTranslationKey: 'editor.style.tooltips.regions',
  ...
  'animation': {
    tooltipTranslationKey: 'editor.style.tooltips.animation',
  ...
  'heatmap': {
    tooltipTranslationKey: 'editor.style.tooltips.heatmap',
