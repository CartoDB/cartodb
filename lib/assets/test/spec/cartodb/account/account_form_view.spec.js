...
var Carto = require('../../../../javascripts/carto-node/carto-node');
...
var GOOGLE_PLUS_IFRAME_SRC = 'https://carto.com/google_plus';
...
describe('account/account_form_view', function () {
  ...
  describe('iframe src', function () {
    beforeEach(function () {
      this.user.set('google_plus_iframe_src', GOOGLE_PLUS_IFRAME_SRC);
    });
