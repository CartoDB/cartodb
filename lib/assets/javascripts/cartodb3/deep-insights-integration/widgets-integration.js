...
var WidgetsService = require('cartodb3/editor/widgets/widgets-service');
var WidgetDefinitionModel = require('cartodb3/data/widget-definition-model');
var WidgetsNotifications = require('cartodb3/widgets-notifications');
var getStylesWithoutAutostyles = require('cartodb3/helpers/styles-without-autostyle');
...
module.exports = {
  ...
  _onWidgetOrderChanged: function (m) {
    // TODO sort widgets
  },
  ...
  _bindWidgetChanges: function (m) {
    ...
    m.bind('change:order', this._onWidgetOrderChanged, this);
  },
  ...
  _unbindWidgetChanges: function (m) {
    ...
    m.unbind('change:order', this._onWidgetOrderChanged, this);
  },
