...
Backbone.Form.editors.Operators = Backbone.Form.editors.Base.extend({
  ...
  initialize: function (opts) {
    ...
    var optionsCollection = opts.schema && opts.schema.options || opts.options || [];
    this.collection = new OperatorListCollection(optionsCollection);
  ...
  _initViews: function () {
    ...
    this._operatorsListView && this._operatorsListView.remove();
