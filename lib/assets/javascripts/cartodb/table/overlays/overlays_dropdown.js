...
cdb.admin.OverlaysDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _getDefaultImageURL: function() {
    return cdb.config.get("url_prefix") + cdb.config.get("assets_url") + "/images/layout/" +  this.placeholders.default_image;
  },

  _getPublicDefaultImageURL: function() {
    return cdb.config.get("url_prefix") + cdb.config.get("assets_url") + "/images/layout/" +  this.placeholders.public_default_image;
  },
