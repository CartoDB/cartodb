...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var tabPaneTabs = [{
      ...
      name: 'style',
      createContentView: function () {
        var analysisDefinitionNodeModel = self._layerDefinitionModel.getAnalysisDefinitionNodeModel();
      ...
      createContentView: function () {
        return new InfowindowsView({
          ...
          userActions: self._userActions,
          layerDefinitionModel: self._layerDefinitionModel,
          querySchemaModel: self._layerDefinitionModel.getAnalysisDefinitionNodeModel().querySchemaModel,
          configModel: self._configModel,
          editorModel: self._editorModel
        });
      }
  ...
  _isCustomQueryApplied: function () {
    ...
    // var query = this._layerDefinitionModel.getAnalysisDefinitionNodeModel().querySchemaModel.get('query');
  ...
  _onClickNewGeometry: function (e) {
    ...
    var editOverlayText = 'Start clicking on the map to draw your ' + featureType;
