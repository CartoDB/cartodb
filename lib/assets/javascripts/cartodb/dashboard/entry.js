...
var DashboardNotificationView = require('./dashboard_notification/dashboard_notification_view');
var DashboardNotificationModel = require('./dashboard_notification/dashboard_notification_model');
...
$(function() {
  cdb.init(function() {
    ...
    if (currentUser.get('actions').builder_enabled && !window.dashboard_notification) {
      var dashboardNotificationModel = new DashboardNotificationModel(window.dashboard_notification, {
        key: 'dashboard_notification',
        configModel: cdb.config
      });

      var dashboardNotification = new DashboardNotificationView({
        notification: dashboardNotificationModel
      });
