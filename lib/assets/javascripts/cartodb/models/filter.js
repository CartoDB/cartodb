...
cdb.admin.models.Filter = cdb.core.Model.extend({
  ...
  getSQLConditionForDate: function() {
    ...
    var lowerDate = moment(lower).format("YYYY-MM-DDTHH:mm:ssZ").toString();
    var upperDate = moment(upper).format("YYYY-MM-DDTHH:mm:ssZ").toString();
    var upperDateWithOffset = moment(upper + 1000).format("YYYY-MM-DDTHH:mm:ssZ").toString();
