  ...
  describe("SimpleWizard", function() {
    ...
    describe('marker color is changed from icon', function(){
      it("should revert to the default marker", function(){
        view.render();
        view.cartoProperties.active('point');
        view.cartoProperties.set('marker-file', "url(http://com.cartodb.users-assets.production.s3.amazonaws.com/simpleicon/heart206.svg)");
