...
var ChangePrivacyModel = require('../../../../../../javascripts/cartodb/new_common/dialogs/change_privacy/view_model');
...
describe('new_dashboard/dialogs/change_privacy/change_privacy_view', function() {
  beforeEach(function() {
    ...
    spyOn(ChangePrivacyDialog.prototype, '_initViews');
  ...
  describe('when can not share vis', function() {
    beforeEach(function() {
      spyOn(ChangePrivacyModel.prototype, 'canShare').and.returnValue(false);
      this.setupView();
    });
  ...
  describe('when can share vis', function() {
    beforeEach(function() {
      spyOn(ChangePrivacyModel.prototype, 'canShare').and.returnValue(true);
      this.setupView();
    });
