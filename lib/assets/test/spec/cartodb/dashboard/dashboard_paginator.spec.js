describe("Dashboard paginator", function() {
  ...
  it("should add 'locked visualizations' link when needed", function() {
    ...
    server.respondWith('/api/v1/viz/?tag_name=&q=&page=1&type=derived&exclude_shared=false&locked=true&per_page=1', [200, { "Content-Type": "application/json" }, '{"visualizations":[{ "name": "hello"}],"total_entries":1}']);
    server.respond();
