...
var CustomView = require('../../../custom-list/custom-view');
var DropdownOverlayView = require('../../../dropdown-overlay/dropdown-overlay-view');
...
module.exports = CoreView.extend({
  ...
  _createListView: function () {
    ...
    if (this._dropdownOverlay) {
      this._dropdownOverlay.clean();
      this.removeView(this._dropdownOverlay);
    }
    ...
    this._dropdownOverlay = new DropdownOverlayView({
      dropdownElement: this.$el
    });
    this._dropdownOverlay.bind('overlayClicked', this.hide, this);
