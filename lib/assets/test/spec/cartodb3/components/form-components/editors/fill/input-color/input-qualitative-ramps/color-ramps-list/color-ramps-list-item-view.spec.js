...
var InputCategoriesRampsListItemView = require('cartodb3/components/form-components/editors/fill/input-color/input-qualitative-ramps/color-ramps-list/list-item-view/color-ramps-list-item-view');
var InputCategoriesRampsListItemTemplate = require('cartodb3/components/form-components/editors/fill/input-color/input-qualitative-ramps/color-ramps-list/list-item-view/color-ramps-list-item.tpl');
