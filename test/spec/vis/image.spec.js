...
//     var image = Image(vizjson).size(640, 480);
...
//     var image = Image(vizjson, { step: 10 });
...
//     var image = Image(vizjson).zoom(4);
...
//     var image = Image(vizjson).center([40, 30]);
...
//     Image(vizjson).bbox([-31.05, -155.74, 82.58, 261.21]).size(400,300).getUrl(function(error, url) {
...
//     Image(vizjson, { override_bbox: true }).size(400,300).getUrl(function(error, url) {
//       expect(error).toEqual(null);
//       expect(url.match(regexp).length).toEqual(2);
//       expect(url).toMatch(regexp);
//       done();
...
//     Image(vizjson).bbox([]).size(400,300).getUrl(function(error, url) {
//       expect(error).toEqual(null);
//       expect(url.match(regexp).length).toEqual(2);
//       expect(url).toMatch(regexp);
//       done();
...
//     var image = Image(vizjson).format("jpg");
...
//     var image = Image(vizjson).format("pin");
...
//     Image(vizjson).getUrl(function(error, url) {
//       expect(error).toEqual(null);
//       expect(url.match(regexp).length).toEqual(2);
//       expect(url).toMatch(regexp);
//       done();
...
//     Image(vizjson).center([40, 10]).zoom(7).size(400, 300).getUrl(function(error, url) {
//       expect(error).toEqual(null);
//       expect(url.match(regexp).length).toEqual(2);
//       expect(url).toMatch(regexp);
//       done();
...
//     Image(vizjson).center([40, 10]).zoom(7).size(400, 300).into(img);
...
//     Image(layer_definition).size(250, 250).zoom(2).getUrl(function(error, url) {
//       expect(url.match(regexp).length).toEqual(2);
//       expect(url).toMatch(regexp);
//       done();
//     });
...
//     Image(layer_definition).size(250, 250).bbox([[-87.82814025878906,41.88719899247721], [ -27.5936508178711,41.942765696654604]]).getUrl(function(error, url) {
...
//     expect(Image(layer_definition)._tilerHost()).toEqual(
...
//     var image = Image(vizjson).size(400, 300);
...
//     var image = Image(vizjson, { no_cdn: true }).size(400, 300);
