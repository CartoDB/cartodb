...
module.exports = cdb.core.View.extend({
  ...
  _initBinds: function() {
    this.model.get('leftColumns').bind('change:selected', this._assertIfReadyForNextStep, this);
    this.add_related_model(this.model.get('leftColumns'));

    this.model.get('rightColumns').bind('change:selected', this._assertIfReadyForNextStep, this);
