...
module.exports = BaseAnalysisFormModel.extend({
  initialize: function () {
    ...
    if (this.nodeDefModel.geometryModel.isFetched()) {
      this._fetchDOMetadata();
    } else {
      this.nodeDefModel.geometryModel.once('change:status', this._fetchDOMetadata, this);
    }
    this._setSchema();
  },

  _fetchDOMetadata: function () {
    var simpleGeometryType = this.nodeDefModel.geometryModel.get('simple_geom') || 'point';
