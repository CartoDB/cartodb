  ...
  describe('.render_content', function () {
    ...
    describe('needs password confirmation', function () {
      ...
      it('should render properly', function () {
        ...
        expect(content).toContain('<input type="password" autocomplete="off" id="deletion_password_confirmation" name="deletion_password_confirmation" class="CDB-InputText CDB-Text Form-input Form-input--long" value=""/>');
      });
    });
  });
