...
describe('new_common/dialogs/publish/publish_view', function() {
  ...
  describe('when map is private', function() {
    ...
    describe('when clicking any change privacy link', function() {
      beforeEach(function() {
        var self = this;
        this.privacyModal = jasmine.createSpyObj('PrivacyDialog', ['appendToBody', 'bind', 'clean']);
      ...
      describe('when privacy modal finishs', function() {
        beforeEach(function() {
          this.privacyModal.bind.calls.argsFor(0)[1].call(this.view);
        });
        ...
        it('should clean the privacy modal', function() {
          ...
          expect(this.privacyModal.clean).toHaveBeenCalled();
        });
      });
    });
  });
  ...
  describe('when map is not private', function() {
    ...
    it('should render the embed option', function() {
      expect(this.innerHTML()).toContain('iframe width=&quot;100%&quot; height=&quot;520&quot; frameborder=&quot;0&quot; src=&quot;http://cartodb.com/user/pepe/viz/abc-123/embed_map&quot; allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen');
    });
