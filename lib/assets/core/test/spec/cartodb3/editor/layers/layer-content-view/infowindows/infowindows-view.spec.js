...
describe('editor/layers/layer-content-view/infowindow/infowindows-view', function () {
  ...
  describe('when layer is non georeferenced', function () {
    ...
    it('should render placeholder', function () {
      ...
      expect(this.view.$('.CDB-Size-huge').text()).toContain('editor.style.style-form.properties.manually-add');
      expect(this.view.$('.CDB-Button-Text').text()).toBe('editor.style.style-form.properties.georeference');
    });
