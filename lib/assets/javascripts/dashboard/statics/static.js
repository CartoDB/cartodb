...
/* global __CARTO_BUILDER_ASSET_HOST__:false */
// __CARTO_BUILDER_ASSET_HOST__ is injected via Webpack
...
(function (window, document) {
  ...
  if (window.StaticConfig.visualization) {
    ...
    window.StaticConfig.assetsBaseUrl = CARTO_BUILDER_ASSET_HOST + '/assets';
    markAsReady();
  } else {
    getUserConfig();
  }
