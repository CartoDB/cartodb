...
describe("organization/groups_admin/router", function() {
  ...
  describe('.normalizeFragmentOrUrl', function() {
    it('should return the normalized pathname for URLs matching current scope', function() {
      expect(this.router.normalizeFragmentOrUrl('https://cartodb.com/user/paco/organization/groups/new')).toEqual('/new');
      expect(this.router.normalizeFragmentOrUrl('https://cartodb.com/user/paco/organization/groups/edit/123')).toEqual('/edit/123');
    });

    it('should return full URL for non-matching URLs', function() {
      expect(this.router.normalizeFragmentOrUrl('https://cartodb.com/user/paco/somewhere/else')).toEqual('https://cartodb.com/user/paco/somewhere/else');
    });
  });
