...
describe('editor/style/style-content-view', function () {
  ...
  describe('when layer is non georeferenced', function () {
    ...
    it('should render placeholder', function () {
      ...
      expect(this.view.$('.CDB-Size-huge').text()).toContain('editor.style.style-form.properties.placeholder-text');
  ...
  it('should update layerDefinitionModel with hasAnimationStyle', function () {
    this.view.$el.appendTo(document.body);
    spyOn(this.view._styleModel, 'setDefaultPropertiesByType');
    this.view._layerDefinitionsCollection.isThereAnyTorqueLayer = function () {
      return true;
    };

    var anyStyle = this.view._carouselCollection.at(Math.floor(Math.random() * this.view._carouselCollection.length));
    ...
    expect(this.layerDefinitionModel.get('hasAnimationStyle')).toBe(false);

    anyStyle.attributes.selected = false;
    ...
    expect(this.layerDefinitionModel.get('hasAnimationStyle')).toBe(true);
  });
});
