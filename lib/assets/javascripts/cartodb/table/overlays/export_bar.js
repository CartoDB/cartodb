cdb.admin.ExportBarActions =  cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    console.log('initializing export_bar.js actions with options:');
...
cdb.admin.ExportBar =  cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    console.log('initializing export bar with options:');
    console.log(this.options);
  ...
  _addActions: function() {
    ...
    if (!this.actions && !this.options.hide_actions) {
      ...
      this.actions = new cdb.admin.ExportBarActions({
        template_base: "table/views/overlays/export_bar_actions",
        model: this.model
  ...
  _remove: function(a, test) {
    ...
    console.log('removing export bar');
  ...
  render: function() {
    ...
    console.log('rendering export bar');
