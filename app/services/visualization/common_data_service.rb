          ...
          begin
            ...
            if visualization
              if visualization.update_remote_data(
                  ...
                  dataset['source'], dataset['attributions'], dataset['display_name'], dataset['exportable'])
                visualization.store
                updated += 1
              else
                not_modified += 1
              ...
              visualization = Member.remote_member(
                ...
                dataset['description'], dataset['tags'], dataset['license'],
                dataset['source'], dataset['attributions'], dataset['display_name'], dataset['exportable']).store
              added += 1
            end
