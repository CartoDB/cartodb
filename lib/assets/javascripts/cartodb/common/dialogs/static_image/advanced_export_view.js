...
module.exports = BaseDialog.extend({
  ...
  _getBounds: function() {
    var nw = this.options.mapView.pixelToLatLon([this.options.x + this.options.width, this.options.y]);
    var sw = this.options.mapView.pixelToLatLon([this.options.x, this.options.y + this.options.height]);
