describe("ImportDropboxPane", function() {
  ...
  it("should change dropbox button and show file name", function() {
    var view = new cdb.admin.ImportDropboxPane();
    view.render();
    view.model.set({
      type: 'url',
    ...
    expect(view.$('p.filename').text()).toBe('jamon.csv');
    expect(view.$('#dropbox-chooser').text()).toBe('Choose from Dropbox');
  });
