  ...
  cdb.open.TablePublic = cdb.core.View.extend({
    ...
    events: {
      'click .export_options .clone': '_copyTableToYourAccount',
    ...
    _initModels: function() {
      ...
      this.table.like = new cdb.open.Like({ 
        vis_id: this.options.vizjson.id
      });
      ...
      this.table.set({
        ...
        likes: this.options.vizjson.likes
      });
    ...
    _initViews: function() {
      ...
      if (this.table && !this.options.isMobileDevice) {
        ...
        this.$(".export_options .download_options").append(export_options.render().el);
    ...
    _initBinds: function() {
      ...
      this.table.like.bind("change:likes, change:liked", this._onLikeChange, this);
