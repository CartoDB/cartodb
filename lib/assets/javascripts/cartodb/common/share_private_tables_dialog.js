  ...
  cdb.admin.SharePrivateTablesDialog = cdb.admin.BaseDialog.extend({
    ...
    render_content: function() {
      ...
      var $content = $("<div>").append(this.getTemplate('common/views/share_private_tables_dialog')(this.model.toJSON()));
      var self = this;
  ...
  cdb.admin.PrivateTable = cdb.core.View.extend({
    ...
    initialize: function() {
      ...
      this.template = cdb.templates.getTemplate('common/views/share_private_table_view');
      this.loading = false;
      this._initBinds();
    },
    ...
    _changePrivacy: function() {
      ...
      this.$('span.status')
        .removeClass('private')
        .addClass('public')
        .text(this._TEXTS.privacy.public);
    },
