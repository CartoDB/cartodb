...
module.exports = Backbone.Collection.extend({
  ...
  createLayerForAnalysisNode: function (nodeId, position) {
    ...
    // If given node is a source layer just duplicate the source instead of creating unnecessary references
    ...
    var newNodeDefModel = layerWithNodeAsHead
      ? nodeDefModel.clone(nextLetter + '1')
      : nodeDefModel.cloneTree(nextLetter);
