...
var VisTableModel = require('cartodb3/data/visualization-table-model');
var renameLayer = require('./operations/rename-layer');
var DeleteLayerConfirmationView = require('cartodb3/components/modals/remove-layer/delete-layer-confirmation-view');
var InlineEditorView = require('cartodb3/components/inline-editor/inline-editor-view');
var ModalExportDataView = require('cartodb3/components/modals/export-data/modal-export-data-view');
var templateInlineEditor = require('./inline-editor.tpl');
var zoomToData = require('cartodb3/editor/map-operations/zoom-to-data');
var TipsyTooltipView = require('cartodb3/components/tipsy-tooltip-view');
var IconView = require('cartodb3/components/icon/icon-view');
...
module.exports = CoreView.extend({
  ...
  _isLayerEmpty: function () {
    return this._layerDefinitionModel.isEmpty();
  },
