    ...
    */
    ...
    _initViews: function() {
      ...
      if (this.user.featureEnabled('new_modals')) {
         ...
         */
        cdb.god.bind('showGeneralError', function(errorMsg) {
          var template = cdb.templates.getTemplate('new_common/templates/fail');
          var dialog = cdb.editor.DialogFactory.byTemplate(template, {
            templateData: {
              msg: errorMsg
            }
          });
          dialog.render().appendToBody();
        });
