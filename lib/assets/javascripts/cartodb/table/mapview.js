...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  clearMap: function() {
    ...
    if (this.staticImageDialog)       {
      this.staticImageDialog.clean();
      this.staticImageDialog = null;
    }
  ...
  _exportImage: function() {
    ...
    if (this.staticImageDialog) return;

    this.staticImageDialog = new cdb.admin.StaticImageDialog({
    ...
    this.staticImageDialog.bind("was_removed", function() {
      this.staticImageDialog = null;
    }, this);

    this.staticImageDialog.bind("finish", function(response) {
      this.staticImageDialog = null;
    ...
    this.mapView.$el.append(this.staticImageDialog.render().$el);
