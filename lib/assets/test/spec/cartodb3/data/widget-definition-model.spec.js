...
describe('data/widget-definition-model', function () {
  ...
  describe('form model', function () {
    ...
    describe('on change', function () {
      beforeEach(function() {
        spyOn(this.widgetDefModel, 'save').and.callThrough();
      });
      ...
      describe('type change', function() {
        beforeEach(function() {
          ...
          this.widgetModel = this.widgetDefModel._widgetModel;
          spyOn(this.widgetDefModel, 'trigger').and.callThrough();
        ...
        it('should generate new form model when type attribute is changed', function () {
          ...
          expect(this.widgetDefModel.save).toHaveBeenCalled();
          expect(this.widgetDefModel.trigger).toHaveBeenCalledWith('change:type', this.widgetDefModel);
        });

        it('should generate new widget model when type attribute is changed', function () {
          expect(this.widgetDefModel._widgetModel).toBeDefined();
          expect(this.widgetDefModel._widgetModel).not.toBe(this.widgetModel);
        });
      });
