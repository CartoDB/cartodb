  ...
  cdb.admin.ShareDialog = cdb.admin.BaseDialog.extend({
    ...
    initialize: function() {
      ...
      var show_disabled_privacy = (free_account && !has_private_maps && privacy != 'PUBLIC') || (!has_private_maps && paid_account && privacy != 'PUBLIC' && privacy != 'LINK')
      ...
      this.options = _.extend({
        ...
        map_description: markdown.toHTML(this.options.vis.get('description')),
