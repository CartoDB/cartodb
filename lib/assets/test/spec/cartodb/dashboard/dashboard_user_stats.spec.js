describe("cdb.admin.dashboard.UserStats", function() {
  ...
  describe("Warnings", function() {
    ...
    /*
       ...
       var user_stats = generateUserStats({ trial_ends_at: Date.now(), migrated: true, account_type: "JOHN SNOW", remaining_byte_quota: 0, table_count: 10, table_quota: 10, byte_quota: 10, username: "development" });
       var spy = spyOn(user_stats, "_showWarning");

       user_stats.render();
       user_stats._toggleWarnings();

    expect(user_stats._showWarning).toHaveBeenCalledWith("trial");
