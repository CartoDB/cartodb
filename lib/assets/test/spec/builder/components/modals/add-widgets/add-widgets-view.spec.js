...
describe('components/modals/add-widgets/add-widgets-view', function () {
  ...
  describe('when the user clicks on continue', function () {
    ...
    it('should call user actions to update widgets order if the _saveSelectedWidgets succeeds', function (done) {
    ...
    it('should call user actions to update widgets order if the _saveSelectedWidgets fails', function (done) {
