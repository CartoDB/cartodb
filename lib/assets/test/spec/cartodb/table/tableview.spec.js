...
describe("tableview", function() {
  ...
  describe('TableView', function() {
    ...
    it("should show the point info when the_Geom is a point", function() {
      model.data().reset([
      ...
      expect(tview.$('td .cell').eq(5).html()).toEqual(1,1);
    ...
    it("should notify the model when a row is being saved", function() {
      var notified = 0;
