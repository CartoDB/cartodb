...
module.exports = cdb.core.View.extend({
  ...
  _updateOrnaments: function() {
    if (this.model.selectedMergeMethod) {
      var selectedMergeMethodName = this.model.selectedMergeMethod().name;
      this.$('.js-ornaments-text').text(selectedMergeMethodName);

      var hasSelectedRightMergeColumn = !!this.model.selectedRightMergeColumn();
      var isCountMethod = selectedMergeMethodName === 'count';
