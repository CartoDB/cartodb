...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this.listenTo(this._featureModel, 'updateFeature', this._updateForms, this);
    this.listenTo(this._featureModel, 'destroyFeature', this._onDestroyFeature, this);
    this.listenTo(this._featureModel, 'destroyFeatureSuccess', this._onDestroyFeatureSuccess, this);
    this.listenTo(this._featureModel, 'destroyFeatureFailed', this._onDestroyFeatureFailed, this);
    this.listenTo(this._featureModel, 'addFeature', this._onAddFeature, this);
    this.listenTo(this._featureModel, 'saveFeature', this._onSaveFeature, this);
    this.listenTo(this._featureModel, 'saveFeatureSuccess', this._onSaveFeatureSuccess, this);
    this.listenTo(this._featureModel, 'saveFeatureFailed', this._onSaveFeatureFailed, this);
  },
