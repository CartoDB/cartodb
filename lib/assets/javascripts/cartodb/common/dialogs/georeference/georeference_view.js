...
module.exports = BaseDialog.extend({
  ...
  _initBinds: function() {
    ...
    options.bind('change:hideFooter', this._onChangeHideFooter, this);
    ...
    this.model.bind('change:showForceAllRows', this._onChangeShowForceAllRows, this);
  },
  ...
  _onChangeSelectedTab: function(tabModel, isSelected) {
    if (isSelected) {
      ...
      this._onChangeHideFooter(tabModel, false);
  ...
  _onChangeHideFooter: function(tabModel, hideFooter) {
    this.$('.js-footer').toggle(!hideFooter);
  },
  ...
  _onChangeShowForceAllRows: function(m, shouldShow) {
    this.$('.js-force-all-rows').toggle(!!shouldShow);
  },
