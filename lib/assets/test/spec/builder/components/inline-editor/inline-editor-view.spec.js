...
describe('components/inline-editor/inline-editor-view', function () {
  ...
  it('.getValue', function () {
    view = new InlineEditorView({
      ...
      onClick: onClick,
      renderOptions: {
        name: '<img src="http://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/cache/b8/b4/b8b4e86a110557e6b6d666c9cf6d6cc8.png" />'
      }
    });
    view.render();
    ...
    expect(value).toEqual('<img src="http://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/cache/b8/b4/b8b4e86a110557e6b6d666c9cf6d6cc8.png" />');
    view.clean();
  });
