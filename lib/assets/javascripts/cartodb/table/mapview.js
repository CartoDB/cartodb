...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _positionZoomOverlay: function() {

    if (this.header) overlay.model.set("y", $(".header.overlay-static").outerHeight(true) + 20);

  },

  _positionZoomInfoOverlay: function() {

    if (this.zoom) overlay.model.set("y", this.zoom.model.get("y") + 70);
...
*/
  ...
  _positionOverlay: function(overlay_model) {
    ...
    if      (type === 'zoom_info')      this._positionZoomInfoOverlay(overlay_model);
  ...
  _positionSearchOverlay: function(overlay_model) {
    ...
    if (this.header) overlay_model.set("y", $(".header.overlay-static").outerHeight(true) + 20);
    else overlay_model.set("y", 20);

    if (this.share) overlay_model.set("x", 60);
    else overlay_model.set("x", 20);
  ...
  _positionLayerSelectorOverlay: function(overlay_model) {
    ...
    if (this.search && this.share) overlay_model.set("x", 220);
    else if (this.search) overlay_model.set("x", 180);
    else if (this.share) overlay_model.set("x", 60);
    else overlay_model.set("x", 20);
  ...
  _positionLoaderOverlay: function(overlay_model) {
    ...
    if (this.fullscreen)  overlay_model.set("y", this.fullscreen.model.get("y") + 20);
    else if (this.zoom)   overlay_model.set("y", this.zoom.model.get("y") + 120);
    else if (this.header) overlay_model.set("y", $(".header.overlay-static").outerHeight(true) + 20);
    else overlay_model.set("y", 20);
  ...
  _positionZoomInfoOverlay: function(overlay_model) {

    if (this.zoom) overlay_model.set("y", this.zoom.model.get("y") + 70);
  ...
  _positionOverlaysVertically: function() {
  ...
  _addOverlays: function() {
    ...
    this.vertical_overlays   = ["zoom", "zoom_info", "fullscreen", "loader"];
