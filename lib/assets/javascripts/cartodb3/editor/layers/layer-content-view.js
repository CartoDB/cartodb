...
module.exports = CoreView.extend({
  ...
  _renderContextButtons: function () {
    ...
    $('.js-editGeometry').bind('click', this._onClickEditGeometry.bind(this));
  ...
  _onClickEditGeometry: function (e) {
    var $target = $(e.target);
    var featureType = $target.closest('.js-editGeometry').data('feature-type');
    var cartoDBID = $target.closest('.js-editGeometry').data('cdbid');

    var feature = new FeatureDefinitionModel({
      id: cartoDBID,
      type: featureType
    });
    // TODO: We need to fetch the feature before we can edit it
    this._mapModeModel.enterEditingFeatureMode(feature);

    this._stackLayoutModel.nextStep(this.layerDefinitionModel);
  },
  ...
  _onClickNewGeometry: function (e) {
    ...
    var feature = new FeatureDefinitionModel({ type: featureType });
