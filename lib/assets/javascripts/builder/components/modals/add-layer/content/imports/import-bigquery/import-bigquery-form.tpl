<form class="Form js-form">
  ...
  <div class="ImportOptions__feedback">
    <p class="CDB-Text CDB-Size-medium">
      <span class="u-altTextColor"><%- _t('components.modals.add-layer.imports.feedback-text', { brand: 'BigQuery' }) %> <a href="https://docs.google.com/forms/d/e/1FAIpQLSf9U6Yca37TlpguW_mC6nr9YdyBJzipCjf_QSHNkqlmkQ8dgQ/viewform" target="_blank"><%- _t('components.modals.add-layer.imports.feedback-link') %></a></span>
    </p>
  </div>
</form>
