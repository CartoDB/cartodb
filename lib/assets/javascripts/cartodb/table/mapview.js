...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  updateDataLayerView: function() {
    if(this.layerDataView) {
      // TODO: invalidate function is defined in db.geo.CartoDBLayer, but not all layers seems to be inheriting its
      // prototype (e.g. cdb.geo.LeafLetTorqueLayer objects). This assertion makes sure an error is not thrown at least.
      if (this.layerDataView.invalidate) {
