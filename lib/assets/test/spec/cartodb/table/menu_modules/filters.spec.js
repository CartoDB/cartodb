...
describe("cdb.admin.Filters", function() {
  ...
  var view, table, filter, schemaSpy;

  beforeEach(function() {

    table = TestUtil.createTable('tst');

    schemaSpy = spyOn(cdb.admin.mod.Filters.prototype, '_onSchemaUpdate');
  ...
  describe('cdb.admin.mod.Filter', function() {
    ...
    it("should throw an event when the schema is updated", function() {
