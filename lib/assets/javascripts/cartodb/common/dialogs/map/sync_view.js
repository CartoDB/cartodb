...
module.exports = BaseDialog.extend({
  ...
  _INTERVALS: [
    { name: 'Every hour', time: 60*60, type: "hourly" }, 
    { name: 'Every day', time: 60*60*24, type: "daily" }, 
    { name: 'Every week', time: 60*60*24*7, type: "weekly" }, 
    { name: 'Every month', time: 60*60*24*30, type: "monthly" }, 
    { name: 'Never', time: 0, type: "never" }
  ],
  ...
  _initIntervals: function() {
    ...
    _.each(this._INTERVALS, function(interval, i) {
      var disabled = from_external_source && interval.type !== "monthly" && interval.type !== "never";
