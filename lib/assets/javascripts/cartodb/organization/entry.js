...
var UserQuota = require('./organization_quota');
...
$(function() {
  cdb.init(function() {
    ...
    if (this.$('.js-userQuota').length > 0 && organization && this.$('#user_quota').length > 0) {
      new UserQuota({
        el: this.$('.js-userQuota'),
        model: new cdb.core.Model({
          orgQuota: organization.get('quota_in_bytes'),
          orgUsedQuota: organization.get('used_quota_in_bytes'),
