...
describe('editor/layers/layers-content-view/data/data-content-view', function () {
  ...
  var createViewFn = function (options) {
    ...
    fakePromise(queryGeometryModel, 'hasValueAsync').resolve(true);
    fakePromise(layerDefinitionModel, 'isDataFiltered').resolve(true);
    fakePromise(layerDefinitionModel, 'canBeGeoreferenced').resolve(true);
