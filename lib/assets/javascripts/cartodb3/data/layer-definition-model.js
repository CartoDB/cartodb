...
var StyleDefinitionModel = require('../editor/wizards/style-definition-model');
...
module.exports = cdb.core.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this._styleModel = new StyleDefinitionModel(opts.wizards_properties, {
  ...
  _initBinds: function () {
    this._styleModel.bind('layerTypeChange', this._onLayerTypeChange, this);
  },

  _onLayerTypeChange: function () {
    /*
      If it is torque:
        - change layer attributes.
        - move it to the top.
        - no more torques allowed.
