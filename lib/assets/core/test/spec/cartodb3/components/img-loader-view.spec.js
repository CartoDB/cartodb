...
describe('components/img-loader-view', function () {
  var svgResponse = {
    ...
    responseText: '<svg xmlns:a="genius.com" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg"><path></path><rect></rect></svg>'
  };
  ...
  describe('.render', function () {
    ...
    it('should render SVG tag if resource is SVG file', function () {
      ...
      var pathFill = $svg.find('rect')[0].style['fill'].toLowerCase();
