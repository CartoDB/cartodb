...
module.exports = BaseAnalysisFormModel.extend({
   ...
   */
  _setSchema: function () {
    var leftSource = this._getSourceOption()[0];
    var rightSource = this._getSourceOptionsForSourceId(this.get('right_source'), 'right_source', '*');
    ...
    BaseAnalysisFormModel.prototype._setSchema.call(this, this._filterSchemaFieldsByType({
      ...
      left_source_column: {
        type: 'Select',
        title: leftSource && leftSource.layerName || 'left source column',
        options: this._leftColumnOptions.all(),
        validators: ['required']
      },
      right_source_column: {
        type: 'Select',
        title: rightSource && rightSource.label || 'right source column',
  ...
  _onChange: function () {
    var changedSourceId = this.changed.right_source;
    if (changedSourceId) {
