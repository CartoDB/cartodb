...
module.exports = BaseDialog.extend({
  ...
  _bindDataLayer: function() {
    if (this.layer) {
      console.log('binding data layer')
  ...
  _onLoadWizard: function() {
    ...
    var column = this.model.get("response").column;
    var p = this.layer.wizard_properties.get("property");
    console.log("%c" + column + "  "  + p,  "font-weight:bold; color:red;");
