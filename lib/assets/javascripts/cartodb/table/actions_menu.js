  ...
  cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
    ...
    _addLayerDialog: function(e) {
      ...
      this.new_layer_dlg = new cdb.common.CreateDialog({
      ...
      this.new_layer_dlg.bind('importCompleted', this._onCreationCompleted, this)
      this.new_layer_dlg.appendToBody().open();
    },

    _onCreationCompleted: function(m, dlg) {
      var self = this;
