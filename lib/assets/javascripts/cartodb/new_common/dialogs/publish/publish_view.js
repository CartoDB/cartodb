...
module.exports = BaseDialog.extend({
  ...
  _initOptions: function() {
    ...
    this._publicUrlOption = new cdb.core.Model({
    ...
    // Embed option
    this._embedOption = new cdb.core.Model({
  ...
  _updateOptionsWithNewPrivacy: function() {
    ...
    this._publicUrlOption.set('disabledBecausePrivate', isPrivate);
    this._embedOption.set('disabledBecausePrivate', isPrivate);
