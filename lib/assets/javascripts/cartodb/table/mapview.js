...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _showMobileCanvas: function(mode) {
    ...
    var onCanvasPortraitStretched = function() {
      ...
      // Let's set bounds view for mobile mode
      var bounds = [ self.map.get('view_bounds_sw'), self.map.get('view_bounds_ne') ]
  ...
  _bindFullScreenOverlay: function(overlay) {
    ...
    overlay.bind("change_y", function() {
      ...
      if (this.loader && mode === 'desktop') {
        this.loader.model.set("y", overlay.model.get("y") + 40);
      }
    ...
    if (this.zoom) {
      ...
      overlay.model.set("y", this.zoom.model.get("y") + 140);
  ...
  _bindZoomOverlay: function(overlay) {
    ...
    if (this.fullscreen ) {
      ...
      this.fullscreen.model.set("y", overlay.model.get("y") + 140);
    ...
    var onDestroy = function() {
      ...
      if (self.fullscreen) {
        ...
        if (self.header) {
          self.fullscreen.model.set("y", $(".header.overlay-static").outerHeight(true) + 20);
        } else {
...
*/
  ...
  _bindHeaderOverlay: function(overlay) {
    ...
    var move = function() {
      ...
      else if (self.fullscreen) self.fullscreen.model.set("y",   top);
  ...
  _setupZoomInfoOverlay: function(type, data) {
    ...
    this._bindZoomInfoOverlay(overlay);

    return overlay;

  },

  _bindZoomInfoOverlay: function(overlay) {
    ...
    if (this.zoom) {
      overlay.model.set("y", this.zoom.model.get("y") + 80);
    }
