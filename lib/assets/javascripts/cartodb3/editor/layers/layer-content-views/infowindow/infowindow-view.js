...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._codemirrorModel = new Backbone.Model({
      content: this.model.get('template') || this._getTemplateContent()
    });
    ...
    var infoboxSstates = [
      {
        ...
        createContentView: function () {
          return Infobox.createConfirmAndCancel({
            ...
            cancelLabel: _t('editor.infowindow.messages.custom-html-applied.cancel'),
            confirmLabel: _t('editor.infowindow.messages.custom-html-applied.accept'),
            confirmType: 'button'
          });
        },
        mainAction: self._cancelApplyHTML.bind(self),
        secondAction: self._confirmApplyHTML.bind(self)
      }
    ];
