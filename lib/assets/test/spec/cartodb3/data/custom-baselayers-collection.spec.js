...
describe('data/custom-baselayers-collection', function () {
  ...
  describe('.hasCustomBaseLayer', function () {
    it('should return layer with same templateurl if any', function () {
      expect(this.layers.hasCustomBaseLayer('http://c.example.com/basemap/6/30/24.png')).toBe(undefined);
      expect(this.layers.hasCustomBaseLayer('http://a.example.com/basemap/6/30/24.png')).toBe(true);
    });
  });
