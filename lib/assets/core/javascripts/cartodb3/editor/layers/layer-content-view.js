...
module.exports = CoreView.extend({
  ...
  _getStyleSubview: function () {
    if (this._styleViewId !== null) {
      return _.find(this._layerTabPaneView._subviews, function (view) {
        return view.cid === this._styleViewId;
      }, this);
    }
  },
