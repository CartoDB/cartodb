...
describe('cdb.admin.FormSchema', function() {
  ...
  describe('form properties', function() {

    it('should set the name of the columns of the specified type', function() {
      cdb.admin.forms.formType = {
        'point': [
          {
            name: 'Column 1',
            form: {
      ...
      var formSchema = new cdb.admin.FormSchema({
        table: table,
        type: 'formType'
      });

      expect(formSchema.get('Column 1').form.property.extra).toEqual([ 'number', 'string', 'boolean' ]);
      expect(formSchema.get('Column 1').form.property.value).toEqual('number');

      expect(formSchema.get('Column 2').form.property.extra).toEqual([ 'string' ]);
      expect(formSchema.get('Column 2').form.property.value).toEqual('string');
    });

    it('should add an extra column as a default', function() {
      cdb.admin.forms.formType = {
        'point': [
          {
            name: 'Column 1',
            form: {
              'property': {
                ...
                extra_default: ['cartodb_id', 'wadus']
              }
            }
          }
         ]
      ...
      expect(formSchema.get('Column 1').form.property.extra).toEqual([ 'cartodb_id', 'wadus', 'number', 'string' ]);
      expect(formSchema.get('Column 1').form.property.value).toEqual('cartodb_id');
    });

    it('should use the first column of the specified type as a default', function() {
      cdb.admin.forms.formType = {
        'point': [
          {
            name: 'Column 1',
      ...
      expect(formSchema.get('Column 1').form.property.extra).toEqual([ 'numberColumn', 'stringColumn1', 'stringColumn2' ]);
      expect(formSchema.get('Column 1').form.property.value).toEqual('stringColumn1');
    });

    it('should use the first column as a default if no column of the specified type is present', function() {
      cdb.admin.forms.formType = {
        'point': [
          {
            name: 'Column 1',
      ...
      expect(formSchema.get('Column 1').form.property.extra).toEqual([ 'numberColumn', 'stringColumn' ]);
      expect(formSchema.get('Column 1').form.property.value).toEqual('numberColumn');
    });

    it('should exclude empty columns exclude_empty_columns is true', function() {
      cdb.admin.forms.formType = {
        'point': [
          {
            name: 'Column 1',
      ...
      table.data().add({ cartodb_id: 1, numberColumn: 999 });
      ...
      expect(formSchema.get('Column 1').form.property.extra).toEqual([ 'numberColumn' ]);
      expect(formSchema.get('Column 1').form.property.value).toEqual('numberColumn');
    });
  })
});
