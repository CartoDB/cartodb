...
(function() {
  ...
  cdb.admin.RightMenu = cdb.core.View.extend({
    ...
    _BTN_TOOLTIPS: {
      'filters_mod' : 'Click to customize layer filters',
      'wizards_mod' : 'Click to customize layer display options',
      'infowindow_mod' : 'Click to customize layer tooltips',
      'legends_mod' : 'Click to customize layer legend'
    },
    ...
    _addButton: function(type, sections) {
      var b = new Button({tooltip: this._BTN_TOOLTIPS[type]});
      b.className = type;
