...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _showScratchDialog: function() {
    if (this.user.featureEnabled('new_modals') && this.table && this.table.data().length === 0) {

      var skipScratchDialog = 'scratchDialog_' + this.table.id + '_' + this.table.get('map_id');
