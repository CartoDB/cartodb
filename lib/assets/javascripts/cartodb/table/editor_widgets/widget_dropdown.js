  ...
  _addForm: function() {
    ...
    this.form = new cdb.forms.Form({
      form_data: [{
        name: 'Text Style',
        form: {
          'font-size':  { type: 'number', value: 12, min: 5, max: 50, inc: 2 },
        ...
        form: {
          ...
          'box-opacity':  { type: 'opacity', value: .7, min:0, max:1, inc: .1 },
        }

      }, {
        name: 'Box Width',
        form: {
          'box-width':  { type: 'number', value: 300, min: 50, max: 2000, inc: 10 },
        }
