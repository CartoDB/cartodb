  ...
  return {
    ...
    createLayerForTable: function (tableName, options) {
      ...
      return layerDefinitionsCollection.create(attrs, {
        ...
        at: at,
        error: options.error,
        success: function (createdLayerDefModel) {
          ...
          // Reset styles when new layer is added and geometry is known
          resetStylesWhenGeometryChanges(createdLayerDefModel.getAnalysisDefinitionNodeModel(), createdLayerDefModel, true);
