...
$(function() {
  ...
  var Dashboard = cdb.core.View.extend({
    ...
    _initViews: function() {
      ...
      this.visPaginator.bind('loadingPage', function(page) {
        console.log("goto page", page);
        self._goto(null, "/visualizations/" + page);
      });
      ...
      this.tablesPaginator.bind('loadingPage', function(page) {
        console.log("goto page", page);
        self._goto(null, "/tables/" + page);
      });
  ...
  var DashboardRouter = Backbone.Router.extend({
    ...
    tag: function(model, tag, page) {
      console.log("tag", model, tag, page);

      dashboard.startView.model.set("path", "tag");
      ...
      if (model == 'visualizations') {
        ...
        dashboard.visualizations.options.set({ tags: tag, per_page: dashboard.visualizations._ITEMS_PER_PAGE, type: "derived" });
        ...
        dashboard.tables.options.set({ tags: tag, per_page: dashboard.tables._ITEMS_PER_PAGE, type: "table" });
    ...
    index: function() {
      ...
      // Visualizations
      dashboard.visualizationsView.showDefaultTitle(true);
      dashboard.visualizations.options.set({ tags: "", per_page: dashboard.visualizations._PREVIEW_ITEMS_PER_PAGE });
      dashboard.visualizationsView.showLoader();
      dashboard.visualizations.fetch();
      ...
      dashboard.tables.options.set({ tags: "", per_page: dashboard.tables._PREVIEW_ITEMS_PER_PAGE, type: "table" });
      dashboard.tables.fetch();
    ...
    tables: function(page) {
      ...
      this._select("tables");
      dashboard.startView.model.set("path", "tables");

      dashboard.search_form.model.set("visible", true);

      // Tables
      dashboard.tables.options.set({ page: page || 1, tags: "", per_page: dashboard.tables._ITEMS_PER_PAGE, type: "table" });
      dashboard.tablesView.showLoader();
      dashboard.tablesView.model.set("padding", true);
      dashboard.tables.fetch();
    ...
    visualizations: function(page) {
      console.log("vis", page);

      dashboard.startView.model.set("path", "visualizations");
      ...
      // Visualizations
      dashboard.visualizationsView.showLoader();
      dashboard.visualizations.options.set({ page: page || 1, tags: "", per_page: dashboard.visualizations._ITEMS_PER_PAGE, type: "derived" });
      dashboard.visualizationsView.showLoader();
      dashboard.visualizations.fetch();
