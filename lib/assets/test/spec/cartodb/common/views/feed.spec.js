...
var Feed = require('../../../../../javascripts/cartodb/common/views/feed/view');
var Visualizations = require('../../../../../javascripts/cartodb/common/views/feed/feed_collection');

describe('common/views/feed/view', function() {
  ...
  beforeEach(function() {
    ...
    authenticatedUser.set('username', this.user.get('username'));
  ...
  it('should hide the load more button when the limit is reached', function() {
    ...
    expect(this.view.$('.js-more').hasClass('is-transparent')).toBeTruthy();
  });

  it('should init the likes', function() {
    expect(this.view._likeModels.length).toBe(4);
  });
