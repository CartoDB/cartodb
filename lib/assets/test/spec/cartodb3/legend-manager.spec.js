...
describe('deep-insights-integrations/legend-manager', function () {
  ...
  it('should listen to a custom event from style in order to render legends', function () {
    expect(StyleDefinitionModel.prototype.on).toHaveBeenCalledWith('style:update', jasmine.any(Function));
  });
