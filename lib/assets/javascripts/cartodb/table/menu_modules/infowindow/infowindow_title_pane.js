  ...
  cdb.admin.mod.InfowindowTitlePane = cdb.admin.mod.InfowindowBasePane.extend({
    ...
    renderFields: function() {
      ...
      //   return pos_a - pos_b;
      // });
      var isSync = self.options.table.get('synchronization') && self.options.table.get('synchronization').from_external_source;
      ...
      _(names).each(function(f) {
        ...
        var v = new cdb.admin.mod.InfowindowFieldItem({ model: self.model,  field: obj , position: self.model.getFieldPos(f), isSync: isSync });
