describe("Create dialog", function() {
  ...
  it('should render properly', function() {
    ...
    expect(view.$('.create-tab').length).toBe(8);
    expect(view.$('.create-panes > .import-pane').length).toBe(2); // Gdrive, dropbox and twitter will be disabled
  ...
  it('should disable "creation panes" when user has reached the limits', function() {
    ...
    view.render();
    expect(view.$('.create-tab > a.disabled').length).toBe(5);
