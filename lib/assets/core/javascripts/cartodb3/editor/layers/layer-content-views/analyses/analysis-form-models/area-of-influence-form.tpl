<form>
  <div class="Editor-HeaderInfo">
    ...
    <div class="Editor-HeaderInfo-inner CDB-Text">
      ...
      <p class="CDB-Text u-upperCase CDB-FontSize-small u-altTextColor u-bSpace--m"><%= linkContent %><%- _t('editor.layers.analysis-form.reference-layer-pluralize', { smart_count: 1 }) %></p>
