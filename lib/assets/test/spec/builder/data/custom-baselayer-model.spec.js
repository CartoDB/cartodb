  ...
  describe('.validateTemplateURL', function () {
    beforeEach(function () {
      ...
      this.layer = {
        visible: true,
        type: 'Tiled',
        urlTemplate: 'https://stamen-tiles-{s}.freetls.fastly.net/watercolor/{z}/{x}/{y}.jpg',
        attribution: null,
        maxZoom: 21,
        minZoom: 0,
    ...
    it('should check a base tile', function () {
      expect(this.img.src).toMatch('https:\/\/stamen-tiles-[a-d]\.');
      expect(this.img.src).toContain('freetls.fastly.net/watercolor/0/0/0.jpg');
    });
