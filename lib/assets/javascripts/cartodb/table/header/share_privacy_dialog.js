   ...
   *
   *  var share_privacy = new cdb.admin.SharePrivacyDialog({
   *    model: visualization_model
   *  });
   */

  cdb.admin.SharePrivacyDialog = cdb.admin.BaseDialog.extend({

    _TEXTS: {
      title: 'Cannot make this visualization public',
      ok_close: 'Ok, close',
      ok_next: 'Share now!'
    },
    ...
    initialize: function() {
      this.options = _.extend({
        ...
        width: 510,
        modal_class: 'share_privacy_dialog'
      }, this.options);
    ...
    render_content: function() {
      return this.getTemplate('table/header/views/share_privacy_dialog')(this.model.toJSON());
    },
