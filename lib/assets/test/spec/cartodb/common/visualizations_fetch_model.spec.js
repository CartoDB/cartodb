...
describe('common/visualizations_fetch_model', function() {
  ...
  describe('.isDashboards', function() {
    it('should return true if content_type is maps and dashboards are enabled', function() {
      this.model.set({
        content_type: 'datasets',
        dashboards: true
      });
      expect(this.model.isDashboards()).toBeFalsy();
      this.model.set({
        content_type: 'maps'
      });
      expect(this.model.isDashboards()).toBeTruthy();
      this.model.set({
        dashboards: false
      });
      expect(this.model.isDashboards()).toBeFalsy();
