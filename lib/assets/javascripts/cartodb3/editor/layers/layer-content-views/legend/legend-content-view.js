...
module.exports = CoreView.extend({
  ...
  _updateModelForForm: function (type) {
    ...
    var legend;
    if (type && type !== 'none') {
      // Search if legend of this type is already there
      legend = this._legendDefinitionsCollection.findByLayerDefModelAndType(this._layerDefinitionModel, type);

      if (legend) {
        this._legendDefinitionModel = legend;
      } else {
