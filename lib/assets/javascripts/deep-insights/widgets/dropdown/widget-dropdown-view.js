...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this._$container.on('click', this._target, _.bind(this._toggle, this))
  },
  ...
  _bindESC: function () {
    $(document).on('keyup.' + this.cid, _.bind(this._onKeyUp, this));
  },
  ...
  clean: function () {
    ...
    this._unbindESC();
    this._dropdownOverlay && this._dropdownOverlay.clean();
    this._$container.off('click', this._target);
