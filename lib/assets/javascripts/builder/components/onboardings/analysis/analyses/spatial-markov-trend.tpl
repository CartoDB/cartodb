...
<p class="CDB-Text Onboarding-description">
  <a href="https://carto.com/learn/guides/analysis/predict-trends-and-volatility" class="Onboarding-readMore" target="_blank" rel="noopener noreferrer"><%- _t('analyses-onboarding.learn-more') %></a>
</p>
