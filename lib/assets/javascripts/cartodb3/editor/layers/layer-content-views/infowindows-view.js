...
module.exports = CoreView.extend({
  ...
  _bindEvents: function () {
    ...
    this._layerInfowindowModel.on('change:template_name', this._updateSelectedChild, this);
    this.add_related_model(this._layerInfowindowModel);
    this._layerTooltipModel.on('change:template_name', this._updateSelectedChild, this);
