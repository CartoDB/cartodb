...
Backbone.$ = $;
require('../../../../../../javascripts/cartodb3/components/form-components/editors/datetime');

describe('components/form-components/editors/datetime', function () {
  beforeEach(function () {
    this.model = new Backbone.Model({
      dateee: '2016-12-01T00:00:00+00:00'
    });
  ...
  describe('when date time is provided', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$('.js-input').html()).toBe('2016-12-01T00:00:00Z');
