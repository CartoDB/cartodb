...
var StyleFormSizeHelper = require('builder/editor/style/style-form/style-form-size-helper');
...
module.exports = {
  ...
  'fillSize': function (params) {
    ...
    // logic should be inside of the helper (after deleting fill)
    var geometryType = params.queryGeometryModel.get('simple_geom');
    // console.log('params: ', params);
    switch (geometryType) {
      case 'point':
        return StyleFormSizeHelper.getPointSize(params, options);
      default:
        return fill(params);
    }
  },
  ...
  'strokeSize': function (params) {
    ...
    return StyleFormSizeHelper.getStrokeSize(params, options);
  },
