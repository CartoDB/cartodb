...
var CategoryAutoStyler = require('../../../../../javascripts/deep-insights/widgets/auto-style/category.js');
...
describe('src/widgets/auto-style/category', function () {
  ...
  describe('.getStyle', function () {
    ...
    it('should generate the ramp with quotation marks when the name are strings containing numbers', function () {
      ...
      this.dataview.layer.set('initialStyle', '#layer {  polygon-line-width: 0.5;  polygon-line-color: #fcfafa;  polygon-line-opacity: 1;  polygon-fill: #e49115;  polygon-fill-opacity: 0.9; }');
      this.updateColorsByData();
      expect(this.categoryAutoStyler.getStyle()).toBe('#layer {  polygon-line-width: 0.5;  polygon-line-color: #fcfafa;  polygon-line-opacity: 1;  polygon-fill: ramp([something], ("#7F3C8D", "#11A579", "#3969AC", "#F2B701", "#E73F74"), ("1", "2", "3", "-4", "235.52"), \'=\');  polygon-fill-opacity: 0.9; }');
    });
