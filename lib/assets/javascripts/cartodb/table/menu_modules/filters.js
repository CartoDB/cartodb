...
cdb.admin.mod.Filters = cdb.core.View.extend({
    ...
    initialize: function() {
      ...
      this.options.table.bind('change', this.initFilters, this);
      var comboData = []
    ...
    initFilters: function() {
      ...
      this.options.table.unbind('change', this.initFilters, this);
    ...
    render: function() {
      ...
      var isQueryApplied = (this.options.dataLayer.get("query"));
