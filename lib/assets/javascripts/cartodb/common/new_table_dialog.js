  ...
  cdb.admin.CreateTableDialog = cdb.ui.common.Dialog.extend({
    ...
    _renderDropboxPane: function($content) {
      if (cdb.config.get('oauth_dropbox')) {
        ...
        this.upload_panes.bind('tabEnabled:dropbox', function() {
          this.dropboxPane.checkToken();
          this.upload_panes.unbind('tabEnabled:dropbox', null, null);
        }, this);
      } else {
    ...
    _renderGDrivePane: function($content) {
      if (cdb.config.get('oauth_gdrive')) {
        ...
        this.upload_panes.bind('tabEnabled:gdrive', function() {
          this.gdrivePane.checkToken();
          this.upload_panes.unbind('tabEnabled:gdrive', null, null);
        }, this);
      } else {
    ...
    _uploadFromService: function(obj) {
      ...
      if (obj.interval > 0) {
        ...
        cdb.log.info("import from service + SYNC!!! TODO")
      } else {
