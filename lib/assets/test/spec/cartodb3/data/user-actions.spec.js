      ...
      describe('when query-schema-model ready attr is changed', function () {
        ...
        describe('when query-schema is fetched', function () {
          beforeEach(function () {
            ...
            spyOn(this.querySchemaModel, 'getGeometry');
          ...
          describe('when data contains polygons geometry', function () {
            beforeEach(function () {
              this.querySchemaModel.getGeometry.and.returnValue(geometry.ex('polygon'));
          ...
          describe('when the geometry is unknown', function () {
            beforeEach(function () {
              this.querySchemaModel.getGeometry.and.returnValue(undefined);
              this.querySchemaModel.set({status: 'fetched'});
            });
