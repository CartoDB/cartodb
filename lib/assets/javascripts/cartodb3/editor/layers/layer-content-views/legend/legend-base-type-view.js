...
module.exports = CoreView.extend({
  initialize: function (opts) {
    ...
    var content = HTML_TEMPLATE({
      preSnippet: this._legendDefinitionModel.get('preHTMLSnippet') || '<!-- put your html above this line -->',
      placeholder: PLACEHOLDER,
      postSnippet: this._legendDefinitionModel.get('postHTMLSnippet') || '<!-- put your html below this line -->'
    });
    ...
    this._overlayModel = new Backbone.Model({
      visible: this._isLayerHidden() || this._isLegendMigrated()
    });

    this._htmlModel = new Backbone.Model();
  ...
  _isLegendMigrated: function () {
    return this._legendDefinitionModel.get('type') === 'html';
  },
  ...
  _infoboxState: function () {
    ...
    if (!edition && this._isLegendMigrated()) {
        ...
        return new ScrollView({
          createContentView: function () {
            return new LegendContentView({
              ...
              htmlModel: self._htmlModel,
              layerDefinitionModel: self._layerDefinitionModel,
              legendDefinitionModel: self._legendDefinitionModel,
