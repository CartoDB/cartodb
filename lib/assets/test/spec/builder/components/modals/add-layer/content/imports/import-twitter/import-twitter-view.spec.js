...
describe('components/modals/add-layer/content/imports/imports-twitter/import-twitter-view', function () {
  beforeEach(function () {
    ...
    var userModel = new UserModel({username: 'a-user-who-wants-twitter'}, {configModel: configModel});
    var twitter = {
      quota: 100,
      monthly_use: 0,
      block_size: 10,
  ...
  describe('user\'s own credentials', function () {
    beforeEach(function () {
      this.spyOnHasOwnTwitterCredentials = spyOn(this.userModel, 'hasOwnTwitterCredentials');

      this.formIsEnabled = function () {
        var categories = !this.view.categories.isDisabled;
        var datepicker = !this.view.datepicker.isDisabled;
        var creditsUsage = !this.view.creditsUsage.isDisabled;
