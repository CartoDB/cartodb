...
module.exports = {
  createAnalysisFormModel: function (nodeModel) {
    var analysisType = nodeModel.get('type');
    var Klass = analysisMap[analysisType].Class;
    return new Klass(nodeModel.attributes, {
      analysisDefinitionNodeModel: nodeModel
    });
  }
};
