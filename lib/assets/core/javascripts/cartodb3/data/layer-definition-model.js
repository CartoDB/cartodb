...
module.exports = Backbone.Model.extend({
  ...
  save: function (attrs, options) {
    ...
    if (!options || options && !options.shouldPreserveAutoStyle) {
      // If the layer is saved without shouldPreserveAutoStyle option,
      // we should disable autostyle if it was enabled and remove any style from it
