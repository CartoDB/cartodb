    ...
    class UserPresenter
      ...
      def data(options = {})
        ...
        data = {
          ...
          storage: {
            quota_in_bytes: @user.quota_in_bytes, # Total quota, including premium subscriptions addons
            db_size_in_bytes: db_size_in_bytes, # Total DB storage used, including premium and public synchronized datasets
            subscriptions_public_size_in_bytes: @user.subscriptions_public_size_in_bytes, # DB storage used by public subscriptions
            subscriptions_premium_size_in_bytes: @user.subscriptions_premium_size_in_bytes # DB storage used by premium subscriptions
          },
