  ...
  render: function () {
    ...
    this.$el.html(
      template({
        ...
        subscriptionId: this._visModel.get('subscription_dataset_id'),
        subscriptionName: (subscription && subscription.type) === 'do-v2' ? 'Data Observatory' : this._visModel.get('subscription'),
