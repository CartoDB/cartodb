...
module CartoDB
  class Application < Rails::Application
    ...
    config.assets.precompile = %w( application.js cdb.js organization.js keys.js dashboard.js common_data.js table.js table_public.js login.js specs.js common.js embeds/jquery.tipsy.js embeds/respond.js)
