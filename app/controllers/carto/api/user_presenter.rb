    ...
    class UserPresenter
      ...
      def data(options = {})
        ...
        data = {
          ...
          org_admin: @user.organization_admin?,
          public_visualization_count: @user.public_visualization_count,
          public_privacy_visualization_count: @user.public_privacy_visualization_count,
          link_privacy_visualization_count: @user.link_privacy_visualization_count,
          password_privacy_visualization_count: @user.password_privacy_visualization_count,
