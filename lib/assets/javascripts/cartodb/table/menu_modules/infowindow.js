  ...
  cdb.admin.mod.InfoWindow = cdb.admin.Module.extend({
    ...
    renderThemeCombo: function() {
      this.themes = new cdb.forms.Combo({
        ...
        disabled: this.model.get('custom_html'),
        extra: [
      ...
      this.model.unbind('change:custom_html', this._setupThemesCombo, this);
      this.model.bind('change:custom_html', this._setupThemesCombo, this);
    },
    ...
    _setupPane: function() {
      ...
      if (this.model.get('custom_html')) active_tab = 'html';
