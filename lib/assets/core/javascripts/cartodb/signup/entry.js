...
function valid_google_signup() {
  return document.getElementById('user_google_sign_in') != null && document.getElementById('user_google_sign_in').value === 'true' && document.getElementById('user_email').value != '' && document.getElementById('user_username').value != '';
}
