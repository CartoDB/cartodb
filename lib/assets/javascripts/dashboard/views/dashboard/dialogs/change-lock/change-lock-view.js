...
module.exports = CoreView.extend({
  ...
  _renderConfirmChangeLock: function () {
    ...
    return viewTemplate({
      ...
      lockOrUnlockStr: areLocked ? _t('dashboard.views.dashboard.dialogs.unlock') : _t('dashboard.views.dashboard.dialogs.lock'),
  ...
  _renderProcessingItems: function () {
    ...
    return loadingView({
      title: _t('dashboard.views.dashboard.dialogs.' + lockingOrUnlockingStr + '_' + this.model.get('contentType'), {smart_count: this.model.get('items').length})
    });
  },
  ...
  _renderProcessItemsFail: function () {
    ...
    return failTemplate({
      msg: _t('dashboard.views.dashboard.dialogs.change_lock.failed_' + lockingOrUnlockingStr)
    });
  }
});
