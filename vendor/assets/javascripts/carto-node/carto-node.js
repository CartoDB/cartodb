(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CartoNode"] = factory();
	else
		root["CartoNode"] = factory();
})(this, function() {
...
var PublicClient = function () {
  ...
  _createClass(PublicClient, [{
    ...
    value: function addHeaders(obj, additional) {
      return _extends({}, obj.headers, additional);
    }
  }, {
    key: 'paramsToURI',
    ...
    value: function request(method, uriParts) {
      ...
      var baseUrl = this.getAssetsBaseUrl();
      var url = uriParts.length !== 0 ? this.makeAbsoluteURI(this.makeRelativeURI(uriParts)) : '';

      $.ajax('' + baseUrl + url, opts).done(this.successCallback(callback)).fail(this.errorCallback(callback));
    }
  }]);
...
var PublicClient = __webpack_require__(0);
...
module.exports = exports = {
  PublicClient: __webpack_require__(0),
  AuthenticatedClient: __webpack_require__(1)
};
