  ...
  /*  Titlecase title function used with aliasing throughout. Various model inputs (vis, table, model)
      may be appropriate */
  cdb.Utils.titleCaseName = function(model) {
    if (model.get('synchronization') && model.get('synchronization').from_external_source) {
      return Sugar.String.titleize(model.get('name'));
    }
