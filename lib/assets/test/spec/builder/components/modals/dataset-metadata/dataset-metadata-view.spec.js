...
describe('components/modals/dataset-metadata/dataset-metadata-view', function () {
  ...
  it('._getMetadataDescription sanitizes input', function () {
    this.view._visMetadataModel.set('description', "<img src='http://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/cache/b8/b4/b8b4e86a110557e6b6d666c9cf6d6cc8.png' />");
  ...
  it('._getMetadataTags sanitizes input', function () {
    this.view._visMetadataModel.set('tags', [
      "<img src='http://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/cache/b8/b4/b8b4e86a110557e6b6d666c9cf6d6cc8.png' />",
