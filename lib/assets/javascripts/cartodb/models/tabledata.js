  ...
  _fetch: function(opts) {
    ...
    var self = this;
      ...
      // get schema
        var process = function(self) {
          if (tmpSchemaAlias === undefined) {
            self.table.fetch(null, function() {
              tmpSchemaAlias = (self.table.get('column_aliases')) ? self.table.get('column_aliases') : undefined;
              process(self);
            }.bind(this));
            console.log('miss');
            return 
        ...
        var tmpSchemaAlias = (self.table.get('column_aliases')) ? self.table.get('column_aliases') : undefined;
        if(tmpSchemaAlias !== undefined) {
            process(self);
        }else{
            self.table.fetch(null, function() {
