cdb.admin.overlays.Image = cdb.admin.overlays.Text.extend({
  ...
  initialize: function() {
    ...
    this.template = this.getTemplate('table/views/overlays/text');
  ...
  _onMouseEnter: function() {
    ...
    if (this.editModel.get("mode") == "editable" && this.timeout) {
  ...
  _enableEditingMode: function() {
    ...
    setTimeout(function() {
      ...
      self.$text.html(text);
      self.$text.css({ height: h, minWidth: w });
  ...
  _disableEditingMode: function() {
    ...
    this.$text.css({ height: "auto", minWidth: "auto" });
