...
var OWN_ATTR_NAMES = ['id', 'order', 'infowindow', 'tooltip', 'error', 'style_history', 'from_layer_id', 'from_letter'];
...
module.exports = Backbone.Model.extend({
  ...
  toJSON: function () {
    ...
    var attributes = _.omit(this.attributes, 'infowindow', 'tooltip', 'options', 'error', 'style_history');
  ...
  _onPosibleLayerSchemaChanged: function (eventName, attrs, options) {
    if (options && options.ignore_schema_change) {
      return;
    }
  ...
  getStyleHistoryForNode: function (node_id) {
    var oldLayerStyle = this.get('style_history');
    return oldLayerStyle && oldLayerStyle[node_id];
  }
