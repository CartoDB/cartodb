...
var AnalysisNotificationErrorMessageHandler = require('./analysis-notification-error-message-handler');
...
var AnalysisNotifications = {
  ...
  _addAnalysisFailedNotification: function (analysisNode) {
    var message = AnalysisNotificationErrorMessageHandler.extractErrorMessage(analysisNode);
