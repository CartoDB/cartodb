...
var ColumnOptions = require('cartodb3/editor/layers/layer-content-views/analyses/column-options');
...
module.exports = BaseAnalysisFormModel.extend({
  ...
  _setSchema: function () {
    var schemaFields = {
      left_source: this._primarySourceSchemaItem(_t('editor.layers.analysis-form.source')),
      right_source: {
        type: 'NodeDataset',
      ...
      left_source_columns: {
        type: 'MultiSelect',
        title: _t('editor.layers.analysis-form.source-data'),
