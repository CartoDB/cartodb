...
var F = function (opts) {
  ...
  opts.editorModel.on('change:settings', this._onEditorSettingsChanged, this);
  ...
  this._getLayers().on('change:visible', function (layer, visible) {
    ...
    layerDefModel && layerDefModel.set({visible: visible});
  }, this);
...
F.prototype._onEditorSettingsChanged = function () {
  var settingsView = this._editorModel.get('settings');
  this._vis().settings.set('settingsView', settingsView);
};
