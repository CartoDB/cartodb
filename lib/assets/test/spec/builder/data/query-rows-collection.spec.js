...
describe('data/query-rows-collection', function () {
  ...
  describe('.isEmptyAsync', function () {
    describe('when collection is done', function () {
      beforeEach(function () {
        spyOn(this.collection, 'isDone').and.returnValue(true);
      });
    ...
    describe('when collection is not done', function () {
      beforeEach(function () {
        spyOn(this.collection, 'isDone').and.returnValue(false);
      });
