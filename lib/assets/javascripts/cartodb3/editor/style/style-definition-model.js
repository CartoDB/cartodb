...
module.exports = Backbone.Model.extend({
  ...
  setPropertiesFromAutoStyle: function (definition, geometryType) {
    ...
    var extendProperties = function (attribute, newProperties) {
    ...
    if (geometryType === 'line') {
      defaultAttrs.stroke = extendProperties('stroke', definition[geometryType]);
    } else {
      defaultAttrs.fill = extendProperties('fill', definition[geometryType]);
    }
