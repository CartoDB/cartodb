...
describe('editor/layers/layer-content-view/analyses/analyses-service', function () {
  ...
  describe('.addGeoreferenceAnalysis', function () {
    it('should add a georeference analysis', function () {
      ...
      expect(AnalysesService._stackLayoutView.model.goToStep).toHaveBeenCalledWith(1, this.layerDefinitionModel, 'layer-content', 'analyses', {
        source: 'a0',
        id: 'a1',
