...
module.exports = cdb.core.Model.extend({
  ...
  /**
   * Depending on analysis type the source model might differ.
   * @param {string} [sourceAttrName=source] - Name of attribute that holds the origin source id.
   * @return {Object, undefined} instance of AnalysisDefinitionModel, or undefined if there is no source
   */
  sourceModel: function (sourceAttrName) {
    return this.collection.get(this.get(sourceAttrName || 'source'));
  },
