...
function dataLoaded (data) {
  ...
  redirector.redirectOrgUsers(user_data.organization, user_data.username, 'profile', window.location);
  redirector.redirectToLoginIfAnotherIsLogged(user_data.username, window.location);
