...
module.exports = CoreView.extend({
  ...
  _initTable: function () {
    ...
    var hasWriteAccess = this._tableNodeModel && this._tableNodeModel.hasWriteAccess(this._userModel);
  ...
  _renderContextButtons: function () {
    ...
    var isSync = this._tableNodeModel && this._tableNodeModel.isSync();
    var hasWriteAccess = this._tableNodeModel && this._tableNodeModel.hasWriteAccess(this._userModel);
    var hasSQLApplied = !SQLUtils.isSameQuery(
      this._getQuerySchemaModel().get('query'),
      defaultQuery
    );
    var isReadOnly = isSync || !isSourceType || !hasWriteAccess || hasSQLApplied;
    var queryGeometryModel = this._getQueryGeometryModel();
