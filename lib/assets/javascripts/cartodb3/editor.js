...
var AddWidgetsView = require('./editor/add-widgets/add-widgets-view');
...
$addWidgetsBtn.on('click', function () {
  ...
  modals.create(function (modalModel) {
    return new AddWidgetsView({
      ...
      tablesCollection: tablesCollection,
      createWidgetsOptionsCollection: function () {
        // TODO implement actual factory method
