...
const BANNER_ACCOUNTS = ['FREE', '[DEDICATED]'];
...
var EmbedView = CoreView.extend({
  ...
  initialize: function (options) {
    ...
    this._showBanner = window.userData && (BANNER_ACCOUNTS.indexOf(window.userData.account_type) > -1);
  ...
  render: function () {
    ...
    if (this._showBanner) {
      ...
      this.$('.js-banner').append(embedView.render().el);
