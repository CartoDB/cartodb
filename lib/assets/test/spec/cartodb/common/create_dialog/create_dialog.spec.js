describe("Create dialog", function() {
  ...
  it('should render properly', function() {
    ...
    expect(view.$('.create-panes > .import-pane').length).toBe(3); // Gdrive, dropbox, arcgis and twitter will be disabled
  ...
  it('should enable/disable "service panes" when user changes keys', function() {
    ...
    expect(view.$('.create-panes > .import-pane').length).toBe(5);
  });
