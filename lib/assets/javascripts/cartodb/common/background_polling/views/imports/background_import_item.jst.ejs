<% if (failed) { %>
  ...
  <button class="Button Button-importShowDetails js-show_error">SHOW</button>
...
<% } else if (completed && !warnings) { %>
  ...
  <% if (showSuccessDetailsButton) { %>
    <% if (service && service === "twitter_search") { %>
      <button class="Button Button-importShowDetails js-show_stats">SHOW</button>
    <% } else if (tables_created_count === 1) { %>
      <a href="<%- url %>" class="Button Button-importShowDetails js-show">SHOW</a>
    <% } %>
  <% } %>
  <button class="ImportItem-closeButton js-close">
    <i class="CDB-IconFont CDB-IconFont-close ImportItem-closeButtonIcon"></i>
...
<% } else if (completed && warnings) { %>
  ...
  <button class="Button Button-importShowDetails js-show_warnings">SHOW</button>
  <button class="ImportItem-closeButton js-close">
    <i class="CDB-IconFont CDB-IconFont-close ImportItem-closeButtonIcon"></i>
  </button>
<% } else { %>
