...
module.exports = CoreView.extend({
  ...
  _renderForm: function () {
    ...
    if (this._formWidgetStyleView) {
      this.removeView(this._formWidgetStyleView);
      this._formWidgetStyleView.clean();
    }

    this._formWidgetStyleView = new WidgetsStyleFormView({
      userActions: this._userActions,
      widgetDefinitionModel: this._widgetDefinitionModel
    });
    this.addView(this._formWidgetStyleView);
    this.$el.append(this._formWidgetStyleView.render().el);
  }
});
