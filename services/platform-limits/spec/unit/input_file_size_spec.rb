...
describe Importer::InputFileSize do
  describe "#methods" do
    ...
    it "new(), maximum_limit?(),  key()" do
      ...
      fake_user_1 = CartoDB::Datasources::Doubles::User.new({username: 'test_1', max_import_file_size: max_value })
      fake_user_2 = CartoDB::Datasources::Doubles::User.new({username: 'test_1', max_import_file_size: max_value })
