...
var ConfirmationView = require('cartodb3/components/modals/confirmation/modal-confirmation-view');
var EditMetadataView = require('cartodb3/components/modals/map-metadata/map-metadata-view');
var templateConfirmation = require('./delete-map-confirmation.tpl');
var ExportView = require('cartodb3/editor/components/modals/export-map/modal-export-map-view');
var ExportMapModel = require('cartodb3/data/export-map-definition-model.js');
var removeMap = require('./map-operations/remove-map');
var renameMap = require('./map-operations/rename-map');
var InlineEditorView = require('cartodb3/components/inline-editor/inline-editor-view');
var templateInlineEditor = require('./inline-editor.tpl');
var CreationModalView = require('cartodb3/components/modals/creation/modal-creation-view');
var VisDefinitionModel = require('cartodb3/data/vis-definition-model');
var errorParser = require('cartodb3/helpers/error-parser');
var ShareWith = require('cartodb3/components/modals/publish/share-with-view');
var ContextMenuFactory = require('cartodb3/components/context-menu-factory-view');
var PrivacyDropdown = require('cartodb3/components/privacy-dropdown/privacy-dropdown-view');
