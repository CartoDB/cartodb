...
module.exports = BaseAnalysisFormModel.extend({
  parse: function (attrs) {
    ...
    attrs.points_source = attrs.points_source || attrs.source || '';
    attrs.polygons_target = attrs.polygons_target || attrs.target || '';
    return attrs;
  },
  ...
  initialize: function () {
    ...
    this.on('change:points_source', this._onChangeTarget, this);
  ...
  _getSourceOption: function () {
    var sourceNodeDefModel = this._layerDefinitionModel.findAnalysisDefinitionNodeModel(this.get('points_source'));
  ...
  _fetchColumns: function () {
    var target = this.get('points_source');
