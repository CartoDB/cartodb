...
var PublicUrlModel = require('./options/public_url_model');
var EmbedModel = require('./options/embed_model');
var CDBModel = require('./options/cdb_model');
...
module.exports = BaseDialog.extend({
  ...
  _initOptions: function() {
    ...
    this._publicUrlOption = new PublicUrlModel({
    ...
    // Embed option
    this._embedOption = new EmbedModel({
  ...
  _openPrivacyDialog: function(e) {
    ...
    privacyModal.bind('hide', function() {
      this.options.clean_on_hide = originalCleanOnHideValue;
      this.show();
      privacyModal.clean();
    }, this);
  }
