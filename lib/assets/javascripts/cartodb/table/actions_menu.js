...
cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
  ...
  showTools: function(tools) {
    this.getActivePane().showTools(tools);
  }
...
cdb.admin.LayerPanelView = cdb.admin.RightMenu.extend({
    ...
    setDataLayer: function(dataLayer) {
      ...
      var carto = new cdb.admin.mod.CartoCSS({
        ...
        self.addClassToButton('style_mod', 'has_errors');
      }).bind('clearError', function() {
        self.removeClassFromButton('style_mod', 'has_errors');
      });
      ...
      self.addModule(carto.render(), ['map', 'mapLite']);
