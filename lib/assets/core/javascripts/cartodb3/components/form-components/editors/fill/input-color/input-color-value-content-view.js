...
var OperatorListCollection = require('./input-operators/operators-list-collection');
...
module.exports = CoreView.extend({
  ...
  _createOperatorsList: function (stackLayoutModel, opts) {
    ...
    this.collection = new OperatorListCollection(columns);
    ...
    view.bind('change', function (item) {
      this._onChangeAttribute(item.attribute, stackLayoutModel);
    }, this);
