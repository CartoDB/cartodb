...
describe('editor/style/style-view', function () {
  ...
  describe('._launchOnboarding', function () {
    var resolveGeoreferencePromise = null;
    var resolveHasGeomPromise = null;

    beforeEach(function () {
      resolveGeoreferencePromise = fakePromise(this.view._layerDefinitionModel, 'canBeGeoreferenced');
      resolveHasGeomPromise = fakePromise(this.view._queryGeometryModel, 'hasValueAsync');
