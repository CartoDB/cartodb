<form>
  <div class="Editor-HeaderInfo">
    ...
    <div class="Editor-HeaderInfo-inner CDB-Text" data-fields="source,final_column">
      ...
      <p class="CDB-Text u-upperCase CDB-FontSize-small u-altTextColor u-bSpace--m"><%= linkContent %><%- _t('editor.layers.analysis-form.data-observatory-measurement-desc') %></p>
    </div>
  </div>
