...
var NotificationErrorHandler = require('../../../../../../javascripts/cartodb3/editor/layers/analysis-views/notification-error-message-handler');

fdescribe('NotificationErrorHandler.extractErrorFromAnalysisNode', function () {
  ...
  it('should extract the error from a string', function () {
    ...
    expect(errorMessage.message).toEqual('notifications.analysis.without-geom-webmercator');
  });
});
