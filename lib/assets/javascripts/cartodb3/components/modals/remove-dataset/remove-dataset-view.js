...
module.exports = ConfirmationView.extend({
  ...
  _runAction: function () {
    ...
    tableDeleteOperation({
      onSuccess: self._onSuccessDestroyDataset.bind(self, this._modalModel),
      onError: self._onErrorDestroyDataset.bind(self, this._modalModel),
  ...
  _onErrorDestroyDataset: function () {
