...
var onboardingKey = require('../../components/onboardings/layers/layer-onboarding-keys').style;
...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._onboardingNotification = new UserNotifications(this._builderNotifications, {
      key: 'builder',
