...
module.exports = CoreView.extend({
  ...
  _onFormModelChanged: function () {
    // If type changes, we should render again to select the proper view
    var typeFormChanged = this._formModel.hasChanged('type');
  ...
  _buildQuotaViewInfo: function () {
    ...
    if (service !== null && formModel.isValid() && dsReady) {
