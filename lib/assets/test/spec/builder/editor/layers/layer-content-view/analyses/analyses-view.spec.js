...
describe('editor/layers/layer-content-views/analyses/analyses-view', function () {
  ...
  describe('_launchOnboarding', function () {
    ...
    it('should do nothing if there is an analysis', function (done) {
      ...
      setTimeout(function () {
        expect(self.view._onboardingNotification.getKey(layerOnboardingKey)).toEqual(true);
    ...
    it('should create and launch onboarding', function (done) {
      ...
      setTimeout(function () {
        expect(self.view._onboardingNotification.getKey(layerOnboardingKey)).toEqual(false);
    ...
    it('should skip onboading if layer can be geocoded', function (done) {
      ...
      setTimeout(function () {
        expect(self.view._onboardingNotification.setKey).toHaveBeenCalledWith(layerOnboardingKey, true);
        done();
      }, 200);
    });
  });
