<div class="Dialog-header ErrorDetails-header">
  ...
  <p class="Dialog-headerTitle--warning">
    <%- _t('components.background-importer.errors.unable-to-import-as-layers') %>
  </p>
  <p class="Dialog-headerText">
    <%- _t('components.background-importer.find-connected-datasets') %></br>
    <%- _t('components.background-importer.upgrade-your-account', { userMaxLayers: warnings.user_max_layers }) %></br>
  </p>
</div>
    ...
    <ul class="ErrorDetails-list">
      <li class="ErrorDetails-item">
        ...
        <div class="ErrorDetails-itemText">
          <%- _t('components.background-importer.errors.too-many-datasets', { maxTablesPerImport: warnings.max_tables_per_import }) %></br>
        </div>
      </li>
    </ul>
  </div>
