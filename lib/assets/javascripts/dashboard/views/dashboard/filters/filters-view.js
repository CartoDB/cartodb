...
// const pluralizeString = require('../common/view_helpers/pluralize_string');
// const DuplicateMap = require('../common/dialogs/duplicate_vis_view');
// const DeleteItemsDialog = require('../common/dialogs/delete_items_view');
// const ChangeLockDialog = require('../common/dialogs/change_lock/change_lock_view');
// const ChangeLockViewModel = require('../common/dialogs/change_lock/change_lock_view_model');
// const DeleteItemsViewModel = require('../common/dialogs/delete_items_view_model');
...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this.listenTo(this.user, 'change:remaining_byte_quota', this.render);
  ...
  _openDeleteItemsDialog: function (e) {
    ...
    const view = new DeleteItemsDialog({
      viewModel: viewModel,
      user: this.user,
      clean_on_hide: true,
  ...
  _openChangeLockDialog: function (e) {
    ...
    const view = new ChangeLockDialog({
      model: viewModel,
      clean_on_hide: true,
      enter_to_confirm: true
    });
  ...
  _onWindowScroll: function () {
    ...
    const anchorPoint = this.options.headerHeight + (this.user.get('notification') ? this.options.headerHeight : 0);
