...
module.exports = CoreView.extend({
      ...
      return new ConfirmationModalView({
        ...
        runAction: function () {
          tableDeleteOperation({
            onSuccess: function () {
              self._onSuccessDestroyDataset.bind(self, modalModel);

              MetricsTracker.track('Deleted dataset', self._tableModel.attributes);
            },
  ...
  _isCustomQueryApplied: function () {
    ...
    return !SQLUtils.isSameQuery(originalQuery, this._querySchemaModel.get('query'));
  },
