...
describe('dashboard/views/public-profile/fav-map-view', function () {
  ...
  describe('given there is no data to create map from an user visualization', function () {
    beforeEach(function () {
      this.attrs = {
        fallbackBaselayer: {
          urlTemplate: 'https://cartodb-basemaps-{s}.freetls.fastly.net/rastertiles/voyager_nolabels/{z}/{x}/{y}.png',
    ...
    it('should create the fallback map with provided base layer', function () {
      ...
      expect(tileLayerArgs[0]).toBe('https://cartodb-basemaps-{s}.freetls.fastly.net/rastertiles/voyager_nolabels/{z}/{x}/{y}.png');
