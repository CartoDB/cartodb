...
const API_TYPES = {
  maps: _t('dashboard.views.api_keys.api_key_form_view.maps'),
  sql: _t('dashboard.views.api_keys.api_key_form_view.sql')
};
...
module.exports = CoreView.extend({
  ...
  _generateForm: function () {
    ...
    const schema = {
      name: {
        type: 'Text',
        title: _t('dashboard.views.api_keys.api_key_form_view.name'),
        validators: ['required'],
        hideValidationErrors: true,
        editorAttrs: {
          disabled: isDisabled,
          placeholder: _t('dashboard.views.api_keys.api_key_form_view.name_place'),
          id: 'js-api-key-name'
        }
      },
      token: {
        type: 'Text',
        title: _t('dashboard.views.api_keys.api_key_form_view.token'),
      ...
      apis: {
        type: 'MultiCheckbox',
        title: _t('dashboard.views.api_keys.api_key_form_view.apis'),
        validators: ['required'],
        hideValidationErrors: true,
        fieldClass: 'u-iBlock',
        inputs: [
          { name: API_TYPES.sql, label: _t('dashboard.views.api_keys.api_key_form_view.input_sql') },
          { name: API_TYPES.maps, label: _t('dashboard.views.api_keys.api_key_form_view.input_maps') }
        ],
        editorAttrs: {
          disabled: isDisabled
        }
  ...
  _renderTooltip: function () {
    this._validationTooltip = new TipsyTooltipView({
      el: this.$('.js-submit'),
      gravity: 's',
      title: () => _t('dashboard.views.api_keys.api_key_form_view.required')
    });
