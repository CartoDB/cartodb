...
module.exports = cdb.core.View.extend({
  ...
  render: function() {
    ...
    var avatarAcceptedExtensions = this._formatAvatarAcceptedExtensions(this.options.avatarAcceptedExtensions);
    ...
    this.$el.html(
      this.template({
        ...
        avatarAcceptedExtensions: this.options.avatarAcceptedExtensions
      })
    )
  ...
  _formatAvatarAcceptedExtensions: function(avatarAcceptedExtensions) {
    ...
    for (var i = 0; i < avatarAcceptedExtensions.length; i++) {
      avatarAcceptedExtensions[i] = "image/" + avatarAcceptedExtensions[i];
    }

    return avatarAcceptedExtensions.join(",");
  }
