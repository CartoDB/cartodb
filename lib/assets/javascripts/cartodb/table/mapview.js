...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _showMobileCanvas: function(mode) {
    ...
    var onBackgroundShown = function() {
      ...
      $map.animate(
        { width: 229, marginLeft: -229/2, left: "50%" },
    ...
    var onCanvasLandscapeStretched = function() {
      ...
      $map.animate(
        { height: 327, marginTop: -327/2,  top:  "50%" },
  ...
  _renderOverlay:  function(delayed_animation, model) {
    ...
    if (model.get("device") && model.get("device") != this.vis.get("canvas_mode")) {
      model.set("display", false);
    } else if (model.get("device")){
