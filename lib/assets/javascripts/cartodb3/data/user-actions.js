...
var nodeIds = require('cartodb3/value-objects/analysis-node-ids');
var MetricsTracker = require('cartodb3/components/metrics/metrics-tracker');
var SimpleStyleDefaults = require('cartodb3/editor/style/style-defaults/simple-style-defaults');
...
var resetStylePerNode = require('cartodb3/helpers/reset-style-per-node');
  ...
  return {
    ...
    createLayerForAnalysisNode: function (nodeId, fromLayerLetter, cfg) {
      ...
      var onNewLayerSaved = function (layer, forceResetStyles) {
        ...
        MetricsTracker.track('Dragged node');
      }.bind(this);
