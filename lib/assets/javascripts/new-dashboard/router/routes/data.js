    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          ...getCommonConnectionsRoutes('new-dataset', 'new-dataset-'),
          {
            path: 'add-local-file',
            name: 'add-local-file',
...
export function getCommonConnectionsRoutes (backNamedRoute, namePrefix = '') {
  return [
    {
      path: `connection/:id/dataset`,
      name: `${namePrefix}connection-dataset`,
      component: DatasetsConnectionPage,
      props: { backNamedRoute: backNamedRoute },
      meta: {
        title: () => 'Your connections | CARTO'
      }
    },
    {
      ...
      component: EditConnectionPage,
      props: { backNamedRoute: backNamedRoute },
      name: `${namePrefix}new-connection-connector`,
      meta: {
        title: () => 'Your connections | CARTO'
      }
    }
