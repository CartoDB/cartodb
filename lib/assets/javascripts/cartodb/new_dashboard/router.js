...
module.exports = Router.extend({
  ...
  routes: {
    ...
    ':content_type/shared/locked/search/:q':         '_changeRouteToSearch',
    ':content_type/shared/locked/search/:q/:page':   '_changeRouteToSearch',

    // Search only in my shared datasets/maps
    ':content_type/shared/search/:q':                '_changeRouteToSearch',
    ':content_type/shared/search/:q/:page':          '_changeRouteToSearch',

    // Search locked datasets/maps
    ':content_type/locked/search/:q':                '_changeRouteToSearch',
    ':content_type/locked/search/:q/:page':          '_changeRouteToSearch',

    // Search only in my liked datasets/maps
    ':content_type/liked/search/:q':                 '_changeRouteToSearch',
    ':content_type/liked/search/:q/:page':           '_changeRouteToSearch',

    // Search only in data library
    ':content_type/library/search/:q':               '_changeRouteToSearch',
    ':content_type/library/search/:q/:page':         '_changeRouteToSearch',
  ...
  initialize: function(opts) {
    ...
    this._rootPath = this._dashboardUrl.rootPath();
  ...
  normalizeFragmentOrUrl: function(str) {
    return str.replace(this._dashboardUrl, '');
  },
  ...
  currentUrl: function() {
    ...
    var type = this.model.get('content_type') || 'datasets';
    return this._dashboardUrl[type]();
  },
