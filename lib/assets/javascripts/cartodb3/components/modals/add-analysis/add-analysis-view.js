...
module.exports = cdb.core.View.extend({
  ...
  render: function () {
    ...
    if (this._isFetchingQueryShema()) {
      ...
      defaultAnalysisOptions.forEach(this._renderCategory, this);
    }
  ...
  _initOptions: function () {
    ...
    var modelsAttrs = _.reduce(defaultAnalysisOptions, function (memo, category) {
      category.analyses.map(function (d) {
        memo.push(_.extend({}, d, {category: category.id}));
      }, this);
