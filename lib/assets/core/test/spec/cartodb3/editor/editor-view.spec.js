...
describe('editor/editor-view', function () {
  ...
  it('should display infobox when a new non georeferenced layer is added', function () {
  ...
  describe('._findNonGeoreferencedLayer', function () {
    it('should display infobox when there are non georeferenced layers', function () {
      ...
      expect(this.view.$el.html()).toContain('editor.tab-pane.layers.georeference.title');
      expect(this.view.$el.html()).toContain('editor.tab-pane.layers.georeference.body');
      expect(this.view.$el.html()).toContain('editor.tab-pane.layers.georeference.show');
    });
  });
