...
describe('common/footer_view_static', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$el.html()).toContain('<li class="Footer-listItem CDB-Text CDB-Size-medium"><a href="https://carto.com/learn/guides/">Guides</a></li>');
  ...
  describe('is hosted', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$el.html()).not.toContain('<li class="Footer-listItem CDB-Text CDB-Size-medium"><a href="https://carto.com/learn/guides/">Guides</a></li>');
    });
  });
