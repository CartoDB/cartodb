describe('cdb.admin.SlidesPanel', function() {
  ...
  it("should activate the first slide after a remove", function(done) {
    ...
    $(view.$('.slide_view:not(".add") .count')[0]).trigger('click'); // activate the first slide
  ...
  it("should activate the last slide after a remove", function(done) {
    ...
    $(view.$('.slide_view:not(".add") .count')[2]).trigger('click'); // activate the last slide
  ...
  it("should activate the next slide after a remove", function(done) {
    ...
    $(view.$('.slide_view:not(".add") .count')[1]).trigger('click'); // activate the second slide
  ...
  it("should active on click", function() {
    slides.reset([{}, {}, {}]);
    $(view.$('.slide_view:not(".add") .count')[0]).trigger('click');
    ...
    $(view.$('.slide_view:not(".add") .count')[1]).trigger('click');
  ...
  it("should show transition dropdown on click", function() {
    slides.reset([{}, {}, {}]);
    $(view.$('.slide_view .info')[0]).trigger('click');
  });
});
