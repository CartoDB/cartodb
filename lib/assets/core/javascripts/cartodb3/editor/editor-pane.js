...
module.exports = CoreView.extend({
  ...
  getTranslatedLayersLabel: function () {
    return _t('editor.tab-pane.layers.title-label', {
      count: this._layerDefinitionsCollection.models.filter(
        function (model) {
          return model.get('type') === 'CartoDB';
        }
      ).length,
      maxCount: this._userModel.get('limits').max_layers
    });
  },
  ...
  render: function () {
    ...
    var tabPaneTabs = [{
      ...
      label: this.getTranslatedLayersLabel(),
  ...
  _onLayerCountChange: function () {
    ...
    layersModel.set('label', this.getTranslatedLayersLabel());
  },
