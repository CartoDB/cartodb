...
fdescribe('components/form-components/editors/fill/input-number/input-number-content-view', function () {
  describe('on model with a range', function () {
    ...
    describe('without default range', function () {
      beforeEach(function () {
        this.min = 1;
        this.max = 45;
    ...
    describe('with a default range', function () {
      it('should skip range calculation', function () {
        this.min = 1;
        this.max = 45;
        ...
        expect(this.model.get('range')).toEqual([6, 18]);
        this.view.remove();
      });
    });
  });
