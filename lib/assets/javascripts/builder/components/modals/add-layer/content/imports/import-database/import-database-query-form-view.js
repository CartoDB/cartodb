...
module.exports = ImportDataView.extend({
  ...
  _onTextChanged: function () {
    ...
    (query ? this.$('.js-submit').removeClass('is-disabled') : this.$('.js-submit').addClass('is-disabled'));
  },
    ...
    if (state === 'selected') {
      try {
        const connector = {
          ...
          connection: this.model.connector,
        ...
        this.model.set('errorMessage', _t('components.modals.add-layer.imports.bigquery.sql-error'));
