...
module.exports = cdb.core.View.extend({
  ...
  render: function() {
    ...
    var $el = $(
      this.getTemplate('common/dialogs/merge_datasets/spatial_merge/spatial_merge')({
        ...
        mergeMethods: this.model.get('mergeMethods'),
  ...
  _initBinds: function() {
    ...
    this.model.bind('change:selectedMergeMethod', this._onChangeSelectedMergeMethod, this);
  ...
  _onChangeSelectedMergeMethod: function(model, methodName) {
    var isCountMergeMethod = methodName === 'count';
