      ...
      describe('is org owner', function () {
        ...
        describe('with cartodb hosted', function () {
          ...
          it('should render properly', function () {
            ...
            expect(view.$el.html()).toContain('<p class="CDB-Text CDB-Size-small u-altTextColor">To renew it, please contact <a href="mailto:sales@carto.com">sales@carto.com</a></p>');
          });
        });
      });
