...
var heatmapConversion = function (style, animated) {
  ...
  if (animated) {
    ...
    style.animated = _.extend({}, defaultProperties);
  }
...
function isTypeTorque (type) {
  return type === 'animated' || type === 'heatmap'; // styleDef.animated && styleDef.animated.enabled && styleDef.animated.enabled !== 'false';
}
