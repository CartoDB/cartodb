...
(function() {
    ...
    cdb.admin.TableView = cdb.ui.common.Table.extend({
      ...
      initialize: function() {
        ...
        _.bindAll(this, "render", "addEmptyRow", "_checkEmptyTable", "rowChanged", "rowSynched", "rowFailed", "rowDestroyed", "emptyTable");
        ...
        this.model.bind('dataLoaded', this._checkEmptyTable);
        // this._models[0].bind('add', this._checkEmptyTable);
      ...
      headerView: function(column) {
        if(column[1] !== 'header') {
          ...
          }).bind('georeference', function() { self.$('.georeference').click();})
          this.addView(v);
          return v.render().el;
        } else {
      ...
      */
      addEmptyTableInfo: function() {
        if(this.$('.noRows').length == 0 && !this.model.isInSQLView()) {
          ...
          columns += '</tr>';
          var columnsFooter = '<tr class="placeholder noRows decoration">';
