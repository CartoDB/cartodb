cdb.admin.MapOptionsDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _setupOptions: function() {
    ...
    var simpleOverlays = ["search" , "share", "fullscreen", "fullscreen"];
  ...
  render: function() {
    ...
    this._addSwitches(['title', 'description', 'search', 'zoom', 'fullscreen', 'share'/*, 'cartodb_logo', 'layer_selector', 'legends', 'scrollwheel'*/]);
