...
module.exports = CoreView.extend({
                ...
                return new ScrollView({
                  createContentView: function () {
                    return new LayersView({
                      ...
                      showMaxLayerError: self._showMaxLayerError.bind(self)
                    });
                  }
                });
              },
  ...
  _getMaxLayerInfoBoxForCurrentUser: function () {
    var infoboxOpts = {
      type: 'alert',
      title: _t('editor.layers.max-layers-infowindow.title', { maxLayers: this._getMaxCount() })
    };
