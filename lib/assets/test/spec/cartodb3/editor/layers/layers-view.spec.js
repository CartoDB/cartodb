...
describe('editor/layers/layers-view', function () {
  ...
  describe('._onOrderOfLayersChanged', function () {
    beforeEach(function () {
    ...
    it('should move layers from top to bottom', function () {
      ...
      layer0.remove();
      this.view.$('.js-layers').append(layer0);
      this.view._onOrderOfLayersChanged('event', { item: layer0 });
    ...
    it('should move layers from bottom to top', function () {
      ...
      layer1.remove();
      this.view.$('.js-layers').prepend(layer1);

      this.view._onOrderOfLayersChanged('event', { item: layer1 });
