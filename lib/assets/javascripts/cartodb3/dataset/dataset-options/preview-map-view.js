...
module.exports = CoreView.extend({
  ...
  render: function () {
    var originalQuery = 'SELECT * FROM ' + this._tableModel.getUnquotedName();
    var isCustomQueryApplied = !SQLUtils.isSameQuery(originalQuery, this._querySchemaModel.get('query'));
