...
describe('editor/editor-pane', function () {
  ...
  var isThereAnyGeometryDataPromiseSpy;
  var handleRouteSpy;
  ...
  beforeEach(function () {
    ...
    isThereAnyGeometryDataPromiseSpy = fakePromise(this.layerDefinitionsCollection, 'isThereAnyGeometryData');
    isThereAnyGeometryDataPromiseSpy.resolve(true);
