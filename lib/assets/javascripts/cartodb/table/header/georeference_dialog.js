...
cdb.admin.GeoreferenceDialog = cdb.admin.BaseDialog.extend({
  ...
  _geocodeAdmin: function(adm, column_name, country_code, geometry_type) {
    ...
    // Event tracking "Geocoding admin"
    cdb.god.trigger('metrics', 'geocoding_admin', {
  ...
  _geocodeZip: function(column_name, country_code, geometry_type) {
    ...
    // Event tracking "Geocoding zip"
    cdb.god.trigger('metrics', 'geocoding_zip', {
      email: window.user_data.email,
      data: {
        type: 'postalcode',
        country_code: country_code,
  ...
  _geocodeWorld: function(column_name, geometry_type) {
    ...
    // Event tracking "Geocoding world"
    cdb.god.trigger('metrics', 'geocoding_world', {
      email: window.user_data.email,
      data: {
        type: 'admin0',
        geometry_type: geometry_type,
  ...
  _geocodeNamedPlace: function(column_name, country_code, geometry_type) {
    ...
    // Event tracking "Geocoding namedplace"
    cdb.god.trigger('metrics', 'geocoding_namedplace', {
      email: window.user_data.email,
      data: {
        type: 'namedplace',
        country_code: country_code,
  ...
  _geoCodeLatAndLng: function() {
    ...
    // Event tracking "Geocoding latlng"
    cdb.god.trigger('metrics', 'geocoding_latlng', {
      email: window.user_data.email,
      data: {
  ...
  _geoCodeIP: function() {
    ...
    // Event tracking "Geocoding ip"
    cdb.god.trigger('metrics', 'geocoding_ip', {
      email: window.user_data.email,
      data: {
        type: kind,
        table_name: this.table.get('id')
  ...
  _geoCodeAddress: function() {
    ...
    if (this._checkAddressInput(address)) {
      ...
      // Event tracking "Geocoding address"
      cdb.god.trigger('metrics', 'geocoding_address', {
        email: window.user_data.email,
        data: {
          type: 'point-address',
          address: address,
