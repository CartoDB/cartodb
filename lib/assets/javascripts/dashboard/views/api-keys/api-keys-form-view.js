...
module.exports = CoreView.extend({
  ...
  events: {
    ...
    'click input#create': '_onClickCreateCheckbox',
    'click input#sql': '_onClickSqlCheckbox'
  ...
  _hasErrors: function () {
    ...
    const selectedCreateOrListing = _.some(this._formView.getValue().datasets);
    const selectedPermissions = selectedDatasetsPermissions || selectedCreateOrListing;
