...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _showPecan: function() {
    ...
    if (this.user.featureEnabled('pecan_cookies') && this.user.featureEnabled('new_modals') && this.options.table && this.options.table.data().fetched && this.options.table.data().length > 0) {
