...
module.exports = cdb.admin.DropdownMenu.extend({
  ...
  _onClickAdministrative: function(e) {
    this.model.set('tags', 'administrative-regions');
    this.hide();
  },

  _onClickCultural: function(e) {
    this.model.set('tags', 'cultural-datasets');
    this.hide();
  },

  _onClickPhysical: function(e) {
    this.model.set('tags', 'physical-datasets');
    this.hide();
  },

  _onClickHistoric: function(e) {
    this.model.set('tags', 'historic');
    this.hide();
  },

  _onClickBuilding: function(e) {
    this.model.set('tags', 'building-footprints');
    this.hide();
  },

  _onClickCensus: function(e) {
    this.model.set('tags', 'us-census');
    this.hide();
  },
