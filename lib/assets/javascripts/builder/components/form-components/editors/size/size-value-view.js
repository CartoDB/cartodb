...
module.exports = CoreView.extend({
  ...
  _initInputColumn: function () {
    var column = this.model.get('attribute');
    var placeholder = column || _t('form-components.editors.style.select-column');
    this._inputColumn = new Backbone.Form.editors.Text({
      schema: {},
      editorAttrs: { placeholder: placeholder }
    });
    this._inputColumn.el.className += ' is-cursor';
    this._inputColumn.on('focus', this._onInputClick.bind(this));
