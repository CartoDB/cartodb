...
module.exports = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    this.template = this.options.template || cdb.templates.getTemplate('new_common/views/custom_datepicker');
  ...
  _setToday: function() {
    ...
    var first = moment(new Date()).utcOffset(utc).subtract('days', (this._MAX_RANGE - 1) ).format("YYYY-MM-DD");
  ...
  _initCalendar: function() {
    ...
    this.calendar = this.$('.DatePicker-calendar').DatePicker(
