...
module.exports = cdb.core.View.extend({
  ...
  initialize: function (opts) {
    ...
    this._infoboxModel = new InfoboxModel({
      state: 'confirm',
      visible: !this._editorModel.get('edition') && this._layerDefinitionModel.get('cartocss_custom')
    });
  ...
  _closeInfobox: function () {
    this._infoboxModel.set({visible: false});
  },
  ...
  _onChangeEdition: function () {
    ...
    this._infoboxModel.set({visible: !edition && cartocss_custom});
        ...
        return new ScrollView({
          createContentView: function () {
            return new StyleContentView({
              ...
              overlayModel: self._infoboxModel
            });
          }
        });
      },
    ...
    var infoboxSstates = [
      {
        ...
        createContentView: function () {
          return Infobox.createConfirmAndCancel({
            ...
            body: 'You just applied styles with CartCSS editor. You can continue or clear all styles.',
            cancelLabel: 'CLEAR',
