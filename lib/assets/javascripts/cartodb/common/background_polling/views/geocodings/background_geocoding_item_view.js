...
var BackgroundSuccessDetailsView = require('./geocoding_success_result_view');
...
module.exports = cdb.core.View.extend({
  ...
  events: {
    ...
    'click .js-success': '_showSucccessDetails',
    'click .js-error': '_showErrorDetails',
  ...
  _showSucccessDetails: function() {
    new BackgroundSuccessDetailsView({
      clean_on_hide: true,
      user: this.user,
      model: this.model
    }).appendToBody();
