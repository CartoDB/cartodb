...
module.exports = CoreView.extend({
  ...
  _fetchAllQueryObjectsIfNecessary: function () {
    if (this.model.isDone()) {
      ...
      this._initializeGeocoding()
        .then(self._initializeLayerEmptyness.bind(self))
  ...
  _initializeGeocoding: function () {
    ...
    return this._layerDefinitionModel.canBeGeoreferenced()
      .then(function (canBeGeoreferenced) {
        if (self._canBeGeoreferenced !== canBeGeoreferenced) {
          self._canBeGeoreferenced = canBeGeoreferenced;
        }
        return Promise.resolve(canBeGeoreferenced);
      });
  },
  ...
  _initializeLayerEmptyness: function () {
    ...
    return this._layerDefinitionModel.isEmptyAsync()
