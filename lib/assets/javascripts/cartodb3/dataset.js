...
var ModalsServiceModel = require('cartodb3/components/modals/modals-service-model');
var MetricsTracker = require('cartodb3/components/metrics/metrics-tracker');
var AnalysisDefinitionNodeSourceModel = require('cartodb3/data/analysis-definition-node-source-model');
...
var DatasetUnlockModalView = require('cartodb3/dataset/dataset-unlock-modal-view');
...
var UserGroupFetcher = require('cartodb3/data/users-group-fetcher');
var SQLUtils = require('cartodb3/helpers/sql-utils');
var BuilderActivatedNotification = require('cartodb3/components/onboardings/builder-activated/builder-activated-notification-view');
var UserNotifications = require('cartodb3/data/user-notifications');
var layerTypesAndKinds = require('cartodb3/data/layer-types-and-kinds');
var DatasetView = require('cartodb3/dataset/dataset-view');
