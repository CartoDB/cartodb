describe('cdb.common.DashboardUrl', function() {
  beforeEach(function() {
    this.url = new cdb.common.DashboardUrl({
      base_url: 'http://team.cartodb.com/u/pepe/dashboard'
    });
  });
  ...
  describe('.datasets', function() {
    ...
    it('should return a new URL pointing for datsets', function() {
      ...
      expect(this.newUrl.get('base_url').toString()).toEqual('http://team.cartodb.com/u/pepe/dashboard/datasets');
    });
  });
  ...
  describe('.maps', function() {
    ...
    it('should return a new URL for maps', function() {
      expect(this.newUrl).not.toBe(this.url);
      expect(this.newUrl.get('base_url').toString()).toEqual('http://team.cartodb.com/u/pepe/dashboard/maps');
    });
  });
});
