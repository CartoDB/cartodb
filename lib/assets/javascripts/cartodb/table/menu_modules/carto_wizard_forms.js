...
var polygon_stroke = {
   ...
   title: 'Border',
   form: {
      'line-width': { type: 'width', value: 1.0 },
      'line-color': { type: 'color' , value: '#FFFFFF' },
      'line-opacity': { type: 'opacity', value: 0.3 }
   }
};
...
var line_stroke = {
   ...
   form: {
      ...
      'line-color': { type: 'color' , value: '#FFA028' },
...
var polygon_fill = {
   ...
   title: 'Fill',
   form: {
      'polygon-fill': { type: 'color' , value: '#FFA028', extra: { image_property: 'polygon-pattern-file', image_kind: 'pattern' }},
      'polygon-opacity': { type: 'opacity_polygon' , value: 0.8 }
  }
};
...
var label_text_properties = {
    ...
    form: {
      ...
      'text-size': { type: 'number', value: 13, min: 1, max:50 },
      'text-fill': { type: 'color' , value: '#FFFFFF' }
    }
};
...
var label_text_offset =  {
    ...
    form: {
      'text-dy': { type: 'number', value: -15, min: -30, max: 30 }
    }
}
var label_text_offset_polygon = $.extend(true, {}, label_text_offset);
label_text_offset_polygon.form['text-dy'].value = 0;
...
var label_halo_properties = {
  ...
  form: {
    'text-halo-fill':  { type: 'color' , value: '#000000' },
    'text-halo-radius': { type: 'number', value: 0, min: 0, max: 10, inc: 0.5}
  }
};
...
var marker_fill = {
       ...
       form: {
          ...
          'marker-fill': { type: 'color' , value: '#FFA028', extra: { image_property: 'marker-file' }},
...
var marker_stroke = {
   ...
   title: 'Border',
   form: {
      'marker-line-width': { type: 'width', value: 0.0 },
      'marker-line-color': { type: 'color' , value: '#FFFFFF' },
      'marker-line-opacity': { type: 'opacity', value: 0.8 }
  }
};
...
var color_ramp_polyline = {
  name: 'Color Ramp',
  form: {
    'color_ramp': { type: 'select', value: 'bbg_amber', 
        extra:['bbg_amber', 'bbg_inverted_amber', 'bbg_purple', 'bbg_inverted_purple', 'bbg_black', 'bbg_inverted_black', 'bbg_green', 'bbg_inverted_green', 'bbg_blue', 'bbg_inverted_blue', 'bbg_amber_blue', 'bbg_blue_amber', 'bbg_red_green', 'bbg_green_red', 'bbg_pink_cyan', 'bbg_cyan_pink', 'bbg_amber_purple', 'bbg_purple_amber', 'bbg_purple_green', 'bbg_green_purple', 'bbg_red_blue', 'bbg_blue_red'] },
    'line-opacity': { type: 'opacity', value: 0.8 }
  }
};
...
var bubble_form = [
  ...
  QuantifyFn,
  {
     ...
     title: 'Size Range',
     form: {
       'radius_min': { type: 'number', value: 12, min:0, max:100 },
       'radius_max': { type: 'number', value: 50, min:0, max:100 }
     },
     text: '- to -'
  },
  {
     ...
     title: 'Fill',
     form: {
       'marker-fill': { type: 'color', value: '#FFA028' },
       'marker-opacity': { type: 'opacity', value: 0.8 }
     }
  },
  {
     ...
     title : 'Border',
     form: {
       'marker-line-width': { type: 'number', value: 0.0, min:0, max:100, inc: 0.5 },
       'marker-line-color': { type: 'color', value: '#FFFFFF' },
       'marker-line-opacity': { type: 'opacity', value: 0.8 }
     }
  },
...
cdb.admin.forms.cluster = {
  'point': [
    ...
    form: {
      'marker-line-width': { type: 'width', value: 0.0 },
      'marker-line-color': { type: 'color' , value: '#ffffff' },
      'marker-line-opacity': { type: 'opacity', value: 0.0 }
    }
  }, {
    name: 'Radius',
    title: 'Size Range',
    form: {
      'radius_min': { type: 'number', value: 22, min:0, max:200 },
    ...
    form: {
      'text-halo-fill':  { type: 'color' , value: '#000000' },
      'text-halo-radius': { type: 'number', value: 0.0, min: 0, max: 10, inc: 0.5}
    }
  }
  ]
};
