...
var EmbedView = CoreView.extend({
  ...
  initialize: function (options) {
    ...
    this._onlyLayerSelector = !this.options.showLegends && this.options.showLayerSelector;
    this._showLegends = this.options.showLegends || this.options.showLayerSelector;
  ...
  render: function () {
    ...
    var mapTabConfig = { name: TAB_NAMES.map, isSelected: true };
    var legendTabConfig = {
