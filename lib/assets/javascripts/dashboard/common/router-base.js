...
var RouterBase = Backbone.Router.extend({
  ...
  enableAfterMainView: function () {
    ...
    this.navigate = function (fragmentOrUrl, opts) {
      console.log(this.normalizeFragmentOrUrl(fragmentOrUrl), opts);
    ...
    Backbone.history.start({
      pushState: true,
      // TODO: Change this apply
      root: this.rootPath.apply(this.rootPath) + '/' // Yes, this trailing slash is necessary for the router to update the history state properly.
    });
  },
