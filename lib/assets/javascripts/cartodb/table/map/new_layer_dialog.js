...
cdb.admin.NewLayerDialog = cdb.admin.BaseDialog.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_onUploadError", "_onUploadProgress", "_onUploadStart", "_onUploadAbort", "_onInputPaste", "_onInputChange", "_onDragOver", "_onDrop", "_onUploadAdd", "_onUploadComplete", "_changeOption", "_checkOptions", "_keydown");
    ...
    var self = this
      ...
      .bind("importComplete", function(e){
        imp.unbind();
          ...
          self.trigger("addLayer", imp.get("table_name"));
  ...
  _ok: function(e) {
    ...
    if (this.active) {
      if (this.option == 1) {
        ...
        this.ok && this.ok(this.result, this.private_vis);
        this.hide();
      }
    }
  }
