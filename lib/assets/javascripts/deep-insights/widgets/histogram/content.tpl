<div class="CDB-Widget-header js-header">
  ...
  <% if (showStats) { %>
    <dl class="CDB-Widget-info CDB-Text CDB-Size-small u-secondaryTextColor u-upperCase u-tSpace">
      <% if (showNulls) { %>
      <dt class="CDB-Widget-infoCount js-nulls">0</dt><dd class="CDB-Widget-infoDescription"><%= _t('deep_insights.widgets.null_rows_3') %></dd>
      <% } %>
      <dt class="CDB-Widget-infoCount js-min">0</dt><dd class="CDB-Widget-infoDescription"><%= _t('deep_insights.widgets.min') %></dd>
      <dt class="CDB-Widget-infoCount js-avg">0</dt><dd class="CDB-Widget-infoDescription"><%= _t('deep_insights.widgets.avg') %></dd>
      <dt class="CDB-Widget-infoCount js-max">0</dt><dd class="CDB-Widget-infoDescription"><%= _t('deep_insights.widgets.max') %></dd>
    </dl>
  <% } %>
</div>
...
<div class="CDB-Widget-content CDB-Widget-content--histogram js-content">
  <div class="CDB-Widget-filter CDB-Widget-contentSpaced ">
    ...
    <div class="CDB-Widget-filterButtons js-filter is-hidden">
      <button class="CDB-Text CDB-Size-small u-upperCase u-actionTextColor CDB-Widget-filterButton js-zoom"><%= _t('deep_insights.widgets.zoom') %></button>
      <button class="CDB-Text CDB-Size-small u-upperCase u-actionTextColor CDB-Widget-filterButton js-clear"><%= _t('deep_insights.widgets.clear') %></button>
    </div>
  </div>
