...
cdb.admin.Map = cdb.geo.Map.extend({
  ...
  setBaseLayer: function(baseLayer) {
    ...
    this._updateAttribution(attributionOfCurrentBaseLayer, newBaseLayer.get('attribution'));
  ...
  _updateAttribution: function(old, new_) {
    var attributions = _.clone(this.get("attribution")) || [];
