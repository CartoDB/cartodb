...
module.exports = {
  ...
  BigQuery: {
    ...
    // TODO: !config.get('bigquery_available') => omit; else !config.get('bigquery_enabled') => grayed out
    enabled: function (config, userModel) {
      // return !!config.get('bigquery_enabled');
      return true;
    },
    fallback: require('./fallbacks/import-bigquery-fallback.tpl'),
    name: 'bigquery',
    title: 'BigQuery',
    type: 'database',
    options: {
  ...
  PostgreSQL: {
    view: ImportDataView,
    enabled: function (config, userModel) { return true; },
    fallback: require('./fallbacks/import-postgresql-fallback.tpl'),
    name: 'postgresql',
    title: 'PostgreSQL',
    type: 'database'
  },
