...
exports.task = function (grunt) {
  return {
    ...
    js_dashboard: {
      files: [{
        expand: true,
        cwd: 'lib/assets/core/javascripts/dashboard/',
        src: ['**/*'],
        dest: 'lib/assets/javascripts/dashboard/'
      }, {
        expand: true,
        cwd: 'lib/assets/client/javascripts/dashboard/',
        src: ['**/*'],
        dest: 'lib/assets/javascripts/dashboard/'
      }]
    },
    ...
    js_test_dashboard: {
      files: [{
        expand: true,
        cwd: 'lib/assets/core/test/spec/dashboard/',
        src: ['**/*'],
        dest: 'lib/assets/test/spec/dashboard/'
      }, {
        expand: true,
        cwd: 'lib/assets/client/test/spec/dashboard/',
        src: ['**/*'],
        dest: 'lib/assets/test/spec/dashboard/'
      }]
    },
