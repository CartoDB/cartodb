...
describe('new_dashboard/datasets/datasets_item', function() {
  ...
  it('should add/remove selectable class', function() {
    this.renderView();
    expect(this.view.$el.hasClass('DatasetsList-item--selectable')).toBeTruthy();
    spyOn(this.vis.permission, 'isOwner').and.returnValue(false);
    this.renderView();
    expect(this.view.$el.hasClass('DatasetsList-item--selectable')).toBeFalsy();
  });
  ...
  describe('given user does NOT own dataset', function() {
    ...
    it('should not be able to select the model', function() {
      this.renderView();
      this.view.$el.click();
      expect(this.view.$el.hasClass('is--selected')).toBeFalsy();
    });
