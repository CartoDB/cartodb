...
const IconPickerDialog = require('dashboard/views/organization/icon-picker/icon-picker-dialog/icon-picker-dialog-view');

const configModel = require('fixtures/dashboard/config-model.fixture');
const orgId = '5p3c724-1ndv572135';

describe('organization/icon-picker/icon-picker-dialog/icon-picker-dialog-view', function () {
  beforeEach(function () {
