...
module.exports = cdb.core.View.extend({
  ...
  _openAddAnalysis: function (layerDefinitionModel) {
    ...
    this._modals.create(function (modalModel) {
      modalModel.once('destroy', function (analysisFormAttrs) {
        this._onAddAnalysisModalClosed(layerDefinitionModel, analysisFormAttrs);
      }, self);
  ...
  _onAddAnalysisModalClosed: function (layerDefinitionModel, analysisFormAttrs) {
    if (analysisFormAttrs) {
      this._stackLayoutModel.nextStep(layerDefinitionModel, 'layer-content', analysisFormAttrs);
    }
  },
