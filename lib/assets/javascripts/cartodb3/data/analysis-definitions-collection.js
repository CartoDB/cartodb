...
module.exports = Backbone.Collection.extend({
  ...
  _onAnalysisDefinitionNodeRemoved: function (removedNodeDefModel) {
    ...
    // defer to let side-effects related to the this removed node finish before the rest
    _.defer(this._deleteOrphanedNodes.bind(this));
  },

  _deleteOrphanedNodes: function () {
    this._analysisDefinitionNodesCollection
      .filter(this._isNodeOrphaned, this)
  ...
  _isNodeOrphaned: function (nodeDefModel) {
    return this.all(function (analysisDefModel) {
