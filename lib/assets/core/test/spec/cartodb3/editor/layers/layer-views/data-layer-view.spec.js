...
describe('editor/layers/data-layer-view', function () {
  ...
  it('should render warning icon when layer doesn\'t have geometry', function () {
    expect(this.view.$('.js-georeferenceIcon').length).toBe(0);
    spyOn(this.view, '_queryGeometryHasGeom').and.returnValue(false);
    this.view.render();
    expect(this.view.$('.js-georeferenceIcon').length).toBe(1);
    expect(this.view.$('.js-georeferenceIcon').data('tipsy')).not.toBeUndefined();
  });
