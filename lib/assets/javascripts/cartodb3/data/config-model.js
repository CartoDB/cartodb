...
module.exports = cdb.core.Model.extend({
   ...
   * @return {String} the full sql api url, including the api endpoint, e.g. http://user.cartodb.com/api/v2/sql
   */
  ...
  /**
   * @return {String} returns the base url to compose the final url, e.g. http://user.cartodb.com/
   */
