...
cdb.admin.GeoreferenceDialog = cdb.admin.BaseDialog.extend({
  ...
  _geocodeAdmin: function(adm, column_name, country_code, geometry_type) {
    ...
    // Hubspot tracking "Geocoding admin"
    cdb.god.trigger('hubspot', '000000266362', {
  ...
  _geocodeZip: function(column_name, country_code, geometry_type) {
    ...
    // Hubspot tracking "Geocoding zip"
    cdb.god.trigger('hubspot', '000000266365', {
      email: window.user_data.email,
      data: {
        type: 'postalcode',
        country_code: country_code,
  ...
  _geocodeWorld: function(column_name, geometry_type) {
    ...
    // Hubspot tracking "Geocoding world"
    cdb.god.trigger('hubspot', '000000266366', {
      email: window.user_data.email,
      data: {
        type: 'admin0',
        geometry_type: geometry_type,
  ...
  _geocodeNamedPlace: function(column_name, country_code, geometry_type) {
    ...
    // Hubspot tracking "Geocoding namedplace"
    cdb.god.trigger('hubspot', '000000266367', {
      email: window.user_data.email,
      data: {
        type: 'namedplace',
        country_code: country_code,
  ...
  _geoCodeLatAndLng: function() {
    ...
    // Hubspot tracking "Geocoding latlng"
    cdb.god.trigger('hubspot', '000000266368', {
      email: window.user_data.email,
      data: {
  ...
  _geoCodeIP: function() {
    ...
    // Hubspot tracking "Geocoding ip"
    cdb.god.trigger('hubspot', '000000266369', {
      email: window.user_data.email,
      data: {
        type: kind,
        table_name: this.table.get('id')
  ...
  _geoCodeAddress: function() {
    ...
    if (this._checkAddressInput(address)) {
      ...
      // Hubspot tracking "Geocoding address"
      cdb.god.trigger('hubspot', '000000266369', {
        email: window.user_data.email,
        data: {
          type: 'point-address',
