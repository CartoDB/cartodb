  ...
  updateSchema: function () {
    ...
    this.schema = {
      ...
      aggregation: {
        ...
        options: [
          {val: 'sum', label: _t('editor.style.style-form.aggregation.options.sum')},
          {val: 'count', label: _t('editor.style.style-form.aggregation.options.count')},
          {val: 'min', label: _t('editor.style.style-form.aggregation.options.min')},
          {val: 'max', label: _t('editor.style.style-form.aggregation.options.max')},
          {val: 'avg', label: _t('editor.style.style-form.aggregation.options.avg')}
        ],
        editorAttrs: {
          showSearch: false
        }
