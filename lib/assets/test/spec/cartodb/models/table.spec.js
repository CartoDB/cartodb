...
describe("admin table", function() {
  ...
  describe("cbd.admin.CartoDBTableMetadata", function() {
    ...
    it("altertabledata", function() {
      ...
      expect(t.alterTableData('create index foo_idx on foo using gist(the_geom)')).toEqual(false);
      expect(t.alterTableData('grant update on foo to jerry')).toEqual(false);
      expect(t.alterTableData('create index foo_idx on public.foo (cartodb_id)')).toEqual(false);
      expect(t.alterTableData('revoke update on foo from jerry')).toEqual(false);
      expect(t.alterTableData('reindex public.foo')).toEqual(false);
      expect(t.alterTableData('cluster public.foo using foo_gidx')).toEqual(false);
