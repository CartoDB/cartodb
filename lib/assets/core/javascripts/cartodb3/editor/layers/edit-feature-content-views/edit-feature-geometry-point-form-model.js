...
module.exports = EditFeatureGeometryFormModel.extend({
  ...
  _getLatitude: function () {
    if (this.has('lat')) {
      return this._formatCoordinate(this.get('lat'));
    }
    ...
    if (latitudeFromGeoJSON) {
      return this._formatCoordinate(latitudeFromGeoJSON);
    }
  },

  _getLongitude: function () {
    if (this.has('lng')) {
      return this._formatCoordinate(this.get('lng'));
    }
    ...
    if (longitudeFromGeoJSON) {
      return this._formatCoordinate(longitudeFromGeoJSON);
    }
  },
