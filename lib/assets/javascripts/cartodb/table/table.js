    ...
    */
    ...
    _initViews: function() {
      ...
      if (this.user.featureEnabled('new_modals')) {
        ...
        bgPollingView.bind('geocodingCompleted', function(mdl) {
        ...
        bgPollingView.bind('geocodingFailed', function() {
        ...
        bgPollingView.bind('importCompleted', function() {
          // Reload user data in order to have updated info
          // about limits etc.
          this.user.fetch();
        }, this);
