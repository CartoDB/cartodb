...
describe('components/modals/add-layer/content/imports/import-database/import-database-connect-form-view', function () {
  const importOptions = { name: 'postgresql', title: 'PostgreSQL', type: 'database', service: 'postgres' };
  ...
  describe('_checkConnectionSuccess', function () {
    it('should set model state `connected` if Import API call succeeds', function () {
      this.view._checkConnectionSuccess(this.view, { status: 200, connected: true });
    ...
    it('should set model state `error` if Import API call succeeds but does not connect', function () {
      this.view._checkConnectionSuccess(this.view, { status: 400, connected: false });
  ...
  describe('_buildQueryParamsString', function () {
    it('should build the query params string given an object', function () {
      const params = {
        param1: 'value1',
        param2: 'value2',
        param3: 'value3'
      ...
      expect(this.view._buildQueryParamsString(params)).toBe('param1=value1&param2=value2&param3=value3');
    });
  });
});
