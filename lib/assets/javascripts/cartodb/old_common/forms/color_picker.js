  ...
  cdb.admin.ColorPicker = cdb.admin.DropdownMenu.extend({
    ...
    _COLORS: [
      // First file
      "#c5fad0","#00ff3d","#ff7987","#ff001e",
      "#ffcf94","#ffa028","#f993dd","#ff28dd","#80bbff","#00b6ff",
      "#fef399","#ffff01","#cccccc","#999999","#ffffff",
      // Second file
      "#00831d","#00420d","#c31634","#55001f",
      "#b6721d","#925b18","#ae1d86","#8b176a","#0056b7","#004592",
      "#b7a100","#928000","#6a6a6a","#2a2a2a","#000000"
    ],
