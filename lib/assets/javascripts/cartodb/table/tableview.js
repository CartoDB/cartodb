    ...
    cdb.admin.TableView = cdb.ui.common.Table.extend({
      ...
      _renderHeader: function() {
        ...
        if (this.user.featureEnabled("bbg_geom_columns")) {
          ...
          _(this.model.get('schema')).each(function(col) {
            if (col[0] !== 'the_geom' && col[0] !== 'the_geom_webmercator') {
      ...
      _getColumnName: function(idx) {
          if (this.user.featureEnabled("bbg_geom_columns")) {
            ...
            columnNames = _.reject(columnNames, function(c) { return (c === 'the_geom' || c === 'the_geom_webmercator') });
    ...
    */
    cdb.admin.TableTab = cdb.core.View.extend({
      ...
      _changeTitle: function() {
        this.$('.table_title').remove();
        this.$el.prepend(cdb.templates.getTemplate('table/views/table_title')({'tablename': this.model.get('name')}));
      },
