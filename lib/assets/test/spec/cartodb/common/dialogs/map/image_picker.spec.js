  ...
  describe('image_picker_view (with dropbox)', function() {
    ...
    it("should toggle the user icons tab depending on the user's assets", function() {
      ...
      this.view.collection.reset([{
        public_url: 'http://com.cartodb.assets.dev.s3.dualstack.us-east-1.amazonaws.com/development/dev/assets/layers.png',
        kind: 'pattern',
        id: 59
      },{
        public_url: 'http://com.cartodb.assets.dev.s3.dualstack.us-east-1.amazonaws.com/development/dev/assets/layers.png',
    ...
    it("should select the asset url when clicking on an asset", function() {
      ...
      this.view.$('.AssetPane.AssetPane-userIcons .AssetsList li:first-child').click();
      expect(this.view.model.get("value")).toBe("http://com.cartodb.assets.dev.s3.dualstack.us-east-1.amazonaws.com/development/dev/assets/layers.png");
    });
