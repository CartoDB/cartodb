(function() {
  ...
  var TableView = cdb.core.View.extend({
    ...
    render: function() {
      ...
      var pretty_rows_counted = this._formatNumber(this.model.get("rows_counted"));

      this.$el.html(this.template(_.extend(this.model.toJSON(), { rows_counted: pretty_rows_counted } )));
