...
module.exports = CoreView.extend({
  ...
  _showStat: function () {
    ...
    if (this._statType === 'formula') {
      this._showFormula(graph, total, shown, limit);
    } else if (this._statType === 'histogram') {
      this._showHistogram(graph, total, shown, limit);
    } else if (this._statType === 'category') {
      this._showCategory(graph, total, shown, limit);
    }
  },
  ...
  _showFormula: function (graph, total, shown, limit) {
  ...
  _showCategory: function (graph, total, shown, limit) {
  ...
  _showHistogram: function (graph, total, shown, limit) {
