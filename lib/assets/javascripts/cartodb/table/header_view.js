...
var HeaderView = cdb.admin.HeaderView = cdb.core.View.extend({
  ...
  _TEXTS: {
    no_geo: {
      ...
      description:  _t('This funcionality is not available in the visualization view. \
                    Please, visit <a href="/tables/{{table_name}}">your table</a> and start georeferencing there.'),
      ok:           _t('Ok, close')
    }
  },
  ...
  render: function() {
    ...
    this.$el.append(this.template({
      ...
      read_only:        this.table.data().isReadOnly(),
  ...
  showGeoreferenceWindow: function(e) {
    ...
    if (!this.vis.isVisualization()) {
      ...
      this.warning_dlg = new cdb.admin.BaseDialog({
        ...
        description: this._TEXTS.no_geo.description.replace('{{table_name}}', this.table.get('name')),
