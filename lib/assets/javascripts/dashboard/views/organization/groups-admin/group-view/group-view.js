  ...
  render: function () {
    ...
    this.$el.html(
      template({
        ...
        sharedMapsCount: _t('dashboard.views.organization.shared_map', {smart_count: sharedMapsCount}),
        sharedDatasetsCount: _t('dashboard.views.organization.shared_dataset', {smart_count: sharedDatasetsCount}),
        url: this._url,
