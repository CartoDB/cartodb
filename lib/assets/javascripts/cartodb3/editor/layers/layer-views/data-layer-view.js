...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._geometryModel = nodeDefModel.geometryModel;
    this.listenTo(this._geometryModel, 'change:simple_geom', this.render);

    if (this._geometryModel.canFetch() && !this._geometryModel.hasValue()) {
  ...
  render: function () {
    ...
    var geometryTemplate = this._getGeometryTemplate(this._geometryModel.get('simple_geom'));
