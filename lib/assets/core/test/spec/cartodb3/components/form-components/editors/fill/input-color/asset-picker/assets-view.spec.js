...
describe('components/form-components/editors/fill/input-color/assets-view', function () {
  ...
  describe('._onAssetUploadError', function () {
    ...
    it('should preserve the number of assets when upload fails', function () {
      var previousAssetsCount = this.view._userAssetCollection.length;

      mockCreate.call(this, 'error');

      expect(this.view._userAssetCollection.length).toBe(previousAssetsCount);
    });
  });
