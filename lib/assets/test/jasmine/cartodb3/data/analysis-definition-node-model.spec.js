...
describe('cartodb3/data/analysis-definition-node-model', function () {
  ...
  it('should not have any geom from start', function () {
    expect(this.a0.geometryModel.get('simple_geom')).toBeFalsy();
  });
  ...
  describe('when given a geom from start', function () {
    ...
    it('should set the geom on the query-schema-model', function () {
      expect(this.model.geometryModel.get('simple_geom')).toEqual('point');
    });
  });
});
