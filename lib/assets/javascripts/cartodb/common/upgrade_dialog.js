  ...
  cdb.admin.UpgradeDialog = cdb.admin.BaseDialog.extend({
    ...
    initialize: function() {
      ...
      _.extend({
        ...
        protocol: "http:",
        // Necessary varible to let us do proper tests later :)
        // Jasmine doesn't load jsonp requests, so in your tests, just try with 'json' dataType -> Happy testing!
    ...
    render_content: function() {
      ...
      var xhr = $.ajax({
        ...
        type: 'GET',
        dataType: this.options.requestDataType,
        success: function(r) {
          ajaxDone = true;
