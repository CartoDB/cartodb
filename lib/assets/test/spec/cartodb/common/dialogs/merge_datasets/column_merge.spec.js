  ...
  describe('when a table is selected', function() {
    ...
    describe('when right columns are fetched', function() {
      ...
      describe('when selected a key column from both lists', function() {
        beforeEach(function() {
          $(this.view.$('.js-left-columns .RadioButton')[1]).trigger('click'); // left_str
          $(this.view.$('.js-right-columns .RadioButton')[1]).trigger('click'); //right_str
        });
        ...
        describe('when select a column of different kind on left', function() {
          beforeEach(function() {
            $(this.view.$('.js-left-columns .RadioButton')[0]).trigger('click'); // left_nr
          });
