  ...
  module.exports = function(grunt) {
    ...
    grunt.registerTask('invalidate', "invalidate cache", function() {
      var cmd = "curl -H 'Fastly-Key: <%= FASTLY_API_KEY %>' -X POST 'https://api.fastly.com/service/<%= FASTLY_CARTODB_SERVICE %>/purge_all";
    ...
    grunt.registerTask('release',  ['default', 's3', 'invalidate']);
