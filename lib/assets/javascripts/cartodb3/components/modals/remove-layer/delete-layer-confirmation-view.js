...
var ExportView = require('cartodb3/editor/components/modals/export-map/modal-export-map-view.js');
var ExportMapModel = require('cartodb3/data/export-map-definition-model.js');
var templateConfirmation = require('cartodb3/editor/layers/delete-layer-confirmation.tpl');
var removeLayer = require('cartodb3/editor/layers/operations/remove-layer');
