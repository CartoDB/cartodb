...
fdescribe('cartodb3/data/analysis-definition-node-model', function () {
  beforeEach(function () {
  ...
  it('should keep a flat, denormalized attrs structure internally', function () {
    ...
    fit('should define the USER_SAVED var', function () {
      expect(this.a0.USER_SAVED).toBeDefined();
      expect(this.a0.USER_SAVED).toEqual(undefined);
    });
  });
