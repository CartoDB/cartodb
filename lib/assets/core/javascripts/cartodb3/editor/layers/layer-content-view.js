    ...
    var tabPaneTabs = [{
      ...
      createContentView: function () {
        ...
        if (_.isString(analysisPayload)) {
          ...
          self.listenTo(self._analysisDefinitionNodesCollection, 'add', function (e) {
            // First time the source changes here, it means the analysis is done
            self.listenToOnce(self._layerDefinitionModel, 'change:source', self.render);
          });
