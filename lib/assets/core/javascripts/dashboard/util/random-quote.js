...
module.exports = function () {
  ...
  var quotes = [
    ...
    {
      quote: 'In that Empire, the Art of Cartography attained such Perfection that the map of a single Province occupied the entirety of a City.',
      ...
      author: null },
    {
      ...
      author: null },
    {
      quote: 'Without geography, you\'re nowhere!',
      author: 'Jimmy Buffett' },
    {
      quote: 'our earth is a globe / whose surface we probe /<br />no map can replace her / but just try to trace her',
      author: 'Steve Waterman' },
    {
      quote: 'Everything happens somewhere.',
      author: 'Doctor Who' },
    {
    ...
    {
      quote: 'Everything is related to everything else,<br />but near things are more related than distant things.',
      author: 'Tobler\'s first law of geography' },
    {
      ...
      author: null },
    {
      ...
      author: null },
    {
      quote: 'Stand in the place where you live / Now face North /<br/>Think about direction / Wonder why you haven\'t before',
      author: 'R.E.M' },
    {
      quote: 'The virtue of maps, they show what can be done with limited space, they foresee that everything can happen therein.',
