...
module.exports = {
  'fill': function (querySchemaModel, styleType, configModel) {
    var editorAttrs = {
      size: {
        min: 1,
        max: 45,
  ...
  'stroke': function (querySchemaModel, styleType, configModel) {
    if (querySchemaModel.get('simple_geom') === 'line') {
  ...
  'blending': function (querySchemaModel, styleType) {
