...
describe('data/analysis-definition-node-model', function () {
  ...
  describe('when model is a source', function () {
    ...
    describe('.destroy', function () {
      beforeEach(function () {
        this.analysisTableModel = this.model.analysisTableModel;
        spyOn(this.model.analysisTableModel, 'destroy');
      ...
      it('should destroy the analysisTableModel', function () {
        expect(this.analysisTableModel.destroy).toHaveBeenCalled();
        expect(this.model.analysisTableModel).toBeNull();
      });
    });
