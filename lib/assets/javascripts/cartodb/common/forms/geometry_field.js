   ...
   *  - It accepts a model with {attribute: 'colum', value: '{{ "type": "Point", "coordinates": [100.0, 0.0] }}'}
  ...
  cdb.admin.GeometryField = cdb.admin.StringField.extend({
    ...
    default_options: {
      template_name: 'common/views/forms/geometry_field',
      label:          false,
      readOnly:       false
    },
    ...
    _onKeyInputUp: function(e) {
      ...
      if (this._checkInputs()) {
        ...
        // Save model
        var lat = this.$("input.latitude").val()
          , lon = this.$("input.longitude").val();
