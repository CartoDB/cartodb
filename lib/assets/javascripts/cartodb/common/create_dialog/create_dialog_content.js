  ...
  cdb.common.CreateDialog.Content = cdb.core.View.extend({
    ...
    _TABS: {
      ...
      arcgis: {
        ...
        title:    _t('ArcGIS online'),
        template: 'common/views/import/import_arcgis_disabled'
      },
      salesforce: {
        type:     'other',
        method:   '_genSalesforcePane',
        title:    _t('Salesforce'),
        template: 'common/views/import/import_salesforce_disabled'
      },
      mailchimp: {
        type:     'other',
        ...
        template: 'common/views/import/import_mailchimp_disabled'
      },
      success:     {
    ...
    _genInstagramPane: function() {
      ...
      var instagramPane = new cdb.admin.ImportInstagramPane({
        service:    'instagram',
        template:   'common/views/import/import_service_instagram',
        acceptSync: false
      });
    ...
    _genArcgisPane: function() {
      ...
      var arcgisPane = new cdb.admin.ImportArcGISPane({
        template:     'common/views/import/import_arcgis',
        user:         this.user,
        type:         'service',
        service_name: 'arcgis',
    ...
    _genSalesforcePane: function() {
      ...
      var salesforcePane = new cdb.admin.ImportUrlPane({
        ...
        template:     'common/views/import/import_salesforce',
        user:         this.user,
        type:         'url',
