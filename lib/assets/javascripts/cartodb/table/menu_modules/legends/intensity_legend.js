...
cdb.admin.mod.IntensityLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _calculateItems: function() {
    ...
    items.push(new cdb.geo.ui.LegendItemModel({ type: "text",  name: "Left label",  value: "Less" }));
    items.push(new cdb.geo.ui.LegendItemModel({ type: "text",  name: "Right label", value: "More" }));
