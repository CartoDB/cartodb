...
module.exports = cdb.core.View.extend({
  ...
  _setupMapDimensions: function(animated) {
    ...
    var titleHeight = this.$body.find('.PublicMap-title').height();
    var headerHeight = this.$body.find('.Header').height() + 50 /* margin-top value */;
    var h, height, top;
    ...
    if (animated) {
      ...
      if (this.options.isMobileDevice) {
        ...
        this.$map.css({ height: windowHeight - ( titleHeight + headerHeight), opacity: 1 })
      }
    }
