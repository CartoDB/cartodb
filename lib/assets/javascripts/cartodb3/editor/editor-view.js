...
module.exports = cdb.core.View.extend({
  ...
  render: function () {
    ...
    this._mapTabPaneView.bind('changeTab', this._updateAddButtonState, this);
  ...
  _updateAddButtonState: function () {
    ...
    switch (this._mapTabPaneView.getSelectedTabPaneName()) {
      case 'widgets':
        if (this._widgetDefinitionsCollection.length) {
          this._showAddButton();
        }
        break;
      case 'layers':
        if (this._layerDefinitionsCollection.length) {
          this._showAddButton();
        }
        break;
      case 'elements':
