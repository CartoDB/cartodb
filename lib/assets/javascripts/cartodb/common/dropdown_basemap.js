...
cdb.admin.BaseMapView = cdb.admin.BaseLayerButton.extend({
  ...
  _openDropdown: function(ev) {
    ...
    // TODO: improve selection of parent 'ul'
    var $e = $(ev.target).parent().parent().parent().parent();
...
cdb.admin.BackgroundMapColorView = cdb.admin.BaseLayerButton.extend({
  ...
  _openPicker: function(ev) {
    ...
    if (!this.color_picker.el.parentElement) {
      ...
      this.color_picker.init("Color: #FFFFFF");
...
cdb.admin.DropdownBasemap = cdb.ui.common.Dropdown.extend({
  ...
  initialize: function() {
    ...
    cdb.god.bind("repaint", this.repaint, this);
  ...
  */
  ...
  add: function(lyr) {
    ...
    if (!$element.find("a").hasClass("default")) {
      $element.find("a").addClass("id_" + v.model.get("id"));
    }
    ...
    if (!$element.find("a").hasClass("default")) this._appendAtTheEnd($element);
    else this._append($element);
  ...
  _appendAtTheEnd: function($element) {

    var $ul = this.$el.find('ul.special');
    $ul.css("height", this.$el.height());
  ...
  _updateTarget: function(className) {
    ...
    if (className) className = className.replace("default ", "");
  ...
  _addAddlink: function() {
    ...
    var $a = $('<li class="add_basemap"><a class="add small" href="#add_basemap"><div class="thumb"></div> <div class="name">Add yours</div></a></li>');
    this._appendAtTheEnd($a);
  ...
  for (var sv in this._subviews) {
    ...
    if (subview.model &&
      ...
      this.model.getBaseLayer().isEqual(subview.model)) {
        ...
        this._updateTarget(this.model.getBaseLayer().get("className"));
