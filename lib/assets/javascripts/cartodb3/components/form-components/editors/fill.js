...
Backbone.Form.editors.Fill = Backbone.Form.editors.Base.extend({
  className: 'CDB-OptionInput CDB-Text js-input',
  ...
  _initInputFields: function () {
    ...
    this._inputCollection.bind('change', _.debounce(this._onInputChange.bind(this), 50));
  },
  ...
  getValue: function () {
    console.log(this._inputCollection.getValues());
  ...
  remove: function () {
    this._removeDialog();
    this._inputCollection.unbind(null, null, this);
