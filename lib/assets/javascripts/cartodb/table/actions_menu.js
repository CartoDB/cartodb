  ...
  cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
    ...
    events: {
      'click .title_bar':      '_switchToTitleLayer',
    ...
    */
    ...
    _switchToTitleLayer: function() {
      ...
      if (!$title.hasClass('open') && this.panelOpen){
        // Close table tabs
        this.hide();
    ...
    _addMapOptions: function() {
      if (!this.mapOptionsDropdown) {
        ...
        $(".title_layer_contents").append(this.mapOptionsDropdown.render().el);
        this._addMetadataForm();
      }
      this.$('.title_layer_contents').show();
    },
    ...
    _addMetadataForm: function() {
      ...
      $(".title_layer_contents").prepend(this.MetadataForm.render().el);
    },
