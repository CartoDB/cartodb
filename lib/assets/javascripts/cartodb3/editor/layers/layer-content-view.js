...
var HeaderView = require('./layer-header-view.js');
...
module.exports = CoreView.extend({
  ...
  _onMapClick: function (ev) {
    ...
    $('.js-mapTableView').toggleClass('is-moved', !!isThereWidgets);
    $('.js-mapTableView').removeClass('in-table');
  ...
  _onTableClick: function (ev) {
    $('.js-mapTableView').removeClass('is-moved');
    $('.js-mapTableView').addClass('in-table');
