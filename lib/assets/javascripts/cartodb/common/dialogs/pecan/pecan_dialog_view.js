...
module.exports = BaseDialog.extend({
  ...
  _start: function() {
    ...
    this.backgroundPollingModel.addAnalysis([{ table_id: "test", column_name: 'field_2' }, { table_id: "test", column_name: 'field_3' }, { table_id:"test", column_name: "field_4" }]);
