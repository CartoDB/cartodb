...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _getZoomOverlay: function() {

    return this._getOverlay("zoom");
  ...
  _onChangeCanvasMode: function() {
    ...
    if (mode === "desktop") {
      ...
      if (this.loader && this.fullscreen) {
        if (this.fullscreen.model.get("display")) this.loader.model.set("y", this.fullscreen.model.get("y") + 40);
        else this.loader.model.set("y", this.fullscreen.model.get("y") );
      }
      ...
      if (this.loader)  this.loader.model.set("y", $(".header.overlay").outerHeight(true) + 15);
  ...
  _setupShareOverlay: function(type, data) {
    ...
    overlay.bind("change_x", function() {

      if (this.search) {

        if (overlay.model.get("display")) {
  ...
  _setupZoomOverlay: function(type, data) {
    ...
    overlay.bind("change_y", function() {
      ...
      if (this.zoomInfo) {
        ...
        if (overlay.model.get("display")) this.zoomInfo.model.set("y", overlay.model.get("y") + 70);
        else this.zoomInfo.model.set("y", overlay.model.get("y"));
  ...
  _setupHeaderOverlay: function(type, data) {
    ...
    overlay.model.set("title", this.vis.get("name"));
    overlay.model.set("description", this.vis.get("description"));
    ...
    this.header.bind("change_y", function() {
      ...
      if (this.zoom)                         this.zoom.model.set("y",   top);
      if (this.search)                       this.search.model.set("y", top);
      if (this.share)                        this.share.model.set("y",  top);
      if (this.layer_selector)               this.layer_selector.model.set("y",  top);
      if (this.loader && mode === 'mobile')  this.loader.model.set("y", top);
  ...
  _setupSearchOverlay: function(type, data) {
    ...
    overlay.bind("change_x", function() {
      ...
      if (this.layer_selector) {
        ...
        if (overlay.model.get("display")) {
          if (this.share.model.get("display")) this.layer_selector.model.set("x", 212);
          else this.layer_selector.model.set("x", 172);

        } else {
          this.layer_selector.model.set("x", this.search.model.get("x"));
        }
      }
  ...
  _setupZoomInfoOverlay: function(type, data) {
    ...
    var overlay = this.zoomInfo = new cdb.admin.overlays[type]({
      model: data,
      map: this.map
    });
  ...
  _renderOverlay:  function(delayed_animation, model) {
    ...
    if (device && device != this.vis.get("canvas_mode")) {
      model.set("display", false);
    } else if (device){
      model.set("display", true);
    }

    if ( (type === "Header" || type === 'Fullscreen' || type === "Share" || type === "LayerSelector") && this.vis.get("type") === "table") {
      return;
    }
