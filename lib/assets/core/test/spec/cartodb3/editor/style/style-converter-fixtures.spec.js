...
module.exports = [
  ...
  },
  {
    ...
    result: {
      point: {
        cartocss: '#layer {\nmarker-width: ramp([cartodb_id], range(1, 20), category(6));\nmarker-fill: ramp([name], (#fabada, black, red, white), (wutang clan, form-components.editors.fill.input-categories.null, public enemy), "=", category);\nmarker-fill-opacity: 0.5;\nmarker-file: ramp([name], (url(\'image1\'), url(\'image2\'), url(\'image3\'), url(\'otherimage\')), (wutang clan, \'\', public enemy), "=");\nmarker-allow-overlap: true;\n}'
      },
      line: {
        cartocss: '#layer {\n}'
      },
      polygon: {
        cartocss: '#layer {\npolygon-fill: ramp([name], (#fabada, black, red, white), (wutang clan, form-components.editors.fill.input-categories.null, public enemy), "=", category);\npolygon-opacity: 0.5;\n}'
      }
    }
  },
  {
