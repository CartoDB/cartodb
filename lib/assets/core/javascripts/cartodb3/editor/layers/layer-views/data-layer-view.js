...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._queryRowsCollection = nodeDefModel.queryRowsCollection;
  ...
  render: function () {
    ...
    var canBeGeoreferenced = m.canBeGeoreferenced();
    ...
    this.$el.html(template({
      ...
      queryGeometryHasGeom: this._queryGeometryHasGeom(),
      canBeGeoreferenced: canBeGeoreferenced
    }));
  ...
  _bindEvents: function () {
    ...
    this.listenTo(this._queryRowsCollection.statusModel, 'change:status', this.render);
  },
