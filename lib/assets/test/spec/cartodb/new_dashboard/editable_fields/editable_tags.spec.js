var EditableTags = require('../../../../../javascripts/cartodb/new_dashboard/editable_fields/editable_tags');
...
describe('new_dashboard/editable_fields/editable_tags', function() {
  ...
  it('should display up to 3 tags', function() {
    ...
    expect($($tagItems[0]).attr('href')).toEqual('http://paco.cartodb.com/dashboard/datasets/tag/ipsum')
    expect($($tagItems[0]).attr('href')).toEqual('http://paco.cartodb.com/dashboard/datasets/tag/quia')
