  ...
  _initViews: function () {
    ...
    var tabPaneDataModel = new cdb.core.Model({
      ...
      createButtonView: function () {
        return self._generateLabel(_t('editor.widgets.widgets-form.data'));
      }
    });
    ...
    var tabPaneStyleModel = new cdb.core.Model({
      ...
      createButtonView: function () {
        return self._generateLabel(_t('editor.widgets.widgets-form.style'));
      }
    });
