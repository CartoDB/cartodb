...
describe('common/private_header_view', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$el.html()).toContain('<img src="http://cartodb.s3.dualstack.us-east-1.amazonaws.com/static/public_dashboard_default_avatar.png" class="UserAvatar-img UserAvatar-img--medium">');
