...
var apiClientError = require('../helpers/error_messages');
...
module.exports = cdb.core.View.extend({
  ...
  _initModels: function () {
    ...
    this._apiClient = CartoApiClient.AuthenticatedClient.setStaticConfig({
      baseUrl: this._userModel.get('base_url')
    });
  ...
  _updateUser: function (user) {
    ...
    this._apiClient.updateUser({ user: user })
      .then(function (data) {
        if (data.errors) {
