...
module.exports = Backbone.Model.extend({
  ...
  _DEFAULT_MAP_NAME: _t('dashboard.views.dashboard.create_map_model.untitled_map'),
  ...
  initialize: function (attributes, options) {
    ...
    this.vis = new VisualizationModel({ name: _t('dashboard.views.dashboard.create_map_model.untitled_map') }, { configModel: this._configModel });
