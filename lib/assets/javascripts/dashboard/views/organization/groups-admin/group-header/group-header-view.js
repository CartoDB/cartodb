...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    const templateData = {
      ...
      title: this._group.get('display_name') || _t('dashboard.views.organization.create_new_group'),
    ...
    if (isNewGroup) {
      ...
      templateData.usersLabel = _t('dashboard.views.organization.user_pl', {smart_count: usersCount});
