cdb.admin.PaginatorDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _click: function(e) {
    ...
    /*// Open the table and visualization list
    dashboard.toggleTable.show();
    dashboard.toggleVisualization.show();*/
  ...
  */
  ...
  open: function(e, target) {
    ...
    console.log(page);
      ...
      //self.$el.find("ul").append("<li><a class='" + selected + tag.name + "' href='/tag/" + tag.name + "'>" + tag.name + "</a></li>");
      self.$el.find("ul").append("<li><a class='" + selected + page + "' href='/tag/" + page + "'>" + page + "</a></li>");
    });
