...
Backbone.Form.editors.MultiSelect = Backbone.Form.editors.Base.extend({
  ...
  _initViews: function () {
    ...
    this._listView = new CustomListView({
      ...
      actions: [{
        ...
        action: this._deselectSearch.bind(this)
      },
      {
  ...
  _selectAll: function () {
    var query = this._listView.model.get('query');
    this._deselectAll();
    this._setSelectForQuery(query, true);
  },

  _deselectSearch: function () {
    var query = this._listView.model.get('query');
    this._setSelectForQuery(query, false);
  },

  _deselectAll: function () {
    this._setSelectForQuery(null, false);
  },

  _setSelectForQuery: function (query, value) {
    this.collection.search(query).each(function (m) {
      m.set('selected', value);
    });
  },
