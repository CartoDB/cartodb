<div class="u-flex u-alignCenter Modal-basemapContainer">
  ...
  <div class="CDB-Text u-flex u-alignCenter ">
    ...
    <div class="Form-rowData Form-rowData--longer">
      <input type="text" class="CDB-InputText CDB-Text js-url" value="<%- url %>" placeholder="<%- _t('components.modals.add-basemap.xyz.eg') %> https://api.mapbox.com/styles/v1/username/ab12cd3/tiles/256/{z}/{x}/{y}@2x?access_token=access_token">
