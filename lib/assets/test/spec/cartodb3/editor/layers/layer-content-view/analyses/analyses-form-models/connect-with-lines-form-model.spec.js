...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/connect-with-lines-form-model', function () {
  ...
  it('should have proper attributes', function () {
    expect(this.model._typeDef().parametersDataFields).toBe('source,type');
    expect(this.model._typeDef().parametersDataSchema).toBe('order,order_column,order_type,category_column');
  });
