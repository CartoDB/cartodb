describe("Basemap adder dialog", function() {
  ...
  it("should transform public mapbox urls to the correct ones", function() {
    var url = cdb.admin.BaseMapAdder.prototype.transformMapboxUrl.call(this, "http://tiles.mapbox.com/ethervoid/map/map-db04byz6")
    expect(url).toEqual('http://a.tiles.mapbox.com/v3/ethervoid.map-db04byz6/{z}/{x}/{y}.png')
  })
