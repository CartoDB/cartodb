...
cdb.admin.BaseMapView = cdb.admin.BaseLayerButton.extend({
  ...
  render: function() {
    ...
    var $e = $("<div class='thumb' style='background-image:url(" + back_tile + ")'></div> <div class='name'>" + this.model.get("name") + "</div><small>max zoom: " + this.model.get("maxZoom") + "</small>" );
...
cdb.admin.DropdownBasemap = cdb.ui.common.Dropdown.extend({
  ...
  */
  ...
  _addAddlink: function() {
    var $a = $('<li class="add_basemap hidden"><a class="add small" href="#add_basemap"><div class="thumb"></div> <div class="name">Add yours</div><small>tileJSON, XYZ or MapBox...</small></a></li>');
  ...
  _addGoogleMaps: function() {
    ...
    for (var i in available) {
      ...
      var base = new cdb.admin.GMapsBaseLayer({ base_type: layer_name, className: layer_name, style: styles[layer_name], name: names[layer_name], maxZoom: undefined });
