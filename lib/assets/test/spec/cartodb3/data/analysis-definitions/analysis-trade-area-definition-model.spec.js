...
describe('data/analysis-definitions/analysis-trade-area-definition-model', function () {
  ...
  it('should create a new id based on source', function () {
    expect(this.model.id).toEqual('a1');
  });
  ...
  describe('.toJSON', function () {
    it('should return serialized object', function () {
      var expectedJSON = _.defaults(
        { id: 'a1' }, // created implicitly
        this.originalAnalysisData
      );
      expect(this.model.toJSON()).toEqual(expectedJSON);
    });
  });
});
