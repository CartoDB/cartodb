  ...
  render: function() {
    ...
    this.collection.each(function(table) {
      var table_item = new cdb.admin.dashboard.TableItem({
        ...
        order: self.collection.options.get("order")
      })
...
cdb.admin.dashboard.TableItem = cdb.core.View.extend({
  ...
  render: function() {
    ...
    this.$el.append(this.template(_.extend(attrs, { order: this.options.order, row_count: pretty_row_count, name: name, description: description, tags: tags })));
