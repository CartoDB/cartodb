...
/*
  ...
  it("torque category should generate sql", function() {
    ...
    var s = [
      'select *, (',
      'CASE WHEN "column_cat" = "a" THEN 1',
      'CASE WHEN "column_cat" = "b" THEN 2',
      ') as torque_category FROM __wrapped'
    ]
  ...
  it("torque category should generate categories", function() {
    ...
    console.log(css);
    expect(css.indexOf('-torque-aggregation-function:"round(avg(torque_category))"') !== -1).toEqual(true)
  ...
  describe("cartoparser", function() {
    ...
    it("shoudl return the rules for main defintion", function() {
      var rules = [
       'marker-fill',
       'marker-opacity',
       'marker-width',
