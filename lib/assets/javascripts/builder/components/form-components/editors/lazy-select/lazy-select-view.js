...
Backbone.Form.editors.LazySelect = Backbone.Form.editors.Base.extend({
  ...
  setValue: function (value) {
    var selectedModel = this.searchCollection.setSelected(value);
  ...
  _getButtonTemplateData: function (model) {
    const label = model.getName && model.getName() || model;
    return _.extend({ isSourceType: false }, model.attributes, { label });
  },
