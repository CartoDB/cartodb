...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    if (this.options.mouseClickAction) {
      this._mouseClickAction = this.options.mouseClickAction;
    }
  ...
  render: function () {
    ...
    this.$el.html(template({
      ...
      privacyDOMElement: this._isOwner ? 'button' : 'span',
  ...
  _getPrivacyInfo: function () {
    ...
    if (!this._isOwner) {
      ...
      privacyInfo = _t('dataset.privacy.info', { name: ownerName });
    }
