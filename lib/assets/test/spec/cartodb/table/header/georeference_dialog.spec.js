describe("cdb.admin.GeoreferenceDialog", function() {
  ...
  it("should set the georeference types option", function() {
    ...
    expect(view.$('li.points').length).toBeTruthy();
    expect(view.$('li.polygons').length).toBeTruthy();

  });

  it("should the georeference types option", function() {
  ...
  describe("cdb.admin.GeoreferenceStyles", function() {
    ...
    it("should allow changing the active style", function() {
      ...
      view.render();
      view.model.set("geometry_type", "polygons");

      expect(view.$('li.points').hasClass("selected")).toBeFalsy();
      expect(view.$('li.polygons').hasClass("selected")).toBeTruthy();

      view.model.set("geometry_type", "points");

      expect(view.$('li.points').hasClass("selected")).toBeTruthy();
      expect(view.$('li.polygons').hasClass("selected")).toBeFalsy();
    ...
    it("should allow to disable the styles", function() {
      ...
      view.render();
      view.model.set("pointsEnabled", false);

      expect(view.$('li.points').hasClass("disabled")).toBeTruthy();

      view.model.set("polygonsEnabled", false);
      expect(view.$('li.polygons').hasClass("disabled")).toBeTruthy();
