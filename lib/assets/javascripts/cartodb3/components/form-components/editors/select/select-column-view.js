...
Backbone.Form.editors.SelectColumn = Backbone.Form.editors.Base.extend({
  ...
  initialize: function (opts) {
    ...
    this.collection = new CustomListCollection(opts.schema.options, { allowMultipleSelection: true });
