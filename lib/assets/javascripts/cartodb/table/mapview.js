...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  mouseMove: function(e) {
    var posInfo = this.layerDataView.getValueForPos(e.containerPoint.x, e.containerPoint.y) || {value:0};
    if(posInfo.value >= 0){
      this.tooltip.show({x: e.containerPoint.x, y: e.containerPoint.y}, {"fields": [{"title": "value", "value":""+posInfo.value}]});
    }
  },
