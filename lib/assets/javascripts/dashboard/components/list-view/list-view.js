...
// TODO: We might want to move this to components
const PlaceholderItem = require('dashboard/views/data-library/content/list/placeholder-item-view');
// TODO: Check if we can use Builder's one
const RemoteDatasetsItem = require('builder/components/modals/add-layer/content/datasets/remote-dataset-item-view');
