...
describe('common/dialog/merge_datasets/merge_datasets_view', function() {
  ...
  describe('when merge type (column) is clicked', function() {
    ...
    it('should have the expected header state', function() {
      expect(this.view._$headerStep2().hasClass('is-selected')).toBeTruthy();
      expect(this.view._$headerStep3().hasClass('is-selected')).toBeFalsy();
      expect(this.view._$headerStep2Title().text()).toContain('merge column');
      expect(this.view._$headerStep3Title().text()).toContain('rest');
    });
  ...
  describe('when click spatial merge type', function() {
    ...
    it('should have the expected header state', function() {
      expect(this.view._$headerStep2().hasClass('is-selected')).toBeTruthy();
      expect(this.view._$headerStep3().hasClass('is-selected')).toBeFalsy();
      expect(this.view._$headerStep2Title().text()).toContain('dataset to merge');
      expect(this.view._$headerStep3Title().text()).toContain('merge columns');
    });
  });
