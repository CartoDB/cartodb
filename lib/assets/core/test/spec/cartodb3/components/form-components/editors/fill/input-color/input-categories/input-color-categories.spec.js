...
fdescribe('components/form-components/editors/fill/input-color/input-categories/input-color-categories', function () {
  beforeEach(function () {
  ...
  describe('.render', function () {
    ...
    it('should display color ranges with 3 colors', function () {
      var fistRange = this.view.$('.ColorBarContainer')[0];
      expect(fistRange.children.length).toEqual(3);
    });
  ...
  // This is not part of this view no more
  xit('should hide the title label back arrow', function () {
  ...
  // This is not part of this view no more
  xit('should not render quantification if hideTabs is defined and quantification is one of the items', function () {
    this.view.render();
  ...
  // This is not part of this view no more
  xdescribe('with booleans', function () {
    beforeEach(function () {
      this.model = new Backbone.Model({
  ...
  // This is not part of this view no more
  xdescribe('with "Others" value', function () {
    beforeEach(function () {
      this.model = new Backbone.Model({
