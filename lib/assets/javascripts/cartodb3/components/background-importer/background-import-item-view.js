...
var DELEGATIONS = {
  ...
  failed: require('./delegated-import-views/failed'),
...
module.exports = CoreView.extend({
  ...
  updateNotification: function () {
    ...
    delegated.call(this, this._importModel, this._notification, status, this._getInfo(), this._showDetails);
  },
