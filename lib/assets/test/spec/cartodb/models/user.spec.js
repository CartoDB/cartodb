...
describe('cdb.admin.User', function() {
  ...
  describe("canAddLayerTo", function() {
    ...
    it("should raise an error when map argument is not defined", function() {
      expect(user.canAddLayerTo()).toThrow(new Error("Map model is not defined or wrong"));
      expect(user.canAddLayerTo({ layers: {} })).toThrow(new Error("Map model is not defined or wrong"));
    });
