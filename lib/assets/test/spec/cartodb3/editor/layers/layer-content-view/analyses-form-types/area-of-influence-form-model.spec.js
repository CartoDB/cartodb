...
describe('editor/layers/layer-content-views/analyses-form-types/area-of-influence-form-model', function () {
  beforeEach(function () {
    ...
    this.model = new AreaOfInfluenceFormModel(this.analysisDefinitionNodeModel.attributes, {parse: true});
  });
  ...
  describe('.applyChanges', function () {
    it('should replace the attributes on the given node model but maintain values not visible/editable in the form', function () {
      this.model.applyChanges(this.analysisDefinitionNodeModel);
