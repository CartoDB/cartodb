...
describe('components/modals/add-analysis/add-analysis-view', function () {
  beforeEach(function () {
    ...
    this.geometryModel = this.a0.geometryModel;
    spyOn(this.geometryModel, 'sync');
    spyOn(this.geometryModel, 'fetch').and.callThrough();
  ...
  describe('when geometry output type is fetched', function () {
    beforeEach(function () {
      ...
      this.geometryModel.sync.calls.argsFor(0)[2].success({
        fields: {},
        rows: []
      });
    });
