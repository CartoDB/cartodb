  ...
  describe("New layer dialog", function() {
    ...
    it("should return the table chosen when clicks over ok button", function() {
      ...
      view.render();
      spyOn(view, 'ok');
      server.respondWith('/api/v1/viz/?tag_name=&q=&page=1&type=table&per_page=300&o%5Bupdated_at%5D=desc', [200, { "Content-Type": "application/json" }, '{"visualizations":[{"id":"f4072f74-d736-11e2-8b6c-94942608096a","name":"test_table","map_id":178,"active_layer_id":511,"type":"table","tags":[],"description":"description","privacy":"PRIVATE","stats":{"2013-05-22":0,"2013-05-23":0,"2013-05-24":0,"2013-05-25":0,"2013-05-26":0,"2013-05-27":0,"2013-05-28":0,"2013-05-29":0,"2013-05-30":0,"2013-05-31":0,"2013-06-01":0,"2013-06-02":0,"2013-06-03":0,"2013-06-04":0,"2013-06-05":0,"2013-06-06":0,"2013-06-07":0,"2013-06-08":0,"2013-06-09":0,"2013-06-10":0,"2013-06-11":0,"2013-06-12":0,"2013-06-13":0,"2013-06-14":0,"2013-06-15":0,"2013-06-16":0,"2013-06-17":0,"2013-06-18":0,"2013-06-19":0,"2013-06-20":0},"created_at":"2013-06-17T10:16:19+02:00","updated_at":"2013-06-19T12:23:58+02:00","table":{"id":85,"name":"test_table","privacy":"PUBLIC","size":24576,"row_count":0,"updated_at":"2013-06-17T12:16:19+02:00"}}],"total_entries":1}']);
      server.respondWith('/api/v1/tables/85', [200, { "Content-Type": "application/json" }, '{"geometry_types":["ST_POLYGON"],"name": "test_table"}']);
      server.respond();
      view.$('a.ok').click();
      expect(view.ok).toHaveBeenCalledWith('test_table');
    });
    ...
    it("should return the table name qualified if the table doesn't belong to him", function() {
      ...
      view.render();
      spyOn(view, 'ok');
      server.respondWith('/api/v1/viz/?tag_name=&q=&page=1&type=table&per_page=300&o%5Bupdated_at%5D=desc', [200, { "Content-Type": "application/json" }, '{"visualizations":[{"id":"f4072f74-d736-11e2-8b6c-94942608096a","name":"test_table","map_id":178,"active_layer_id":511,"type":"table","tags":[],"description":"description","privacy":"PRIVATE","stats":{},"created_at":"2013-06-17T10:16:19+02:00","updated_at":"2013-06-19T12:23:58+02:00","table":{"id":85,"name":"jam.test_table","privacy":"PUBLIC","size":24576,"row_count":0,"updated_at":"2013-06-17T12:16:19+02:00"}}],"total_entries":1}']);
