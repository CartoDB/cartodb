...
describe("cartodb.models.Map", function() {
  ...
  describe("layers", function() {
    ...
    it("should include tooltip in toJSON", function(done) {
      ...
      setTimeout(function() {
        expect(layer.save.calls.argsFor(0)[0]).toEqual({ tooltip: layer.tooltip.toJSON() })
        done() ;
      }, 300);
    });
    ...
    it("should remove missing fields before save", function(done) {
      ...
      setTimeout(function() {
        ...
        var fieldNames = _.pluck(layer.save.calls.argsFor(0)[0].infowindow.fields, 'name')
