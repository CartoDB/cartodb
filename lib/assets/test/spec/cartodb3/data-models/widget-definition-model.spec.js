...
describe('widget-defintion-model', function () {
  ...
  describe('on change type', function () {
    it('should set right attributes for the widget definition type', function () {
      ...
      expect(this.widgetDefModel.get('options').column).toBeDefined();
      expect(this.widgetDefModel.get('options').dummy).toBeUndefined();
    });
  });
