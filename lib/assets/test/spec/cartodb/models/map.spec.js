describe("cartodb.models.Map", function() {
  ...
  describe('.setBaseLayer', function() {
    ...
    var cartoDBAttribution = 'CartoDB <a href="https://cartodb.com/attributions" target="_blank">attribution</a>';
  ...
  it('should update the attribution of the map when layers change', function() {
    ...
    expect(map.get('attribution')).toEqual([
      "attribution1",
      "wadus",
      'CartoDB <a href="https://cartodb.com/attributions" target="_blank">attribution</a>'
    ]);
  });
