...
cdb.admin.dashboard.TableItem = cdb.core.View.extend({
  ...
  _like: function() {
    ...
    var self = this;
    var url  = "/api/v1/viz/" + this.model.get("id") + "/like";

    var $button  = this.$el.find(".LikeButton");
    var $icon    = this.$el.find(".LikeButton-icon");
    var $counter = this.$el.find(".LikeButton-counter");

    var onSuccess = function(response) {

      self.model.set("liked", true);
