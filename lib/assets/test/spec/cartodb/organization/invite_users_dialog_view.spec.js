...
describe('organization/invite_users/invite_users_dialog_view', function() {
  ...
  describe("form view", function() {
    ...
    it("should set to true the model enableOrganizationSignIn attribute", function() {
      var $button = this.$form.find('.js-enableSignInButton');
      $button.click();
      expect(this.formView.model.get('enableOrganizationSignIn')).toBe(true);
    });

  });

  describe("form view on submit", function() {
    ...
    it("should not submit the form if submit button is disabled", function() {
