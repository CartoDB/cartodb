      ...
      var legends = [];
        ...
        _.each(layers, function(layer) {
          ...
          if (layer.options.layer_definition) {
            legends = legends.concat(this.addLegends(layer.options.layer_definition.layers));
          }
...
_changePreview: function() {
  ...
  var $legends        = this.$('div.cartodb-legend-stack');
