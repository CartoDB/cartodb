...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _exportImage: function() {
    ...
    if (this.user.featureEnabled('new_modals')) {
      ...
      this.exportImageDialog = new cdb.admin.ExportImageDialog({
      ...
      this.exportImageDialog.bind("was_removed", function() {
        this.exportImageDialog = null;
      }, this);

      this.exportImageDialog.bind("finish", function(response) {
        this.exportImageDialog = null;
      ...
      this.mapView.$el.append(this.exportImageDialog.render().$el);
