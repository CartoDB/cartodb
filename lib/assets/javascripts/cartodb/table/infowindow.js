  ...
  var MapInfowindow = cdb.geo.ui.Infowindow.extend({
    ...
    render: function() {
      ...
      this.$('.cartodb-popup-content-wrapper')
        .append(this.getTemplate('table/views/infowindow/infowindow_footer')({"cartodb_id": cartodb_id}));
    ...
    _getTemplateURL: function() {
      ...
      // an infowindow type
      var template_name = this.template_map[this.model.get("template_name")] || this.model.get("template_name");
      return this.model.templateURL + "/" + template_name;
    },
  });
