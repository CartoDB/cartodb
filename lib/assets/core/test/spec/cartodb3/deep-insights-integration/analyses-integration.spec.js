...
describe('deep-insights-integrations/analyses-integration', function () {
  ...
  beforeEach(function (done) {
    ...
    var onDashboardCreated = function (dashboard) {
      ...
      spyOn(this.diDashboardHelpers.getAnalyses(), 'analyse').and.callThrough();
  ...
  describe('when analysis-definition-node is created', function () {
    ...
    it('should analyse node', function () {
      expect(this.diDashboardHelpers.getAnalyses().analyse).toHaveBeenCalledWith({
        id: 'a1',
        type: 'source',
        params: {
          query: 'SELECT * FROM foobar'
    ...
    describe('when changed', function () {
      beforeEach(function () {
        this.diDashboardHelpers.getAnalyses().analyse.calls.reset();
    ...
    describe('when changed only id', function () {
      ...
      it('should not analyse node', function () {
        expect(this.diDashboardHelpers.getAnalyses().analyse).not.toHaveBeenCalled();
      });
    ...
    describe('when changed id and another thing', function () {
      ...
      it('should analyse node', function () {
        expect(this.diDashboardHelpers.getAnalyses().analyse).toHaveBeenCalled();
      });
