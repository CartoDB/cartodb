  cdb.admin.ShareDialog = cdb.admin.BaseDialog.extend({
    ...
    _setLinkURL: function() {
      ...
      if (this.options.user.isInsideOrg()) {
        origin = "http://" + location.host + cdb.config.prefixUrl();
      }
    ...
    _setIframeURL: function() {
      ...
      var iframe     = "<iframe width='100%' height='520' frameborder='0' src='" + embed_url + "?scrollwheel=false' allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>";
