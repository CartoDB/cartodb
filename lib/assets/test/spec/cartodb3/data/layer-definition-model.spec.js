...
describe('data/layer-definition-model', function () {
  ...
  describe('.isVisible', function () {
    it('should return if is visible', function () {
      expect(this.isVisible()).toBe(true);

      this.model.set({ visible: false }, { silent: true });
  ...
  describe('.canBeGeoreferenced', function () {
    ...
    it('should be true if there is data, no geocoding analysis applied, no custom query or doesn\'t have geom', function () {
    ...
    it('should be false if there is no data', function () {
    ...
    it('should be false if there is a geocoding analysis applied', function () {
    ...
    it('should be false if there is a custom query applied', function () {
      this.nodeModel.queryRowsCollection.isEmpty.and.returnValue(true);
      this.nodeModel.queryGeometryModel.hasValue.and.returnValue(false);
    ...
    it('should be false if there is geom value', function () {
      this.nodeModel.queryRowsCollection.isEmpty.and.returnValue(true);
