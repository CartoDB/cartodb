...
module.exports = cdb.core.Model.extend({
  ...
  initialize: function(attrs, opts) {
    ...
    this.collection = new cdb.admin.Visualizations(opts.selectedItems);
  ...
  getSelectedDatasets: function() {
    if (this._selectedVisualizations) {
      return this._selectedVisualizations.toArray();
    } else {
  ...
  createMap: function() {
    ...
    this._selectedVisualizations = new cdb.admin.Visualizations(selectedItems);
  ...
  _checkCollection: function() {
    if (this._selectedVisualizations.length > 0) {
      this._importDataset(this._selectedVisualizations.pop());
    } else {
