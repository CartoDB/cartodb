...
module CartoDB
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( common.css keys.css leaflet.css tables.css map.css table.css front.css cdb/themes/css/cartodb.css specs.css map/leaflet.ie.css plugins/tipsy.css fonts_ie.css)
