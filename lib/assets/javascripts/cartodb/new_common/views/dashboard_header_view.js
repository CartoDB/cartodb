...
module.exports = cdb.core.View.extend({
  ...
  _renderLogoLink: function() {
    ...
    // setTimeout(function() {
    //   self.$('.FlipLogo').addClass('flip');
    //   setTimeout(function() {
    //     self.$('.FlipLogo').addClass('rotate');
    //   }, 500);  
    // }, 2000);


    // setTimeout(function() {
    //   self.$('.FlipLogo').addClass('stop');
    //   setTimeout(function() {
    //     self.$('.FlipLogo').removeClass('flip');
    //   }, 500);
    //   setTimeout(function() {
    //     self.$('.FlipLogo').removeClass('stop rotate');
    //   }, 1200);
    // },6000);
  },
