...
var TimeSeriesNoneOptionModel = require('../../../../../javascripts/cartodb3/editor/add-widgets/time-series/time-series-none-option-model');
...
describe('editor/add-widgets/widgets-types', function () {
  ...
  describe('times-series', function () {
    beforeEach(function () {
      this.d = widgetsTypes.find(function (d) {
    ...
    describe('.createOptionModels', function () {
      it('should always create a none-option even if there are no tuples items', function () {
        var models = this.d.createOptionModels([]);
