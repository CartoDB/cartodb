...
var InfowindowView = require('./infowindows/infowindow-view');
var InfowindowModel = require('./infowindows/infowindow-model');
...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    this.$el.append(this._infowindowView.render().el);
  ...
  getInfowindowModel: function () {
    return this._infowindowView
      ? this._infowindowView.model
      : null;
  },
