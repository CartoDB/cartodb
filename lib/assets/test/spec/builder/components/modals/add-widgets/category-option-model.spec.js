...
describe('components/modals/add-widgets/category/category-option-model', function () {
  var model;
  var defaultOptions;
  ...
  var createModelFn = function (options, optionsTuples) {
    ...
    return new CategoryOptionModel(_.extend(defaultOptions, options));
  };
  ...
  it('should have a "category" type by default', function () {
