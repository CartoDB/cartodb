    ...
    createLayerForAnalysisNode: function (nodeId, cfg) {
      ...
      if (prevLayer) {
        if (nodeDefModel.hasPrimarySource()) {
          ...
          var oldNodeStyle = nodeDefModel.getPrimarySource().getStyleHistoryForLayer(prevLayer.id);
        ...
        var oldNodeStyle = nodeDefModel.getStyleHistoryForLayer(ownerLayer.id);
