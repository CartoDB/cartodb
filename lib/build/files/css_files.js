...
module.exports = css_files = {
  ...
  // All new required to retrofit new dialogs with current editor styles
  new_table: [
    '<%= assets_dir %>/stylesheets/new_common/0-utilities.css',
    '<%= assets_dir %>/stylesheets/new_common/badge.css',
    '<%= assets_dir %>/stylesheets/new_common/icon-font.css',
    '<%= assets_dir %>/stylesheets/new_common/dialog.css',
    '<%= assets_dir %>/stylesheets/new_common/default-paragraph.css',
    '<%= assets_dir %>/stylesheets/new_common/default-title.css',
    '<%= assets_dir %>/stylesheets/new_common/default-time-diff.css',
    '<%= assets_dir %>/stylesheets/new_common/buttons.css',
    '<%= assets_dir %>/stylesheets/new_common/intermediate-info.css',
    '<%= assets_dir %>/stylesheets/new_common/icons/layout-icon.css',
    '<%= assets_dir %>/stylesheets/new_common/map-card.css',
    '<%= assets_dir %>/stylesheets/new_common/nav-button.css',
    '<%= assets_dir %>/stylesheets/new_common/spinner.css',
