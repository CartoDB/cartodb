...
module.exports = [
  {
    // Without method property, same scenario for users with styles
    // already applied
    style: {
      type: 'simple',
      properties: {
    ...
    // Method property set as 'dot', without blending
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Point marker with line, no method applied
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Point with stroke, method **dot**, blending applied
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Testing point and polygon with image icon/pattern
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Simple point and polygon with range and domain
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Dot point with range and domain
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    result: {
      point: {
        cartocss: '#layer {\ndot-fill: ramp([address], (#B2DF8A, #FF2900, #FF0011, #CCC), ("_", "Albania", "Andorra", Luxemburg), "=");\ndot-opacity: 0.4;\n}',
        type: 'CartoDB'
      }
    }
  }, {
    // Point and polygon with range and domain and using Others
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Dot point with range + domain and using Others
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    result: {
      point: {
        cartocss: '#layer {\ndot-fill: ramp([address], (#FFFFFF, #1D6996, #129C63, #73AF48, #EDAD08, #E17C05, #C94034, #BA0040, #8E1966, #6F3072, #DC1721), ("one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten"), "=");\ndot-opacity: 0.4;\n}',
        type: 'CartoDB'
      }
    }
  }, {
  ...
  {
    // labels without attribute defined
    style: {
      type: 'simple',
      properties: {
        labels: {
  ...
  {
    // labels with different placement
    style: {
      type: 'simple',
      properties: {
        labels: {
  ...
  {
    // With color and size ramps, without quantification or bins in size
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // With color and size ramps, quantification jenks
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    // Dot points with color and size ramps, quantification jenks
    style: {
      type: 'simple',
      properties: {
        fill: {
    ...
    result: {
      point: {
        cartocss: '#layer {\ndot-width: ramp([cartodb_id], range(1, 20), jenks(6));\ndot-fill: ramp([test], (#fabada, black, red, white), jenks);\ndot-opacity: 0.5;\ndot-comp-op: multiply;\n}'
      }
    }
  }, {
    // Points and polygons with color, size and image ramps, quantification jenks
    style: {
      type: 'simple',
      properties: {
        fill: {
  ...
  {
    // Points and polygons with color and size ramps, number domain
    style: {
      type: 'simple',
      properties: {
        fill: {
  ...
  {
    // Points and polygons with color, size and image ramps, strings domain
    style: {
      type: 'simple',
      properties: {
        fill: {
  ...
  {
    // Points and polygons with color and size ramps, no images
    style: {
      type: 'simple',
      properties: {
        fill: {
  ...
  {
    // Points and polygons with color, size and images ramps 😱
    style: {
      type: 'simple',
      properties: {
        fill: {
  ...
  {
    // Line with color and size ramps (turbocarto)
    style: {
      type: 'simple',
      properties: {
        stroke: {
  ...
  {
    // Styles reset for each geometry
    style: {
      type: 'none'
    },
    result: {
