...
cdb.admin.GeometryEditor = cdb.core.View.extend({
  ...
  _showStopEdit: function(row) {
    ...
    if (this.options.user.featureEnabled('new_modals')) {
      dlg = cdb.editor.ViewFactory.createDialogByTemplate('common/dialogs/confirm_edit_geom');
    } else {
      dlg = new cdb.admin.BaseDialog({
        title: "This geometry is too big to edit from the web",
        descriptionSafeHtml: "Editing this geometry could freeze or crash your browser, and you could lose your work. We encourage you to edit this feature through the API.",
