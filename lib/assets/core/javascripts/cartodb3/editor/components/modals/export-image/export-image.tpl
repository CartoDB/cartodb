<div class="u-flex u-justifyCenter">
  <div class="Modal-inner Modal-inner--grid u-flex u-justifyCenter">
    ...
    <div>
      <h2 class=" CDB-Text CDB-Size-huge is-light u-bSpace--xl"><%- _t('editor.maps.export-image.title', { name: name }) %></h2>
      <p class="CDB-Text CDB-Size-large u-altTextColor"><%- _t('editor.maps.export-image.desc', { format: format, dimensions: dimensions }) %><p>
      <p class="CDB-Text CDB-Size-large u-altTextColor"><%- _t('editor.maps.export-image.available-in') %>: <a href="<%- url %>" class="u-ellipsis"><%- url %></a></p>
      <ul class="Modal-listActions u-flex u-alignCenter">
        <li class="Modal-listActionsitem">
          <button class="CDB-Button CDB-Button--secondary CDB-Button--big js-cancel">
            <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-medium u-upperCase">
               <%- _t('editor.maps.export-image.cancel') %>
            </span>
          </button>
        </li>
        <li class="Modal-listActionsitem">
          <button class="CDB-Button CDB-Button--primary CDB-Button--big js-confirm">
            <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-medium u-upperCase">
              <%- _t('editor.maps.export-image.download') %>
            </span>
          </button>
        </li>
      </ul>
