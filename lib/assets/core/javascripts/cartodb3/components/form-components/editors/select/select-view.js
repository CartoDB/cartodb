...
Backbone.Form.editors.Select = Backbone.Form.editors.Base.extend({
  ...
  initialize: function (opts) {
    ...
    if (this.options.stateModel) {
      this._stateModel = this.options.stateModel;
    ...
    if (this.options.toggleHoverAction) {
      this._toggleHoverAction = this.options.toggleHoverAction;
    }
  ...
  _renderButton: function (model) {
    ...
    var data = _.extend({}, model.attributes, { label: model.getName() });
  ...
  _toggleHover: function () {
    this._toggleHoverAction && this._toggleHoverAction();
  },
