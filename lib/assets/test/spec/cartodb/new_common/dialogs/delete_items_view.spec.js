...
var DeleteItems = require('../../../../../javascripts/cartodb/new_common/dialogs/delete_items_view');
var ViewModel = require('../../../../../javascripts/cartodb/new_common/dialogs/delete_items_view_model');
var cdbAdmin = require('cdb.admin');

describe('new_common/dialogs/delete_items_view', function() {
  beforeEach(function() {
    ...
    describe('when loading prerequisities finished successfully', function() {
      ...
      describe('when there are affected maps', function() {
          ...
          spyOn(this.viewModel, 'affectedVisData').and.returnValue([
            {
              ...
              permission: {
                ...
                owner: {
                  ...
                  base_url: 'http://org.cartodb.com/u/development',
        ...
        it('should render the vizjson', function() {
          expect(this.innerHTML()).toContain('data-vizjson-url="http://org.cartodb.com/u/development/api/v2/viz/8b44c8ba-6fcf-11e4-8581-080027880ca6/viz.json"');
        });

        it('should be linked to open map in new window', function() {
          expect(this.innerHTML()).toContain('<a href="http://org.cartodb.com/u/development/viz/8b44c8ba-6fcf-11e4-8581-080027880ca6/map" target="_blank"');
        });
      });
    });
  });
