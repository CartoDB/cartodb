...
module.exports = Router.extend({
  ...
  _changeRouteToSearch: function(contentType, q, page) {
    ...
    var excludeShared = !this._doesCurrentUrlContain('shared/search');
  ...
  _changeRouteToTag: function(contentType, tag, page) {
    page = this._getPage(page);
    var excludeShared = !this._doesCurrentUrlContain('shared/tag');
  ...
  _changeRouteToDatasets: function(page) {
    page = this._getPage(page);
    var excludeShared = !this._doesCurrentUrlContain('datasets/shared');
  ...
  _changeRouteToMaps: function(page) {
    page = this._getPage(page);
    var excludeShared = !this._doesCurrentUrlContain('maps/shared');
