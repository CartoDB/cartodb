...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    if (this._isUnanimatable()) {
      ...
      if (styleType !== TYPES.HEATMAP && styleType !== TYPES.ANIMATED) {
      ...
      if (currentGeometry && currentGeometry.getSimpleType() === 'point' && (styleType === TYPES.ANIMATED || styleType === TYPES.HEATMAP)) {
