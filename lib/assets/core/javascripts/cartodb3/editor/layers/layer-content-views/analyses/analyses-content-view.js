...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    this.listenTo(this.model, 'change:selectedNodeId', this._onSelectedNodeChanged);
  ...
  _onSelectedNodeChanged: function () {
    Router.goToAnalysisNode(this._layerDefinitionModel.get('id'), this._getSelectedNodeId(), { trigger: false });
    this.render();
  },
