...
(function() {
    ...
    cdb.admin.TableView = cdb.ui.common.Table.extend({
      ...
      _onSQLView: function() {
        ...
        this.options.sqlView.unbind('loading reset error', null, this);
        ...
        this.options.sqlView.bind('reset', _renderSQLHeader, this);
        this.options.sqlView.bind('error', _renderSQLHeader, this);
        _renderSQLHeader();
      },
      ...
      _editCell: function(e, cell, x, y) {
        ...
        if (this.model.isReservedColumn(column) && !this.model.data().isReadOnly() && columnType!='geometry') {
          return;
        }
