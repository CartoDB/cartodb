...
var PanelWithOptionsView = require('cartodb3/components/view-options/panel-with-options-view');
var StyleContentView = require('./style-content-view');
var StyleCartoCSSView = require('./style-cartocss-view');
var ScrollView = require('cartodb3/components/scroll/scroll-view');
var TabPaneView = require('cartodb3/components/tab-pane/tab-pane-view');
var TabPaneCollection = require('cartodb3/components/tab-pane/tab-pane-collection');
...
var ParserCSS = require('cartodb3/helpers/parser-css');
var Infobox = require('cartodb3/components/infobox/infobox-factory');
var InfoboxModel = require('cartodb3/components/infobox/infobox-model');
var InfoboxCollection = require('cartodb3/components/infobox/infobox-collection');
var Notifier = require('cartodb3/components/notifier/notifier');
var CartoCSSNotifications = require('cartodb3/cartocss-notifications');
var MetricsTracker = require('cartodb3/components/metrics/metrics-tracker');
var OnboardingLauncher = require('cartodb3/components/onboardings/generic/generic-onboarding-launcher');
var OnboardingView = require('cartodb3/components/onboardings/layers/style-onboarding/style-onboarding-view');
...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    var createControlView = this._isDataEmpty
      ? null
      : this._createControlView.bind(this);

    var createActionView = this._isDataEmpty
      ? null
      : this._createActionView.bind(this);
    ...
    var panelWithOptionsView = new PanelWithOptionsView({
      ...
      createControlView: createControlView,
  ...
  _isLayerHidden: function () {
    return !this._layerDefinitionModel.get('visible');
  },
