...
describe('MapsStore', () => {
  ...
  describe('actions', () => {
    ...
    it('goToPage', done => {
      ...
      testAction2({ action: actions.goToPage, payload: page, expectedMutations, expectedActions, done });
    });
    ...
    it('filterMaps', done => {
      ...
      const expectedActions = [{ type: 'fetchMaps' }];
      testAction2({ action: actions.filterMaps, payload: { filter }, expectedMutations, expectedActions, done });
    });
    ...
    it('orderMaps', done => {
      ...
      const expectedActions = [{ type: 'fetchMaps' }]
      testAction2({ action: actions.orderMaps, payload:{ order }, expectedMutations, expectedActions, done });
    });
    ...
    it('resetFilters', done => {
      ...
      const expectedActions = [{ type: 'fetchMaps' }];
      testAction2({ action: actions.resetFilters, expectedMutations, expectedActions, done });
    });
    ...
    it('updateMap', done => {
      ...
      testAction2({ action: actions.updateMap, payload: mapOptions, expectedMutations, done });
    });
    ...
    it('setURLOptions', done => {
      ...
      testAction2({ action: actions.setURLOptions, payload: URLOptions, expectedMutations, expectedActions, done });
    });
    ...
    describe('like', () => {
      ...
      it('success', done => {
        ...
        testAction2({ action: actions.like, payload: state.list[mapId], state, expectedMutations, done });
      });
      ...
      it('errored', done => {
        ...
        testAction2({ action: actions.like, payload: state.list[mapIdErr], state, expectedMutations, done });
      });
    });
    ...
    describe('deleteLike', () => {
      ...
      it('success', done => {
        ...
        testAction2({ action: actions.deleteLike, payload: state.list[mapId], state, expectedMutations, done });
      });
    });
  });
});
