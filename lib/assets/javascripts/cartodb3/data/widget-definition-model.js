...
module.exports = cdb.core.Model.extend({
  ...
  update: function (layerDefinitionModel, attrs) {
    if (layerDefinitionModel !== this._layerDefModel) {
      this._layerDefModel = layerDefinitionModel;

      // TODO this should handled internally by the dataview; temporary hack to get things working for now
      this.widgetModel.dataviewModel.layer = this._layerDefModel.layerModel;
    }

    this.widgetModel.update(this._flatten(attrs));
    this.save(attrs);
  },
