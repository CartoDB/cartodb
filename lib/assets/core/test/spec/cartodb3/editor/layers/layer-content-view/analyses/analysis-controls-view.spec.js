...
describe('editor/layers/layer-content-view/analyses/analysis-controls-view', function () {
  beforeEach(function () {
    ...
    DataServicesApiCheck.get(configModel).state = 'ready';
  ...
  describe('analysis with quota', function () {
    ...
    describe('dataservices api not existing', function () {
      beforeEach(function () {
        DataServicesApiCheck.get().state = 'error';
      });

      afterEach(function () {
        DataServicesApiCheck.get().state = 'ready';
      });

      it('should get back to analyses list when close is clicked', function () {
