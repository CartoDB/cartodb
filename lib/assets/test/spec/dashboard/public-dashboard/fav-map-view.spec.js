...
var FavMapView = require('../../../../javascripts/dashboard/public-dashboard/fav-map-view');

describe('dashboard/public-dashboard/fav-map-view', function () {
  beforeEach(function () {
  ...
  describe('given there is no data to create map from an user visualization', function () {
    ...
    it('should create the fallback map with a given basemap template URL', function () {
      ...
      expect(args[1].layers[0].options.urlTemplate).toEqual('https://cartodb-basemaps-{s}.global.ssl.fastly.net/rastertiles/voyager_nolabels/{z}/{x}/{y}.png');
