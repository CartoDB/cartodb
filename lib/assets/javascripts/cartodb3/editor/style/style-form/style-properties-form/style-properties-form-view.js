...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var simpleGeometry = currentGeometry && currentGeometry.getSimpleType();
  ...
  _initViews: function () {
    ...
    if (this._isUnanimatable()) {
      ...
      if (currentGeometry && currentGeometry.getSimpleType() === 'point' && (styleType === TYPES.ANIMATION || styleType === TYPES.HEATMAP)) {
