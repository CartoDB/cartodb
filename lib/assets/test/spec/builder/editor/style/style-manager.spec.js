...
describe('editor/style/style-manager', function () {
  ...
  describe('track changes', function () {
    ...
    it('should change alphamarker url based on asset host', function () {
      ...
      this.configModel.set('app_assets_base_url', 'https://cartodb-libs.freetls.fastly.net/cartodbui/assets');
      this.layerDefModel.styleModel.set('style', 'dummy1');
      expect(this.layerDefModel.get('type')).toBe('torque');
      expect(this.layerDefModel.get('cartocss')).toContain('marker-file: url(https://cartodb-libs.freetls.fastly.net/cartodbui/assets/unversioned/images/alphamarker.png);');
      ...
      expect(this.layerDefModel.get('cartocss')).not.toContain('marker-file: url(https://cartodb-libs.freetls.fastly.net/cartodbui/assets/unversioned/images/alphamarker.png);');
