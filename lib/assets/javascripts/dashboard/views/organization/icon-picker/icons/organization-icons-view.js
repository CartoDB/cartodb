...
module.exports = CoreView.extend({
  ...
  _beforeIconUpload: function () {
    ...
    if (this._numOfUploadingProcesses > 0) {
      this._runningMessage = _t('dashboard.views.organization.icon_picker.uploading');
  ...
  _refreshActions: function () {
    ...
    this.$('.js-deleteIcons a').text(_t('dashboard.views.organization.icon_picker.delete_pl', {smart_count: numOfSelectedIcons}));
  },
  ...
  _beforeIconDelete: function () {
    ...
    if (this._numOfDeletingProcesses > 0) {
      this._runningMessage = _t('dashboard.views.organization.icon_picker.deleting');
      this.model.set('isProcessRunning', true);
    }
  },
