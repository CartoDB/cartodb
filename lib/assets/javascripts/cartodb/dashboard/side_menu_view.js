...
module.exports = cdb.core.View.extend({
  ...
  _initCategoryTree: function() {
    ...
    var sideMenuContent = this.$el.find(".SideMenuContent");

    sideMenuContent.find(".MenuItem").click(function(){
      sideMenuContent.find(".MenuItem").removeClass("selected");
      ...
      if (order) {
        ...
        self.router.model.set('order', order);
      }
