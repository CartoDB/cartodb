...
<p class="CDB-Text Onboarding-description">
  <a href="https://carto.com/learn/guides/analysis/georeference" class="Onboarding-readMore" target="_blank" rel="noopener noreferrer"><%- _t('analyses-onboarding.learn-more') %></a>
</p>
