...
module.exports = cdb.core.View.extend({
  ...
  _updateOrnaments: function() {
    if (this.model.selectedMergeMethod) {
      var isCountMethod = false;
      var mergeMethodName = '';

      var selectedMergeMethod = this.model.selectedMergeMethod();
      if (selectedMergeMethod) {
        isCountMethod = this.model.isCountMergeMethod(selectedMergeMethod);
        mergeMethodName = selectedMergeMethod.name;
      }

      var hasSelectedRightMergeColumn = !!this.model.selectedRightMergeColumn();
      this.$('.js-ornaments-bottom').toggle(hasSelectedRightMergeColumn && !isCountMethod);
      this.$('.js-ornaments').toggleClass('MergeDatasets-ornamentsTop--withSpatialKeyColumn', !isCountMethod);
      this.$('.js-ornaments-text').text(mergeMethodName);
    }
  },
