...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var simpleGeometry = this._querySchemaModel.get('simple_geom');
  ...
  _initViews: function () {
    ...
    if (this._isUnanimatable()) {
      ...
      if (this._querySchemaModel.get('simple_geom') === 'point' && (styleType === TYPES.ANIMATION || styleType === TYPES.HEATMAP)) {
