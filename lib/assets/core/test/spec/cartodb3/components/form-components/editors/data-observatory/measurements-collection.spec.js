...
fdescribe('components/form-components/editors/data-observatory/measurements-collection', function () {
  beforeEach(function () {
  ...
  it('model', function () {
    ...
    expect(m.get('id')).toBe('us.zillow.AllHomes_Zhvi');
    expect(m.get('name')).toBe('Zillow Home Value Index for All homes');
