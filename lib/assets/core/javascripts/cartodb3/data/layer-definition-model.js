...
module.exports = Backbone.Model.extend({
  ...
  canBeGeoreferenced: function () {
    ...
    console.log('No geocoding applied', !hasGeocodingAnalysisApplied(), 'No geometry', !analysisDefinitionNodeModel.queryGeometryModel.hasValue(), 'No custom query', !analysisDefinitionNodeModel.isCustomQueryApplied(), '!analysisDefinitionNodeModel.queryRowsCollection.isEmpty()', !analysisDefinitionNodeModel.queryRowsCollection.isEmpty());
    console.log(analysisDefinitionNodeModel.queryRowsCollection, analysisDefinitionNodeModel.queryRowsCollection.size());
