...
F.prototype._onBaseLayerChanged = function () {
  ...
  var previousMapProvider = basemapProvidersAndCategories.getProvider(baseLayerDefinition.previous('category'));
  var newMapProvider = basemapProvidersAndCategories.getProvider(baseLayerDefinition.get('category'));
