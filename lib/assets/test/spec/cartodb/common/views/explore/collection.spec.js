...
describe('common/views/explore/feed_collection', function() {
  ...
  it('should generate a query depending on the type', function() {
    ...
    expect(this.collection.generateQuery('datasets', 'mapviews', 1, 8)).toEqual(query);
  });
