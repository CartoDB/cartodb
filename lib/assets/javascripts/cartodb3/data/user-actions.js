  ...
  var resetStylesWhenGeometryChanges = function (nodeDefModel, layerDefModel, forceStyleUpdate) {
    ...
    onQueryGeometryAndSchemaReady = function () {
      ...
      saveDefaultStylesIfStillRelevant = function () {
        ...
        if (
            !forceStyleUpdate && (
              (!queryGeometryModel.hasChanged('simple_geom') && !querySchemaModel.hasDifferentSchemaThan(styleModel.getColumnsUsedForStyle())) ||
    ...
    nodeDefModel.queryGeometryModel.bind(CHANGE_READY, onQueryGeometryAndSchemaReady);
    nodeDefModel.querySchemaModel.bind(CHANGE_READY, onQueryGeometryAndSchemaReady);
