...
describe('deep-insights-integrations', function () {
  ...
  describe('when a widget-definition is created', function () {
    ...
    it('should call widgets service properly', function () {
      var widget = this.dashboard.getWidget(this.model.id);
  ...
  describe('autoStyle', function () {
    ...
    beforeEach(function () {
      ...
      spyOn(layerDefinitionModel.styleModel, 'resetPropertiesFromAutoStyle');
      spyOn(layerDefinitionModel.styleModel, 'setPropertiesFromAutoStyle');
    ...
    it('should cancel autostyle on remove widget', function () {
      var model = this.dashboard.getWidget(category.id);
