var IconView = require('../../../../../javascripts/cartodb/organization/icons/organization_icon_view');
var IconModel = require('../../../../../javascripts/cartodb/organization/icons/organization_icon_model');

describe('organization/icons/organization_icon_view', function () {
  beforeEach(function () {
  ...
  describe('render', function () {
    it('should render properly', function () {
      ...
      expect(this.view.model.get('visible')).toBe(true);
    });
  });
