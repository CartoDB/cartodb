...
module.exports = cdb.core.View.extend({
  ...
  events: {
    ...
    'click .js-mapTemplates':   '_onMapTemplatesClick',
  ...
  render: function(m, c) {
    ...
    var d = _.extend({
        ...
        mapTemplatesEnabled:   this.user.featureEnabled('templated_workflows'),
    ...
    var template = cdb.templates.getTemplate('common/views/create/listing/navigation');
    ...
    if (this.createModel.get('listing') === "templated_workflows" && this.workflowModel && this.workflowModel.getStepNumber() !== null) {
      ...
      template = cdb.templates.getTemplate( 'common/views/create/listing/workflow_navigation');
    }

    this.clearSubViews();
    this.$('.Filters-inner').html(template(d));
    this._animate();
  ...
  _onMapTemplatesClick: function() {
    if (this.user.featureEnabled('templated_workflows')) {
      this.createModel.set('listing', 'templated_workflows');
    }
  },
