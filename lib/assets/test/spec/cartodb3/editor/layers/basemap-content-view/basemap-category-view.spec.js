...
var BasemapCategoryView = require('../../../../../../javascripts/cartodb3/editor/layers/basemap-content-views/basemap-category-view');
var CarouselCollection = require('../../../../../../javascripts/cartodb3/components/custom-carousel/custom-carousel-collection');

describe('editor/layers/basemap-content-views/basemap-category-view', function () {
  beforeEach(function () {
    ...
    this.view = new BasemapCategoryView({
