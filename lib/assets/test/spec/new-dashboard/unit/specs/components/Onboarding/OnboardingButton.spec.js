...
describe('OnboardingButton.vue', () => {
  ...
  it('should not contain not-visited class after opening onboarding', async () => {
    const $router = {
      push: jest.fn()
    };
  ...
  describe('Methods', () => {
    it('should call router.push when opening onboarding', async () => {
      const $router = {
        push: jest.fn()
      };
    ...
    it('should call updateHasVisitedOnboarding with true when opening onboarding', async () => {
      const $router = {
        push: jest.fn()
      };
