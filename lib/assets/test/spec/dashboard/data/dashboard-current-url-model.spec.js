var CurrentUrlModel = require('dashboard/data/dashboard-current-url-model');
...
describe('dashboard/router/dashboard-current-url-model', function () {
  beforeEach(function () {
    var dashboardUrl = new DashboardUrlModel({
