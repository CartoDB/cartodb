  ...
  cdb.admin.mod.SelectorFilter = cdb.core.View.extend({
    ...
    render: function() {
      ...
      this.$el.html(this.getTemplate('table/menu_modules/filters/templates/selection')({
        ...
        legend: this._getColumnName(),
        short_legend: this._getColumnName(),
      ...
      if (this.model.get("reached_limit")) {
        ...
        this._toggleMode();
        this.model.set("legend", this._getColumnName());
    ...
    _getColumnName: function() {
      if (this.model.table.get('synchronization') && this.model.table.get('synchronization').from_external_source) {
        return Sugar.String.titleize(this.model.escape('column'));
      }
      return this.model.escape('column');
    }
