...
var SharePublishView = require('./publish/share-publish-view');
...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    console.log(this._privacyCollection, this._userModel.get('account_type').toLowerCase());
  },
