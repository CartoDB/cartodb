describe("cdb.admin.dashboard.UserStats", function() {
  ...
  describe("UserStats", function() {
    ...
    it("should show graph when user is from a organization", function() {
      var org = new cdb.admin.Organization({ id:3, users: [1,2,3] });
      var user = new cdb.admin.User({ account_type: "JOHN SNOW", remaining_byte_quota: 0, table_count: 0, table_quota: 10, quota_in_bytes: 10, username: "development" });
