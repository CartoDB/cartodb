...
module.exports = CoreView.extend({
  ...
  _isToggleDisable: function () {
    return this._modelView.get('state') === 'error' || this._legendDefinitionModel.get('type') === 'none' || this._legendDefinitionModel.get('type') === 'html' || this._areLegendsDisabled();
  },
  ...
  _infoboxState: function () {
    ...
    } else if (!edition && this._hasLegendMigrated()) {
