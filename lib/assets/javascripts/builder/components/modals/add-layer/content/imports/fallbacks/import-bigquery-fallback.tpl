<div class="ImportPanel-header">
  ...
  <a href="mailto:sales@carto.com?subject=<%- _t('components.modals.add-layer.imports.demo-email-title', { name: 'BigQuery' }) %>&body=<%- _t('components.modals.add-layer.imports.demo-email-desc', { name: 'BigQuery' }) %>" class="CDB-Button CDB-Button--primary CDB-Button--medium">
