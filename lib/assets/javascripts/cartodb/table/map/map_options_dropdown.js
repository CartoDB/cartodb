cdb.admin.MapOptionsDropdown = cdb.ui.common.Dropdown.extend({
  ...
  initialize: function() {
    ...
    this.mapOptions = new cdb.core.Model({
      ...
      fullscreen:       false,
      share:            true,
      logo:             this.options.user.featureEnabled("disabled_cartodb_logo") ? false: true,
      zoom:             true,
      scrollwheel:      false,
      legends:          true
    });
  ...
  _setupOptions: function() {
    ...
    // If user has set the diable cartodb logo FeatureFlag then remove the logo
    if(this.options.user.featureEnabled("disabled_cartodb_logo")) {
      simpleOverlays.pop();
    }
  ...
  render: function() {
    ...
    this.$el.html(this.template_base({
      // Feature flag that indicates if cartodb logo must be shown
      disabled_cartodb_logo: this.options.user.featureEnabled("disabled_cartodb_logo")
    }));
