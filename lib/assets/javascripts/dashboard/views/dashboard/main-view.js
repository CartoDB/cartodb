...
// TODO: Still needed
// const MamufasImportView = require('../common/mamufas_import/mamufas_import_view');
const BackgroundPollingView = require('../common/background_polling/background_polling_view');
...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    this._backgroundPollingView = new BackgroundPollingView({
      ...
      // Only create a visualization from an import if user is in maps section
      createVis: this._routerModel.model.isMaps(),
      user: this.user
    });
