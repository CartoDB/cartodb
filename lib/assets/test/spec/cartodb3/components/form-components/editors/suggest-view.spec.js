...
require('../../../../../../javascripts/cartodb3/components/form-components/editors/select/suggest-view.js');
...
describe('components/form-components/editors/suggest', function () {
  ...
  describe('when all column row values are null', function () {
    beforeEach(function () {
      this.modelEmpty = new Backbone.Model({
        names: null
      });

      this.viewEmpty = new Backbone.Form.editors.Suggest({
        key: 'names',
        schema: {
      ...
      this.viewEmpty.render();
      this.listView = this.viewEmpty._listView;
    });
