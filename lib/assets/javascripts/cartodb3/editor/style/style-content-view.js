...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    if (this._queryGeometryModel.canFetch()) {
      this._queryGeometryModel.fetch();
    }
    if (this._querySchemaModel.canFetch()) {
  ...
  _initBinds: function () {
    ...
    this.modelView.on('change:state', this._onSQLError, this);
  ...
  _onSelectAggregation: function (mdl) {
    ...
    if (mdl.get('selected')) {
      ...
      currentGeometryType = this._querySchemaModel.get('simple_geom');
