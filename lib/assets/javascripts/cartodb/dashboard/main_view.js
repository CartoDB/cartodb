...
var TemplatedWorkflowDialogView = require('./templated_workflows/templated_workflows_dialog_view');
...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function() {
    // ----------- TODO: move it wherever it should be
    var templatedWorkflowDialog = new TemplatedWorkflowDialogView({
      clean_on_hide: true
    }).appendToBody();
    // -----------
