...
cdb.admin.Visualization = cdb.core.Model.extend({
   ...
   * @throws {Error} if this vis represents a Visualization
  ...
  tableMetadata: function() {
    if (this.get('type') === 'table') {
      ...
      throw new Error('A visualization of type '+ this.get('type') +" cannot have a tablemetadata! Check for `vis.get('type') === 'table'` before using this method");
    }
  },
