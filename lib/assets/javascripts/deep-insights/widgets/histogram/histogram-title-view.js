...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    this.widgetModel.bind('change:title change:collapsed change:autoStyle change:autoStyler change:style', this.render, this);
    ...
    this.dataviewModel.bind('change:source', this.render, this);
