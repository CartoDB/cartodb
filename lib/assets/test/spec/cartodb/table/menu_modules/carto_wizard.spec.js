...
describe('CartoWizard', function() {
  ...
  it("when the query is cleared and it was generated by a wizard the default style should be set", function() {
    view.render();
    view.panels.active('bubble');
    view.activated();
    model.set({ query: null, query_generated: true});
    expect(view.panels.getActivePane().type == 'polygon').toEqual(true)

    view.panels.active('bubble');
    view.activated();
    model.set({ query: null, query_generated: false});
    expect(view.panels.getActivePane().type == 'bubble').toEqual(true)
  });
