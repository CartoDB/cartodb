...
var GeocodingsCollection = require('../../../../../javascripts/cartodb3/data/background-importer/background-importer-geocodings-collection');
var UserModel = require('../../../../../javascripts/cartodb3/data/user-model');
var ConfigModel = require('../../../../../javascripts/cartodb3/data/config-model');

describe('editor/components/importer-manager/background-importer', function () {
  beforeEach(function () {
  ...
  it('should add importers properly', function () {
    ...
    expect(this.importer.length).toBe(1);
  });
});
