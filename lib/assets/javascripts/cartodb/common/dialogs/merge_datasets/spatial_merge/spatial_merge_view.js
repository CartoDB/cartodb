...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function() {
    ...
    if (rightTableData) {
      this._stickyHeaderView = new StickyHeaderView({
        leftKeyColumn: this.model.get('leftKeyColumn'),
        rightKeyColumn: this.model.get('rightKeyColumn'),
        ornamentsTop: 'MergeDatasets-ornamentsTop--spatial',
  ...
  _updateOrnaments: function() {
    if (this.model.selectedMergeMethod) {
      ...
      var isCountMethod = selectedMergeMethod ? this.model.isCountMergeMethod(selectedMergeMethod) : false;
      this.$('.js-ornaments').toggleClass('MergeDatasets-ornamentsTop--spatial', !isCountMethod);
    }
  },
