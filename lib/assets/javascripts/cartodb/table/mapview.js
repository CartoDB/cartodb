...
*/
      ...
      console.log(layer.widgets.length)
      //layer.widgets.each(function(model) {
        //self._renderWidget(model);
      //});
  ...
  _renderWidgets: function() {
   ...
   _.each(this.widgets, this._renderWidget, this);
