    ...
    cdb.admin.PostsModel = cdb.core.Model.extend({
      ...
      defaults: {
        url:      "http://api.tumblr.com/v2/blog/<%= name %>.<%= service %>.com/posts?api_key=<%= api_key %>&limit=5&offset=0&callback=",
        service:  "tumblr",
        name:     "cartodb"
      },
    ...
    cdb.admin.PostsWidget = cdb.core.View.extend({
      ...
      _destroyBinds: function() {
        this.tables.unbind('reset',         this._destroyBinds, this);
        this.visualizations.unbind("reset", this._destroyBinds, this);
      },
