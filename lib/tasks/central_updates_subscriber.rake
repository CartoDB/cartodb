...
namespace :poc do
  ...
  task :central_cartodb_commands => [:environment] do |_task, _args|
    ...
    subscription.register_callback(:update_user) do |user_param|
    ...
    subscription.register_callback(:create_user) do |user_param|
    ...
    subscription.register_callback(:delete_user) do |user_param|
      begin
