...
describe("Export table", function() {
  ...
  it("should pass the correct parameters when csv is clicked", function() {
    ...
    expect(submitedData['skipfields']).toEqual('the_geom,the_geom_webmercator');
  ...
  it("should detect if the table is georeferenced and refresh", function() {
    ...
    export_dialog.checkGeoreference();
    expect(called).toBeTruthy();;
  })

  it("should detect if the table is georeferenced", function() {
    export_dialog.checkGeoreference();
    expect(export_dialog.dataGeoreferenced).toBeTruthy();;
  })

  it("should detect if the table is NOT georeferenced", function() {
    fetchResponse  = false;
    export_dialog.checkGeoreference();
    expect(export_dialog.dataGeoreferenced).toBeFalsy();;
  })
  ...
  it("should show a warning if the table is NOT georeferenced", function() {
    ...
    expect(export_dialog.$('.geospatial').is('.hidden')).toBeFalsy();;
  })
