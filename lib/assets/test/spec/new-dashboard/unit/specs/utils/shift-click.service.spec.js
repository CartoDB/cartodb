...
describe('.shiftClick', () => {
  ...
  describe('when there are multiple selected items', () => {
    ...
    describe('when there are two elements selected consecutively without shift', () => {
      describe('and you select the one below', () => {
        it('should select two elements: the clicked one and the one above', () => {
      ...
      describe('and you select the one above', () => {
        it('should select two elements: the clicked one and the one below', () => {
          const dummyItems = [{id: 0}, {id: 1}, {id: 2}];
