...
describe('editor/layers/layers-content-view/data/data-content-view', function () {
  ...
  describe('._setViewState', function () {
    ...
    it('should be able to update the view state of hasGeom', function (done) {
      view._viewState.set('hasGeom', false);
      fakePromise(view._queryGeometryModel, 'hasValueAsync').resolve(true);
      fakePromise(view._layerDefinitionModel, 'isDataFiltered').resolve(false);
      fakePromise(view._layerDefinitionModel, 'canBeGeoreferenced').resolve(false);
    ...
    it('should be able to update the view state of isDataFiltered', function (done) {
      view._viewState.set('hasGeom', false);
      fakePromise(view._queryGeometryModel, 'hasValueAsync').resolve(false);
      fakePromise(view._layerDefinitionModel, 'isDataFiltered').resolve(true);
      fakePromise(view._layerDefinitionModel, 'canBeGeoreferenced').resolve(false);
    ...
    it('should be able to update the view state of canBeGeoreferenced', function (done) {
      view._viewState.set('canBeGeoreferenced', false);
      fakePromise(view._queryGeometryModel, 'hasValueAsync').resolve(false);
      fakePromise(view._layerDefinitionModel, 'isDataFiltered').resolve(false);
      fakePromise(view._layerDefinitionModel, 'canBeGeoreferenced').resolve(true);
