...
var LegendsView = require('cartodb3/editor/layers/layer-content-views/legend/legends-view');
...
var sqlErrorTemplate = require('cartodb3/editor/layers/layer-content-views/legend/legend-content-sql-error.tpl');
...
describe('editor/layers/layer-content-view/legend/legends-view', function () {
  ...
  describe('.render', function () {
    ...
    it('should call showEmptyData if there is no data and there is no error', function () {
      var showEmptyDataSpy = spyOn(this.view, '_showEmptyData');
      spyOn(this.layerContentModel, 'isErrored').and.returnValue(false);
