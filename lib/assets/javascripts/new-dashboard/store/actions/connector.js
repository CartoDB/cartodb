...
async function __createNewConnection (context, payload) {
  ...
  const url = 'https://connreg.carto-staging.com/api/v4/connections?api_key=913394f3c93702c3c2bcc927a0fcb954ec80c569';
...
export async function fetchConnectionById (context, id) {
  ...
  const url = `https://connreg.carto-staging.com/api/v4/connections/${id}?api_key=913394f3c93702c3c2bcc927a0fcb954ec80c569`;
  try {
    const response = await fetch(url);
...
export async function checkOauthConnection (context, connector) {
  ...
  const url = `https://connreg.carto-staging.com/api/v4/connections/check_oauth/${connector}?api_key=913394f3c93702c3c2bcc927a0fcb954ec80c569`;
  const response = await fetch(url);
...
export async function fetchOAuthFileList (context, connector) {
  ...
  const url = `https://connreg.carto-staging.com/api/v1/imports/service/${connector}/list_files?api_key=913394f3c93702c3c2bcc927a0fcb954ec80c569`;
  const response = await fetch(url);
...
export async function connectionDryrun (context, { connector, id, sql_query, import_as }) {
  ...
  const url = `https://connreg.carto-staging.com/api/v1/connectors/${connector}/dryrun?api_key=913394f3c93702c3c2bcc927a0fcb954ec80c569`;
  const response = await fetch(url, { method: 'POST',
    headers: {
      'content-type': 'application/json'
    },
...
export async function checkServiceAccount (context, payload) {
  ...
  const url = 'https://connreg.carto-staging.com/api/v1/connectors/bigquery/projects?api_key=913394f3c93702c3c2bcc927a0fcb954ec80c569';
  const response = await fetch(url, { method: 'POST',
    headers: {
      'content-type': 'application/json'
    },
