describe("cdb.admin.dashboard.Dashboard", function() {
  ...
  describe("Support", function() {
    ...
    it("should show the support block", function() {
      dashboard.user.set('actions', { dedicated_support: true });
      expect(dashboard.supportBlock.$el.css('display')).toBe('block');
    });

    it("shouldn't show the support block", function() {
      dashboard.user.set('actions', { dedicated_support: false });
      expect(dashboard.supportBlock.$el.css('display')).toBe('none');
    });
