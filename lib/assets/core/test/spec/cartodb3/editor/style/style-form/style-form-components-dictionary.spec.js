...
describe('editor/style/style-form/style-form-components-dictionary', function () {
  ...
  describe('fill', function () {
    ...
    it('should not enable image/icons when geometry is point, style simple and method dot', function () {
      this.queryGeometryModel.set('simple_geom', 'point');
      var componentDef = Dictionary['fill']({
        queryGeometryModel: this.queryGeometryModel,
        querySchemaModel: this.querySchemaModel,
  ...
  describe('stroke', function () {
    ...
    it('should be disabled and not show help when method is dot for point geometry', function () {
      this.queryGeometryModel.set('simple_geom', 'point');
      ...
      expect(componentDef.editorAttrs.size.help).toBe('');
      expect(componentDef.editorAttrs.color.help).toBe('');
      expect(componentDef.editorAttrs.disabled).toBeTruthy();
    });
