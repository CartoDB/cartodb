...
module.exports = CoreView.extend({
  ...
  _enableUpdateBind: function () {
    this._editor.on('update', _.debounce(this._updateColors.bind(this), 100));
  },

  _disableUpdateBind: function () {
    this._editor.off('update', _.debounce(this._updateColors.bind(this), 100));
  },
  ...
  _createPicker: function (ev, cursor, token) {
    ...
    this._colorPicker.bind('change', _.debounce(this._onColorPickerChange.bind(this, ev), 10), this);
