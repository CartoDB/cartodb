...
$(function() {
  cdb.init(function() {
    ...
    cdb.config.set('explore_user', window.config.explore_user);
    cdb.config.set('account_host', window.config.account_host);
    ...
    var onSuccess = function(model) {
      ...
      var visURL = '//' + model.get('username') + '.' + cdb.config('account_host') + '/api/v2/viz/' + model.get('id') + '/viz.json';

      var url = '//' + model.get('username') + '.' + cdb.config('account_host') + '/viz/' + model.get('id') + '/public_map';
