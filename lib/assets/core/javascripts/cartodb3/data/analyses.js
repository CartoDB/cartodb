...
var MAP = {
  ...
  'data-observatory-multiple-measures': {
    ...
    checkIfEnabled: function (configModel, userModel) {
      ...
      var doApiData = dataservicesApiHealth.getService('data_observatory');
      ...
      return checkIfDataObservatoryIsEnabled(configModel) && userModel.featureEnabled('data-observatory-multiple-measures') && !hideDataObservatory;
    },
