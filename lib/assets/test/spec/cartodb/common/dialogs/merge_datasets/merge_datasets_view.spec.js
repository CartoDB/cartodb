...
describe('common/dialog/merge_datasets/merge_datasets_view', function() {
  ...
  describe("MergeTablesDialogEvents", function() {
    ...
    beforeEach(function() {
      ...
      onRadioButtonClicked = spyOn(MergeDatasetsView.prototype, '_onRadioClick');
  ...
  describe("MergeTablesDialog (string merge)", function() {
    ...
    it("should have a title", function() {
      ...
      expect(dialog._$title()).toBeDefined();
      expect(dialog._$title().length > 0).toBeTruthy();
      expect(dialog._$title().text()).toEqual('Merge with another dataset');
    });

    it("should have a description", function() {
      dialog.render();

      expect(dialog._$description()).toBeDefined();
      expect(dialog._$description().length > 0).toBeTruthy();
    });

    it("should have a description title", function() {
      dialog.render();

      expect(dialog._$descriptionTitle()).toBeDefined();
      expect(dialog._$descriptionTitle().length > 0).toBeTruthy();
      expect(dialog._$descriptionTitle().text()).toEqual('');
    });

    it("should have a next button", function() {
      dialog.render();

      expect(dialog._$next()).toBeDefined();
      expect(dialog._$next().length > 0).toBeTruthy();
      expect(dialog._$next().text()).toEqual('Next');
    });

    it("should have a back button", function() {
      dialog.render();

      expect(dialog._$back()).toBeDefined();
      expect(dialog._$back().length > 0).toBeTruthy();
      expect(dialog._$back().text()).toEqual('Go back');
    });
    ...
    it("next button should be disabled on the begining", function() {
      dialog.render();
      expect(dialog._$next().hasClass('disabled')).toBeTruthy();
    });

    it("back button should be hidden on the begining", function() {
      dialog.render();
      expect(dialog._$back().hasClass("hidden")).toBeTruthy();
    });
    ...
    it("should allow to enable/disable the next button", function() {
      ...
      dialog.model.set("enableNext", true);
      expect(dialog._$next().hasClass("disabled")).toBeFalsy();
    ...
    it("should allow to show/hide the back button", function() {
      ...
      dialog.model.set("enableBack", true);
      expect(dialog._$back().not().hasClass("hidden")).toBeTruthy();
    ...
    it("should allow to change the title", function() {
      ...
      expect(dialog._$title().text()).toEqual(text);
    ...
    it("should allow to change the description", function() {
      ...
      expect(dialog._$description().text()).toEqual(text);
    });
    ...
    it("should allow to change the description title", function() {
      ...
      expect(dialog._$descriptionTitle().text()).toEqual(text);
    ...
    it("should allow to change the text of the next button", function() {
      ...
      jasmine.clock().tick(500);
      expect(dialog._$next().text()).toEqual(text);
      jasmine.clock().uninstall();
    });
