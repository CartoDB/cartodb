...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this.listenTo(this._createModel, 'change:navigationVisible', this._toggleNavigation);
  ...
  _toggleNavigation: function () {
    this._createModel.get('navigationVisible') ? this._navigationView.show() : this._navigationView.hide();
  }
});
