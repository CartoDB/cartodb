...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._renderIfAnyGeometryDataChanges();
  },
  ...
  _renderIfAnyGeometryDataChanges: function () {
    var self = this;
    this._layerDefinitionsCollection.isThereAnyGeometryData()
      .then(function (anyGeometry) {
        if (anyGeometry !== self._anyGeometryData) {
          self._anyGeometryData = anyGeometry;
          self.render();
        }
      });
  },
