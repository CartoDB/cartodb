...
var EditorHelpers = require('cartodb3/components/form-components/editors/editor-helpers-extend');
...
var itemListTemplate = require('cartodb3/components/custom-list/custom-list-item.tpl');
var template = require('./select.tpl');
var PopupManager = require('cartodb3/components/popup-manager');
...
Backbone.Form.editors.Select = Backbone.Form.editors.Base.extend({
  ...
  _getButtonTemplateData: function (model) {
    return _.extend({}, model.attributes, { label: model.getName() });
  },
