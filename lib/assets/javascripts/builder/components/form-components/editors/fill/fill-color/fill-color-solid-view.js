...
var InputColorSolidView = require('builder/components/form-components/editors/fill/fill-color/inputs/input-color-solid');
var InputImageView = require('builder/components/form-components/editors/fill/fill-color/inputs/input-image');
