...
var IconView = require('../../components/icon/icon-view');
...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    this.$el.html(
      template({
        ...
        hasGeometry: this._queryGeometryHasValue()
      })
    );
  ...
  _initViews: function () {
    ...
    if (!this._queryGeometryHasValue()) {
      var warningIcon = new IconView({
        tagName: 'li',
        placeholder: this.$el.find('.js-nogeometrylayer'),
        icon: 'warning'
      });
      warningIcon.render();
  ...
  _queryGeometryHasValue: function () {
    var nodeModel = this._getNodeModel();
    return !!nodeModel.queryGeometryModel.hasValue();
  },
