...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._querySchemaModel = this._getQuerySchemaModel();
  ...
  render: function () {
    ...
    var renderPlaceholder = this._getQueryRowsCollection().isFetching() || this._getQueryRowsCollection().isUnavailable();
