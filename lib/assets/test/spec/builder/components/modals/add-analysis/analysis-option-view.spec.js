var AnalysisOptionModel = require('cartodb3/components/modals/add-analysis/analysis-option-models/analysis-option-model');
var AnalysisOptionView = require('cartodb3/components/modals/add-analysis/analysis-option-view');
