...
module.exports = cdb.core.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    if (this.get('table_name')) {
      ...
      this._queryGeometryModel = new cdb.core.Model({ geometry_type: 'point' });
      this._styleModel = new StyleDefinitionModel(this.get('style_properties'), {
        parse: true,
  ...
  toJSON: function () {
    ...
    options.style_properties = this._styleModel.toJSON();
