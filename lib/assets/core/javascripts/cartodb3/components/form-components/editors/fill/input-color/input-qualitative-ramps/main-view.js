...
var CategoriesRampsView = require('./input-categories-ramps/input-categories-ramps-list-view');
var CategoriesListView = require('./input-categories-list/input-color-categories-list-view');
...
module.exports = CoreView.extend({
    ...
    var stackViewCollection = new Backbone.Collection([
      {
        ...
        createStackView: this._createCategoriesRampsView.bind(this)
      },
      {
  ...
  _createCategoriesRampsView: function (stackLayoutModel, opts) {
    var view = new CategoriesRampsView({
      maxValues: MAX_VALUES,
      model: this.model
    });
