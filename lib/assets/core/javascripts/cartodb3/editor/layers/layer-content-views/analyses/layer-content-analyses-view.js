...
var AnalysesQuotaInfo = require('./analyses-quota-info');
...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._quotaInfo = new AnalysesQuotaInfo([], {
      configModel: opts.configModel
    });

    // this._quotaInfo.fetch()
    //   .then(function () {
    //     console.log(this._quotaInfo);
    //   }.bind(this), function (error) {
    //     console.log(error);
    //   });

    // AnalysesQuotaEstimation(this._configModel, this._querySchemaModel.get('query')).then(function (data) {
    //   console.log(data);
    // }, function (error) {
    //   console.log(error);
    // });
