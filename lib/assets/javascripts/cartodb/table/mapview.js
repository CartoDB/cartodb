...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_renderWidgets", "_renderWidget");
  ...
  */
  ...
  _addWidgetDropdown: function() {
    ...
    if (!this.widgetDropdown) {

      this.widgetDropdown = new cdb.admin.AddWidgetDropdown({
        target: $('.add_widget'),
        position: "position",
      ...
      this.addView(this.widgetDropdown);

      cdb.god.bind("closeDialogs", this.widgetDropdown.hide, this.widgetDropdown);

      $(".add_widget").append(this.widgetDropdown.render().el);
    }
  ...
  */
  ...
  _onClickAddWidget: function(e) { // TODO: move this to a proper Header button tabs 
    ...
    this.widgetCollection.add(model);
  ...
  _renderWidget:  function(delayed_animation, data) {
    ...
    var text = new cdb.admin.TextWidget({ model: data });
