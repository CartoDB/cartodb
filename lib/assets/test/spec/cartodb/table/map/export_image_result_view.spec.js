describe('export_image_result_view', function() {
  ...
  it('should render the result view', function() {
    ...
    expect(this.view.$('p.Dialog-headerText').html()).toMatch('It\'s now available in: <a href="' + this.url + '" target="_blank" class="ExportImageResult--url" download="' + this.filenameRegexp + '">' + this.url.substring(0, 255) + '</a>');
  });
