<div class="Dialog-header Dialog-header--expanded CreateDialog-header with-separator">
  ...
  <h2 class="CDB-Text CDB-Size-large u-mainTextColor u-bSpace"><%- name %> <%- _t('components.modals.share-org.modal-title') %></h2>
  <h3 class="CDB-Text CDB-Size-medium u-altTextColor"><%- _t('components.modals.share-org.modal-desc') %></h3>
</div>
    ...
    <div class="CreateDialog-footerInner ">
      ...
      <div class="CreateDialog-footerActions js-footerActions u-flex u-justifySpace">
        <button class="CDB-Button CDB-Button--secondary js-cancel">
          <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-medium u-upperCase"><%- _t('components.modals.share-org.cancel-btn') %></span>
        </button>
        <button class="CDB-Button CDB-Button--primary js-save">
          <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-medium u-upperCase"><%- _t('components.modals.share-org.save-btn') %></span>
        </button>
      </div>
    </div>
  </div>
