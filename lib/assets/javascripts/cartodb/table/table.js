...
$(function() {
  ...
  var Table = cdb.core.View.extend({
   ...
   _saveTitleAlias: function(value) {
      var self = this;
      // var current_alias_info = this.table.get('aliases');
      var current_alias_info = this.table.get('name_alias');
      // current_alias_info.name = value;
      current_alias_info = value;
      // this.table.set('aliases', current_alias_info);
    ...
    titleClick: function(e){
      ...
      // this.titleDropdown.initializeState({alias: this.table.get('aliases').name || null});
