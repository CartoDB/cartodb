...
cdb.admin.ExportImageView = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_onResizeWindow", "_onChangeDimensions", "_onImageCallback", "_keydown", "_onDrag", "_onResize", "_updateHelpers");
  ...
  _updateHelpers: function(x, y, width, height) {
    ...
    this.$(".CanvasExport").toggleClass('is-top', y < this._DEFAULT_MARGIN);
    this.$(".CanvasExport").toggleClass('is-bottom', y + height + this._DEFAULT_MARGIN > canvasHeight);
  },
