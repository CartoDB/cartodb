const Carto = require('../carto-node/index.js.babel');
const PACKAGE = require('../../../../package.json');
const version = PACKAGE.version;
const AssetsVersionUtils = require('../utils/assets-version');
...
(function (window, document) {
  ...
  client.getConfig(function (err, response, data) {
    ...
    if (err) {
      ...
      var assetsUrl = AssetsVersionUtils.getAssetsUrl(version);
