...
$(function() {
  ...
  var Table = cdb.core.View.extend({
    ...
    */
    ...
    setTable: function(table, sqlView) {
      ...
      table.setReadOnly(table.permission.getPermission(this.user) !== cdb.admin.Permission.READ_WRITE);
      this.table = table;
  ...
  cdb.init(function() {
    ...
    Backbone.history.start({ pushState: true, root: cdb.config.prefixUrl() + "/" })
  });
