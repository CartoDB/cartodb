...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this.queryGeometryModel = new QueryGeometryModel({simple_geom: this.get('simple_geom')}, modelOpts);

    this.listenTo(this.queryGeometryModel, 'change:val', this._onGeometryValChanged);
  },
