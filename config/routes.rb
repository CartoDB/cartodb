...
CartoDB::Application.routes.draw do
  ...
  scope :module => 'carto/api', :format => :json do
    ...
    post '(/user/:user_domain)(/u/:user_domain)/api/v1/organization/:org_name/users' => 'organization_users#create', as: :api_v1_organization_users_create
    get '(/user/:user_domain)(/u/:user_domain)/api/v1/organization/:org_name/users/:u_username' => 'organization_users#show', as: :api_v1_organization_users_show
    delete '(/user/:user_domain)(/u/:user_domain)/api/v1/organization/:org_name/users/:u_username' => 'organization_users#destroy', as: :api_v1_organization_users_delete
    put '(/user/:user_domain)(/u/:user_domain)/api/v1/organization/:org_name/users/:u_username' => 'organization_users#update', as: :api_v1_organization_users_update
