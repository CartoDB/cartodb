...
module.exports = cdb.core.View.extend({
  ...
  initialize: function() {
    this.template = cdb.templates.getTemplate('new_common/views/create/listing/import_types/twitter_category');
    this._initBinds();
  },
  ...
  _onInputChange: function(e) {
    ...
    // Change icon class
    this.$('.iconFont-Twitter')[value.length > 0 ? 'addClass' : 'removeClass']('is-highlighted');
