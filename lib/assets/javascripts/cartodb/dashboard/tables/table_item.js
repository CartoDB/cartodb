...
cdb.admin.dashboard.TableItem = cdb.core.View.extend({
  ...
  _onLikeClick: function(e) {
    ...
    this.$el.find(".LikeButton-icon").addClass("is-pulsating is-animated");
    this.$el.find(".LikeButton-icon").one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
