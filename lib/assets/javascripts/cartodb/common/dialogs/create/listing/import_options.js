 ...
 *  configKey: name of the key in cdb.config that enables this service if present
 *  fallbackClassName: ...
 *  name: local name
...
module.exports = {
  ...
  Twitter: {
    ...
    configKey: 'datasource_search_twitter',
