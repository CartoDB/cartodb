...
cdb.admin.DuplicateTable = cdb.admin.BaseDialog.extend({
  ...
  _TEXTS: {
    title: {
      normal:   t('Name for your copy of this table'),
      query:    t('Name your new table from this query')
    },
    ok_button: {
      normal:   t('Duplicate table'),
      query:    t('Create table')
    },
    error: {
      default:  t('Sorry, something went wrong and we\'re not sure what. Contact us \
  ...
  initialize: function() {
    ...
    _.extend(this.options, {
      title: inSQLMode ? this._TEXTS.title.query : this._TEXTS.title.normal,
      description: '',
