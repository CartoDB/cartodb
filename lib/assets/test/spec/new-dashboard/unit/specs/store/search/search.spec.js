...
import searchStore from 'new-dashboard/store/search';
...
describe('notificationsStore', () => {
  ...
  describe('actions', () => {
    ...
    describe('.doSearch', () => {
      it('should commit mutations to fetch maps and datasets and set fetching state', done => {
        const actionPayload = { searchTerm: 'fakeSearchTerm' };
      ...
      it('should commit mutations to set data coming from API', done => {
        ...
        const expectations = () => {
          expect(rootState.client.getVisualization).toHaveBeenCalledWith(
            '', { type: 'derived', page: 1 }, expect.any(Function)
          );
    ...
    describe('.fetchDatasets', () => {
      it('should commit mutations to set data coming from API', done => {
        ...
        const expectations = () => {
          expect(rootState.client.getVisualization).toHaveBeenCalledWith(
            '', { type: 'table', page: 1 }, expect.any(Function)
          );
