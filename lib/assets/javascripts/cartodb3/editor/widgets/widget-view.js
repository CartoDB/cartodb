...
module.exports = cdb.core.View.extend({
  ...
  initialize: function (opts) {
    if (!opts.layerTableModel) {
      throw new Error('layerTableModel should be provided');
    }
    this.stackLayoutModel = opts.stackLayoutModel;
    this.layerTableModel = opts.layerTableModel;
  ...
  _onEdit: function () {
    this.stackLayoutModel.nextStep(this.model, this.layerTableModel);
  },
