...
F.prototype._onWidgetDefinitionAdded = function (m) {
  ...
  if (widgetModel) {
    ...
    widgetModel.bind('change:autoStyle', this._onWidgetAutoStyleChanged, this);
    widgetModel.bind('change:color', this._onWidgetColorChanged, this);
  }
};
...
F.prototype._onWidgetColorChanged = function (m) {
  ...
  if (isAutoStyleApplied && styleModel && geometryType) {
    styleModel.setPropertiesFromAutoStyle(autoStyleInfo.definition, geometryType);  
  }
};
...
F.prototype._onWidgetAutoStyleChanged = function (m) {
  ...
  var onLayerChange = function () {
    var resetLayerCSS = true;
    if (m.isAutoStyle()) {
      resetLayerCSS = false;
    }
    m.autoStyle(resetLayerCSS);
  };

  if (layerDefModel && nodeDefModel) {
    layerDefModel.set({
      autoStyle: isAutoStyleApplied,
  ...
  if (isAutoStyleApplied) {
    ...
    if (layerDefModel.get('autoStyle')) {
      styleModel.resetPropertiesFromAutoStyle();
      layerDefModel.set('autoStyle', false);
    }
  }
};
...
F.prototype._onWidgetDefinitionChanged = function (m) {
  ...
  if (widgetModel) {
    if (m.hasChanged('type')) {
      ...
      var attrs = this._formatWidgetAttrs(m.toJSON());
...
F.prototype._onWidgetDefinitionDestroyed = function (m) {
  ...
  if (widgetModel) {
    widgetModel.unbind('change:autoStyle', this._onWidgetAutoStyleChanged, this);
    widgetModel.unbind('change:color', this._onWidgetColorChanged, this);
    widgetModel.remove();
  }
};
