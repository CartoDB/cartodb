cdb.admin.overlays.Text = cdb.core.View.extend({
  ...
  _onMouseDown: function() {
    ...
    this.$el.css({ right: "auto", left: this.$el.offset().left })
  ...
  _place: function() {
    ...
    console.log(landscapeDirection, portraitDirection);
  ...
  render: function() {
    ...
    this.$el.find(".text").filteredPaste();
