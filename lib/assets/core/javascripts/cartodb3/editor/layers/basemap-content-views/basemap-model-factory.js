...
BasemapModelFactory.prototype.createBasemapModel = function (basemapCategory, basemapAttrs) {
  ...
  basemapAttrs = basemapAttrs.retina
    ? _setRetinaUrls(basemapAttrs)
    : basemapAttrs;
...
var _setRetinaUrls = function (basemapAttrs) {
  basemapAttrs.url = basemapAttrs.retina
    ? basemapAttrs.retina.url
    : basemapAttrs.url;

  if (basemapAttrs.labels) {
    basemapAttrs.labels.url = basemapAttrs.retina_labels
      ? basemapAttrs.retina_labels.url
      : basemapAttrs.labels.url;
  }

  delete basemapAttrs.retina;
  delete basemapAttrs.retina_labels;
