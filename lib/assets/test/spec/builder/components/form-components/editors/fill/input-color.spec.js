...
describe('components/form-components/editors/fill/input-color', function () {
  ...
  beforeEach(function () {
    ...
    jasmine.Ajax
      .stubRequest(new RegExp('^/u/pepe'))
      .andReturn(userResponse);

    jasmine.Ajax
      .stubRequest(new RegExp('^http(s)?.*/image.svg'))
  ...
  describe('image', function () {
    ...
    describe('with image enabled', function () {
      ...
      describe('with image', function () {
        ...
        it('SVG should have been loaded', function (done) {
          setTimeout(function () {
        ...
        it('._updateImageColor should change fill attribute', function (done) {
