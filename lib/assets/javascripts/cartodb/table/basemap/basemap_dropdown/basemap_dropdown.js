...
cdb.admin.DropdownBasemap = cdb.ui.common.Dropdown.extend({
  ...
  _addAddlink: function() {
    var $a = $('<li class="add_basemap hidden"><a class="add small" href="#add_basemap"><div class="thumb"></div> <div class="name">Add yours</div><small>XYZ, WMS, NASA, MapBox,...</small></a></li>');
  ...
  open: function(ev,target) {
    ...
    this.$el.css({
      bottom: this.options.target.position().top + this.options.vertical_offset,
