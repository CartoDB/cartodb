...
describe('common/views/mapcard_preview', function() {
  ...
  describe('with vizjson', function() {
  ...
  describe('with vis_id', function() {
    ...
    it('should generate the image template', function() {
      expect(view._generateImageTemplate()).toEqual('tpl_12_34_5');
    });
    ...
    it("should generate the image URL using a CDN", function() {
      var s = sinon.stub(view, '_isHTTPS');
      s.returns(true);
      view.load();
      expect(view._loadImage).toHaveBeenCalledWith({}, 'https://cdn.url.com/javier/api/v1/map/static/named/tpl_12_34_5/300/170.png');
    });
  ...
  describe('with vis_id and cdn', function() {
    ...
    it("should generate the image url", function() {
      view.load();
      expect(view._loadImage).toHaveBeenCalledWith({}, 'http://cdn.url.com/javier/api/v1/map/static/named/tpl_12_34_5/300/170.png');
    });
    ...
    it("should generate the image URL with the right protocol", function() {
      ...
      s.returns(true);
      view.load();
      expect(view._loadImage).toHaveBeenCalledWith({}, 'https://cdns.url.com/javier/api/v1/map/static/named/tpl_12_34_5/300/170.png');
    });
