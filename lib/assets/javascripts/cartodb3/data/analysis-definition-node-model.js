...
module.exports = cdb.core.Model.extend({
   ...
   */
  getOutputGeometryType: function () {
    var promise = this.get('output_geometry_promise');

    if (!promise) {
      promise = $.Deferred();
      this.set('output_geometry_promise', promise);
      this._fetchGeometryType(promise);
    }
