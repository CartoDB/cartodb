...
describe('cdb.admin.WizardProperties', function() {
  ...
  describe('propertiesFromStyle', function() {
    ...
    it("should return new properties based on cartocss", function() {
      ...
      var modified = model.propertiesFromStyle('#layer { polygon-fill: #FFF; line-width: 0.1; marker-fill: red; polygon-pattern-file: url(https://s3.dualstack.us-east-1.amazonaws.com/com.cartodb.users-assets.production/production/matallo/assets/20130808152815bullet.png);\n}');
      expect(modified).toEqual({
        'polygon-fill': '#ffffff',
        'line-width': 0.1,
        'polygon-pattern-file': 'url(https://s3.dualstack.us-east-1.amazonaws.com/com.cartodb.users-assets.production/production/matallo/assets/20130808152815bullet.png)'
      });
    });
