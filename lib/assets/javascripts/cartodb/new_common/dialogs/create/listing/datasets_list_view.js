...
var DatasetsItem = require('new_common/dialogs/create/listing/datasets/dataset_item_view');
var RemoteDatasetsItem = require('new_common/dialogs/create/listing/datasets/remote_dataset_item_view');
...
module.exports = cdb.core.View.extend({
  ...
  _addItem: function(m, i) {
    var type = (this.routerModel.get('library') && 'remotes') || 'datasets';
