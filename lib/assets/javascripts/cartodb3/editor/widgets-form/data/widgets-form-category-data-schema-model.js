...
module.exports = cdb.core.Model.extend({
  ...
  updateSchema: function () {
    ...
    this.schema = {};
    this.schema[_t('editor.widgets.data.title')] = {
      type: 'Text',
      validators: ['required']
    };

    this.schema[_t('editor.widgets.data.column')] = {
      type: 'Select',
      options: columns,
      editorAttrs: {
    ...
    this.schema[_t('editor.widgets.data.aggregation')] = {
      type: 'Select',
      options: ['sum', 'count']
    };

    this.schema[_t('editor.widgets.data.aggregation_column')] = {
      type: 'Select',
      options: columns,
      editorAttrs: {
        disabled: columns[0].disabled
    ...
    this.schema[_t('editor.widgets.data.suffix')] = {
      type: 'Text'
    };

    this.schema[_t('editor.widgets.data.prefix')] = {
      type: 'Text'
    };
  },
