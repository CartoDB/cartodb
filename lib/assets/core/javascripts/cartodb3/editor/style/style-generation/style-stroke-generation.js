...
function dotStroke (strokeObj, animationType, fillDef) {
  var css = {};
...
module.exports = {
  getPointCSS: function (strokeObj, animationType, styleDef) {
    var fillObj = styleDef && styleDef.fill;
    if (fillObj && StyleUtils.canApplyDotProperties(fillObj)) {
      return dotStroke(strokeObj, animationType, fillObj);
    } else {
      return markerStroke(strokeObj, animationType);
    }
  },
