...
var mapCreation = function () {
  ...
  var dashboardNotification = builderNotifications.dashboard_notification || {};
  if (userModel.get('actions').builder_enabled && !dashboardNotification.builder_activated) {
    var builderActivatedNotification = new UserNotifications(builderNotifications, {
    ...
    window.builderActivatedNotificationView = builderActivatedNotificationView;
  }
