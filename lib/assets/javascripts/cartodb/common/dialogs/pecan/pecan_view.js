...
module.exports = cdb.core.View.extend({
  ...
  _EXCLUDED_COLUMNS: [
    ...
    'latdd', 'longdd', 'iso2', 'iso3', 'x', 'y', 'x_coord', 'y_coord', 'coord_x', 'coord_y',
    'minlat', 'maxlat', 'minlon', 'maxlon', 'minlng', 'maxlng',
    'coordx', 'coordy', 'center_lon', 'centerlon', 'xcoord', 'ycoord', 'cartodb_georef_status'
  ],
