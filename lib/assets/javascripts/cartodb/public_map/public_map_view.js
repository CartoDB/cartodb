...
module.exports = cdb.core.View.extend({
  ...
  setLabelsOnTop: function(vis, layers) {
    ...
    if ((m.get('type') === "Tiled" || m.get('type') === "tiled") && isCartoDBBasemap(m.get('urlTemplate'))) {
      ...
      // hack on top of a hack, set zindex to be on top of torque layers
      // torque zindex start on 200
      vis.mapView.getLayerByCid(vis.map.layers.last().cid).setZIndex(300);
    }
  },
