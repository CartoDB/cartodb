...
module.exports = CoreView.extend({
  ...
  _getBaseLayerCategory: function () {
    // baseLayer *has no category* at map creation, if baseLayer is Plain, or if baseLayer is Custom
    ...
    if (this._baseLayer.get('category')) {
      ...
      category = 'Color';
    } else if (this._customBaselayersCollection.hasCustomBaseLayer(this._baseLayer.get('urlTemplate'))) {
      category = 'Custom';
    }
