...
module.exports = cdb.core.View.extend({
  ...
  _desc: function() {
    ...
    if (this.options.isUsingVis) {
      var nameOrThisUser = this.model.get('name') || 'this user';
      var revokeAccessConsequences = this._canRead() ? ' is using this dataset' : "'s maps will be affected";
      desc += '. ' + nameOrThisUser + revokeAccessConsequences;
    }
  ...
  _willRevokeAccess: function() {
    return this.options.isUsingVis && !this._canRead();
  },
