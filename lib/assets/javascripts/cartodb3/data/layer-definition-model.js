...
module.exports = Backbone.Model.extend({
  ...
  toJSON: function () {
    ...
    var attributes = _.omit(this.attributes, 'infowindow', 'tooltip', 'options', 'error');
  ...
  _canBeFoldedUnderAnotherLayer: function () {
    ...
    return this.collection.any(function (m) {
      if (m !== this && m.isDataLayer()) {
        var lastNode = _.last(m.getAnalysisDefinitionNodeModel().linkedListBySameLetter());
  ...
  _isAllDataLayersDependingOnAnyAnalysisOfThisLayer: function () {
    ...
    if (nodeDefModel.letter() !== this.get('letter')) return false;
