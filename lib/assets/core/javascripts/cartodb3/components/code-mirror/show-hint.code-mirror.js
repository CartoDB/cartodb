...
module.exports = function (CodeMirror) {
  ...
  function getText(completion, options) {
    var autocompleteSuffix = options && options.autocompleteSuffix;

    if (typeof completion == "string") return autocompleteSuffix ? completion + autocompleteSuffix : completion;
    else return autocompleteSuffix ? completion.text + autocompleteSuffix : completion.text;
  }
