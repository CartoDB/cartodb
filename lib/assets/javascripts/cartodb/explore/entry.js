...
$(function() {
  cdb.init(function() {
    ...
    var onSuccess = function(model) {
      ...
      var visURL = '//' + model.get('username') + '.' + config.account_host + '/api/v2/viz/' + model.get('id') + '/viz.json';

      var url = 'http://' + model.get('username') + '.' + config.account_host + '/viz/' + model.get('id') + '/public_map';
