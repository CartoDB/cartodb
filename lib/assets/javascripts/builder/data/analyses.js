...
var DO_DEPRECATION_WARNING_DATE = '2021-02-05';
...
var MAP = {
  ...
  'data-observatory-measure': {
    ...
    checkIfEnabled: function (options) {
      var creationDate = new Date(options.userModel.get('created_at')).getTime();
      var deprecationWarningDate = new Date(DO_DEPRECATION_WARNING_DATE).getTime();

      if (deprecationWarningDate < creationDate) {
        return false;
      }
    ...
    deprecationWarningDate: DO_DEPRECATION_WARNING_DATE,
    deprecationDate: '2021-03-15',
    deprecationLink: 'https://carto.com'
  },
