...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._widgetDefinitionsCollection.on('successAdd', this._onWidgetAdded, this);
  ...
  _onWidgetAdded: function (widgetModel) {
    var selectedOptionModels = this._optionsCollection.filter(this._isSelected);
    this._widgetsAdded.push(widgetModel);

    if (selectedOptionModels.length === this._widgetsAdded.length) {
      this._widgetsAdded = [];
      this._userActions.updateWidgetsOrder();
    }
  },
