...
const USE_CASES = [
  'Catastrophe Analytics', 'Data Monetization', 'Fraud Detection', 'Geomarketing', 'Healthcare & Social Factor Analysis',
  'Indoor Mapping', 'Investment Analysis', 'Logistics & Supply Chain Management', 'Mobility Planning',
  'Network Deployment & Optimization', 'Risk Analysis', 'Site Planning',
  'Smart Cities & IOT', 'Territory Management', 'Other - My use case is not listed'
];
