...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  /////////////////////////////////////////
  _addExportBar: function(model, form_data, hide_actions, forceReset) {
    console.log('add overlay export bar now');
    ...
    if (!this.exportBar) {
      ...
      console.log('export bar has layerModel');
      ...
      console.log('exportBar is:');
      console.log(this.exportBar);
  ...
  _removeExportBar: function(show_toolbar, model, force) {
    console.log('remove overlay export bar');
  ...
  _exportImage: function(e) {
    ...
    console.log('clicked exportImage');
    ...
    this._addExportBar(this.layerModel.legend, form_data, true, true);
