...
module.exports = Router.extend({
  ...
  routes: {
    ...
    // Dashboards
    'dashboards':                             '_changeRouteToDashboards',
    'dashboards/':                            '_changeRouteToDashboards',
    'dashboards?:q':                          '_changeRouteToDashboards',
    'dashboards/:page':                       '_changeRouteToDashboards',
    'dashboards/:page?:q':                    '_changeRouteToDashboards'
  },
  ...
  _changeRouteToDashboards: function(page) {
    page = this._getPage(page);
    this.model.set({
      content_type:   'maps',
      page:           page,
