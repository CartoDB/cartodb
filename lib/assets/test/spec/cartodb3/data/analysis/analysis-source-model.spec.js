var AnalysisSourceModel = require('../../../../../javascripts/cartodb3/data/analysis/analysis-source-model');

describe('data/analysis/analysis-source-model', function () {
  beforeEach(function () {
    this.model = new AnalysisSourceModel({
      id: 'a0',
      table_name: 'foo_bar'
    });
  });
