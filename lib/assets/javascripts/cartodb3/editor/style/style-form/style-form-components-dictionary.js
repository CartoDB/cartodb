...
module.exports = {
  'fill': function (querySchemaModel, styleType, geometryModel, configModel) {
    var editorAttrs = {
      size: {
        min: 1,
        max: 45,
  ...
  'stroke': function (querySchemaModel, styleType, geometryModel, configModel) {
    if (geometryModel.get('simple_geom') === 'line') {
  ...
  'blending': function (querySchemaModel, styleType, geometryModel) {
  ...
  'labels-attribute': function (querySchemaModel, styleType, geometryModel) {
  ...
  'animated-attribute': function (querySchemaModel, styleType, geometryModel) {
    var filterFunction = function (item) {
      var columnType = item.get('type');
