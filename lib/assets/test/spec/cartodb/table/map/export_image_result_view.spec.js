...
var ExportImageResultView = require('../../../../../../javascripts/cartodb/common/dialogs/static_image/export_image_result_view.js');
...
describe("export_image_result_view", function() {
  beforeEach(function() {
    ...
    this.view = new ExportImageResultView({
      vis: this.vis,
      clean_on_hide: true,
  ...
  it("should generate exported image filename correctly", function() {
    ...
    expect(filename).toMatch(/^[\S]+_by_[\S]+_\d\d_\d\d_\d\d\d\d_\d\d_\d\d_\d\d$/)
  });
