...
module.exports = Backbone.Model.extend({
  ...
  fetchQueryObjects: function () {
    if (this.get('status') === 'ready' && !this.get('error') && this.isNodeOnTop()) {
  ...
  isNodeOnTop: function () {
    var currentPos = this.collection.indexOf(this);

    return currentPos === this.collection.getTopNodeIndex();
  },
