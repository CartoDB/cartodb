...
describe('data/query-schema-model', function () {
  ...
  it('should not have any geometry initially', function () {
    expect(this.model.get('simple_geom')).toBeUndefined();
  });
    ...
    describe('when fetch', function () {
      ...
      describe('when request succeeds', function () {
        ...
        it('should reset columns', function () {
          ...
          expect(this.model.columnsCollection.pluck('type')).toEqual(['number', 'string', 'geometry'], 'should still mark geom columns as geometry');
        });
