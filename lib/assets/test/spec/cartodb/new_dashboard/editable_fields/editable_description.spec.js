var EditableDescription = require('../../../../../javascripts/cartodb/new_dashboard/editable_fields/editable_description');
...
describe('new_dashboard/editable_fields/editable_description', function() {
  ...
  it('should add the "EditableDescription" class to the element', function() {
    view.render();

    expect(view.el.classList).toContain('EditableDescription');
  });
