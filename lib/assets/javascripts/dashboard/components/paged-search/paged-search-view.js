  ...
  _initViews: function () {
    ...
    this._panes.addTab('no_results',
      ViewFactory.createByHTML(noResultsView({
        ...
        title: this.options.noResults.title || _t('dashboard.components.paged_search.paged_search_view.no_results'),
        msg: this.options.noResults.msg || _t('dashboard.components.paged_search.paged_search_view.nothing_found')
      })).render()
    );

    this._panes.addTab('loading',
      ViewFactory.createByHTML(loadingView({
        title: _t('dashboard.components.paged_search.paged_search_view.searching')
      })).render()
    );
