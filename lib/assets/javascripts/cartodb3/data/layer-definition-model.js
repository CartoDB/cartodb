...
var InfowindowHTMLModel = require('../editor/layers/layer-content-views/infowindow/infowindow-html-model');
...
module.exports = Backbone.Model.extend({
  ...
  parse: function (r, opts) {
    ...
    if (r.infowindow) {
      if (!this.infowindowModel) {
        ...
        this.infowindowHTMLModel = new InfowindowHTMLModel({
          content: attrs.cartocss // html
        }, {
  ...
  save: function () {
    var saveResult = Backbone.Model.prototype.save.apply(this, arguments);
