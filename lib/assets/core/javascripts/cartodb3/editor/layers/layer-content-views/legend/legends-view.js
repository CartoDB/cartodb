...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    var tabPaneTabs = [this._colorTabPane(), this._sizeTabPane()];
  ...
  _sizeTabPane: function () {
    var self = this;

    var disabled = !self._isStyleCompatibleWithLegendSize();
    var tooltipForDisabled = _t('editor.legend.menu-tab-pane-labels.size-disabled');
    var tooltip = disabled ? tooltipForDisabled : undefined;
  ...
  _isStyleCompatibleWithLegendSize: function () {
    var styleModel = this._layerDefinitionModel.styleModel;
    var compatibleTypes = LegendSizeTypes.filter(function (type) {
      var check = type.isStyleCompatible;
      if (typeof check === 'undefined') {
        return true;
      }
      return check(styleModel);
    });
    var anyTypeBeyondNone = compatibleTypes.length > 1;
    return anyTypeBeyondNone;
  },
