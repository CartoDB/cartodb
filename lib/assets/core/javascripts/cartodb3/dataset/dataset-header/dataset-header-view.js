...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    this.$el.html(
      template({
        ...
        privacyDOMElement: this._isDatasetOwner() ? 'button' : 'span',
  ...
  _initViews: function () {
    ...
    if (this._userModel.isInsideOrg()) {
      if (this._isDatasetOwner()) {
        ...
        var privacyTooltip = new TipsyTooltipView({
          el: this.$('.js-privacyDropdown'),
          gravity: 'n',
          html: true,
          title: function () {
  ...
  _getPrivacyInfo: function () {
    var ownerName = this._tableModel.getOwnerName();
    return _t('dataset.privacy.info', { name: ownerName });
  },
