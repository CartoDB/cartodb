...
describe('DatasetCard.vue', () => {
  ...
  describe('Methods', () => {
    ...
    it('should copy to the clipboard the name of the dataset', () => {
      // document.execCommand = function (value) { return true; };
      ...
      datasetCard.vm.showCopyDropdown();
      datasetCard.vm.copyName();

      expect(datasetCard.vm.copySuccessful).toBe(true);
      expect(datasetCard).toMatchSnapshot();
    });
  });
