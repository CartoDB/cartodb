...
var EditorHeader = require('../../../../javascripts/cartodb3/editor/editor-header.js');
...
describe('editor/editor-header', function () {
  beforeEach(function () {
    ...
    var modals = FactoryModals.createModalService();

    var onClickPrivacy = jasmine.createSpy('onClickPrivacy');
    var onRemoveMap = jasmine.createSpy('onRemoveMap');

    spyOn(EditorHeader.prototype, '_duplicateMap');

    this.view = new EditorHeader({
  ...
  it('should render properly', function () {
    ...
    this.view._userModel._organizationModel = new Backbone.Model({
      id: 1
    });
  ...
  it('should call duplicate when duplicate option is clicked', function () {
    ...
    expect(EditorHeader.prototype._duplicateMap).toHaveBeenCalled();
  });
