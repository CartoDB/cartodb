...
module.exports = cdb.core.View.extend({
  ...
  _loadFromVisId: function() {
    var id = this.visId;
    var template = 'tpl_' + id.replace(/-/g, '_');

    var url = 'http://' + this.options.username + '.' + this.options.account_host + '/api/v1/map/static/named/' + template + '/' + this.width + '/' + this.height + '.png';
    this._loadImage({}, url);
  },
