  ...
  return {
    js_core_cartodb: {
      files: [
        ...
        'lib/assets/core/javascripts/cartodb/public_common/**/*'
      ],
    ...
    js_test_spec_core_cartodb3: {
      ...
      tasks: ['copy:js_test_spec_core_cartodb3', 'copy:js_test_spec_client_cartodb3'],
      options: {
        spawn: false,
        atBegin: false
      }
    ...
    js_test_jasmine_core_cartodb3: {
      ...
      tasks: ['copy:js_test_jasmine_core_cartodb3', 'copy:js_test_jasmine_client_cartodb3'],
      options: {
        spawn: false,
        atBegin: false
      }
