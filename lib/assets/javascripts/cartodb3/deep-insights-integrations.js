...
var removeWidgetConfirmationTemplate = require('./editor/widgets/delete-widget-confirmation.tpl');
...
F.prototype._onEditionWidget = function (m) {

};

F.prototype._onRemoveWidget = function (m) {
  var widgetName = m.get('title');
...
F.prototype._bindWidgetChanges = function (m) {
  m.bind('editWidget', this._onEditionWidget, this);
...
F.prototype._unbindWidgetChanges = function (m) {
  m.unbind('editWidget', this._onEditionWidget, this);
