...
describe CommonData do
  ...
  it 'should use SQL API V2 for export URLs' do
    ...
    @common_data.datasets.first['url'].should match(%r{common-data\.localhost\.lan/api/v2})
  end
  ...
  it 'should use SQL API V2 from user defined base url for export URLs' do
    ...
    @common_data.datasets.first['url'].should match(%r{^https://www\.userdefinedurl\.com/api/v2})
  end
  ...
  VALID_JSON_RESPONSE = <<~response.freeze
      {
        "visualizations": [
            {
