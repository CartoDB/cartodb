...
var InputColorPickerView = require('cartodb3/components/form-components/editors/fill/input-color/input-color-picker/input-color-picker-view');
var CategoriesListView = require('./input-color-categories-list-view');
var rampList = require('cartocolor');
var AssetPickerView = require('cartodb3/components/form-components/editors/fill/input-color/assets-picker/input-asset-picker-view');
var MAX_VALUES = 10;
...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var hideQuantification = !!(this._hideTabs && _.contains(this._hideTabs, 'quantification'));
