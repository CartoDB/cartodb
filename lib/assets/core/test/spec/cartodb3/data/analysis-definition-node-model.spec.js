...
describe('cartodb3/data/analysis-definition-node-model', function () {
  beforeEach(function () {
  ...
  describe('.nodeReady', function () {
    it('should notice the collection that it is ready', function () {
      spyOn(this.collection, 'nodeReady');

      this.b1.nodeReady();

      expect(this.collection.nodeReady).toHaveBeenCalledWith(this.b1);
    });
  });
});
