...
describe('QuotaSection.vue', () => {
  ...
  describe('Computed', () => {
    it('should return all the correct computed variables', () => {
      ...
      const availableStorage = quotaSection.vm.availableStorage;
      const remainingStorage = quotaSection.vm.remainingStorage;
      const geocodingUsed = quotaSection.vm.geocodingUsed;
      const geocodingAvailable = quotaSection.vm.geocodingAvailable;
      const routingUsed = quotaSection.vm.routingUsed;
      const routingAvailable = quotaSection.vm.routingAvailable;
      const isolinesUsed = quotaSection.vm.isolinesUsed;
      const isolinesAvailable = quotaSection.vm.isolinesAvailable;
      const usedStorage = quotaSection.vm.usedStorage;
      const amountExponent = quotaSection.vm.amountExponent;
