...
describe('editor/layers/layer-content-view', function () {
  beforeEach(function () {
    ...
    this.layer.layerTableModel = new cdb.core.Model({ table_name: 'hello' });
    ...
    this.view = new LayerContentView({
      ...
      analysisDefinitonsCollection: new Backbone.Collection(),
  ...
  it('should render correctly', function () {
    ...
    expect(this.view.$('.Editor-HeaderInfo-TitleText').text()).toBe('hello');
