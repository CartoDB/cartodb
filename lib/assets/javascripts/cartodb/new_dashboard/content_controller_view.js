...
// var CategoriesView = require('new_dashboard/categories_view');
...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function() {
    ...
    filtersView.bind('dialogOpened', function() {
      this.trigger('dialogOpened', this);
    }, this);
    filtersView.bind('dialogClosed', function() {
    ...
    // this.controlledViews['categories'] = categoriesView;
  ...
  _onDataFetched: function() {
    ...
    // if (library) activeViews.push('categories');
