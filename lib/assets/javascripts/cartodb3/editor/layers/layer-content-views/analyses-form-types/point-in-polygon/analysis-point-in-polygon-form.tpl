<form>
  <div class="CDB-HeaderInfo">
    ...
    <div class="CDB-HeaderInfo-Inner CDB-Text" data-fields="points_source,polygons_source">
      ...
      <p class="CDB-Text u-upperCase CDB-FontSize-small u-altTextColor u-bSpace--m"><%- _t('editor.layers.analysis-form.reference-layers') %></p>
    </div
  </div>
</form>
