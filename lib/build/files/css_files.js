...
module.exports = css_files = {
  ...
  public_dashboard: [
    '<%= assets_dir %>/stylesheets/embeds/public_header.css',
    '<%= assets_dir %>/stylesheets/embeds/public_footer.css',
    '<%= assets_dir %>/stylesheets/embeds/public_dropdown.css',
    '<%= assets_dir %>/stylesheets/public_dashboard/**/*.css'
  ],

  public_dashboard_ie: [
    '<%= assets_dir %>/stylesheets/public_dashboard_ie/**/*.css'
  ],
