...
module.exports = BaseDialog.extend({
  ...
  _EXCLUDED_COLUMNS: ['cartodb_id', 'cartodb_georef_status', 'the_geom', 'lat', 'lon', 'lng', 'long', 'latitude', 'longitude', 'shape_length', 'shape_area', 'objectid', 'id', 'country', 'state', 'created_at', 'updated_at', 'iso2', 'iso3', 'x_coord', 'y_coord', 'xcoord', 'ycoord', 'x', 'y'],
