...
cdb.admin.VideoPlayer = cdb.core.View.extend({
  ...
  initialize: function(id) {
    ...
    _.bindAll(this, "_onInitDraggable", "_onStopDragging");
  ...
  close: function(e) {
    ...
    this.$el.animate({ width: 0, height: 0, opacity: 0 }, { easing: "easeInQuad", duration: 200, complete: function() {
      self._clearStoredData();
      self.remove();
    }});
