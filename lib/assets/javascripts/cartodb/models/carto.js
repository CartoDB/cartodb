...
cdb.admin.CartoStyles = Backbone.Model.extend({
    ...
    _generateCarto: function(){
      var self = this;
      var gen = this.constructor.generators[this.get('type')];
...
cdb.admin.CartoStyles.registerGenerator('polygon',      simple_polygon_generator);
cdb.admin.CartoStyles.registerGenerator('cluster',      cluster_generator);
cdb.admin.CartoStyles.registerGenerator('bubble',       bubble_generator);
cdb.admin.CartoStyles.registerGenerator('intensity',    intensity_generator);
cdb.admin.CartoStyles.registerGenerator('choropleth',   choropleth_generator);
cdb.admin.CartoStyles.registerGenerator('color',        cdb.admin.carto.category.category_generator.bind(cdb.admin.carto.category)),
cdb.admin.CartoStyles.registerGenerator('category',     cdb.admin.carto.category.category_generator.bind(cdb.admin.carto.category)),
cdb.admin.CartoStyles.registerGenerator('density',      density_generator); // the same generator than choroplet
cdb.admin.CartoStyles.registerGenerator('torque',       cdb.admin.carto.torque.torque_generator.bind(cdb.admin.carto.torque));
cdb.admin.CartoStyles.registerGenerator('torque_heat',  cdb.admin.carto.torque.torque_generator.bind(cdb.admin.carto.torque));
cdb.admin.CartoStyles.registerGenerator('torque_cat',   cdb.admin.carto.torque_cat.generate.bind(cdb.admin.carto.torque_cat));
