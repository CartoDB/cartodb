  ...
  cdb.admin.ShareDialog = cdb.admin.BaseDialog.extend({
    ...
    _setupPrivacySettings: function() {
      ...
      if (privacy == 'PUBLIC') {
        ...
        this.model.set({ password_button_label: "edit", password_placeholder: "Edit your password" });
    ...
    _onSaveSuccess: function() {
      ...
      if (option) {
        ...
        this.model.set("password_button_label", "edit");
        this.model.set("password_placeholder", "Edit your password");
      }
