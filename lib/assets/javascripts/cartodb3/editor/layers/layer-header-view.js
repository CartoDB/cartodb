...
module.exports = CoreView.extend({
  ...
  _onSourceChanged: function () {
    ...
    this._topQueryGeometryModel = nodeModel.queryGeometryModel.bind('change:simple_geom', this._onNodeGeometryChanged, this);
    this._checkIfGeometryVisible();
  },

  _onNodeGeometryChanged: function () {
    this._checkIfGeometryVisible();
  },
  ...
  _changeStyle: function () {
    ...
    this._getZoomIcon().attr('fill', editing ? whiteColor : blueColor);
  },
