...
module.exports = cdb.core.View.extend({
  ...
  _showSuccess: function (m, res, req) {
    this._setFlashMessage(res, 'Your changes have been saved correctly.', 'success');
  },

  _showErrors: function (m, res, req) {
    this._setFlashMessage(res, 'Could not save profile, please try again.', 'error');
  }
});
