...
vis.done(function () {
  ...
  // TODO: move scroll setup and handling
  ...
  $(container).on('ps-y-reach-start', function () {
    $('.Editor-HeaderInfo').removeClass('is-fixed');
  })
  .on('ps-y-reach-end', function () {
    $('.Editor-HeaderInfo').addClass('is-fixed');
  })
  .on('ps-scroll-y', function () {
    $('.Editor-HeaderInfo').toggleClass('is-fixed', $container.scrollTop() > 10);
  });
