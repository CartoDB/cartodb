...
-                      undefined;
    ...
    _initViews: function() {
      ...
      // Append menu
      this.menu = new cdb.admin.ActionsMenu({
        table: this.table,
      ...
      this.workView.bind('tabEnabled:map', function() {
        this.mapTab.bind('clearSQLView', this._clearSQLView, this);
      }, this);
    ...
    updateQueryInfo: function() {
      ...
      this.$('.sqlview p').html(
        this.getTemplate('table/views/sql_view_notice_message')({
          empty: total == 0,
          sql_source: this.dataLayer.get('sql_source')
        })
      );
    }
  });
