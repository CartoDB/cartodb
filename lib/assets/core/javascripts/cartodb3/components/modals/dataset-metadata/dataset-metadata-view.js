...
module.exports = CoreView.extend({
  ...
  _getMetadataName: function () {
    return cartodb.core.sanitize.sanitize(this._visMetadataModel.get('name'));
  },

  _getMetadataDescription: function () {
    return cartodb.core.sanitize.sanitize(this._visMetadataModel.get('description'));
  },

  _getMetadataTags: function () {
    return _.map(this._visMetadataModel.get('tags'), function (tag) {
      return cartodb.core.sanitize.sanitize(tag);
    });
  }
});
