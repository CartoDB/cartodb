...
var F = function (opts) {
  ...
  this._analysisDefinitionNodesCollection.on('add', _.debounce(this._onAddAnalyseDefinitionNode, 120), this);
...
F.prototype._onAddAnalyseDefinitionNode = function (m) {
  var layerDefModel = this._layerDefinitionsCollection.findOwnerOfAnalysisNode(m);
  var queryRowsCollection = m.queryRowsCollection;
  ...
  var launchGeoreferenceOnboarding = function () {
    if (!layerDefModel.hasAnalyses() &&
      ...
      GeoreferenceOnboardingLauncher.setLayerId(layerDefModel.get('id'));
