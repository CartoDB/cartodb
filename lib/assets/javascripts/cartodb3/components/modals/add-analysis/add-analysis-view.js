...
var defaultAnalysisOptions = require('./default-analysis-options');
...
module.exports = cdb.core.View.extend({
  ...
  render: function () {
    ...
    if (this._isFetchingQueryShema()) {
      ...
      Object.keys(defaultAnalysisOptions).forEach(this._renderCategory, this);
    }
  ...
  _renderCategory: function (category) {
    var view = new AnalysisCategoryView({
      ...
      category: category,
      categoryTitle: defaultAnalysisOptions[category].title,
  ...
  _initOptions: function () {
    ...
    var modelsAttrs = _.reduce(Object.keys(defaultAnalysisOptions), function (memo, category) {
      var categoryDef = defaultAnalysisOptions[category];
