  ...
  describe('actions', () => {
    describe('fetchDatasets', () => {
      ...
      it('success', done => {
        ...
        testAction2({ action: actions.fetchDatasets, state, expectedMutations, done });
      });
    ...
    it('setURLOptions', done => {
      ...
      testAction2({ action: actions.setURLOptions, payload: URLOptions, expectedActions, expectedMutations, done });
    });
    ...
    it('updateDataset', done => {
      ...
      testAction2({ action: actions.updateDataset, payload: datasetOptions, expectedMutations, done });
    });
    ...
    describe('like', () => {
      ...
      it('success', done => {
        ...
        testAction2({ action: actions.like, payload: state.list[datasetId], state, expectedMutations, done });
      });
      ...
      it('errored', done => {
        ...
        testAction2({ action: actions.like, payload: state.list[datasetIdErr], state, expectedMutations, done });
      });
    });
    ...
    describe('deleteLikeDataset', () => {
      ...
      it('success', done => {
        ...
        testAction2({ action: actions.deleteLike, payload: state.list[datasetId], state, expectedMutations, done });
      });
    });
  });
});
