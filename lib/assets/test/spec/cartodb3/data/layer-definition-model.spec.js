...
describe('data/layer-definition-model', function () {
  ...
  describe('for a layer with an infowindow', function () {
    ...
    describe('infowindow/tooltip reset', function () {
      ...
      it('should reset infowindow/tooltip fields if style model type is aggregated', function () {
        this.styleModel.set('type', 'heatmap');
        expect(this.model.infowindowModel.clearFields).not.toHaveBeenCalled();
        expect(this.model.tooltipModel.clearFields).not.toHaveBeenCalled();
        this.styleModel.set('type', 'squares');
        expect(this.model.infowindowModel.clearFields).toHaveBeenCalled();
        expect(this.model.tooltipModel.clearFields).toHaveBeenCalled();
      });

      it('should reset infowindow/tooltip fields if style model has animated enabled', function () {
