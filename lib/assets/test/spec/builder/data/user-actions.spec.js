...
describe('builder/data/user-actions', function () {
  ...
  describe('.saveWidgetOptionAsync', function () {
    beforeEach(function () {
      this.a0 = this.analysisDefinitionNodesCollection.add({
        id: 'a0',
        type: 'source',
    ...
    describe('when source of widget is not yet persisted', function () {
      beforeEach(function () {
        this.userActions.saveWidgetOptionAsync(this.widgetOptionModel);
      });
  ...
  describe('smoke tests', function () {
    ...
    it('Metro Madrid use case', function () {
      ...
      this.userActions.saveWidgetOptionAsync(categoryWidgetOption);
