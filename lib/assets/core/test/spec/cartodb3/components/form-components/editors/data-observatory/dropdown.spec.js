...
require('../../../../../../../javascripts/cartodb3/components/form-components/editors/data-observatory/dropdown');
var LayerDefinitionModel = require('../../../../../../../javascripts/cartodb3/data/layer-definition-model');

describe('components/form-components/editors/data-observatory/dropdown', function () {
  ...
  it('should genereate an measurements and filters collections', function () {
    ...
    expect(this.view.measurements).toBeDefined();
    expect(this.view.filters).toBeDefined();
    expect(this.view.measurements.size()).toBe(3);
  });
  ...
  describe('render', function () {
    ...
    it('should render selected item', function () {
      this.createView();
      this.view.measurements.getItem('us.census.acs.B19083001').set({selected: true});
  ...
  it('should change button value and hide dialog when a new item is selected', function () {
    ...
    this.view.measurements.getItem('us.zillow.AllHomes_Zhvi').set({selected: true});
