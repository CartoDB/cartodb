...
cdb.admin.forms.torque = [
  ...
  },
  {
    name: 'Steps',
    form: {
      'torque-steps': { type: 'select', value: 512, extra: [1, 64, 128, 256, 512, 1024, 2048] }
    }
  },
  {
    name: 'Blend Mode',
    form: {
      'torque-blend-mode': { type: 'select', value: 'lighter', extra: [
        'lighter', 'source-over', 'xor' //, 'source-atop', 'source-in', 'source-out', 'destination-atop', 'destination-in', 'destination-out', 'destination-over',  'xor', 'copy'
      ]},
    }
  },
  {
