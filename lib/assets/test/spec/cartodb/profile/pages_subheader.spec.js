...
var PagesSubheader = require('../../../../javascripts/cartodb/profile/pages_subheader');

var BILLING_LINK = '<li class="SideMenu-typeItem"><a href="/account/pepe/plan" class="SideMenu-typeLink">Billing</a></li>';

describe('profile/pages_subheader', function () {
  beforeEach(function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$el.html()).toContain('<a class="Filters-link" href="/account/pepe/plan">');
      ...
      expect(this.view.$el.html()).toContain(BILLING_LINK);
    });
  ...
  describe('cartodb_com_hosted', function () {
    describe('.render', function () {
      it('should render properly', function () {
        ...
        expect(this.view.$el.html()).not.toContain(BILLING_LINK);
      });
    });
  });
