var OrganizationUserUrl = require('../../../../../javascripts/cartodb/new_common/urls/organization_user_model');
var UserUrl = require('../../../../../javascripts/cartodb/new_common/urls/organization_user_model');
...
describe("new_common/urls/organization_user_model", function() {
  ...
  describe('.toAccountSettings', function() {
    it('should return account url', function() {
      expect(this.url.toAccountSettings()).toMatch('(http|file)://bodega.host.ext/u/pepe/account');
    });
  });

  describe('.toOrganizationUrl', function() {
    describe('given user is also organization admin', function() {
      ...
      it('should return URL to manage organization', function() {
        expect(this.url.toOrganization()).toMatch('(http|file)://bodega.host.ext/u/baz/organization');
      });
    });
    it('should return account url', function() {
      expect(this.url.toOrganization()).toMatch('(http|file)://bodega.host.ext/u/pepe/account');
    });
  });
