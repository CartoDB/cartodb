...
module.exports = cdb.core.View.extend({
  ...
  render: function(m, c) {
    ...
    var isDashboards = this.router.model.isDashboards();
    var contentType = isDashboards ? 'dashboard' : routerContentType.slice(0, -1);

    var template = cdb.templates.getTemplate(
      isDashboards ? 'dashboard/views/filters_dashboards' : 'dashboard/views/filters'
    );
    ...
    var pluralizedContentTypeSelected = pluralizeString(routerContentType, selectedItemsCount)
