...
var InputColor = require('cartodb3/components/form-components/editors/fill/input-color/input-color');
var rampList = require('cartodb3/components/form-components/editors/fill/input-color/input-quantitative-ramps/ramps');
