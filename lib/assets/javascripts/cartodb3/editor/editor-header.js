...
var EditorHeader = CoreView.extend({
  events: {
  ...
  initialize: function (opts) {
    ...
    this._initContextMenu([{
      ...
      val: 'delete-map',
      destructive: true,
      action: this._confirmDeleteLayer
    }]);
...
_.extend(EditorHeader.prototype, HasContextMenu);
