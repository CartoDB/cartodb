...
var LayerStyleCollection = require('cartodb3/embed/style-collection');
var MetricsTracker = require('cartodb3/components/metrics/metrics-tracker');
var deepInsights = require('deep-insights/index');
var EmbedIntegrations = require('cartodb3/embed/embed-integrations');
...
var embedView = new EmbedView({
  title: vizJSON.title,
  description: stripHTML(vizJSON.description),
...
deepInsights.createDashboard('.js-embed-map', vizJSON, dashboardOpts, function (error, dashboard) {
  ...
  embedView.injectTitle($('.CDB-Legends-canvasInner'));
