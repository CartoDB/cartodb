...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    if (this._queryGeometryModel.get('status') !== 'fetched' && this._querySchemaModel.get('status') !== 'fetched') {
  ...
  _initBinds: function () {
    this._queryGeometryModel.bind('change:status', this._onStatusChange, this);
