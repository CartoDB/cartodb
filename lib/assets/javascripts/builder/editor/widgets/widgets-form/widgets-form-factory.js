...
var dataMap = {
  category: {
    ...
    iconTemplate: require('cartodb3/editor/widgets/widget-icon-category.tpl'),
    Class: require('./schema/widgets-form-category-schema-model')
  },
  formula: {
    labelTranslationKey: 'editor.widgets.widgets-form.type.formula',
    iconTemplate: require('cartodb3/editor/widgets/widget-icon-formula.tpl'),
  ...
  histogram: {
    ...
    iconTemplate: require('cartodb3/editor/widgets/widget-icon-histogram.tpl'),
  ...
  'time-series': {
    ...
    iconTemplate: require('cartodb3/editor/widgets/widget-icon-timeSeries.tpl'),
