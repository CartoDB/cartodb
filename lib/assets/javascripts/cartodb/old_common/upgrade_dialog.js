  ...
  cdb.admin.UpgradeDialog = cdb.admin.BaseDialog.extend({
    ...
    initialize: function() {
      ...
      _.extend(this.options, {
        ...
        width: 932,
        clean_on_hide: true,
        template_name: 'old_common/views/upgrade_dialog_base',
    ...
    _renderPlans: function($content, r) {
      var self = this
        ...
        , template = cdb.templates.getTemplate('old_common/views/upgrade_dialog_content');
    ...
    _renderDedicated: function($content, r) {
      var username = this.model.get("username")
        , template = cdb.templates.getTemplate('old_common/views/upgrade_dedicated_dialog_content');
