...
module.exports = CoreView.extend({
  ...
  _onResizeWindow: function (e) {
    if (e.target === window) {
      var latLngToPixel = this._visDefinitionModel.get('latLngToPixel');
  ...
  _updateHelpers: function () {
    ...
    var size = this._visDefinitionModel.get('mapViewSize');
  ...
  _calcCenter: function () {
    ...
    var pixelToLatLng = this._visDefinitionModel.get('pixelToLatLng');
