...
module.exports = [
  {
    ...
    legendIcon: require('cartodb3/editor/layers/layer-content-views/legend/carousel-icons/none.tpl'),
    label: _t('editor.legend.types.none')
  }, {
    value: 'category',
    tooltipTranslationKey: 'editor.legend.tooltips.style.category',
    legendIcon: require('cartodb3/editor/layers/layer-content-views/legend/carousel-icons/category.tpl'),
    ...
    legendIcon: require('cartodb3/editor/layers/layer-content-views/legend/carousel-icons/gradient.tpl'),
    ...
    legendIcon: require('cartodb3/editor/layers/layer-content-views/legend/carousel-icons/custom.tpl'),
