...
var InputColorByValueView = require('builder/components/form-components/editors/fill/fill-color/inputs/input-color-by-value');
...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    this._popupManager = new PopupManager(this._popupConfig.cid, this._popupConfig.$el, this._fillDialogView.$el);
  },
