...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _showGMapsDeprecationDialog: function() {
    ...
    var dialog = new cdb.admin.BaseDialog({ 
      ...
      description: "Since this visualization uses a Google Maps basemap, if you click 'Ok' we'll automatically render the visualization with a similar basemap provided by Leaflet.<br /><br />If you want to get rid of this notification, click 'Ok' and select a different basemap.",
      ok_title: "Ok, change the basemap",
  ...
  enableMap: function() {
    ...
    if (baseLayer && layerName && layerName.toLowerCase().indexOf("gmaps") !== -1) {
