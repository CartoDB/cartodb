<div class="ImportPanel-header">
  ...
  <a href="mailto:sales@cartodb.com?subject=I am interested in the Twitter connector&body=Hi, I am interested in testing the Twitter connector. Please, contact me to schedule a demo of this feature." class="Button Button--invert ImportPanel-headerLink">
