...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var imageURL = this._iconStylingEnabled() && this._imageEnabled && this._getImageURL();
    var categoryImagesPresent = this._iconStylingEnabled() && this._imageEnabled && !this._getImageURL() && this._categoryImagesPresent();
  ...
  _getImageURL: function () {
    return this.model.get('image') ? this.model.get('image') : '';
  },
  ...
  _updateColor: function () {
    this.iconView.updateImageColor(this.model.get('fixed'));
  },
