...
module.exports = cdb.core.View.extend({
  ...
  initialize: function (opts) {
    ...
    console.log("TODO: auto selecting analysis, change that");
    this.viewModel = new cdb.core.Model({
      selectedNode: this._getFirstNode()
    });
  ...
  render: function () {
    ...
    var analysisDefinitionModel = this.analysisDefinitonsCollection._findAnalysisDefinitionModel(sourceId);

    if (!sourceId || !analysisDefinitionModel) {
  ...
  _getFirstNode: function () {
    var sourceId = this.layerDefinitionModel.get('source');
    return this.analysisDefinitonsCollection._findAnalysisDefinitionModel(sourceId);
  },
