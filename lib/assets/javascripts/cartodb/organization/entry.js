...
$(function() {
  cdb.init(function() {
    ...
    // API keys
    var regenerateApiKeyHandler = function(that, ev, scope) {
    ...
    $('.js-regenerateOrganizationUsersApiKey').bind('click', function(ev) {
      regenerateApiKeyHandler($(this), ev, 'organization');
    });

    $('.OrganizationUser-renewApiKeyLink').bind('click', function(ev) {
      regenerateApiKeyHandler($('.js-regenerateOrganizationUserApiKey'), ev, 'organization_user');
    });
  });
