...
import DatasetCard from 'new-dashboard/components/AddLayer/DatasetCard';
import DatasetCardFake from 'new-dashboard/components/Dataset/DatasetCardFake';
import Pagination from 'new-dashboard/components/Pagination';


export default {
  name: 'AddLayerFromDataset',
  props: {
    sharedTab: Boolean
  },
  components: {
  ...
  methods: {
    ...
    updateDatasetFilter() {
      let urlOptions = {page: this.currentPage, per_page: this.elemsPerPage, filter: 'mine'}
      if(this.sharedTab)
        urlOptions = {page: this.currentPage, filter: 'shared'}
