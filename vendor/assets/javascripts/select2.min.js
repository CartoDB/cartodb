...
(function ($, undefined) {
                ...
                opts.query = this.bind(function (query) {
                    ...
                    process=function(element, collection) {
                        ...
                        if (element.is("option")) {
                            if (query.matcher(term, (element.attr('alias') !== 'undefined') ? element.attr('alias') : element.text(), element)) {
                                collection.push({id:element.attr("value"), text:element.text(), element: element.get(), css: element.attr("class"), alias: (element.attr('alias') !== 'undefined') ? element.attr('alias') : undefined});
                            }
    ...
    $.fn.select2.defaults = {
        ...
        formatResult: function(result, container, query) {
            var markup=[];
            markMatch((result.alias) ? result.alias : result.text, query.term, markup);
            return markup.join("");
        },
        formatSelection: function (data, container) {
            if (data) {
                ...
                if (data.element && data.element.attr && data.element.attr('alias')) {
                    return data.element.attr('alias');
                }
                return data.text;
            }
            return undefined;
