...
$(function() {
  cdb.init(function() {
    ...
    $('.OrganizationUser-renewApiKeyLink').bind('click', function(ev) {
      ...
      var current_username = $(this).attr('data-cdb-current_username');
      var authenticity_token = $('[name=authenticity_token][value]').get(0).value;
      regenerateApiKeyHandler($('.js-regenerateOrganizationUserApiKey'), ev, 'organization_user', '/u/' + current_username + '/organization/users/' + username + '/regenerate_api_key', authenticity_token);
    });
  });
