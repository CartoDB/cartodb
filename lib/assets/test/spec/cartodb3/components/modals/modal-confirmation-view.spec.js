var $ = require('jquery');
var ModalConfirmationView = require('cartodb3/components/modals/confirmation/modal-confirmation-view');
var templateExample = require('cartodb3/components/table/head/modals-templates/rename-table-column.tpl');
