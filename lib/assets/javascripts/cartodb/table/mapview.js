...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _onChangeCanvasMode: function() {
    ...
    if (mode === "desktop") {
      ...
      setTimeout(function() {
        if (self.loader) self.loader.model.set("y", self._getHeaderHeight() + 15);
      }, 300);
  ...
  _positionZoomOverlay: function() {
    ...
    if (this.header) overlay.model.set("y", this._getHeaderHeight() + 20);
...
*/
  ...
  _positionLoaderOverlay: function(overlay_model) {
    ...
    if      (this.fullscreen) overlay_model.set("y", this.fullscreen.model.get("y") + 40);
