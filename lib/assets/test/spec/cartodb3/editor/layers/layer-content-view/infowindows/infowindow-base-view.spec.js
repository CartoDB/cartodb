...
var InfowindowBaseView = require('cartodb3/editor/layers/layer-content-views/infowindow/infowindow-base-view');
...
var TEMPLATES = [
  {
    value: '',
    infowindowIcon: require('cartodb3/editor/layers/layer-content-views/infowindow/infowindow-icons/infowindow-none.tpl'),
    label: _t('editor.layers.infowindow.style.none'),
    tooltip: _t('editor.layers.infowindow.tooltips.none')
  }, {
    value: 'infowindow_light',
    infowindowIcon: require('cartodb3/editor/layers/layer-content-views/infowindow/infowindow-icons/infowindow-light.tpl'),
...
describe('editor/layers/layer-content-view/infowindow/infowindow-base-view', function () {
  ...
  var createViewFn = function (options) {
    ...
    view = new InfowindowBaseView(_.extend(defaultOptions, options));
  ...
  beforeEach(function () {
    ...
    isLayerHiddenSpy = spyOn(InfowindowBaseView.prototype, '_isLayerHidden').and.returnValue(false);
