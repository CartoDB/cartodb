...
describe('components/modals/add-widgets/histogram/histogram-option-model', function () {
  ...
  var createModelFn = function (options, optionsTuples) {
    ...
    widgetDefinitionsCollection.addWidgetAsync = function () {
      return true;
    };
  ...
  it('should trigger a loading state', function () {
    spyOn(widgetDefinitionsCollection, 'addWidgetAsync').and.returnValue(true);
  ...
  it('should return the result of the "addWidget" function from the given widgetDefinitionsCollection', function () {
    var addWidgetSpy = spyOn(widgetDefinitionsCollection, 'addWidgetAsync').and.returnValue(true);
