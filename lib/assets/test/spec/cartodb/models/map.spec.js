...
describe('cdb.admin.TileLayer', function() {
  ...
  describe('.byCustomURL', function() {
    beforeEach(function() {
      this.layer = cdb.admin.TileLayer.byCustomURL('http://{S}.basemaps.cartocdn.com/light_nolabels/{Z}/{X}/{Y}.png');
    });
    ...
    it('should have the URL set as template with vars in small caps', function() {
      expect(this.layer.get('urlTemplate')).toEqual('http://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}.png');
    });
    ...
    it('should have a set of default values', function() {
      ...
      expect(this.layer.get('className')).toEqual('httpsbasemapscartocdncomlight_nolabelszxypng');
    });
