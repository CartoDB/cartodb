...
module.exports = CoreView.extend({
  ...
  _exportImage: function () {
    ...
    var logo = () => this._loadLogo();

    var basemap = () => {
      if (this._hasGoogleMapsBasemap()) {
        return this._loadGMapBasemap();
      }
    };
    var image = () => this._onLoadImage(this._downloadImage.bind(this));

    var attribution = () => this._loadAttribution();
    ...
    return Promise.resolve()
      ...
      .then(attribution)
      .then(image)
      .catch((error) => { this._onFail(error); });
  },
