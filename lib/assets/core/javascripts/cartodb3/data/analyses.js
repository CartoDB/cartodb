...
var MAP = {
  ...
  'data-observatory-measure': {
    ...
    checkIfValid: function (configModel) {
      ...
      return configModel.dataServiceEnabled('data_observatory');
    },
...
var checkIfInternalGeocodingIsEnabled = function (configModel) {
  if (!configModel) throw new Error('configModel is required');
  // CODE REVIEW: don't let this pass!! vvv
  return true;
  //return !!configModel.dataServiceEnabled('geocoder_internal');
};

var checkIfRoutingIsEnabled = function (configModel) {
  if (!configModel) throw new Error('configModel is required');
  return !!configModel.dataServiceEnabled('routing');
};
...
var checkIfExternalGeocodingIsEnabled = function (configModel) {
  ...
  // CODE REVIEW: don't let this pass!! vvv
  return true;
  //return !!configModel.dataServiceEnabled('hires_geocoder');
};
