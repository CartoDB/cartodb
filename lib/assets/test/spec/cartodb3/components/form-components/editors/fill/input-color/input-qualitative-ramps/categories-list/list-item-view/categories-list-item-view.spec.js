...
var CategoriesListItemView = require('cartodb3/components/form-components/editors/fill/input-color/input-qualitative-ramps/categories-list/list-item-view/categories-list-item-view');
var inputColorCategoriesListItemTemplate = require('cartodb3/components/form-components/editors/fill/input-color/input-qualitative-ramps/categories-list/list-item-view/categories-list-item.tpl');
