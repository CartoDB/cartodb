...
var nodeIds = require('../../../../../../javascripts/cartodb3/value-objects/analysis-node-ids');
...
describe('editor/layers/analysis-views/source-layer-analysis-view', function () {
  ...
  describe('._bgColor', function () {
    var letter = 'Z';

    it('should call .getColorForLetter with the correct letter', function () {
      spyOn(nodeIds, 'letter').and.returnValue(letter);
      spyOn(layerColors, 'getColorForLetter');

      this.view._bgColor();
      expect(layerColors.getColorForLetter).toHaveBeenCalledWith(letter);
    });
  });
