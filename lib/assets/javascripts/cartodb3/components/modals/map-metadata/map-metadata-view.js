...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._onPrivacyAction = opts.onPrivacyAction;
  ...
  _initViews: function () {
    ...
    var formView = new FormView({
      ...
      onPrivacyAction: this._onChangePrivacy.bind(this)
    });
  ...
  _onChangePrivacy: function () {
    this._onPrivacyAction && this._onPrivacyAction();
  },
  ...
  _onErrorSave: function () {
    this._stateModel.set({status: 'error'});
  }
});
