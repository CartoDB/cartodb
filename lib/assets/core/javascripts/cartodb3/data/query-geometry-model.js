...
module.exports = Backbone.Model.extend({
  ...
  fetch: function (opts) {
    ...
    var cacheParam = this._getCacheParam(this._httpMethod());
  ...
  _getCacheParam: function (method) {
    var detectedBrowser = browserDetect();
    var name = detectedBrowser && detectedBrowser.name && detectedBrowser.name.toUpperCase().trim();
    if (name === 'IE' && method === 'GET') {
      return {
        nocache: Date.now()
      };
    }
