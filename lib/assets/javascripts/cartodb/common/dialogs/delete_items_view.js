...
module.exports = BaseDialog.extend({
  ...
  _getTitle: function() {
    ...
    if (firstItem) {
      if (firstItem.get('synchronization') && firstItem.get('synchronization').from_external_source) {
        return Sugar.String.titleize(firstItem.get('name'));
      }
