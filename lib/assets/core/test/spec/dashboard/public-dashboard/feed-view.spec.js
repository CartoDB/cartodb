var $ = require('jquery');
var Feed = require('../../../../javascripts/dashboard/public-dashboard/feed-view.js');
var Visualizations = require('../../../../javascripts/dashboard/public-dashboard/user-feed/feed-collection');
var ConfigModel = require('../../../../javascripts/dashboard/data/config-model');
var AuthenticatedUser = require('../../../../javascripts/dashboard/data/authenticated-user-model');
var UserModel = require('../../../../javascripts/dashboard/data/user-model');

describe('dashboard/public-dashboard/feed-view', function () {
  afterEach(function () {
    $('.js-feed').remove();
  });
