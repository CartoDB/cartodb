...
module.exports = CoreView.extend({
  ...
  render_content: function () {
    switch (this.model.get('state')) {
      case 'prefetching':
        return this._renderLoading(_t('dashboard.views.dashboard.sync_dataset.check_sync'));
      case 'error':
        return failTemplate({ msg: '' });
      case 'saving':
        return this._renderLoading(_t('dashboard.views.dashboard.sync_dataset.saving'));
      default:
        return template({
