...
describe('editor/style/style-form/style-animated-properties-form-view', function () {
  ...
  beforeEach(function () {
    ...
    this.view._styleModel.set({type: 'heatmap'});
  ...
  describe('render heatmap', function () {
  ...
  describe('render animated', function () {
    it('should not include enabler', function () {
      this.view._styleModel.set({type: 'animated'});
      this.view.$el.empty();
      this.view._enablerView = undefined;
      this.view.render();

      expect(this.view._enablerView).not.toBeDefined();
      expect(this.view.$('[name="enabler"]').length).toBe(0);
      expect(this.view.$('[name="enabler"] .js-input').length).toBe(0);
    });
  });
