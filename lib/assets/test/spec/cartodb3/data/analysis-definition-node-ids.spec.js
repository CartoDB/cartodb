...
describe('data/analysis-definition-node-ids', function () {
  ...
  describe('.nextSecondary', function () {
    it('should geenerate a new id that represents a secondary node', function () {
      expect(analysisDefinitionNodeIds.nextSecondary('a0')).toEqual('a0-secondary');
      expect(analysisDefinitionNodeIds.nextSecondary('a1')).toEqual('a1-secondary');
    });
  });
