...
// We can use the builder one, but as this one was already migrated :shrug:
...
module.exports = CoreView.extend({
  ...
  _openPrivacyDialog: function (ev) {
    this.killEvent(ev);
    // TODO: Fix this
    console.warn('_openPrivacyDialog')
