...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attributes, options) {
    ...
    this.upload = new UploadModel(
      { create_vis: true },
      { user: this._user, configModel: this._configModel }
    );

    this.selectedDatasets = new Backbone.Collection(options.selectedItems);
    this.collection = new VisualizationsCollection();
    this.vis = new VisualizationModel({ name: 'Untitled map' });
