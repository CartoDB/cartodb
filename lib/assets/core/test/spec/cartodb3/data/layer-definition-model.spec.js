...
describe('data/layer-definition-model', function () {
  ...
  describe('.canBeGeoreferenced', function () {
    ...
    it('should be true if there is data, no analysis, no custom query or doesn\'t have geom', function () {
    ...
    it('should be false if there is any other analysis', function () {
      this.nodeModel.queryRowsCollection.isEmpty.and.returnValue(true);
