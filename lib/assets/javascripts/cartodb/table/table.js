...
$(function() {
  ...
  var Table = cdb.core.View.extend({
    ...
    initialize: function(options) {
      ...
      this.table.bind('change', function(ev) {
    ...
    */
    ...
    _initModels: function() {
      ...
      var layers = [
        /*{
          url: 'http://a.tiles.mapbox.com/v3/cartodb.map-4xtxp73f.jsonp',
          maxZoom: 17,
          name: 'Graphite',
        ...
        /*{
          url: 'http://a.tiles.mapbox.com/v3/cartodb.map-uulyudas.jsonp',
          maxZoom: 17,
          name: 'Warden',
    ...
    _initViews: function() {
      ...
      this.map.bind('change:dataLayer', _.once(function() {
        ...
        var carto = new cdb.admin.mod.Carto({
          ...
          self.menu.addClassToButton('carto_mod', 'hasErrors')
        }).bind('clearError', function() {
          self.menu.removeClassFromButton('carto_mod', 'hasErrors');
        });
    ...
    cdb.init(function() {
      ...
      if(table.initializated) {
        ...
        table.table.bind('change', _.once(function() {
          var router = new TableRouter(window.table);
          // expose to debug
          Backbone.history.start();
        }));
