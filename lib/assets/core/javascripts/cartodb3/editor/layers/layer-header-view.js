...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    this._inlineEditor = new InlineEditorView({
      ...
      renderOptions: {
        alias: utils.escapeHtml(this._layerDefinitionModel.getName())
      },
  ...
  _onSaveSuccess: function (newName) {
    this.$('.js-title').html(utils.escapeHtml(newName)).show();
    this._inlineEditor.hide();
  },

  _onSaveError: function (oldName) {
    this.$('.js-title').html(utils.escapeHtml(oldName)).show();
    this._inlineEditor.hide();
  },
