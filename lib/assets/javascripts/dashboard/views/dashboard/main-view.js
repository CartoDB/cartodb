...
module.exports = CoreView.extend({
  ...
  _onRouterChange: function (model, value) {
    ...
    this._backgroundPollingView._createVis = this._routerModel.model.isMaps();
  },
  ...
  _initViews: function () {
    ...
    CreateDialog.addProperties({ mamufasView });
    ...
    this.$('#app').append(this.controllerView.render().el);
    this.addView(this.controllerView);
  ...
  _onClick: function (event) {
    ...
    if (this._isEventTriggeredOutsideOf(event, '.Dialog')) {
      this.controllerView._closeDialogs();
      ...
      if (this._isEventTriggeredOutsideOf(event, '.js-skip-unselect-all')) {
        this.controllerView._unselectItems();
      }
    }
  },
