...
module.exports = BaseDialog.extend({
  ...
  _loadState: function() {
    ...
    if (stepName == "regular_1") {
      ...
      this.resetHeaderSteps(mergeFlavor);
  ...
  resetHeaderSteps: function(mergeFlavor) {
    this._$headerStep2().addClass('is-selected');
    this._$headerStep2Title().text(this._TEXTS[mergeFlavor].headerStep2Title);
    this._$headerStep3().removeClass('is-selected');
