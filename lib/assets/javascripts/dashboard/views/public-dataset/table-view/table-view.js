...
module.exports = Table.extend({
  ...
  */
  rowSaving: function () {
    this.notice(_t('dashboard.views.public_dataset.table_view.saving'), 'load', -1);
  },
  ...
  */
  rowSynched: function () {
    this.notice(_t('dashboard.views.public_dataset.table_view.saved'));
  },
  ...
  */
  rowFailed: function () {
    this.notice(_t('dashboard.views.public_dataset.table_view.error'), 'error');
  },
  ...
  */
  ...
  rowDestroying: function () {
    this.notice(_t('dashboard.views.public_dataset.table_view.row_deleting'), 'load', -1);
  },
  ...
  */
  ...
  rowDestroyed: function () {
    this.notice(_t('dashboard.views.public_dataset.table_view.row_deleted'));
    this._checkEmptyTable();
  }
});
