...
module.exports = Backbone.Collection.extend({
  ...
  isBaseLayerAdded: function (layer) {
    ...
    if (layerTypesAndKinds.isTiledType(myType) && myType === itsType) {
      var myName = me.name || me.options.name;
      var itsName = other.name || other.options.name;
      var myCategory = me.category || me.options.category;
      var itsCategory = other.category || other.options.category;

      return myName === itsName && myCategory === itsCategory;
    }
  ...
  _updateBaseLayer: function (newBaseLayerAttrs, opts) {
    ...
    currentBaseLayer.set(attrs, opts);
