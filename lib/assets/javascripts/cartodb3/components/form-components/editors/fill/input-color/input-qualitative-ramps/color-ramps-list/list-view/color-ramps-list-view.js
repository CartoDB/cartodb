...
var CustomRampTemplate = require('./color-ramp-custom-item.tpl');
var InputCategoriesRampListTemplate = require('./color-ramps-list-view.tpl');
var InputCategoryRampsListItemTemplate = require('../list-item-view/color-ramps-list-item.tpl');
var InputCategoryRampsListItemView = require('../list-item-view/color-ramps-list-item-view');

var CustomListView = require('cartodb3/components/custom-list/custom-view');
var CustomListCollection = require('cartodb3/components/custom-list/custom-list-collection');

var CartoColor = require('cartodb3/helpers/carto-color');
