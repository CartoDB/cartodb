describe('Date field', function() {
  ...
  beforeEach(function() {
    view = new cdb.admin.DateField({
      model: new cdb.core.Model({
        attribute:  'date',
        value:      '2012-12-12T10:10:10+2:00'
      })
    });
  });
  ...
  it("should be valid adding a correct time", function() {
    view.render();
    var $time = view.$el.find('input.time');
    $time.val('02:02:02');
    $time.trigger(jQuery.Event( 'keyup', { keyCode: 11 } ));
    ...
    expect(view.model.get('value')).toBe('2012-12-12T02:02:02+00:00');
  });
  ...
  it("should change the timezone", function() {
    ...
    expect(view.model.get('value')).toBe('2012-12-12T10:04:12+01:00');
  });
