cdb.admin.overlays.Text = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_click", "_close", "_onChangeMode", "_onKeyDown", "_putOnTop");
  ...
  _enableEditingMode: function() {
    ...
    this.$el.animate({ padding: width: width }, { duration: 200, easing: "easeInOutQuad", complete: function() {
      self.$el.css("max-width", width);
      self.$text.html(text);
      self.$el.find(".hint").fadeIn(150);
    }});
