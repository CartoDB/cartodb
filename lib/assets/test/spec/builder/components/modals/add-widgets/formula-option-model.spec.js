...
describe('components/modals/add-widgets/formula/formula-option-model', function () {
  var model;
  var defaultOptions;
  ...
  var createModelFn = function (options, optionsTuples) {
    ...
    return new FormulaOptionModel(_.extend(defaultOptions, options));
  };
  ...
  it('should have a "formula" type by default', function () {
