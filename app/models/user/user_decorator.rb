  ...
  module UserDecorator
    ...
    def data(options = {})
      ...
      data = {
        ...
        public_privacy_visualization_count: public_privacy_visualization_count,
        link_privacy_visualization_count: link_privacy_visualization_count,
        password_privacy_visualization_count: password_privacy_visualization_count,
