...
var CategoriesRampsListView = require('./input-categories-ramps/input-categories-ramps-list-view');
...
module.exports = CoreView.extend({
  ...
  _createCategoriesRampsListView: function (stackLayoutModel, opts) {
    var view = new CategoriesRampsListView({
      model: this.model,
      maxValues: MAX_VALUES,
      requiredNumberOfColors: this._requiredNumberOfColors
    });

    view.on(CategoriesRampsListView.EVENTS.RAMP_SELECTED, function () {
      stackLayoutModel.goToStep(STEPS.CATEGORIES_LIST_VIEW);
    }, this);

    view.on(CategoriesRampsListView.EVENTS.CUSTOMIZE, function () {
      stackLayoutModel.goToStep(STEPS.CATEGORIES_LIST_VIEW);
    }, this);

    view.on(CategoriesRampsListView.EVENTS.CUSTOM_COLOR, function () {
      stackLayoutModel.goToStep(STEPS.CATEGORIES_LIST_VIEW);
    }, this);
