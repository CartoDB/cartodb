...
describe('dashboard/data/user-tables-model', function () {
  ...
  describe('.url', function () {
    it('sets the default params in the url', function () {
      var defaultUrl = 'http://wadus.com/api/v1/viz?tag_name=&q=&page=1&type=&exclude_shared=false&per_page=10&tags=&shared=no&only_liked=false&order=updated_at&types=table&deepInsights=false';
  ...
  describe('.generateParams', function () {
    it('returns the paramsModel attributes encoded', function () {
      var encodedParams = 'tag_name=&q=&page=1&type=&exclude_shared=false&per_page=10&tags=&shared=no&only_liked=false&order=updated_at&types=table&deepInsights=false';
