<div class="u-tSpace-xl CDB-Text u-flex js-name-field">
  <label class="Metadata-label CDB-Text CDB-Size-medium u-ellipsis"><%- _t('components.modals.maps-metadata.form.name') %></label>
</div>

<div class="u-tSpace-xl CDB-Text u-flex">
  <label class="Metadata-label CDB-Text CDB-Size-medium u-ellipsis"><%- _t('components.modals.maps-metadata.form.description') %></label>
  <div class="u-grow">
...
<div class="u-tSpace-xl CDB-Text u-flex u-alignCenter js-tags-field">
  <label class="Metadata-label CDB-Text CDB-Size-medium u-ellipsis"><%- _t('components.modals.maps-metadata.form.tags') %></label>
</div>