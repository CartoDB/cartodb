/*
  TODO:
    ...
    - Limit only 3 layers in visualization.
    - Remove and visibility buttons should not appear in table visualization.
    - Remove layer should work.
    - Tests and more tests!
    - Visibility action should work using gmaps.
    - Save orders.
    - Re-calculate orders and save them when a change is done.
    - Should save active layer when changes.
    - Check active layer.
    - Wizard panel should be the default one.
*/
...
cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
  ...
  initialize: function() {
    /* test */
    _.bindAll(this, 'manageLayers', '_checkResize');
