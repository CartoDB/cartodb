  ...
  cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
    ...
    initialize: function() {
      ...
      this.title = this._setInitialTitle(this.options.vis);
    ...
    *******/
    ...
    _setName: function() {
      ...
      document.title = this.title + " | CartoDB";
    },

    _setInitialTitle: function(vis) {
      if (vis.get('type') === 'remote' || vis.get('synchronization') && vis.get('synchronization').from_external_source) {
    ...
    *******/
    ...
    _addTitleLayer: function() {
      ...
      var d = {
        'title': this.title || this._setInitialTitle(this.vis)
      };
    ...
    *******/
    ...
    _manageLayers: function() {
      ...
      var $el = $(this.el);
      var $active_layer = this.metadataOpen ? $el.find('.title_layer') : activePane.$el;
      ...
      if (this.metadataOpen) {
        ...
        $el.find('.title_layer').css({height: 66});
      ...
      // Set layers offset
      var offset = this.metadataOpen ? 23 : -23;
