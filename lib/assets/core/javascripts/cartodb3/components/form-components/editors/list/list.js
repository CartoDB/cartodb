...
Backbone.Form.editors.List = Backbone.Form.editors.Base.extend({
  ...
  addItem: function (value, userInitiated) {
    ...
    this._refreshDeleteButtonsVisibility();
  ...
  _refreshDeleteButtonsVisibility: function () {
    if (this.items.length > 1) {
      this.$('.js-item-delete').removeClass('is-hidden');
    } else {
      this.$('.js-item-delete').addClass('is-hidden');
    }
  }
}, {
