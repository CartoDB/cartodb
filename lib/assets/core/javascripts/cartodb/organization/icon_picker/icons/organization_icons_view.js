...
module.exports = cdb.core.View.extend({
  ...
  _plantilla: function () {
    var vnode = h('div.FormAccount-rowLabel.IconActions', {});
    vnode.children = [];
    vnode.children.push(h('label.CDB-Text.CDB-Size-medium.is-semibold.u-mainTextColor.u-rSpace--xl.js-iconMainLabel'));
    vnode.children.push(h('label.CDB-Text.CDB-Size-small.u-rSpace--xl.u-altTextColor.js-iconsInfo', {}, ['These icons can be used as markers.']));
    vnode.children.push(h('label.CDB-Text.CDB-Size-small.u-rSpace--xl.u-altTextColor.js-runningInfo'));
    vnode.children.push(h('label.CDB-Text.CDB-Size-medium.u-rSpace--xl.js-selectAllIcons', [
      h('a', { attrs: { href: '#/select_all' }}, [ 'Select all' ])
    ]));
    vnode.children.push(h('label.CDB-Text.CDB-Size-medium.u-rSpace--xl.js-deselectAllIcons', [
      h('a', { attrs: { href: '#/deselect_all' }}, [ 'Deselect all'])
    ]));
    vnode.children.push(h('label.CDB-Text.CDB-Size-medium', [
      h('a.IconText.is--critical', { attrs: { href: '#/delete_icons' }}, [ 'Delete icons...'])
    ]));
  ...
  render: function () {
    this.vnode = this._plantilla();
    patch(this.$el[0], this.vnode);
