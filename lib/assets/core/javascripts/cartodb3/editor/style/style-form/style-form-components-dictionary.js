...
function generateSimpleStroke (params, type) {
  ...
  var isDisabled = params.styleMethod === 'dot';
  var helpColorMsg = _t('editor.style.tooltips.stroke.color', {type: _t('editor.style.tooltips.' + styleType)});
  var helpSizeMsg = _t('editor.style.tooltips.stroke.size', {type: _t('editor.style.tooltips.' + styleType)});
  ...
  return {
    ...
    editorAttrs: {
      ...
      size: {
        ...
        step: 0.5,
        hidePanes: ['value'],
        help: !isDisabled ? helpSizeMsg : ''
      },
      color: {
        hidePanes: ['value'],
        help: !isDisabled ? helpColorMsg : ''
      }
    },
    validators: ['required']
  };
...
module.exports = {
  'method': function (params) {
    return {
      type: 'Radio',
      title: _t('editor.style.components.method.label'),
      options: [
        {
          val: 'marker',
          label: _t('editor.style.components.method.options.marker')
        }, {
          val: 'dot',
          label: _t('editor.style.components.method.options.dot')
        }
      ]
    };
  },
  ...
  'fill': function (params) {
    ...
    if (params.styleMethod === 'dot') {
      color.imageEnabled = false;
    }
  ...
  'stroke': function (params) {
    var strokeParams = {
      ...
      userModel: params.userModel,
      modals: params.modals,
      styleMethod: params.styleMethod
    };
