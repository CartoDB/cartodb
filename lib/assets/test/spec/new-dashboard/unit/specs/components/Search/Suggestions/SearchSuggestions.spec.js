...
describe('SearchSuggestions.vue', () => {
  ...
  describe('Methods', () => {
    ...
    describe('getActiveSuggestionElement', () => {
      it('should return the proper suggestion list element', async () => {
        const searchSuggestions = createSearchSuggestions({
          data () {
            return {
    ...
    describe('keydownDown', () => {
      it('should set as active the next item in the suggestion list', async () => {
        const searchSuggestions = createSearchSuggestions();
    ...
    describe('keydownUp', () => {
      it('should set as active the previous item in the suggestion list', async () => {
        const searchSuggestions = createSearchSuggestions({
          data () {
            return {
    ...
    describe('resetActiveSuggestion', () => {
      it('should reset the active item to the initial state', async () => {
        const searchSuggestions = createSearchSuggestions({
          data () {
            return {
              activeSuggestionIndex: 3
    ...
    describe('updateActiveSuggestion', () => {
      it('should update the active element to the third search suggestion', async () => {
        const searchSuggestions = createSearchSuggestions();
