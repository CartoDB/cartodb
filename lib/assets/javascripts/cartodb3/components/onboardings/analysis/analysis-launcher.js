var LocalStorage = require('cartodb3/components/local-storage/local-storage');
var AnalysisOnboardingView = require('cartodb3/components/onboardings/analysis/analysis-view');
