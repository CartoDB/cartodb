...
gem 'google-cloud-bigquery-storage-v1', git: 'https://juanrmn:bd52ab87ff5baad9c58f78ac59c2f9c290a0382c@github.com/CartoDB/db-connectors.git', :branch => 'feature/ch97488/use-storage-api-for-do-sync'
gem 'avro', '~>1.10.0'
