...
describe('builder/editor/layers/layer-content-views/analyses/analysis-source-options-model', function () {
  ...
  describe('when analysis nodes are fetched', function () {
    ...
    it('should fetch tables reducing the data to be retrieved', function () {
      var data = this.tablesCollection.fetch.calls.first().args[0].data;

      expect(data.load_totals).toBeDefined();
      expect(data.per_page).toBeDefined();
      expect(data.show_liked).toBeDefined();
      expect(data.show_permission).toBeDefined();
      expect(data.show_stats).toBeDefined();
      expect(data.show_synchronization).toBeDefined();
      expect(data.show_table_size_and_row_count).toBeDefined();
      expect(data.show_table).toBeDefined();
      expect(data.show_uses_builder_features).toBeDefined();
    });
