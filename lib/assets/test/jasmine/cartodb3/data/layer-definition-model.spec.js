...
describe('cartodb3/data/layer-definition-model', function () {
  ...
  describe('.toJSON', function () {
    it('should return the original data', function () {
      expect(this.model.toJSON()).toEqual({
        ...
        infowindow: jasmine.any(Object),
        tooltip: jasmine.any(Object),
        id: 'abc-123'
      });
    });
  });
  ...
  describe('for a layer without infowindow or tooltip, but data type', function () {
    beforeEach(function () {
      this.configModel = new ConfigModel({
        base_url: '/u/pepe'
      });
      ...
      this.infowindowModel = this.model.infowindowModel;
      this.tooltipModel = this.model.tooltipModel;
    });

    it('should generate infowindow and tooltip with default attributes', function () {
      expect(this.infowindowModel).toBeDefined();
      expect(this.infowindowModel.get('template_name')).toBe('none');
      expect(this.infowindowModel.get('fields')).toBeNull();
      expect(this.tooltipModel).toBeDefined();
      expect(this.tooltipModel.get('template_name')).toBe('none');
      expect(this.tooltipModel.get('fields')).toBeUndefined();
    });
  });
