...
$(function() {
  ...
  cdb.dashboard.Main = cdb.core.View.extend({
    ...
    _initModels: function() {
      ...
      this.collection =  new cdb.admin.Visualizations({ type: "table" });
    ...
    _fetchCollection: function(m, changes) {
      ...
      var order = this.localStorage.get("dashboard.order") || 'udpated_at';
      delete storage;
      ...
      this.collection.options.set({
        ...
        page:           params.page || 1,
        tags:           params.tag,
        per_page:       this.collection[ "_" + ( params.model === "tables" ? 'TABLES' : 'ITEMS') + '_PER_PAGE'],
