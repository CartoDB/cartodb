    ...
    <div class="Filters-row js-filters">
      <div class="Filters-typeItem Filters-typeItem--searchEnabler">
        <p class="Filters-searchLink js-search-link u-alignCenter CDB-Text CDB-Size-medium">
          <i class="Filters-searchLinkIcon CDB-IconFont CDB-IconFont-lens"></i><%= _t('dashboard.components.paged_search.paged_search.search') %>
        </p>
      </div>
      <div class="Filters-typeItem Filters-typeItem--searchField">
        <form class="Filters-searchForm js-search-form" action="#">
          <input class="Filters-searchInput CDB-Text CDB-Size-medium js-search-input" type="text" value="<%- q %>" placeholder="<%= _t('dashboard.components.paged_search.paged_search.placeholder') %>" />
