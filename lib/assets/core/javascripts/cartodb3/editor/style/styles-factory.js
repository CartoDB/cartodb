...
var STYLE_MAP = {
  ...
  'simple': {
    tooltipTranslationKey: 'editor.style.aggregation.tooltips.simple',
  ...
  'squares': {
    tooltipTranslationKey: 'editor.style.aggregation.tooltips.squares',
  ...
  'hexabins': {
    tooltipTranslationKey: 'editor.style.aggregation.tooltips.hexabins',
  ...
  'regions': {
    tooltipTranslationKey: 'editor.style.aggregation.tooltips.regions',
  ...
  'animation': {
    tooltipTranslationKey: 'editor.style.aggregation.tooltips.animation',
  ...
  'heatmap': {
    tooltipTranslationKey: 'editor.style.aggregation.tooltips.heatmap',
