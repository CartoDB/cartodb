...
var DataObservatoryCountView = require('../../../../../../../javascripts/cartodb3/components/form-components/editors/data-observatory-measurements//measurements-count-view');
...
describe('components/form-components/editors/data-observatory-measurements/measurements-count-view', function () {
  ...
  it('should render top results if query is empty', function () {
    ...
    expect(this.view.$el.html()).toContain('analyses.data-observatory-measure.count.top');
  });
