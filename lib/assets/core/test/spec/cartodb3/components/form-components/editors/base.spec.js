...
describe('components/form-components/editors/base', function () {
  ...
  it('should add a custom class if it has been passed as parameter', function () {
    var view = new Backbone.Form.editors.Base({
      value: 'Hello!',
      className: 'track-greeting',
      schema: {}
    });

    expect(view.$el.hasClass('track-greeting')).toBeTruthy();
  });
