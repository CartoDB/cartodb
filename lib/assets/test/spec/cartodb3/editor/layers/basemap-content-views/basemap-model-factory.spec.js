...
var BasemapModelFactory = require('../../../../../../javascripts/cartodb3/editor/layers/basemap-content-views/basemap-model-factory');
...
var testCases = [
  ...
  },
  {
    ...
    basemapAttrs: {
      ...
      'retina_labels': {
        'url': 'http://{s}.basemaps.cartocdn.com/light_only_labels/{z}/{x}/{y}@2x.png'
      }
    },
    expectedBasemapModelAttrs: {
      'default': true,
      'urlTemplate': 'http://{s}.basemaps.cartocdn.com/light_nolabels/{z}/{x}/{y}@2x.png',
      'subdomains': 'abcd',
      'minZoom': '0',
      'maxZoom': '18',
      'name': 'Positron',
...
describe('cartodb3/editor/layers/basemap-content-views/basemap-model-factory.js', function () {
