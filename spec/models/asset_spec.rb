...
describe Asset do
  ...
  it 'should upload the asset_file to s3 passing a full path' do
    ...
    asset.public_url.should == "https://s3.amazonaws.com/com.cartodb.assets.dev/test/#{@user.username}/assets/simple.json"
  ...
  it 'should upload the asset_file to s3 passing an uploaded file' do
    ...
    asset.public_url.should == "https://s3.amazonaws.com/com.cartodb.assets.dev/test/#{@user.username}/assets/column_number_to_boolean.csv"
