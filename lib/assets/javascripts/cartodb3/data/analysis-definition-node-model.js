...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this.querySchemaModel = new QuerySchemaModel(this.pick('raw_geom'), {
      configModel: opts.configModel
    });

    this.listenTo(this.querySchemaModel, 'change:raw_geom', this._onQuerySchemaRawGeomChanged);
  },
  ...
  _onQuerySchemaRawGeomChanged: function (m, rawGeom) {
    this.set('raw_geom', rawGeom);
  }
