...
describe('cartodb3/data/analysis-definition-node-model', function () {
  ...
  it('should not have a raw geom from start', function () {
    expect(this.a0.querySchemaModel.simpleGeometry()).not.toEqual(jasmine.any(String));
  });
  ...
  describe('when given a raw_geom from start', function () {
    beforeEach(function () {
      this.model = this.collection.add({
        ...
        params: {},
        options: {
          raw_geom: '0105000020E6100000010000000102000000020000002635B401D8C00DC08978EBFCDB35444076FD82DDB0AD0DC070B54E5C8E354440'
        }
      });
    });

    it('should set the raw_geom on the query-schema-model', function () {
      expect(this.model.querySchemaModel.simpleGeometry()).toBeDefined();
    });
  });
});
