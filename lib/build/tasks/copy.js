    ...
    return {
      ...
      app: {
        ...
        files: [
          ...
          {
            expand: true,
            cwd: 'app/client/assets/stylesheets/',
            src: ['**/*.css.scss', '**/*.scss'],
            dest: 'tmp/sass/',
            rename: function (dest, src) {
              return dest + src.replace(/\.css.scss$/, '.scss');
      ...
      js_core: {
        files: [
          {
            expand: true,
            cwd: 'lib/assets/core/javascripts/',
            src: ['**/*'],
      ...
      js_client: {
        files: [
          {
            expand: true,
            cwd: 'lib/assets/client/javascripts/',
            src: ['**/*'],
            dest: 'lib/assets/javascripts/'
          }
        ]
