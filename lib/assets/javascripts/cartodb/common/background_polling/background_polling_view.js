...
var ImportItem = require('./views/imports/background_import_item_view');
var GeocodingItem = require('./views/geocodings/background_geocoding_item_view');
var ImportLimitItem = require('./views/imports/background_import_limit_view');
...
module.exports = cdb.core.View.extend({
  ...
  _addGeocoding: function(mdl) {
    var geocodingItem = new GeocodingItem({
    ...
    geocodingItem.bind('completed', function(mdl) {
      this.trigger('geocodingCompleted', mdl, this);
    }, this);

    geocodingItem.bind('failed', function(mdl) {
      this.trigger('geocodingFailed', mdl, this);
    }, this);
  ...
  _addImport: function(m) {
    ...
    importItem.bind('completed', function(mdl) {
      this.trigger('importCompleted', mdl);
    }, this);
