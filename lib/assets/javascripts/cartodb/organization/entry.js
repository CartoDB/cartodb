...
var IconPickerView = require('./icons/organization_icon_picker_view');
var ImagePickerView = require('../common/dialogs/map/image_picker_view');
...
$(function() {
  cdb.init(function() {
    ...
    var onImageFileChosen = function(url) {
      console.log(url);
    };

    // Organization assets
    var viewOrgUsersIcons = function(ev) {
      ...
      dialog.appendToBody();
      dialog.bind('fileChosen', onImageFileChosen, this);
    };
