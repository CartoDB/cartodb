...
var EditableField = require('../../new_common/editable_field');
var EditableTags = require('../../new_common/editable_tags');
...
module.exports = cdb.core.View.extend({
  ...
  _renderDescription: function() {
    ...
    var view = new EditableField({
      el: this.$('.DatasetsList-itemDescription'),
      model: this.model,
