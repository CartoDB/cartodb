describe("cdb.admin.dashboard.Messages", function() {
  ...
  it("should render the messages", function() {
    ...
    messagesHTML      += '<li class="'+c3.cid+'"><div class="inner">Ha Ha! upgrade dude!.<a href="#/close" class="smaller close">x</a><a class="button small green upgrade" href="-?utm_source=Dashboard_Limits_Reached&amp;utm_medium=referral&amp;utm_campaign=Upgrade_from_Dashboard">Upgrade now</a></div></li>';
    messagesHTML      += '</ul>';
