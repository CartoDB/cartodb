...
describe Carto::Api::VisualizationsController do
  ...
  describe 'main behaviour' do
    ...
    it 'tests exclude_shared and only_shared filters' do
      ...
      table = create_table(privacy: UserTable::PRIVACY_PUBLIC, name: "#{random_name('table')}_1", user_id: user_1.id)
      u1_t_1_id = table.table_visualization.id
      u1_t_1_perm_id = table.table_visualization.permission.id

      table = create_table(privacy: UserTable::PRIVACY_PUBLIC, name: "#{random_name('table')}_2", user_id: user_2.id)
    ...
    describe 'tests visualization likes endpoints in organizations' do
      ...
      it 'tests totals calculations' do
        ...
        table = create_table(privacy: UserTable::PRIVACY_PUBLIC, name: "#{random_name('table')}_1_1", user_id: @org_user_1.id)
        u1_t_1_id = table.table_visualization.id

        table = create_table(privacy: UserTable::PRIVACY_PUBLIC, name: "#{random_name('table')}_2_2", user_id: @org_user_2.id)
        u2_t_1_id = table.table_visualization.id
  ...
  describe 'index shared_only' do
    ...
    it 'should not display nor count the shared visualizations you own' do
      table = create_table(privacy: UserTable::PRIVACY_PUBLIC, name: "#{random_name('table')}_1", user_id: @org_user_1.id)
      u1_t_1_id = table.table_visualization.id
      u1_t_1_perm_id = table.table_visualization.permission.id
  ...
  describe 'visualization url generation' do
    ...
    it 'generates a user table visualization url' do
      table = create_table(privacy: UserTable::PRIVACY_PUBLIC, name: "#{random_name('table')}_1_1", user_id: @user.id)
  ...
  describe 'error with wrong visualization url' do
    ...
    describe 'normal user urls' do
      ...
      before(:each) do
        ...
        @vis_owner.save
        @other_user = @user2
        @table = create_random_table(@vis_owner, random_name('viz'), UserTable::PRIVACY_PRIVATE)
