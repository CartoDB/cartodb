...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._renderIfFetchAllQueryObjects();
  ...
  _initBinds: function () {
    ...
    this.listenTo(this.model, 'change:state', this._renderIfFetchAllQueryObjects);
    ...
    this.listenTo(layerDefinitionModel, 'change:source', this._renderIfFetchAllQueryObjects);
  ...
  _renderIfFetchAllQueryObjects: function () {
