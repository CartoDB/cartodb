...
var DeleteItemsDialog = require('../new_common/dialogs/delete_items_view');
...
var DeleteItemsViewModel = require('../new_common/dialogs/delete_items_view_model');
...
module.exports = cdb.core.View.extend({
  ...
  _newMap: function(e) {
    ...
    // Hubspot tracking "Opened Create new map"
  ...
  _connectDataset: function(e) {
    ...
    // Hubspot tracking "Opened Connect new dataset"
    window._hsq = window._hsq || [];
    window._hsq.push(['trackEvent', {
      id: '000000266348',
      value: null
