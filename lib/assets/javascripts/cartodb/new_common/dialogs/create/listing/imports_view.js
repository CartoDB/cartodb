...
module.exports = cdb.core.View.extend({
  ...
  _genPanes: function() {
    ...
    _.each(this._IMPORT_OPTIONS, function(imp,i) {
      ...
      var isEnabled = (fn && fn(imp, self)) || true;

      if (isEnabled) {
        pane = new imp.className({ user: self.user });
      } else if (imp.fallbackClassName) {
        pane = new imp.fallbackClassName();
      }
  ...
  _onTabChange: function(tabName) {
    ...
    this._setUploadModel(v.getModelData());
