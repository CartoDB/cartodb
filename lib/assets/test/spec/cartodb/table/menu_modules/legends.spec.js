...
describe('cdb.admin.mod.Legends', function() {
  ...
  describe('Legends', function() {
    ...
    beforeEach(function() {
      ...
      view = new cdb.admin.mod.Legends({
        el: $('<div>'),
           model: model,
           table: table,
    ...
    it("should have a model with the default template set to custom ", function() {
      expect(view.model.get('template_name')).toEqual('custom');
    });
  ...
  describe("ColorWizard", function() {
    ...
    it("should generate custom colors list", function() {
      view.render();
      view.setCarpropertiesSilent({ property: 'jamon_column', colors: [['rojo', '#F11810', 'string']] });
    ...
    it("should get values when property has changed", function() {
      ...
      view.cartoProperties.set({ property: 'jamon_column' });
    ...
    it("should render new values after changing property adding the default one", function() {
      ...
      server.respondWith('/api/v1/queries/',
