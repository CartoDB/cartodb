cdb.admin.MapOptionsDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _setupOptions: function() {
    ...
    var simpleOverlays = ["search", "shareable", "zoom", "zoom_info", "share", "fullscreen", "layer_selector"];
  ...
  _onSwitchSwitched: function(property, value) {
    ...
    } else if (property == 'search' || property == 'fullscreen' || property == 'share' || property == 'layer_selector') {
