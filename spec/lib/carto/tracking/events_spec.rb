      ...
      describe 'Events' do
        ...
        describe ExportedMap do
          ...
          it 'reports by user with access' do
            ...
            allow_any_instance_of(Carto::Visualization).to receive(:is_accesible_by_user?).with(@intruder).returns(true)
        ...
        describe CreatedMap do
          ...
          it 'reports by user with access' do
            ...
            allow_any_instance_of(Carto::Visualization).to receive(:writable_by?).with(@intruder).returns(true)
