...
var randomQuote = require('../../../cartodb3/components/loading/random-quote');
var Visualizations = require('./user-feed/feed-collection');
var ViewFactory = require('../../../cartodb3/components/view-factory');
var MapCardPreview = require('../../components/mapcard-preview-view');
var LikeModel = require('../../data/like-model');
var LikeView = require('../../components/likes/like-view');
...
module.exports = CoreView.extend({
  ...
  _initLike: function (vis, $el) {
    ...
    if (likeable) {
      ...
      this._authenticatedUser.bind('change', function () {
        this._fetchLike(likeModel, url);
      }, this);
    }
