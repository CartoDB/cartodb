describe("cdb.admin.overlays.Text", function() {
  ...
  it("should remove the overlay when the content of the overlay contains a br tag and it is not selected", function() {
  ...
  it("shouldn't remove the overlay when the content of the overlay is empty and it's selected", function() {
