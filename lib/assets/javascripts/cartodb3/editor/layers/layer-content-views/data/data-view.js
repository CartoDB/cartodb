...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._columnsNumberModel = new Backbone.Model({
      columns: 0
    });
  ...
  _onQuerySchemaStatusChange: function () {
    if (this._hasFetchedQuerySchema()) {
      ...
      this._columnsNumberModel.set({columns: this._columnsModel.getCollection().length});
    }
  },
    ...
    var tabPaneTabs = [{
        ...
        return new ScrollView({
          createContentView: function () {
            return new DataContentView({
              ...
              columnsNumberModel: self._columnsNumberModel,
      ...
      createActionView: function () {
        return new ShowMoreView({
          columnModel: self._columnsNumberModel,
