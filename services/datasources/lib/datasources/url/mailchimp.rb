    ...
    module Url
      ...
      class MailChimp < BaseOAuth
        ...
        def validate_callback(params)
          ...
          token_response = Carto::Http.post(ACCESS_TOKEN_URI, http_options(token_call_params, :post))
          ...
          metadata_response = Carto::Http.get(MAILCHIMP_METADATA_URI,http_options({}, :get, {
