...
describe('AnalysisNotificationErrorMessageHandler.extractErrorMessage', function () {
  it('should extract the right error message', function () {
    ...
    expect(AnalysisNotificationErrorMessageHandler.extractErrorMessage(analysisDefinitionNodeModel)).toEqual('found non-noded intersection between LINESTRING (-96.5796 32.577, -96.579 32.5768) and LINESTRING (-96.579 32.5768, -96.579 32.5768) at -96.578972198741511 32.576761407730309');
