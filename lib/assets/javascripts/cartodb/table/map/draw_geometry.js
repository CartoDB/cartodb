...
_.extend(MarkerGMaps.prototype,
  google.maps.Marker.prototype, {
    ...
    geojson: function() {
      return cdb.geo.gmaps.PathView.getGeoJSON(this, 'MultiPoint');
    }
  }
...
_.extend(PolylineGMaps.prototype,
  google.maps.Polyline.prototype, {
    ...
    setPath: function(points) {
      google.maps.Polyline.prototype.setPath.call(this, _(points).map(function(p) {
        return new google.maps.LatLng(p[0], p[1]);
      })
      );
    },
...
var PolygonLeaflet = L.Polygon.extend(PathPrototype).extend({
  geojson: function() {
    ...
    var geo = L.GeoJSON.toGeoJSON(this);
    return {
      type: 'MultiPolygon',
...
var BaseDrawTool = cdb.core.View.extend({
  ...
  image:  {
    url: '/assets/icons/edit_marker_icon.png',
    anchor: {x: 5, y: 5}
  },
