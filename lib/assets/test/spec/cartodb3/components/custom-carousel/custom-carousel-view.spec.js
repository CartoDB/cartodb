var CustomCarouselView = require('cartodb3/components/custom-carousel/custom-carousel-view');
...
describe('components/custom-carousel/custom-carousel-view', function () {
  ...
  it('should allow to add a className for every list item', function () {
