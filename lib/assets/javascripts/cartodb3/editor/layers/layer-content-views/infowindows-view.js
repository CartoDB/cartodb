...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var isAggregated = this._layerDefinitionModel.styleModel.isAggregatedType();
    var isAnimated = this._layerDefinitionModel.styleModel.get('animated') &&
                     this._layerDefinitionModel.styleModel.get('animated').enabled;

    if (this._layerInfowindowModel && !isAggregated && !isAnimated) {
      this._initViews();
      this._bindEvents();
    } else {
  ...
  _bindEvents: function () {
    ...
    this._layerInfowindowModel.on('change:template_name', this.render, this);
    this.add_related_model(this._layerInfowindowModel);
    this._layerTooltipModel.on('change:template_name', this.render, this);
