describe('modules.Filters', function() {
  ...
  describe('cdb.admin.models.Filter (date)', function() {
    ...
    beforeEach(function() {
      ...
      bounds.lower = 360000000000;
      bounds.upper = 760000000000;

      bounds.bucket_size = 1

      for (var i = 0; i < 10; ++i) {
        hist.push(bounds.upper + i*10);
      };
    ...
    it("should return the condition", function() {
      expect(model.getSQLCondition()).toEqual(" (c >= ('Fri, 29 May 1981 16:00:00 GMT') AND c <= ('Mon, 31 Jan 1994 07:06:41 GMT')) ");
    });
    ...
    it("should serialize to json", function() {
      expect(model.toJSON()).toEqual({
        ...
        items: [
          ...
          { bucket: 'test3', value: 40, selected: false }
        ],
        free_text : undefined,
        list_view : true
      });
  ...
  describe('FilterDiscrete: null', function() {
    ...
    beforeEach(function() {
      ...
      hist.rows = [
        { bucket: 'test1', value: "tiger" },
        { bucket: 'test2', value: "lion" },
        { bucket: 'test3', value: "zombie" },
        { bucket: 'test4', value: null }
      ];
