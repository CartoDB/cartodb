...
describe('components/privacy-dropdown/privacy-dropdown-view', function () {
  ...
  beforeEach(function () {
    ...
    privacyChangeSpy = spyOn(PrivacyDropdown.prototype, '_onPrivacyChange');
  ...
  it('should change privacy', function () {
    ...
    expect(PrivacyDropdown.prototype._onPrivacyChange).toHaveBeenCalled();
  ...
  describe('_onPrivacyChange', function () {
    it('should save privacy when privacy warning modal is not shown', function () {
      ...
      privacyChangeSpy.and.callThrough();

      view._onPrivacyChange();
