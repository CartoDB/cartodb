...
var NetworkResponseInterceptor = require('builder/data/backbone/network-interceptors/interceptor');
NetworkResponseInterceptor.patchBackboneSync();
NetworkResponseInterceptor.addSuccessInterceptor(
  require('builder/data/backbone/network-interceptors/interceptors/forbidden')
);
