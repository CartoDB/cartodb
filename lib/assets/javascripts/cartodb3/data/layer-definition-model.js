...
module.exports = cdb.core.Model.extend({
  ...
  parse: function (r, opts) {
    ...
    if (r.infowindow) {
      if (!this.infowindowModel) {
        this.infowindowModel = new InfowindowDefinitionModel(_.defaults(r.infowindow, {
    ...
    if (r.tooltip) {
      if (!this.tooltipModel) {
        this.tooltipModel = new InfowindowDefinitionModel(_.defaults(r.tooltip, {
          vertical_offset: 0,
          horizontal_offset: 0,
          position: 'top|center'
        }), {
    ...
    if (r.options.table_name) {
      if (!this.styleModel) {
        ...
        this.cartocssModel = new StyleCartoCSSModel({
          ...
          history: r.options.cartocss_custom || r.options.tile_style_custom
        });
      }
    }
  ...
  toJSON: function () {
    ...
    if (this.cartocssModel) {
      d.cartocss_history = this.cartocssModel.getHistory();
    }
