...
module.exports = function() {
  ...
  var template  = _.template('<div class="Quote">"<%= quote %>"</div><% if (author) { %><div class="Quote-author"><%= author %>.</div><% } %>');
  ...
  var quotes = [
    ...
    { quote: "our earth is a globe / whose surface we probe / no map can replace her / but just try to trace her", author: "Steve Waterman" },
    ...
    { quote: "Everything is related to everything else, but near things are more related than distant things.", author: "Tobler's first law of geography" },
    { quote: "Hic Sunt Dracones", author: null },
    { quote: "Here be dragons", author: null },
    { quote: "Stand in the place where you live / Now face North / Think about direction / Wonder why you haven't before from Stand", author: "R.E.M" },
    { quote: "Look to the future & leave the past behind", author: "@xavijam" }
  ];
