...
var UpgradeDialogView = require('./upgrade-dialog-view');
...
module.exports = CoreView.extend({
  ...
  _makeUpgradeDialog: function () {
    return new UpgradeDialogView({
      userModel: this._userModel,
      configModel: this._configModel
    });
  },
  ...
  _configPanes: function () {
    ...
    var tabPaneTabs = [{
      ...
      createContentView: self._makeUpgradeDialog.bind(self)
    }];
  ...
  _showPrivacyDialog: function () {
    ...
    if (this._userModel.isPrivacyEnabled()) {
  ...
  _showUpgradeDialog: function () {
    ...
    if (showTrial && upgradeURL) {
      this._collectionPane.at(3).set({selected: true});
    }
  },
