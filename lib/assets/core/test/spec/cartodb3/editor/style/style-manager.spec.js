...
describe('editor/style/style-manager', function () {
  ...
  describe('track changes', function () {
    it('should track style changes', function () {
      ...
      expect(this.layerDefModel.get('cartocss').indexOf('dot-fill: #000;')).not.toBe(-1);
    });
    ...
    it('should track style changes on add', function () {
      ...
      expect(layerDefModel.get('cartocss').indexOf('dot-fill: #000')).not.toBe(-1);
      expect(layerDefModel.get('cartocss').indexOf('dot-opacity: 0.4')).not.toBe(-1);
    });
