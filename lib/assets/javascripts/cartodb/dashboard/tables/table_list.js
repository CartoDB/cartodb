...
cdb.admin.dashboard.TableItem = cdb.core.View.extend({
  ...
  render: function() {
    ...
    this.$el.append(this.template(_.extend(attrs, { order: this.options.table_options.get("order"), row_count: pretty_row_count, name: name, description: description, tags: tags, extra_tags_count: extra_tags_count })));
