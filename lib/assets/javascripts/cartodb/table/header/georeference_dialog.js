...
cdb.admin.GeoreferenceDialog = cdb.admin.BaseDialog.extend({
  ...
  _showChooseGeometryTypeStep: function() {
    ...
    if (regionsEnabled && !pointsEnabled) this.styles.model.set("geometry_type", "regions");
    else if (!regionsEnabled && pointsEnabled) this.styles.model.set("geometry_type", "points");
  ...
  _onChangeAdm: function() {
    ...
    else if (adm === 'postalcode') available_geometries = this.model.get("postalcode");
  ...
  _geoReference: function(ev) {
    ...
    if (this.hasContent) {
      ...
      switch (option) {
        ...
        break;
        case 2:
          if (this.model.get("adm") == "postalcode") this._geoCodeZip(this.model.get("column"), this.model.get("country"), this.model.get("geometry_type"));
        break;
      }
