...
cdb.forms.Color = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    //if(this.image_property) {
      ...
      //this.model.bind('change:' + this.image_property, function() {
        //console.log(this.image_property, this.property);
        //if (this.model.get(this.image_property)) {
          //this.model.unset(this.property);
        //}
      //}, this);
  ...
  _initPicker: function() {
    ...
    this.color_picker = new cdb.admin.ColorPicker({
      ...
      if (this.image_property == this.property) {
        ...
        var properties = { }
        properties[this.property] = color
        properties[this.image_property] = "";
        self.model.set(properties);

        self.model.set(this.image_property, "");
        self.model.set(self.property, color);
      }
      ...
      if (this.image_property) {
        ...
        if (this.image_property == this.property) {
          ...
          properties[this.image_property] = 'url(' + url + ')';
...
cdb.forms.Combo = cdb.core.View.extend({
  ...
  _getOptions: function() {
    ...
    if (this.placeholder) options = "<option></option>" + options;
