describe('cdb.common.Url', function() {
  ...
  describe('.rootPath', function() {
    it('should return the root path of this URL', function() {
      expect(this.url.rootPath()).toEqual('/foobar');
    });
  });
  ...
  describe('.toPath', function() {
    ...
    describe('when given any argument', function() {
      beforeEach(function() {
        this.newUrl = this.url.toPath('sub', 'path');
      });
