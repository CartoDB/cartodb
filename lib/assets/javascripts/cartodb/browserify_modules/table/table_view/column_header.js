...
var Title = require('table/table_view/column_header/title');
var Type = require('table/table_view/column_header/type');
...
module.exports = React.createClass({
  ...
  _isAllowedToEditColumn: function() {
    var type = this._type();
    return type !== 'the_geom' && type !== 'the_geom_webmercator';
  },
