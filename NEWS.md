...
- Kepler.gl visualizations (Dashboard): Integrate Kepler.gl visualizations saved to CARTO into Dashboard and allow deleting them ([#15484](https://github.com/CartoDB/cartodb/issues/15484))
