...
describe('editor/layers/layer-content-view/analyses-content-view', function () {
  ...
  beforeEach(function () {
    ...
    onSelectedNodeChangedSpy = spyOn(AnalysesContentView.prototype, '_onSelectedNodeChanged');
  ...
  describe('_initBinds', function () {
    it('should listen to model change selectedNodeId', function () {
      ...
      expect(onSelectedNodeChangedSpy).toHaveBeenCalled();
    });
  ...
  describe('_onSelectedNodeChanged', function () {
    it('should call goToAnalysisNode in Router', function () {
      onSelectedNodeChangedSpy.and.callThrough();
      spyOn(Router, 'goToAnalysisNode');

      var layerId = layerDefinitionModel.get('id');
      var selectedNode = view.model.get('selectedNodeId');

      view._onSelectedNodeChanged();

      expect(Router.goToAnalysisNode).toHaveBeenCalledWith(layerId, selectedNode, { trigger: false });
    });
  });
