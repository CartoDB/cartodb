  ...
  cdb.admin.VisPrivacySelector = cdb.core.View.extend({
    ...
    _TYPES: [
      {
        type: 'PUBLIC',
        title: 'Public',
        description: 'All people can view this table',
        limitation: false
      },
      {
        type: 'LINK',
      ...
      },
      {
        ...
        description: 'Only people with password can view this',
        limitation: 'private'
      },
      {
        type: 'ORGANIZATION',
        title: 'Shared within your organization',
        description: 'Selected people can view and edit this',
        limitation: 'organization'
      },
      {
        type: 'PRIVATE',
        title: 'Private',
        description: 'This is only accesible by yourself',
        limitation: 'private'
      }
    ],
    ...
    _initViews: function() {
      ...
      this.selected.bind('showList', this._showList, this);
  ...
  cdb.admin.VisPrivacySelectorItem = cdb.core.View.extend({
    ...
    initialize: function() {
      ...
      this.template = cdb.templates.getTemplate('table/views/privacy_dialog/vis_privacy_selector_item');
    },
