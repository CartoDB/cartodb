...
describe('DatasetBulkActions.vue', () => {
  ...
  it('should render all multiple actions for all selected when there are no locked or shared datasets "Deselect all", "Create map", "Lock datasets" and "Delete datasets" actions', () => {
  ...
  it('should render single locked actions: "Select all", "Duplicate dataset" and "Unlock dataset"', () => {
    const selectedDatasets = datasetsLocked.visualizations.slice(0, 1);
    const datasetBulkAction = createDatasetBulkActionComponent({ selectedDatasets });
    expect(datasetBulkAction).toMatchSnapshot();
  });

  it('should render multiple locked actions when not all datasets have been selected: "Select all", Deselect all" and "Unlock datasets"', () => {
