...
module.exports = Backbone.Model.extend({
  ...
  resetPropertiesFromAutoStyle: function () {
    if (this._stylesPreAutoStyle) {
      delete this.attributes.autoStyleGenerated;
  ...
  setPropertiesFromAutoStyle: function (definition, geometryType) {
    ...
    var defaultAttrs = StylesFactory.getDefaultStyleAttrsByType('simple', geometryType);
    if (geometryType === 'line') {
      defaultAttrs.stroke = extendAutoStyleProperties('stroke', definition[geometryType]);
    } else {
      defaultAttrs.fill = extendAutoStyleProperties('fill', definition[geometryType]);
    }
