cdb.admin.overlays.Text = cdb.geo.ui.Text.extend({
  ...
  form_data: [{
    name: 'Text',
    form: {
      'font-size':  { type: 'simple_number', value: 12, min: 5, max: 50, inc: 2, disable_triggering: false },
    ...
    form: {
      ...
      'box-opacity': { type: 'simple_opacity', value: .7, min:0, max:1, inc: .1, disable_triggering: false },
      'box-padding': { type: 'simple_number_with_label', value: 10, min: 5, max: 200, inc: 1, label: "P", disable_triggering: false }
    }
  }, {
    name: 'Max Width',
    form: {
