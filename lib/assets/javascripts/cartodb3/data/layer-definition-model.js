...
var InfowindowClickModel = require('./infowindow-click-model');
var InfowindowHoverModel = require('./infowindow-hover-model');
  ...
  parse: function (r, opts) {
    ...
    if (r.infowindow) {
      if (!this.infowindowModel) {
        this.infowindowModel = new InfowindowClickModel(r.infowindow, {
    ...
    if (r.tooltip) {
      if (!this.tooltipModel) {
        this.tooltipModel = new InfowindowHoverModel(r.tooltip, {
          configModel: opts.configModel || this._configModel
        });
      }
    }
