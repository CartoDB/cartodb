...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    this.model.on('change', this._onChange.bind(this), this.model);
    ...
    var infoboxSstates = [
      {
        ...
        createContentView: function () {
          return Infobox.createWithAction({
            ...
            secondAction: {
              label: _t('editor.messages.limit.cta'),
              type: 'secondary'
            }
          });
        },
        secondAction: self._redirectToUpgrade
      }
    ];
  ...
  _redirectToUpgrade: function () {
    window.location = 'https://carto.com/pricing/';
  },
