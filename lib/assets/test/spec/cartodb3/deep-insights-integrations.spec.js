...
describe('deep-insights-integrations', function () {
  ...
  describe('when an analysis definition is added', function () {
    beforeEach(function () {
      ...
      this.analysisDefinitionsCollection.add({node_id: 'c0'});
    });
    ...
    describe('when a analysis definition is removed', function () {
      beforeEach(function () {
        this.node = jasmine.createSpyObj('node', ['remove']);
        this.analysis.findNodeById.and.returnValue(this.node);

        this.analysisDefinitionsCollection.remove(this.analysisDefinitionsCollection.last());
      });
