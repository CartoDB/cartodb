...
var column_category = {
  name: 'Column',
  form: { 'property': { type: 'select', columns: 'number|string|boolean', exclude_empty_columns: true } } /* value is filled by wizard */
};
...
var column_numeric_date_with_cartodb_id = {
  name: 'Time Column',
  form: { 'property': { type: 'select', columns: 'number|date', extra_default: ['cartodb_id'], default_column: 'date' } } /* value is filled by wizard */
};
