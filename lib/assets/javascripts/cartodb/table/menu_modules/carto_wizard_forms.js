...
var label_text_properties = {
    ...
    form: {
      'text-face-name': {
        ...
        extra: ["DejaVu Sans Book","unifont Medium", "Open Sans Regular"]
      },
...
var column_numeric_date_with_cartodb_id = {
  name: 'Column',
  form: { 'property': { type: 'select', columns: 'number|date',extra_default: ['cartodb_id']
...
var bubble_form = [
  ...
  QuantifyFn,
  {
     ...
     form: {
       'radius_min': { type: 'number', value: 10, min:0, max:300 },
       'radius_max': { type: 'number', value: 25, min:0, max:300 }
     },
     text: '- to -'
  },
  {
  ...
  },
  {
     name: 'Bubble stroke',
     form: {
       'marker-line-width': { type: 'number', value: 1.5, min:0, max:100, inc: 0.5 },
       'marker-line-color': { type: 'color', value: '#FFF' },
       'marker-line-opacity': { type: 'opacity', value: 1.0 }
     }
  },
...
cdb.admin.forms.cluster = {
  'point': [
    ...
    name: 'Marker Fill',
    form: {
      'marker-fill': { type: 'color' , value: '#397DBA' },
      'marker-opacity': { type: 'opacity' , value: 0.75 },
      'marker-allow-overlap': { type: 'hidden', value: true },
      'marker-placement':{ type:'hidden', value: 'point'},
      'marker-type':{ type:'hidden', value: 'ellipse'}
    }
    ...
    form: {
      ...
      'marker-line-color': { type: 'color' , value: '#000' },
