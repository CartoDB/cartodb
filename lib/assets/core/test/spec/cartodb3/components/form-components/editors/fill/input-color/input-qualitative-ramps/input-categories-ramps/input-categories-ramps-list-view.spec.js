...
var InputCategoriesRampsListView = require('../../../../../../../../../../javascripts/cartodb3/components/form-components/editors/fill/input-color/input-qualitative-ramps/input-categories-ramps/input-categories-ramps-list-view');

describe('components/form-components/editors/fill/input-color/input-qualitative-ramps/input-categories-ramps/input-categories-ramps-list-item-view', function () {
  var view, model;
  ...
  var createViewFn = function (options) {
    ...
    model = new Backbone.Model({
      ...
      range: _.isUndefined(options.range) ? undefined : options.range,
      images: ['', '', '', '', '', '', '', '', '', '', ''],
  ...
  describe('.render', function () {
    ...
    it('should render the custom ramp if any', function () {
      ...
      expect(view.$el.find('.js-customList .ColorBarContainer').children().length).toBe(ramp.length);
    });
  });
  ...
  describe('._onClickCustomize', function () {
    ...
    it('should set the current selected ramp as custom', function () {
      ...
      expect(view._customRamp.get('range')).toBe(ramp);
    });
  ...
  describe('._onClickCustomRamp', function () {
    ...
    it('should change to customize view if the clicked ramp is already selected', function () {

    });

    it('should deselect previous selected ramp and select the custom ramp', function () {
