(function() {
  ...
  cdb.admin.mod.SelectorFilter = cdb.core.View.extend({
    ...
    _addSwitch: function() {
      ...
      this.switch.model.unbind("change:list_view", this._toggleMode);
      this.switch.model.bind("change:list_view", this._toggleMode, this);
    ...
    _toggleSwitch: function() {
      this.switch.model.set("list_view", !this.switch.model.get("list_view"));
    },

    _toggleMode: function() {

      var self = this;
      var list_view = this.switch.model.get("list_view");
      ...
      if (!list_view) {
        ...
        self.trigger("refresh_scroll");

      } else {

        self.$textarea.fadeOut(250, function() { });
