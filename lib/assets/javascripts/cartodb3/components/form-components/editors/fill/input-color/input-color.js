...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    if (this.model.get('quantification') && QUANTIFICATION_REF[this.model.get('quantification')]) {
      this.model.set('quantification', QUANTIFICATION_REF[this.model.get('quantification')]);
    }
