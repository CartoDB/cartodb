...
var LegendsSate = require('./legends-state');
...
module.exports = Backbone.Model.extend({
  ...
  setAttributes: function (attrs) {
    ...
    LegendsSate.set(this.layerDefinitionModel, this.get('type') || attrs.type, attrs);
    this.set(attrs);
  },
  ...
  set: function (key, val, options) {
    ...
    var state = LegendsSate.get(layerDefinitionModel, type);
