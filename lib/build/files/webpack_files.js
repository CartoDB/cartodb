var files = {
  dashboard: {
    ...
    scripts: [
      ...
      '/javascripts/dashboard_new_vendor.js',
      '/javascripts/dashboard_new.js'
    ]
  },
  profile: {
    page: 'profile',
    ...
    scripts: [
      '/javascripts/common_dashboard.js',
      '/javascripts/profile_new_vendor.js',
      '/javascripts/profile_new.js'
    ]
  },
  // show: {
  //   stylesheets: [
  ...
  //   scripts: [
  //     '/javascripts/common_dashboard.js',
  //     '/javascripts/account_new_vendor.js',
  //     '/javascripts/account_new.js'
  //   ]
  // },
  account: {
    page: 'account',
