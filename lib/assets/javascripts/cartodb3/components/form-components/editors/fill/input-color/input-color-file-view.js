...
var CarouselFormView = require('cartodb3/components/carousel-form-view');
var CarouselCollection = require('cartodb3/components/custom-carousel/custom-carousel-collection');
var StaticAssetsCollection = require('cartodb3/data/static-assets-collection');
var StaticAssetModel = require('cartodb3/data/static-asset-model');
