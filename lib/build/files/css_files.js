...
module.exports = css_files = {
  ...
  public_data_dashboard: [
    ...
    '<%= assets_dir %>/stylesheets/vendor/reset.css',
    '<%= assets_dir %>/stylesheets/common/utilities.css',
    '<%= assets_dir %>/stylesheets/common/icon-font.css',
    '<%= assets_dir %>/stylesheets/components/grid.css',
    '<%= assets_dir %>/stylesheets/components/header.css',
    '<%= assets_dir %>/stylesheets/components/logo.css',
    '<%= assets_dir %>/stylesheets/public_data_dashboard/base.css',
    // '<%= assets_dir %>/stylesheets/public_data_dashboard/main.css'
  ],
  ...
  public_table: [
    ...
    '<%= assets_dir %>/stylesheets/old_elements/duplicate_dialog.css',
    '<%= assets_dir %>/stylesheets/old_elements/duplicate_table_dialog.css',
