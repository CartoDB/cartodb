...
cdb.admin.GeoreferenceDialog = cdb.admin.BaseDialog.extend({
  ...
  _ASIDE_MESSAGES: {
    0: "<p>Georeferencing by this option doesn’t take any geocoding credits.</p><p>Just select your lon/lat columns and enjoy.</p>",
    1: "<p>Georeferencing by this option doesn’t take any geocoding credits.</p><p>Just select your lon/lat columns and enjoy.</p>",
    2: "<p>Georeferencing by this option doesn’t take any geocoding credits.</p><p>Just select your lon/lat columns and enjoy.</p>",
    3: ""
  },
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_onCountrySelected", "_onColumnSelected", "_onAdmSelected", "_onChangeCountry", "_onAdmGetSuccess",
  ...
  _showInitialStep: function() {
    ...
    this.model.set({
      ...
      this.$el.find(".foot").slideUp(250, function() {
  ...
  _showChooseGeometryTypeStep: function() {
    ...
    this.$el.find(".inner").animate({ height: 178, left: -550 }, { easing: "easeOutQuad", duration: 200, complete: function() {
      ...
      self.$el.find(".foot").slideDown(250);
