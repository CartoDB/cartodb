...
module.exports = Feed.extend({
  ...
  _CARD_HEIGHT: 220,
  _LOADER_TITLE: _t('cartodb.explore.title'),

  _DROPDOWN_TEXT: {
    null: _t('cartodb.explore.maps_data'),
    'table': _t('cartodb.explore.datasets'),
    'derived': _t('cartodb.explore.maps')
  },
  ...
  initialize: function() {
    _.bindAll(this, '_onWindowResize', '_renderStaticMaps');
