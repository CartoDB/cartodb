...
describe('editor/layers/layer-content-view', function () {
  beforeEach(function () {
    ...
    node.querySchemaModel = new Backbone.Model();

    spyOn(this.layer, 'findAnalysisDefinitionNodeModel').and.returnValue(node);
    spyOn(this.layer, 'getAnalysisDefinitionNodeModel').and.returnValue(node);
