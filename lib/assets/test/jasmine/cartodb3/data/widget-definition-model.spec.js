...
describe('cartodb3/data/widget-definition-model', function () {
  beforeEach(function () {
  ...
  describe('.containsNode', function () {
    it('should return true if given node is used by the widget', function () {
      expect(this.widgetDefModel.containsNode({id: 'a0'})).toBe(true);

      expect(this.widgetDefModel.containsNode({id: 'a1'})).toBe(false);
