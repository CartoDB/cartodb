...
describe('editor/widgets/widgets-form/widgets-header', function () {
  ...
  it('should rename', function () {
    ...
    this.view.$('.js-toggle-menu').trigger('click');
    this.view._contextMenuFactory.getContextMenu().$('[data-val="rename-widget"]').trigger('click');
  ...
  it('should delete', function () {
    this.view.$('.js-toggle-menu').trigger('click');
    this.view._contextMenuFactory.getContextMenu().$('[data-val="delete-widget"]').trigger('click');
