...
module.exports = [
  ...
  },
  {
    ...
    result: {
      point: {
        cartocss: '#layer {\ndot-width: ramp([cartodb_id], range(1, 20));\ndot-fill: ramp([test], colorbrewer(Greens), 6, jenks);\ndot-opacity: 0.5;\ndot-comp-op: multiply;\n}'
      },
      line: {
  ...
  },
  {
    ...
    result: {
      point: {
        cartocss: '#layer {\ndot-width: ramp([cartodb_id], range(1, 20), jenks(6));\ndot-fill: ramp([name], (#fabada, black, red, white), (a, b, c), "=", category);\ndot-opacity: 0.5;\n}'
      },
      line: {
        cartocss: '#layer {\n}'
      },
