...
'CartoDB': [{
    ...
    url: 'https://cartocdn_{s}.freetls.fastly.net/base-antique/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
    ...
    url: 'https://cartocdn_{s}.freetls.fastly.net/base-eco/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
    ...
    url: 'https://cartocdn_{s}.freetls.fastly.net/base-flatblue/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
    ...
    url: 'https://cartocdn_{s}.freetls.fastly.net/base-midnight/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
...
'Stamen': [{
    url: 'https://stamen-tiles-{s}.freetls.fastly.net/toner-background/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    name: 'Toner',
    ...
    url: 'https://stamen-tiles-{s}.freetls.fastly.net/toner-lite/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    name: 'Toner Lite',
    ...
    url: 'https://stamen-tiles-{s}.freetls.fastly.net/toner-lines/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    name: 'Toner Lines',
    ...
    url: 'https://stamen-tiles-{s}.freetls.fastly.net/toner-hybrid/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    name: 'Toner Hybrid',
