...
module.exports = cdb.core.View.extend({
  ...
  _generateForm: function () {
    this.widgetFormModel = WidgetFormFactory.createWidgetFormModel(this.formType, this.widgetDefinitionModel.toJSON());
    ...
    this.widgetFormModel.bind('change', function () {
      // TODO: replace toJSON() method in order to provide proper values to
      // each widget
      this.widgetDefinitionModel.saveAttributes(this.widgetFormModel.changed);
    }, this);

    this.widgetFormModel.bind('update', function () {
      this.render();
    }, this);
