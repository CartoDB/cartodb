...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _renderOverlay:  function(delayed_animation, data) {
    ...
    console.log(type)
    if (type != "Search" && type != "Fullscreen" && type != "Share") { // TODO: improve this
  ...
  _onResetOverlays: function(overlays) {
    ...
    var header = this._getOverlay("title");
    var search = this._getOverlay("search");
    var share  = this._getOverlay("share");
