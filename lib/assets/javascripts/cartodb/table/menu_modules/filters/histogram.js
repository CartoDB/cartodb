  ...
  **/
  ...
  cdb.admin.mod.Filter = cdb.core.View.extend({
    ...
    _renderRange: function() {
      ...
      var l = this.model.get('lower');
      var h = this.model.get('upper');
    ...
    _updateBounds:function(bounds) {
      ...
      if (bounds) {
        ...
        console.log(bounds[0], bounds[1], n);

        var lower = this.model.interpolate(bounds[0]/n);//.toPrecision(2);
        var upper = this.model.interpolate(bounds[1]/n);//.toPrecision(2);
