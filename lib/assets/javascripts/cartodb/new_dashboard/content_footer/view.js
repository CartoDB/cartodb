...
module.exports = cdb.core.View.extend({
  ...
  _renderFilterShortcut: function() {
    ...
    this._renderFilterShortcut = function() {
      ...
      } else if (this._isLockInfoNeeded()) {
  ...
  _isLockInfoNeeded: function() {
    return this.router.model.get('shared') === 'no' && !this.router.model.get('library') && !this.router.model.isSearching()
  },

  _updateFilterShortcut: function() {
    var rModel = this.router.model;
    var totalCount = this.collection.total_entries;
