...
describe('editor/editor-view', function () {
  ...
  describe('max layers', function () {
    ...
    it('should have no maxlayer-infobox state by default', function () {
      expect(this.view._maxLayerInfoboxModel.get('state')).toBe(null);
    });
    ...
    it('should show the infobox when max layer are reached', function () {
      this.view._layerDefinitionsCollection.add(otherLayer);
      expect(this.view._maxLayerInfoboxModel.get('state')).not.toBe(null);
    });
