...
cdb.admin.SlidesPanel = cdb.core.View.extend({
  ...
  _bindSlides: function() {
    ...
    this.slides.bind('remove', this._onRemoveSlide, this);

  } ,

  _onRemoveSlide: function() {
    ...
    if (this.slides.length > 0) {
      this.slides.setActive(this.slides.at(this.slides.length - 1));
    }
...
cdb.admin.SlideView = cdb.core.View.extend({
  ...
  render: function() {
    ...
    var attributes = _.extend(this.model.attributes, { count: 1 }); // TODO: remove count && get the value from the model
