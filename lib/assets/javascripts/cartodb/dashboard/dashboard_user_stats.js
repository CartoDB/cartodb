...
cdb.admin.dashboard.UserStats = cdb.core.View.extend({
  ...
  _removeLimitMessage: function() {
    ...
    if (tableLimit == null && mapviewsLimit == null && spaceLimit == null) this.messages.removeMessage("limits_exceeded");
  ...
  */
  ...
  _checkTrialExpired: function() {
    ...
    if (this.model.get("trial_ends_at")) {
      this.messages.addMessage("trial_ended", this.model.attributes);
    }
