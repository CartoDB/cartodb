...
$(function() {
  ...
  var Dashboard = cdb.core.View.extend({
    ...
    _initModels: function() {
      ...
      this.tables.bind('error', function() {
        //'ERROR FECTHING ROWS, PUT HERE A LOVELY MESSAGE WITH APOLOGIES AND THE LIE THAT WE ARE WORKING ON IT, HAHAHAHA!');
        alert("ERROR");
      });
    },
    ...
    _initViews: function() {
      ...
      // Popular tables
      var popular_tables = this.popular_tables = new cdb.admin.dashboard.PopularTables({
        el: this.$("aside div.content ul:eq(1)")
      });
