...
describe('data/layer-definitions-collection', function () {
  ...
  describe('.setBaseLayer', function () {
    ...
    it('should add high resolution url template if present when base layer is updated', function () {
      ...
      var args = LayerDefinitionModel.prototype.save.calls.mostRecent().args;
