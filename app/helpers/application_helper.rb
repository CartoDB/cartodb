...
module ApplicationHelper
  ...
  def frontend_config
    config = {
      ...
      sql_api_protocol:    Cartodb.config[:sql_api]["private"]["sql_api_protocol"],
      sql_api_domain:      Cartodb.config[:sql_api]["private"]["sql_api_domain"],
      sql_api_endpoint:    Cartodb.config[:sql_api]["private"]["sql_api_endpoint"],
      sql_api_port:        Cartodb.config[:sql_api]["private"]["sql_api_port"],
