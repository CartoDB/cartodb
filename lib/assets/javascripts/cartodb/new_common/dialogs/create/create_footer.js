...
module.exports = cdb.core.View.extend({
  ...
  render: function() {
    ...
    this.$el.html(
      this.template({
        ...
        isLibrary: this.createModel.routerModel.get('library'),
  ...
  _initBinds: function() {
    ...
    this.createModel.routerModel.bind('change:library', this.render, this);
    this.model.bind('change:type_guessing', this.render, this);
    this.add_related_model(this.createModel);
    this.add_related_model(this.createModel.routerModel);
  },
