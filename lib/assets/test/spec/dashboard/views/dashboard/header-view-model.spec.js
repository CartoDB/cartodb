...
const DashboardUrl = require('dashboard/data/dashboard-url-model');
const Router = require('dashboard/common/router-dashboard');
const sharedTests = require('../../shared/header-view-model');

describe('dashboard/views/dashboard/header-view-model', function () {
  beforeEach(function () {
