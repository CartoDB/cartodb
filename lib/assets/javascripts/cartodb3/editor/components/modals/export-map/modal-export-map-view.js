...
var templateError = require('../../../../components/error/error.tpl')
var REQUIRED_OPTS = [
  'renderOpts',
  'modalModel',
  'exportMapModel'
...
module.exports = CoreView.extend({
  ...
  events: {
    ...
    'click .js-modal-close': '_onCancel',
    ...
    if (w === undefined) {
      this.$el.html(
        templateExportMapDownload({
          downloadURL: this._exportMapModel.get('url')
        })
      );
    } else {
      w.focus();
