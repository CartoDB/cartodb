...
module.exports = Backbone.Collection.extend({
  ...
  initialize: function (models, options) {
    ...
    this._analysisDefinitionNodesCollection.bind('change:simple_geom', function (mdl) {
      var layerDefModel = this._layerDefinitionsCollection.findWhere({ source: mdl.get('id') });
      if (layerDefModel) {
        this.saveAnalysisForLayer(layerDefModel);  
      }
    }, this);
  },
