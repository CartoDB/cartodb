...
module.exports = BaseDialog.extend({
  ...
  _analyzeColumn: function(column) {
    ...
    this.analyzedColumns[column.get("name")] = null;

    this.sql.describe(this.query, column.get("name"), function(stats) {

      self.analyzedColumns[column.get("name")] = {"col": column, "stats": stats};

      for (var colname in self.analyzedColumns){
        if (self.analyzedColumns[colname] === null){
          return;
        }
      }
  ...
  _guessMaps: function(){
    ...
    for (var colname in this.analyzedColumns){
      var column = this.analyzedColumns[colname].col; 
      var stats = this.analyzedColumns[colname].stats;
