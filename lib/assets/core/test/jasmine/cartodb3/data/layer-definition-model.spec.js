...
describe('cartodb3/data/layer-definition-model', function () {
  ...
  describe('.isCustomQueryApplied', function () {
    beforeEach(function () {
      ...
      spyOn(this.nodeModel, 'isCustomQueryApplied').and.returnValue(true);
      spyOn(this.model, 'getAnalysisDefinitionNodeModel').and.returnValue(this.nodeModel);
    });

    it('should return true if has custom query applied', function () {
      expect(this.model.isCustomQueryApplied()).toBe(true);
    });
  });
