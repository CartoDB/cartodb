...
describe CartoDB::HiresBatchGeocoder do
  ...
  describe '#upload' do
    ...
    it 'raises error on failure' do
      ...
      end.to raise_error('Geocoding API communication failure: Input parameter validation failed. JobId: 9rFyj7kbGMmpF50ZUFAkRnroEiOpDOEZ Email Address is missing!')
    end
  end
