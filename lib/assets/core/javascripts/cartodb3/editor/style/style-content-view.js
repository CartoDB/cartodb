...
module.exports = CoreView.extend({
  ...
  _onSelectAggregation: function (mdl) {
    ...
    if (mdl.get('selected')) {
      ...
      // if (styleType === 'simple' && Utils.isTVTTable(this._layerDefinitionModel.get('table_name')) && this._userModel.featureEnabled('dot_properties')) {
      if (styleType === 'simple' && Utils.isTVTTable(this._layerDefinitionModel.get('table_name'))) {
        styleType = 'tvt';
      }
