...
describe('TagsSection.vue', () => {
  ...
  describe('Methods', () => {
    it("goToRecentSection: should emit 'sectionChange' with value 'RecentSection' and change URL parameters", async () => {
    ...
    it('getTags: should call getTags and setURLParams', async () => {
      const page = 1;
    ...
    it('goToPage: should call getTags and setURLParams', async () => {
      const page = 2;
      const setURLParams = jest.fn();
    ...
    it('setURLParams: should call router.push with new query parameters', async () => {
