...
module.exports = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    this.createModel.maybePrefetchDatasets();
    this._onChangeListing();
    window.v=this; // TODO remove me
  },
  ...
  _onChangeListing: function() {
    if (this.createModel.isListingSomething()) {
      if (this.listingPane) {
  ...
  _initViews: function() {
    ...
    var navigationView = new NavigationView({
      ...
      user: this.user,
      routerModel: this.createModel.routerModel,
    ...
    if (this.user.canCreateDatasets()) {
      ...
      this._addListingPane('scratch', createEmptyView);
