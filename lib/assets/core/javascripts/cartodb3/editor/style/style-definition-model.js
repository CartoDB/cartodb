...
module.exports = Backbone.Model.extend({
  ...
  setPropertiesFromAutoStyle: function (params) {
    ...
    } else if (params.geometryType === 'polygon') {
      currentAttrs.fill = extendAutoStyleProperties('fill', params.definition['polygon']);
      currentAttrs.stroke = extendAutoStyleProperties('stroke', params.definition['line']);
    } else {
