var StyleShapePropertiesFormModel = require('../../../../../../javascripts/cartodb3/editor/style/style-form/style-properties-form/style-shape-properties-form-model');
...
describe('editor/style/style-form/style-shape-properties-form-model', function () {
  describe('.parse', function () {
    ...
    it('should not provide method if type is not simple or geometry is not point', function () {
      var attrs = StyleShapePropertiesFormModel.prototype.parse(
        this.generateData('simple', 'point')
      );
      expect(attrs.method).toBeDefined();

      attrs = StyleShapePropertiesFormModel.prototype.parse(
        this.generateData('heatmap', 'point')
      );
      expect(attrs.method).not.toBeDefined();
