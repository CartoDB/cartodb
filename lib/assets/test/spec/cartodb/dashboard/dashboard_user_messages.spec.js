describe("cdb.admin.dashboard.Messages", function() {
  ...
  it("should render the messages", function() {
    ...
    messagesHTML      += '<li class="'+c1.cid+'"><div class="inner"><p>This is another message.</p></div></li>';
    messagesHTML      += '<li class="'+c2.cid+'"><div class="inner"><p>This is yet another message.</p><a href="#/close" class="smaller close">x</a></div></li>';
    messagesHTML      += '<li class="'+c3.cid+'"><div class="inner"><p>Ha Ha! upgrade dude!.</p><a href="#/close" class="smaller close">x</a><a class="button small green upgrade" href="-?utm_source=Dashboard_Limits_Reached&amp;utm_medium=referral&amp;utm_campaign=Upgrade_from_Dashboard&amp;utm_content=Upgrade%20now%20%28button%29">Upgrade now</a></div></li>';
    messagesHTML      += '</ul>';
