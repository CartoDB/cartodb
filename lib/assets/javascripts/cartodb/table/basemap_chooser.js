...
cdb.admin.BaseLayerButton = cdb.core.View.extend({
  ...
  bindMap: function(map) {
    ...
    map.layers.bind('reset', this.checkIfSelected, this);
    map.layers.bind('add', this.checkIfSelected, this);
  },
  ...
  */
  checkIfSelected: function() {
    if(this.model.toJSON().options && this.options && this.options.map) {
      var baseLayer = this.options.map.getBaseLayer();
      if(baseLayer && this.model.isEqual(baseLayer)) {
        this.selectButton();
      }
    }
  }
...
cdb.admin.BaseMapChooser = cdb.core.View.extend({
  ...
  _addBackgroundView: function() {
    ...
    if (!this.backgroundMapColorView) {
      this.backgroundMapColorView = new cdb.admin.BackgroundMapColorView({ model: this.model });
    }
