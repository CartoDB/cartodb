...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._editorModel.set({
      edition: !!this._querySchemaModel.get('sql_custom')
    });
  ...
  _saveSQL: function () {
    ...
    this._querySchemaModel.fetch({
      success: self._clearSqlErrors.bind(self)
    });
  },
  ...
  _configPanes: function () {
    var self = this;
    var tabPaneTabs = [{
      selected: !this._querySchemaModel.get('sql_custom'),
