    ...
    describe("when the current baseLayer doesn't have labels", function () {
      ...
      describe("when the new baseLayer doesnt't have labels", function () {
        ...
        describe('when the base layer is saved', function () {
          beforeEach(function () {
            Backbone.Model.prototype.save.calls.argsFor(0)[1].success();
          });

          it('should update the baseLayer', function () {
        ...
        describe('when the base layer is NOT saved', function () {
          beforeEach(function () {
            Backbone.Model.prototype.save.calls.argsFor(0)[1].error();
          });
      ...
      describe('when the new baseLayer has labels', function () {
        ...
        describe('when the base layer is saved', function () {
          ...
          it('should create the labels layer', function () {
            expect(Backbone.Model.prototype.save.calls.count()).toEqual(2);
          ...
          describe('when the labels layer is saved', function () {
            beforeEach(function () {
              Backbone.Model.prototype.save.calls.argsFor(1)[1].success({}, {}, {});
            });
          ...
          describe('when the labels layer is NOT saved', function () {
            beforeEach(function () {
              Backbone.Model.prototype.save.calls.argsFor(1)[1].error();
            });
      ...
      describe("when the new baseLayer doesnt't have labels", function () {
        ...
        describe('when the base layer is saved', function () {
          ...
          describe('when the labels layer is destroyed', function () {
            beforeEach(function () {
              Backbone.Model.prototype.destroy.calls.argsFor(0)[0].success();
            });
          ...
          describe('when the labels layer is NOT destroyed', function () {
            beforeEach(function () {
              Backbone.Model.prototype.destroy.calls.argsFor(0)[0].error();
            });
