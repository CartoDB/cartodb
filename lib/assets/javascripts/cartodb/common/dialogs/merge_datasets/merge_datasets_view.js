...
module.exports = BaseDialog.extend({
  ...
  _onChangeTitle: function() {
    var self = this;
    this._$title().fadeOut(250, function() {
      self._$title().text(self.model.get("title"));
      self._$title().fadeIn(250);
    });
  },

  _onChangeDescription: function() {
    var self = this;
    this._$description().fadeOut(250, function() {
      self._$description().text(self.model.get("description"));
      self._$description().fadeIn(250);
    });
  },

  _onChangeDescriptionTitle: function() {
    var self = this;
    this._$descriptionTitle().fadeOut(250, function() {
      self._$descriptionTitle().text(self.model.get("description_title"));
      self._$descriptionTitle().fadeIn(250);
    });
  },
  ...
  _onChangeEnableBack: function() {
    if (this.model.get("enableBack")) {
      this._$back().fadeIn(250, function() {
        $(this).removeClass("hidden");
      });
    } else {
      this._$back().fadeOut(250, function() {
  ...
  _onRadioClick: function(e) {
    ...
    this._$mergeFlavorList().find(".radiobutton").removeClass("selected");
  ...
  _onToggleMergeFlavorList: function() {
    if (this.model.get("show_merge_flavor_list")) {
      this._$mergeFlavorList().delay(170).slideDown(150);
    } else {
      this._$mergeFlavorList().delay(170).slideUp(150);
    }
  },

  _onToggleTableSelector: function() {
    if (this.model.get("show_table_selector")) {
      this._$tableSelector().delay(100).slideDown(150);
    } else {
      this._$tableSelector().delay(100).slideUp(150);
    }
  },
  ...
  render_content: function() {
    ...
    var $content = $(this.getTemplate('common/dialogs/merge_datasets/merge_datasets_content')(this.model.toJSON()));
  ...
  _$title: function() {
    return this.$('.tables_selector h3');
  },
