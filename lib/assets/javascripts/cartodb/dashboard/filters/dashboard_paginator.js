...
cdb.admin.DashboardPaginator = cdb.core.View.extend({
  ...
  _renderLinks: function() {
    ...
    var $li = $("<li>");
    var $link = $("<a href='#' class='paginator_filter'>1</a>");
  ...
  _renderPrevLink: function() {
    ...
    if (this.current_page - 1 > 0) {
      ...
      if (tag) {
        opts.url = "/" + this.options.what + "/tag/" + tag + "/" + (this.current_page - 1);
      } else if (q) {
        opts.url = "/" + this.options.what + "/search/" + q + "/" + (this.current_page - 1);
      } else {
        opts.url = "/" + this.options.what + "/" + (this.current_page - 1);
      }
