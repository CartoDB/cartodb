...
Backbone.Form.editors.Fill = Backbone.Form.editors.Base.extend({
  ...
  _adjustImageSize: function (mdl) {
    var changedImage = mdl.get('image') && mdl.changed.image && !mdl.previous('image');
    var changedImages = mdl.get('images') && mdl.changed.images && _.isEmpty(_.compact(mdl.previous('images')));
