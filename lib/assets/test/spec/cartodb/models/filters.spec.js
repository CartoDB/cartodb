describe('modules.Filters', function() {
  ...
  describe('cdb.admin.models.Filter (date)', function() {
    ...
    beforeEach(function() {
      ...
      bounds.lower = 360000000000; // Mon Jan 31 1994 08:06:40 GMT+0100 (CET)
      bounds.upper = 760000000000; // Fri May 29 1981 18:00:00 GMT+0200 (CEST)
    ...
    it("should return the condition", function() {
      ...
      expect(model.getSQLCondition()).toEqual(" (c >= ('1981-05-29T18:00:00+02:00') AND c <= ('1994-01-31T08:06:41+01:00')) ");

      // Tests the selection of a small range
      model.set("upper_limit", bounds.upper + 10000);
      expect(model.getSQLCondition()).toEqual(" (c >= ('1981-05-29T18:00:00+02:00') AND c <= ('1994-01-31T08:06:40+01:00')) ");
    });
    ...
    it("should transform a timestamp to a date", function() {
      ...
      expect(date.toString()).toEqual("Thu Jun 18 1981 02:00:00 GMT+0200 (CEST)");
    });
  ...
  describe('FilterDiscrete', function() {
    ...
    it("should return a 'partial' SQL condition when some of the items are selected", function() {
      var sql = model.getSQLCondition();
      expect(sql).toEqual("c IN ('test1','test2') OR c IS NULL ");
    });
    ...
    it("should return sql condition with selected only", function() {
      ...
      var sql = model.getSQLCondition();
      expect(sql).toEqual("c IN ('test2') OR c IS NULL ");
    });
