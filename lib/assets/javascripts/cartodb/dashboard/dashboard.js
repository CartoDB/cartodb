...
<<<<<<< HEAD
=======
      this.visPaginator = new cdb.admin.VisualizationPaginator({
...
>>>>>>> fefff39... Adds new paginator routes. Adds paginator buttons
  ...
  var DashboardRouter = Backbone.Router.extend({
    ...
    visualizations: function(page) {
      ...
      // Visualizations
      dashboard.visualizations.options.set({ tags: "", per_page: dashboard.visualizations._ITEMS_PER_PAGE, type: "derived" });
      dashboard.visualizations.fetch();
