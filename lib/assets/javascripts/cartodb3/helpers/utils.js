...
module.exports = {
   ...
   * Duplicated at lib/assets/javascripts/cartodb/models/models_utils.js to make it available for older models.
   */
  safeTableNameQuoting: function(table_name) {
    if(table_name.indexOf('-') == -1 || table_name[0] == '"' || table_name[table_name.length - 1] == '"') {
      return table_name;
    } else {
      return '"' + table_name + '"';
    }
