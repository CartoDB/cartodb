   ...
   *
      ...
      - Add white shadows for the scroll list
      - Get "aprox" rows in the new table (if it fails?) -> IT COULD KILL THE SERVER
      - Tables select placeholder!
      - ESC when tables select is open (:()
      - Tests though!
