describe("SQL module", function() {
  ...
  it("should qualify tables", function() {
    user.tables = ['table1', 'table2', 'table3'];
    var sql = view.qualifyTables("select * from table1, table2,\"table3\", uu.table");
    expect(sql).toEqual("select * from u.table1, u.table2,\"u.table3\", uu.table");
  });
