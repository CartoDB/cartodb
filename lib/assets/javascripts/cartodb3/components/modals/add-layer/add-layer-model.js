...
module.exports = cdb.core.Model.extend({
  ...
  _addNewLayer: function (tableModel) {
    ...
    var m = this._layerDefinitionsCollection.first();
    ...
    delete attrs.options.infowindow;
    delete attrs.options.tooltip;
    attrs.options.table_name = tableName;
    attrs.options.interactivity = '';
    attrs.options.query = 'SELECT * FROM ' + tableName;
    attrs.options.tile_style = camshaftReference.getDefaultCartoCSSForType();
    attrs.options.cartocss = camshaftReference.getDefaultCartoCSSForType();
