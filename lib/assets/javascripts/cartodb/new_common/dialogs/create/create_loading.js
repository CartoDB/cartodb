...
module.exports = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    this.model = new cdb.core.Model({ state: 'loading' });
  ...
  render: function() {
    ...
    var d = {
      ...
      currentImportName: currentImport && currentImport.upl.get('value'),
      tableIdsArray: this.model.get('tableIdsArray'),
      selectedDatasets: this.model.get('selectedDatasets'),
      quote: randomQuote()
    };
