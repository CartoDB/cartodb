    ...
    this._modals.create(function (modalModel) {
      return new ConfirmationView({
        ...
        renderOpts: {
          ...
          widgetsNumber: this.widgetDefinitionsCollection.widgetsOwnedByLayer(self.model.get('id')),
          analysisNumber: self.model.getNumberOfAnalyses() - 1,
          layersNumber: self.model.getAllDependentLayers()
        },
        runAction: function () {
          removeLayer({
