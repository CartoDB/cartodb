...
module.exports = LegendBaseDefModel.extend({
  ...
  _initialColor: function () {
    var color = this.legendDefinitionModel.get('definition') && this.legendDefinitionModel.get('definition').color || this.layerDefinitionModel.styleModel.get('fill').color;
