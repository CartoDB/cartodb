var DeleteItemsViewModel = require('../../../../../javascripts/cartodb/new_dashboard/dialogs/delete_items_view_model');
  ...
  describe('.affectedVisData', function() {
    ...
    describe('when there are affected vis', function() {
      ...
      beforeEach(function() {
        ...
        this.fakeTableMetadata = function(model, depVisualizations, nonDepVisualizations) {
          spyOn(model, 'tableMetadata').and.returnValue({
            get: function(attr){
      ...
      it('should return a list with the affected vis', function() {
        this.fakeTableMetadata(vis1, [{ id: 'vis2' }], [{ id: 'vis3'}]);
      ...
      it('should NOT return duplicated visualizations', function() {
        this.fakeTableMetadata(vis1, [{ id: 'vis2' }], [{ id: 'vis3'}]);
        this.fakeTableMetadata(vis2, [{ id: 'vis1' }], [{ id: 'vis3'}]);
