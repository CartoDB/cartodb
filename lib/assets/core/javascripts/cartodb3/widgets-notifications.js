...
var WidgetsNotifications = {
  ...
  track: function (widgetsCollection) {
    ...
    this._widgetDefinitionsCollection.on('add', this._showAddNotification, this);
    this._widgetDefinitionsCollection.on('replace', this._showReplaceNotification, this);
