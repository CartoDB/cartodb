  ...
  _fetch: function(opts) {
    ...
    var self = this;
      ...
      // get schema
        ...
        var tmpSchemaAlias = (self.table.get('aliases')) ? (self.table.get('aliases').columns) ?  self.table.get('aliases').columns : {} : undefined;
        if(tmpSchemaAlias !== undefined) {
            process(self);
        }else{
            self.table.fetch(null, function() {
              tmpSchemaAlias = (self.table.get('aliases')) ? (self.table.get('aliases').columns) ?  self.table.get('aliases').columns : {} : undefined;
              process(self);
            }.bind(this));
        }
