...
module Carto
  class AccountType
    ...
    SOFT_GEOCODING_PLANS = "ACADEMIC|Academy|Academic|INTERNAL|FREE|AMBASSADOR|ACADEMIC MAGELLAN|PARTNER|FREE|Magellan|Academy|ACADEMIC|AMBASSADOR|PRO"
    SOFT_GEOCODING_PLANS_REGEXP = /(#{SOFT_GEOCODING_PLANS})/

    DEDICATED_SUPPORT_PLANS_REGEXP = /(FREE|MAGELLAN|JOHN SNOW|ACADEMY|ACADEMIC|ON HOLD|BASIC|PRO)/i
    REMOVE_LOGO_PLANS_REGEXP = /(FREE|MAGELLAN|JOHN SNOW|ACADEMY|ACADEMIC|ON HOLD|BASIC|PRO)/i
