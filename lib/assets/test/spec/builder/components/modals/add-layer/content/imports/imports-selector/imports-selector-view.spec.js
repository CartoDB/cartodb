...
describe('components/modals/add-layer/content/imports/imports-selector/imports-selector-view', function () {
  ...
  describe('_checkImportStatus', function () {
    it('should return the status of the import', function () {
      expect(['enabled', 'disabled', 'beta']).toContain(this.view.model._checkImportStatus(importOptions.BigQuery));
      expect(['enabled', 'disabled', 'beta']).toContain(this.view.model._checkImportStatus(importOptions.GDrive));
    });
  });
});
