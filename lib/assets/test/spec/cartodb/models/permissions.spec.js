describe('cdb.admin.Permission', function() {
  ...
  describe('.revokeAccess', function() {
    describe('when model has own ACL item', function() {
      beforeEach(function() {
        this.permission.acl.add(this.permission._newAclItem(user1, cdb.admin.Permission.READ_ONLY));
  ...
  describe('access', function() {
    beforeEach(function() {
      ...
      this.permission.acl.add(this.permission._newAclItem(this.groupX, cdb.admin.Permission.READ_ONLY));
      this.groupA = new cdb.admin.Group({ id: 'ga' });
      this.permission.acl.add(this.permission._newAclItem(this.groupA, cdb.admin.Permission.READ_ONLY));
      this.groupB = new cdb.admin.Group({ id: 'gb' });
      this.permission.acl.add(this.permission._newAclItem(this.groupB, cdb.admin.Permission.READ_WRITE));
    });
  ...
  it("toJSON", function() {
    ...
    expect(model.toJSON()).toEqual({
      ...
      acl: [
        { type: 'user', entity: { id: 'uuid', username: 'u1', avatar_url : 'http://cartodb.s3.dualstack.us-east-1.amazonaws.com/static/public_dashboard_default_avatar.png' }, access: 'r' },
        { type: 'user', entity: { id: 'uuid2', username: 'u2', avatar_url : 'http://cartodb.s3.dualstack.us-east-1.amazonaws.com/static/public_dashboard_default_avatar.png' }, access: 'rw' }
      ]
    });
  });
