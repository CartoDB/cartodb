...
FactoryGirl.define do
  ...
  factory :carto_user, class: Carto::User do
    ...
    trait :mfa_setup do
      after :create do |carto_user|
        carto_user.user_multifactor_auths << FactoryGirl.create(:totp, user_id: carto_user.id)
      end
    end

    trait :mfa_enabled do
      after :create do |carto_user|
        carto_user.user_multifactor_auths << FactoryGirl.create(:totp, user_id: carto_user.id, enabled: true)
      end
    end
