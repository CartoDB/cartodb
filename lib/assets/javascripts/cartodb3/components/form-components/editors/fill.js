...
Backbone.Form.editors.Fill = Backbone.Form.editors.Base.extend({
  ...
  _initInputFields: function () {
    ...
    data = {
      categories: {
        categories: [
          { title: 'Lorem', title_type: 'string', color: '#FF2900', value_type: 'color' },
          { title: 'Ipsum', title_type: 'string', color: '#1F78B4', value_type: 'color' },
          { title: 'Consectetur', title_type: 'string', color: '#B2DF8A', value_type: 'color' },
          { title: 'Veritatis', title_type: 'string', color: '#33A02C', value_type: 'color' },
          { title: 'Quasi', title_type: 'string', color: '#FB9A99', value_type: 'color' },
          { title: 'Deserunt', title_type: 'string', color: '#E31A1C', value_type: 'color' },
          { title: 'Similique', title_type: 'string', color: '#FDBF6F', value_type: 'color' }
        ]
      }
    };
