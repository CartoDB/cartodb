describe("Filter view", function() {
  ...
  it("should disable/enable the filter tags view when collection is fetched", function() {
    ...
    server.respondWith('/api/v1/tags?type=table', [200, { "Content-Type": "application/json" }, '[{ "name" : "paco", "count": 5 }]']);
    server.respond();
