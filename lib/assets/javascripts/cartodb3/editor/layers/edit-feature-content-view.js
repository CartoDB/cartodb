...
module.exports = CoreView.extend({
  ...
  _onDestroyFeatureFailed: function (mdl, error) {
    this.notification.set({
      status: 'error',
      info: _t('notifications.edit-feature.error.body', {
        body: NOTIFICATION_ERROR_TEMPLATE({
          title: _t('notifications.edit-feature.destroy.error.title')
        }),
  ...
  _onSaveFeatureFailed: function (mdl, error) {
    this.notification.set({
      ...
      info: _t('notifications.edit-feature.error.body', {
        body: NOTIFICATION_ERROR_TEMPLATE({
          title: _t('notifications.edit-feature.save.error.title')
        }),
        error: errorParser(error)
      }),
      closable: true
