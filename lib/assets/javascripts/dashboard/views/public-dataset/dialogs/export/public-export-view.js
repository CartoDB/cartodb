  ...
  render: function () {
    ...
    if (_.isBoolean(isGeoreferenced)) {
      this.$el.html(templatePublicExport({
        preparingDownloadContent: this._renderLoadingContent(_t('dashboard.views.public_dataset.dialogs.preparing')),
      ...
      this.$el.html(this._renderLoadingContent(_t('dashboard.views.public_dataset.dialogs.checking')));
    }
