...
cdb.admin.MetadataForm = cdb.core.View.extend({
  ...
  _initCategoryCombos: function() {
    ...
    var isParentCategory = categoryItem ? (categoryItem.parent_id == this._DATASETS_CATEGORY || categoryItem.parent_id == this._MAPS_CATEGORY) : false;
    this.model.set('parent_category', categoryItem ? (isParentCategory ? categoryItem.id : categoryItem.parent_id) : -1);
    ...
    this._subCategoryDropdown = new cdb.forms.Combo({
      ...
      extra: this._getCategoriesForFormsCombo(categoryItem ? (isParentCategory ? categoryItem.id : categoryItem.parent_id): -1, 'Select a sub-category...')
