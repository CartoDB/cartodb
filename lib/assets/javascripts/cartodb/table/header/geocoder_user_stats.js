  ...
  cdb.admin.GeocoderStats = cdb.core.View.extend({
    ...
    _TEXTS: {
      ...
      not_enough_hard: _t('<strong>Only first <%= quota - monthly_use %> rows will be geocoded</strong> under your plan this month.'),
      not_enough_soft: _t('<strong>First <%= quota - monthly_use %> rows available</strong> under your plan, next <strong>$<%= block_price %> per row</strong>.'),
