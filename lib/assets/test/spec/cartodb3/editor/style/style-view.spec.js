...
var CartoCSSModel = require('cartodb3/editor/style/style-cartocss-model');
...
describe('editor/style/style-view', function () {
  ...
  describe('._createControlView', function () {
    it('should return a Toggler with togglerModel as model', function () {
      var toggler = this.view._createControlView();

      expect(toggler instanceof Toggler).toBe(true);
      expect(toggler.model).toEqual(this.view._togglerModel);
    });
  });

  describe('._createActionView', function () {
    it('should return a TabPaneView with ', function () {
      var tabPaneView = this.view._createActionView();

      expect(tabPaneView instanceof TabPaneView).toBe(true);
      expect(tabPaneView.collection).toEqual(this.view._collectionPane);
