...
module.exports = {
  ...
  addTwitterMeta: function (vizdata, mapOwnerUser) {
    ...
    var twitterImage = mapOwnerUser.get('twitter_image');
    ...
    $metaSite.setAttribute('content', '@cartodb');
    ...
    $metaImage.setAttribute('content', twitterImage);
    document.head.appendChild($metaImage);

    return this;
  },

  addFacebookMeta: function (vizdata, image, mapOwnerUser) {
    var SITE_NAME = 'CARTO';
    var TYPE = 'article';
