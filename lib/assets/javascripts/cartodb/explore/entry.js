...
var ExploreModel = require('../common/views/explore/model');
...
$(function() {
  cdb.init(function() {
    ...
    var data = _.extend({ q: this.exploreModel.generateQuery() });
    ...
    this.exploreModel.fetch({ data: data, success: onSuccess });
