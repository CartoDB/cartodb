cdb.admin.CartoDBLayer = cdb.geo.CartoDBLayer.extend({
  ...
  bindLegend: function(legend) {
    ...
    this.legend.bind('change:template change:type change:title change:show_title change:items change:style', _.debounce(function() {
      // call with silent so the layer is not reloaded
