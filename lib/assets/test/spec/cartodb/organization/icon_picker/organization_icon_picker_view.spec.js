var IconPickerView = require('../../../../../javascripts/cartodb/organization/icon_picker/organization_icon_picker_view.js');
...
describe('organization/icon_picker/organization_icon_picker_view', function () {
  ...
  describe('_onIconDeleted', function () {
    it('should set icon model to `deleted`, refresh actions and add another icon from the non visible ones', function () {
