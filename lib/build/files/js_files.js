...
module.exports = files = {
  ...
  _new_dashboard_templates: [
    'lib/assets/javascripts/cartodb/new_dashboard/common/**/*.jst.ejs',   // Common templates (right now inside new-dashboard)
    'lib/assets/javascripts/cartodb/new_dashboard/**/*.jst.ejs'           // New dashboard templates
  ],
