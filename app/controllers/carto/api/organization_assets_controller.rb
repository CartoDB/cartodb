  ...
  module Api
    class OrganizationAssetsController < ::Api::ApplicationController
      ...
      def create
        ...
        raise UnprocesableEntityError.with_full_messages(e)
      end
      ...
      def organization_members_only
        raise UnauthorizedError.new unless current_viewer.belongs_to_organization?(@organization)
      end
      ...
      def load_resource
        ...
        raise UnprocesableEntityError.new('Missing resource for asset') unless @resource.present?
      end
