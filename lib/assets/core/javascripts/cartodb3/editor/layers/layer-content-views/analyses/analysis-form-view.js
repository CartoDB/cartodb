...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._link = this._formModel._analyses.MAP[this._formModel.attributes.type].modalLink;
  ...
  render: function () {
    ...
    this._formView = new Backbone.Form({
      ...
      templateData: _.extend(
        this._formModel.getTemplateData(),
        {linkContent: linkTemplate({link: this._link})}
      )
    });
