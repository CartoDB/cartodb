<form>
  ...
  <div class="CDB-HeaderInfo">
    ...
    <div class="CDB-HeaderInfo-Inner CDB-Text">
      ...
      <div class="u-tSpace-xl CDB-Text">
        <p class="CDB-Legend u-upperCase u-iBlock CDB-Text is-semibold CDB-Size-small u-rSpace--m"><%- _t('editor.layers.analysis-form.radio') %></p>
        <div class="CDB-Text CDB-Size-medium u-iBlock" data-editors="radio"></div>
      </div>
    </div>
  </div>
</form>
