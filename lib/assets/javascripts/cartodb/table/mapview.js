    ...
    _addLayer: function(layer, layers, opts) {
      ...
      if (layer.get('type') === 'CartoDB') {
        ...
        if(!this.groupLayer) {
          ...
          // HACK: Set the attribution of the layer in the groupLayer model so that
          // cdb.admin.[Leaflet|GoogleMaps]MapView._addLayerToMap adds the new attribution
          // to the map.
          this.groupLayer.model.set('attribution', layer.get('attribution'));
