      ...
      schema = _.extend(schema, {
        ...
        aggregate_operation: {
          ...
          options: [
            {
              val: 'sum',
              label: _t('editor.layers.aggregate-functions.sum')
            }, {
              val: 'avg',
              label: _t('editor.layers.aggregate-functions.avg')
            }, {
              val: 'min',
              label: _t('editor.layers.aggregate-functions.min')
            }, {
              val: 'max',
              label: _t('editor.layers.aggregate-functions.max')
            }
          ],
          validators: ['required']
        }
