...
var MamufasDialog = require('new_dashboard/dialogs/mamufas_import_dialog_view');
...
module.exports = cdb.core.View.extend({
  ...
  _initBinds: function() {
    ...
    $body.on('drop', function (e) {
      e.preventDefault();
      self.trigger('onDrop', e.originalEvent.dataTransfer.files, this);
      self.mamufasDialog.bind('hide', self._destroyDialog, self);
      self.mamufasDialog.close();
      self.model.set('visible', false);
      $dropable.add($body).removeData('dragCount');
    });
  },
