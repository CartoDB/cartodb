...
module.exports = CoreView.extend({
  ...
  _defaultSQL: function () {
    var tableName = SQLUtils.getUnqualifiedName(this._layerDefinitionModel.getTableName());
    var userName = this._layerDefinitionModel.get('user_name');
    var isInOrganization = this._userModel.isInsideOrg();
    var query = 'SELECT * FROM ' + tableName;

    if (isInOrganization && userName) {
