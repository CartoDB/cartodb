  ...
  cdb.admin.dashboard.StartView = cdb.core.View.extend({
    ...
    _initBinds: function() {
      ...
      this.model.bind('change',             this._setupStartView, this);
    ...
    _decideActiveBlock: function() {
      ...
      this.$(".empty_search").fadeOut(100);

      var path = this.model.get('model');
      var what = ( this.model.get('q') && 'search' ) || ( this.model.get('tag') && 'tag' ) || '';
    ...
    */
    ...
    _navigateToVisualizations: function() {
