...
module.exports = CoreView.extend({
  ...
  _orderImports: function (importOptions, importOptionsOrder) {
    ...
    const importOptionsKeys = Object.keys(importOptions);
    importOptionsOrder.forEach(function (key) {
      if (importOptionsKeys.includes(key)) {
        orderedOptions.set(key, importOptions[key]);
      }
    });
  ...
  _filterImportsByType: function (type) {
    ...
    imports.forEach(function (value, key) {
      if (value.type === type) {
