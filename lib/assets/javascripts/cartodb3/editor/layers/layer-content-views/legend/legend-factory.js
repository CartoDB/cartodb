...
var CategoryModel = require('cartodb3/data/legends/legend-category-definition-model');
var BubbleModel = require('cartodb3/data/legends/legend-bubble-definition-model');
var ChoroplethModel = require('cartodb3/data/legends/legend-choropleth-definition-model');
var CustomChoroplethModel = require('cartodb3/data/legends/legend-custom-choropleth-definition-model');
var CustomModel = require('cartodb3/data/legends/legend-custom-definition-model');
var TorqueModel = require('cartodb3/data/legends/legend-torque-definition-model');
