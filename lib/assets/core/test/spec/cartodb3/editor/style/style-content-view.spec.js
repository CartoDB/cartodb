...
describe('editor/style/style-content-view', function () {
  ...
  describe('._initBinds', function () {
    ...
    it('should fetch all query objects when query-geometry-model query has changed', function () {
      StyleContentView.prototype._fetchAllQueryObjectsIfNecessary.calls.reset();
      this.queryGeometryModel.set('query', 'dummy query');
      expect(this.queryGeometryModel.get('status')).toBe('unfetched');
      expect(StyleContentView.prototype._fetchAllQueryObjectsIfNecessary.calls.count()).toBe(1);
    });
  });
