...
var StyleContentView = require('cartodb3/editor/style/style-content-view');
...
var styleSQLErrorTemplate = require('cartodb3/editor/style/style-content-sql-error.tpl');
...
describe('editor/style/style-content-view', function () {
  ...
  describe('.render', function () {
    ...
    it('should call _showEmptyData if there is no data', function () {
      this.view._isDataEmpty = true;
      var showEmptyDataSpy = spyOn(this.view, '_showEmptyData');
  ...
  describe('._showEmptyData', function () {
    it('should render the empty data message properly', function () {
      this.view.render();
      this.view._showEmptyData();

      expect(this.view.$el.text().trim().indexOf('editor.messages.no-data.message') > -1).toBeTruthy();
      expect(this.view.$el.text().trim().indexOf('editor.messages.no-data.action-message') > -1).toBeTruthy();
    });
  });
