...
describe('common/dialogs/duplicate_dataset_view', function() {
  ...
  describe('when duplication finishes successfully', function() {
    ...
    beforeEach(function() {
      ...
      newTable.viewUrl.and.returnValue('https://cartodb.com/user/pepe/table/my_table_copy');
    ...
    it("should redirect to the new table's edit page", function() {
      expect(this.view._redirectTo).toHaveBeenCalledWith('https://cartodb.com/user/pepe/table/my_table_copy');
    });
  });
