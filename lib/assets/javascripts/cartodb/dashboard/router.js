...
module.exports = Router.extend({
  ...
  routes: {
    ...
    // If URL is lacking the trailing slash (e.g. 'http://username.carto.com/dashboard_static'), treat it like index
    'dashboard_static': '_changeRouteToMaps',
    'dashboard_static?:queries': '_changeRouteToMaps',
    '*prefix/dashboard_static': '_changeRouteToMaps',
    '*prefix/dashboard_static?:queries': '_changeRouteToMaps',
