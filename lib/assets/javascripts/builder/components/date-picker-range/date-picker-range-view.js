...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    var isDisabled = opts && opts.disabled;
  ...
  _setValues: function () {
    ...
    var _formattedDate = function (which) {
    ...
    if (data.fromDate && data.toDate) {
      ...
      text = _formattedDate('from') + ' ' + _formattedDate('to') + calendarIcon;
    }
  ...
  _setLastFourHours: function () {
    this._setPreviousTime(4, 'hours');
  },

  _setLastDay: function () {
    this._setPreviousTime(1, 'day');
  },

  _setLastWeek: function () {
    this._setPreviousTime(1, 'week');
  },

  _setPreviousTime: function (amount, unit) {
    var previous = moment().utc(0).subtract(amount, unit);
    this._setModelFromPrevious(previous);
