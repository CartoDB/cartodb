...
var FeatureDefinitionModel = Backbone.Model.extend({
  ...
  _onChange: function () {
    _.each(this.changed, function (value, key) {
      if (!_.contains(this._changedHistory, key)) {
        this._changedHistory.push(key);
      }
    }, this);
  },

  hasBeenChangedAfterLastSaved: function (key) {
    return _.contains(this._changedHistory, key);
  },
