...
module.exports = BaseLayerAnalysisView.extend({
  ...
  _renderSecondaryNode: function () {
    ...
    var view = nodeIds.letter(this.model.id) === nodeIds.letter(secondarySourceModel.id)
      ? this._createSourceNodeView(secondarySourceModel)
      : this._createRefLayerNodeView(secondarySourceModel);
  ...
  _createRefLayerNodeView: function (secondarySourceModel) {
    var otherLayerDefModel = this._layerDefinitionModel.collection.find(function (m) {
