...
module.exports = Backbone.Collection.extend({
  ...
  moveLayer: function (options) {
    ...
    this.add(movingLayer, { at: to, parse: false });
  ...
  save: function (options) {
    var promises = this.map(function (layerDefModel) {
  ...
  model: function (d, opts) {
    ...
    var m = new LayerDefinitionModel(attrs, {
      parse: opts.parse === false ? false : true, // make sure data is structured as expected
      collection: self,
  ...
  // TODO: Move to analysisDefinitionsCollection
