...
beforeEach(function() {
  this.addMatchers({
    toHaveNoLeaks:function() {
      ...
      var linked = TestUtil.linkedObjects(this.actual);
      if (linked.length) {
      ...
      this.message = function() {
        return [
          "Expected objects not linked (" + linked.length + "), check the console"
        ];
      };
...
TestUtil.checkView = function(v, name) {
  name = name || v.cid;
  it("should not have leaks: " + name, function() {
    TestUtil.assertNotLeaks(v);
  });
};
