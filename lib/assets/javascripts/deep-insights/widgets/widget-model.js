...
module.exports = cdb.core.Model.extend({
  ...
  initialize: function (attrs, models, opts) {
    ...
    this._getColumnNames().then(columns => this.set('layerColumns', columns));
  },
  ...
  _getColumnNames: function () {
    ...
    var sqlApiUrl = window.configModel.getSqlApiUrl();
    if (!tableName) {
    ...
    return fetch(url)
      ...
      .then(jsonResponse => Object.keys(jsonResponse.fields));
  },
  ...
  _modelHasRequiredColumns: function () {
    return this.get('layerColumns').includes(this.dataviewModel.get('column'));
  },
