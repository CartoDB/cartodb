...
module.exports = cdb.core.View.extend({
  ...
  _showSuccess: function (model, response) {
    this._setFlashMessage(response, _t('account.flash_messages.save_changes.success'), 'success');
  },

  _showErrors: function (model, response) {
    this._setFlashMessage(response, _t('account.flash_messages.save_changes.error'), 'error');
  }
});
