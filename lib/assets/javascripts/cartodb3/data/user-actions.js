...
module.exports = function (params) {
  ...
  return {
    _resetStylePerNode: function (nodeDefModel, layerDefModel, forceStyleUpdate) {
      resetStylePerNode(nodeDefModel, layerDefModel, forceStyleUpdate);
    },
    ...
    createLayerForAnalysisNode: function (nodeId, cfg) {
      ...
      var onNewLayerSaved = function (layer, resetStyles) {
        if (resetStyles) {
          this._resetStylePerNode(layer.getAnalysisDefinitionNodeModel(), layer, true);
        }
      ...
      if (prevLayer) {
        if (nodeDefModel.hasPrimarySource()) {
          ...
          this._resetStylePerNode(prevLayer.getAnalysisDefinitionNodeModel(), prevLayer, true);
