var LayerView = require('cartodb3/components/modals/add-basemap/wms/wms-layer-view');
var LayerModel = require('cartodb3/components/modals/add-basemap/wms/wms-layer-model');
var ConfigModel = require('cartodb3/data/config-model');
var CustomBaselayersCollection = require('cartodb3/data/custom-baselayers-collection');
var CustomBaselayerModel = require('cartodb3/data/custom-baselayer-model');
var WMSService = require('cartodb3/data/wms-service');
