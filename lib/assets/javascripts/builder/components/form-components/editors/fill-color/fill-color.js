...
Backbone.Form.editors.FillColor = Backbone.Form.editors.Base.extend({
  ...
  _getSelectedTabPaneIndex: function () {
    ...
    return this.model.get(this._colorKeyAttribute).range &&
  ...
  _getFillFixedValues: function () {
    ...
    var colorAttributes = _.omit(this._fixedColorInputModel.toJSON(), colorOmitAttributes);
    var imageAttributes = _.omit(this._imageInputModel.toJSON(), imageOmitAttributes);
