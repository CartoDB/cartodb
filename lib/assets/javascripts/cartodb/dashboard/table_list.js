(function() {
  ...
  var TableList = cdb.core.View.extend({
    ...
    initialize: function() {
      window.tl =  this;
      _.bindAll(this, "render", "hardRender", "_updateListHeader", "_addAll", "_addTable", "_removeAllPrivacy", "markForDeletion");
      _.defaults(this.options, this.default_options);
    ...
    _addTable: function(m) {
      ...
      this.addView(li);
      this._updateListHeader();
      li.bind('saving', this._showLoader)
      li.bind('saved', this._hideLoader)
