...
module.exports = CoreView.extend({
  ...
  _initColorByValueInput: function () {
    if (this._valueColorInputModel.get('quantification') && QUANTIFICATION_REF[this._valueColorInputModel.get('quantification')]) {
      this._valueColorInputModel.set(
        'quantification',
        QUANTIFICATION_REF[this._valueColorInputModel.get('quantification')], { silent: true });
    }
    ...
    this._inputCollection && this._inputCollection.push(this._valueColorInputView);
  },
