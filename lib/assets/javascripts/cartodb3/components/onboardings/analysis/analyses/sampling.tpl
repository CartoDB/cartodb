  ...
  <div class="Onboarding-body">
    ...
    <ul class="Onboarding-list">
      <li class="Onboarding-listItem">
        <div class="CDB-Text Onboarding-listItemValue">pred_value</div>
        <p class="CDB-Text Onboarding-description">contains the resulting value based on your given input columns</p>
      </li>
      <li class="Onboarding-listItem">
        <div class="CDB-Text Onboarding-listItemValue">pred_value</div>
        <p class="CDB-Text Onboarding-description">contains the resulting value based on your given input columns</p>
