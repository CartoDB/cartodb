  ...
  */
  ...
  cdb.admin.dashboard.Visualizations = cdb.core.View.extend({
    ...
    initialize: function() {
      ...
      this.$no_vis_view = $('article.no_vis');           // No visualization block
