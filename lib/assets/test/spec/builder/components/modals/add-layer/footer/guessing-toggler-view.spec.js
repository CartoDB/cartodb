...
describe('components/modals/add-layer/footer/guessing-toggler-view', function () {
  ...
  describe('when twitter import is active', function () {
    ...
    it('should display how to get historical data when user has their own credentials', function () {
    ...
    it('should display a deprecated warning if user does not have their own credentials', function () {
