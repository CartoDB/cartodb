...
var editorTabPaneView = createEditorMenuTabPane([
  {
    ...
    createContentView: function () {
      return new SettingsView({
        ...
        modals: modals,
        editorModel: editorModel,
        settingsCollection: new Backbone.Collection(SettingsOptions(vizJSON.overlays, mapDefModel, userModel))
      });
    }
  }
], {
...
deepInsights.createDashboard('#dashboard', vizJSON, {
  ...
  mapDefModel.setVis(vis);
  overlaysCollection.setMirrorCollection(vis.overlaysCollection);
