...
describe('cartodb3/data/user-actions', function () {
  ...
  describe('.deleteLayer', function () {
    ...
    describe('when given a layer with a source pointing to source of another layer', function () {
      beforeEach(function () {
      ...
      it('should just delete the layer and leave the nodes alone', function () {
        expect(this.layerDefinitionsCollection.pluck('id')).toEqual(['basemap', 'A', 'B', 'C', 'D', 'E'], 'should exclude X');
        expect(this.analysisDefinitionNodesCollection.pluck('id').sort()).toEqual(['a0', 'a1', 'b0', 'b1', 'b2', 'c1', 'c2', 'd1', 'd2', 'e1']);
      });
    });
  });
