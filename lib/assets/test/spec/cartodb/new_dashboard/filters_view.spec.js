...
describe('new_dashboard/filters_view', function() {
  ...
  describe('and click change privacy', function() {
    ...
    it('should created dialog with selected items', function() {
      expect(this.createdWith).toEqual(jasmine.objectContaining({ vis: this.collection.at(1) }));
    });

    it('should created dialog with current user', function() {
      expect(this.createdWith).toEqual(jasmine.objectContaining({ user: this.user }));
    });

    it('should created dialog with upgrade URL', function() {
      expect(this.createdWith).toEqual(jasmine.objectContaining({ upgradeUrl: '/upgrade' }));
    });
