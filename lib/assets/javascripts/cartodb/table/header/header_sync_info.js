  ...
  cdb.admin.SyncInfo = cdb.core.View.extend({
    ...
    _SYNC_GAP: 5,  // Gap necessary to perform next synchronization
                    // Value in minutes
    ...
    _onClickOptions: function(e) {
      ...
      if (this.sync_settings) this.sync_settings.clean();
      
      var dlg = this.sync_settings = new cdb.admin.SyncSettings({
        table: this.table
      });
