    ...
    */
    ...
    _initModels: function() {
      ...
      this.map.bind('change:dataLayer', _.once(function() {
        ...
        self.table.bind('columnRename columnDelete columnAdded', function() {
        ...
        self.sqlView.bind('reset', function() {
          ...
          if(data.isGeoreferenced() && self.menu.activeSection === 'map') {
            self.menu.showTools('map', true);
            return;
          }
          self.menu.showTools('mapLite', true);
        }, this);
    ...
    _initViews: function() {
      ...
      this.map.bind('change:dataLayer', _.once(function() {
        ...
        var addGeom = self.menu.addToolButton('add_row', ['mapLite', 'map']);
        addGeom.bind('click', function() {
          self.mapTab.addGeometry();
        });
