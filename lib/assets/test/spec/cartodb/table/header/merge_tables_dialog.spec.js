describe("MergeDialog", function() {
  ...
  describe("MergeTablesDialog", function() {
    ...
    it("should generate a well formated REGULAR query (1/4)", function() {
      ...
      var queryResult = "SELECT a.the_geom, a.field_a, a.field_b, a.field_c, b.the_geom AS b_the_geom, b.field_d, b.field_e FROM a FULL OUTER JOIN b ON LOWER(a.field_a) = LOWER(b.field_d)";
    ...
    it("should generate a well formated REGULAR query (2/4)", function() {
      ...
      var queryResult = "SELECT a.the_geom, a.field_a, a.field_b, a.field_c, b.the_geom AS b_the_geom, b.field_d, b.field_e FROM a FULL OUTER JOIN b ON LOWER(a.field_b) = LOWER(b.field_d)";
    ...
    it("should generate a well formated REGULAR query (3/4)", function() {
      ...
      var queryResult = "SELECT a.the_geom, a.field_a, a.field_b, a.field_c, b.the_geom AS b_the_geom, b.field_d, b.field_e FROM a FULL OUTER JOIN b ON LOWER(a.field_a) = LOWER(b.field_e)";
    ...
    it("should generate a well formated REGULAR query (4/4)", function() {
      ...
      var queryResult = "SELECT a.the_geom, a.field_a, b.the_geom AS b_the_geom, b.field_d, b.field_e FROM a FULL OUTER JOIN b ON LOWER(a.field_a) = LOWER(b.field_d)";
