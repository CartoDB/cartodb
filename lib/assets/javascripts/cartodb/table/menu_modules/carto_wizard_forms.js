  ...
  'point': [
    {
      ...
      form: {
        ...
        // see issue #1166 on github, for related bug report and discussion.
        'layer-type': { type: 'hidden', value: 'torque' },
        'marker-file': { type: 'hidden', value: 'url(/marker/alphamarker.png)' },
        'image-filters': { type: 'hidden', value: 'colorize-alpha(blue, cyan, green, yellow , orange, red)' },
        'torque-trails': { type: 'hidden', value: 0 },
    ...
    },
    {
      name: 'Steps',
      form: {
        'torque-frame-count': { type: 'select', value: 1, extra: [1, 64, 128, 256, 512, 1024, 2048] }
      }
    },
