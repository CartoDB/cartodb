...
module.exports = {
  ...
  track: function (options) {
    ...
    this._invalidateMap = this._diDashboardHelpers.invalidateMap.bind(this._diDashboardHelpers);
  ...
  _tryToSetupDefinitionNodeSync: function (m) {
    ...
    if (node.get('type') !== 'source') {
      ...
      m.listenTo(m.querySchemaModel, 'resetDueToAlteredData', this._invalidateMap);
    }
  }
