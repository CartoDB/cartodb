...
module.exports = Backbone.Model.extend({
  ...
  validate: function(attrs) {
    ...
    if (attrs.type === "file") {
      ...
      // File size
      if ((this.user.get('remaining_byte_quota') * UploadConfig.fileTimesBigger) < attrs.value[0].size) return "Unfortunately the size of the file is bigger than your remaining quota"
      // File extension
