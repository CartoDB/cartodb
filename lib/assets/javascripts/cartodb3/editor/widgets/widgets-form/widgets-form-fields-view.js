...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    this._widgetFormModel.bind('change:auto_style_definition', function (m, changed) {
      var previousAutoStyleDefinition = m.previous('auto_style_definition');
      if (_.isEmpty(previousAutoStyleDefinition) && !_.isUndefined(previousAutoStyleDefinition)) {
        this._widgetFormModel.updateSchema();
        this.render();
      }
    }, this);
