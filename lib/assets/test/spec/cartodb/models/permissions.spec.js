describe('cdb.admin.Permission', function() {
  ...
  describe('.getPermission', function() {
    it('should be deprecated; uses has-access methods internally', function() {
      this.permission.grantReadAccess(user1);
      expect(this.permission.getPermission(user1)).toEqual('r');

      this.permission.grantWriteAccess(user1);
      expect(this.permission.getPermission(user1)).toEqual('rw');

      expect(this.permission.getPermission(user2)).toEqual(null);
    });
  });
