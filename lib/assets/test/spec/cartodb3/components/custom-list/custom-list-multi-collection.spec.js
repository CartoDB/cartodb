var CustomListItemModel = require('cartodb3/components/custom-list/custom-list-item-model');
var CustomListCollection = require('cartodb3/components/custom-list/custom-list-multi-collection');
