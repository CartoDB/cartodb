...
module.exports = Backbone.Router.extend({
  ...
  enableAfterMainView: function() {
    ...
    Backbone.history.start({
      pushState:  true,
      root:       this.currentUserUrl.toStr() +'/' //Yes, this trailing slash is necessary for the router to update the history state properly.
    });
  },

  _normalizeFragmentOrUrl: function(str) {
    return str.replace(this.currentUserUrl.toStr(), '');
  }
});
