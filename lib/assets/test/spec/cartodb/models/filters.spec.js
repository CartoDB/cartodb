describe('modules.Filters', function() {
  ...
  describe('cdb.admin.models.Filter (date)', function() {
    ...
    beforeEach(function() {
      ...
      bounds.lower = 360000000;
      bounds.upper = 760000000;
    ...
    it("should return the condition", function() {
      expect(model.getSQLCondition()).toEqual(" (c >= date('Fri, 29 May 1981 16:00:00 GMT') AND c < date('Mon, 31 Jan 1994 07:06:40 GMT')) ");
    });

    it("should transform a timestamp to a date", function() {
      var timestamp = 361670400;
