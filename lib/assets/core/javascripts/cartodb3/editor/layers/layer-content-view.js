  ...
  _renderLayerTabPaneView: function () {
    ...
    var tabPaneTabs = [{
      ...
      createContentView: function () {
        ...
        analysisFormsCollection.resetByLayerDefinition(AnalysesService.getNotApplied());
        ...
        if (_.isString(analysisPayload)) {
          if (selectedNodeId && analysisFormsCollection.find(selectedNodeId)) {
            selectedNodeId = analysisPayload;
          } else {
            selectedNodeId = layerDefinitionModel.get('source');
          ...
          AnalysesService.saveAnalysis(analysisPayload);
