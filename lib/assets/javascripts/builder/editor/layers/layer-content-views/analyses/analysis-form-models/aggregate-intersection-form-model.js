...
module.exports = BaseAnalysisFormModel.extend({
    ...
    BaseAnalysisFormModel.prototype._setSchema.call(this, this._filterSchemaFieldsByType({
      ...
      target: {
        ...
        editorAttrs: {
          ...
          column: 'column',
          nodeDefModel: this._getTargetNodeDef(),
          configModel: this._configModel
        }
      },
      aggregate: {
  ...
  _fetchColumns: function () {
    ...
    var nodeDefModel = this._getTargetNodeDef();
  ...
  _getTargetNodeDef: function () {
    var target = this.get('target');
    return this._layerDefinitionModel.findAnalysisDefinitionNodeModel(target);
  },
