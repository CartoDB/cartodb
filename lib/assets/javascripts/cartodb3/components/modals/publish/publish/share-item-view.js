...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._isDisabled = this.model.get('disabled');
    ...
    if (this.model.isPrivate()) {
      ...
      this._body = _t('components.modals.publish.share.' + this._type + '.disabled.body');
    } else {
    ...
    this.$el.toggleClass('is-disabled', this.model.isPrivate() || this._isDisabled);
  },
  ...
  render: function () {
    ...
    this.$el.empty();
    this._initViews();
    if (!this.model.isPrivate() && this._isPublished && !this._isDisabled) {
      this._initClipboard();
    }
    return this;
  },
