...
F.prototype._formatWidgetAttrs = function (changedAttrs, widgetDefModel) {
  ...
  if (_.isString(formattedAttrs.source)) {
    ...
    formattedAttrs.source = {id: formattedAttrs.source};
  }

  if (formattedAttrs.widget_style_definition || formattedAttrs.auto_style_allowed || formattedAttrs.auto_style_definition) {
