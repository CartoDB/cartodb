...
module.exports = cdb.core.View.extend({
  ...
  initialize: function (opts) {
    ...
    var retryIfRejected = this._analysisDefinitionNodeModel.fetchOutputGeometryType().state() !== 'resolved';
    this._analysisDefinitionNodeModel
      .fetchOutputGeometryType(retryIfRejected)
  ...
  render: function (outputGeometry) {
    ...
    switch (this._analysisDefinitionNodeModel.fetchOutputGeometryType().state()) {
      case 'pending':
