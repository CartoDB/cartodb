...
describe('editor/widgets/widgets-form/widgets-header', function () {
  beforeEach(function () {
    ...
    spyOn(this.view, '_confirmDeleteWidget');
    spyOn(this.view, '_renameWidget');
  ...
  it('should show context menu', function () {
    ...
    expect(this.view._menuView.$('[data-val="rename-widget"]').length).toBe(1);
    expect(this.view._menuView.$('[data-val="delete-widget"]').length).toBe(1);
  });
  ...
  it('should rename', function () {
    ...
    this.view.$('.js-toggle-menu').click();
    this.view._menuView.$('[data-val="rename-widget"]').click();
    this.view.$('.js-input').val('foo').trigger('keyup');
    this.view.$('.js-input').trigger(e);
    expect(this.view._renameWidget).toHaveBeenCalled();
  });

  it('should delete', function () {
    this.view.$('.js-toggle-menu').click();
    this.view._menuView.$('[data-val="delete-widget"]').click();
    expect(this.view._confirmDeleteWidget).toHaveBeenCalled();
  });
