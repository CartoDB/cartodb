...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _renderStackedLegends: function() {
    ...
    if (this.legends && this.legends.length) {
      // restore legend CSS if placed in a custom spot
      var legendStyle = this.legends[0].model.get("style");
      if (legendStyle) {
        this.stackedLegend.$el.attr("style", legendStyle);
      }
    }
  },
