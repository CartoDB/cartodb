...
describe("Pecan", function() {
  ...
  describe("Dialog", function() {
    ...
    it("should exclude columns based on a list", function() {

      this.view._analyzeColumns();

      var rejectedColumns = this.view.columns.reject(function(column) {
        return !column.get("analyzed") && !column.get("success")
      });

      expect(this.view.columns.length).toBe(4);
      expect(rejectedColumns.length).toBe(4); // excludes 3 columns, leaves 2 
    });
