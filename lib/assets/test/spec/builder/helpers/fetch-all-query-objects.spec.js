...
fdescribe('helpers/fetch-all-query-objects', function () {
  describe('all models should fetch', function () {
    ...
    it('every query model should fetch and resolve when they are done', function (done) {
      ...
      fetchAllQueryObjects({
        ...
        expect(true).toBe(true); // We only need to get a green if we pass by here
        done();
      });
    });
