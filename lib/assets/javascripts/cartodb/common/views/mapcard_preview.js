...
module.exports = cdb.core.View.extend({
  ...
  _loadFromVisId: function() {
    ...
    var template = _.template(this.options.cdn_url ? this.templates.cdn : this.templates.regular);
    ...
    if (this.options.cdn_url) {
      options = _.extend(options, { cdn: this.options.cdn_url[protocol] });
    }

    this._loadImage({}, template(options));
  },
