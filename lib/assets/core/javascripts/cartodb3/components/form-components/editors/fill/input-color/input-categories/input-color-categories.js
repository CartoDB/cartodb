...
module.exports = CoreView.extend({
  ...
  _updateRange: function (categories) {
    ...
    // Just to test CartoCSS generation
    var images = [];
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/parking-garage-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/airfield-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/roadblock-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/ferry-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/harbor-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/bicycle-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/park-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/park2-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/museum-18.svg');
    images.push('https://s3.amazonaws.com/com.cartodb.users-assets.production/maki-icons/lodging-18.svg');

    images[4] = '';

    this.model.set('image', images);
  },
