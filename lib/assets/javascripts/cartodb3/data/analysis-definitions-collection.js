...
module.exports = Backbone.Collection.extend({
  ...
  initialize: function (models, options) {
    ...
    this._analysisDefinitionNodesCollection.on('save', this._onAnalysisDefinitionNodeSave, this);
    this._analysisDefinitionNodesCollection.on('change', this._onAnalysisDefinitionNodeChange, this);
  ...
  _onAnalysisDefinitionNodeSave: function (nodeDefModel) {
    var analysisDefModel = this.findByNodeId(nodeDefModel.id);
    var attrs = {analysis_definition: nodeDefModel.toJSON()};
  ...
  _onAnalysisDefinitionNodeChange: function (nodeDefModel) {
    // save all analysis, since any node within the analyis might be affected
