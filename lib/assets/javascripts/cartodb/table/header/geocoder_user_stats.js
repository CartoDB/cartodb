  ...
  cdb.admin.GeocoderStats = cdb.core.View.extend({
    ...
    _TEXTS: {
      ...
      not_enough_soft: _t('Not enough geocoding credits this month. <strong>After limits you will be charged $<%= block_price %>/1,000 rows</strong>.'),
      no_rows_available: _t('Not enough geocoding credits this month. <strong>From now on you will be charged $<%= block_price %> per 1,000 rows</strong>.'),
      no_rows_upgrade: _t('Not enough geocoding credits this month. <a href="<%= upgrade_url %>">Upgrade your account</a> to get more.')
    },
