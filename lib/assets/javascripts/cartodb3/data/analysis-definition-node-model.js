...
module.exports = cdb.core.Model.extend({
  ...
  /**
   * @override {Backbone.prototype.parse} to flatten the provided analysis data
   */
  parse: function (r) {
  ...
  /**
   * @override {Backbone.prototype.toJSON} to unflatten the internal attributes structure
   */
  toJSON: function () {
