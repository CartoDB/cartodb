...
module.exports = function() {
  ...
  describe('.createEmptyLabel', function() {
    it('should return a string for the create-empty link', function() {
      expect(this.model.createEmptyLabel()).toEqual(jasmine.any(String));
    });
  });
