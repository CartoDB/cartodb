...
cdb.admin.OverlaysDropdown = cdb.ui.common.Dropdown.extend({
  ...
  _addTitleOverlay: function() {
    ...
    var defaultStyle = {
      ...
      "color":            "#ffffff",
      "text-align":       "left",
      "font-size":        this._isDesktop() ? "32" : "17",
      "font-family-name": "Lato",
      "box-padding":      10,
      "box-color":        "#000000",
      "box-opacity":      0,
      "box-width":        this._isDesktop ? 600 : 200
    };
  ...
  _addTextOverlay: function() {
    ...
    var defaultStyle = {
      ...
      "color":            "#ffffff",
      "text-align":       "left",
      "font-size":        this._isDesktop() ? "19" : "12",
      "font-family-name": "Lato",
      "box-padding":      6,
      "box-color":        "#FFFFFF",
      "box-opacity":      .12,
  ...
  _addAnnotationOverlay: function() {
    ...
    var defaultStyle = {
      ...
      "color":            "#ffffff",
      "text-align":       "left",
      "font-size":        this._isDesktop() ? "15" : "12",
      "font-family-name": "Lato",
      "box-color":        "#FFFFFF",
      "box-opacity":      .25,
      "box-padding":      6,
      "line-color":       "#FFFFFF",
      "line-width":       this._isDesktop() ? 60 : 25,
  ...
  _addButton: function(title, tooltip, callback) {
  ...
  render: function() {
    ...
    this._addButton("Title", "Click to insert title. Titles are not geographically pinned.", this._addTitleOverlay);
    this._addButton("Text", "Click to insert text. Textboxes are not geographically pinned.", this._addTextOverlay);
    this._addButton("Annotation", "Click to insert annotation. Annotations are geographically pinned.", this._addAnnotationOverlay);
