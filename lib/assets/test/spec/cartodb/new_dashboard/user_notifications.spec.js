...
describe("new_dashboard/user_notifications", function() {
  var view, user, localStorage, navigation;
  ...
  beforeEach(function() {
    ...
    // navigationMock = sinon.mock(navigation);
    // navigationMock.expects('upgradeUrl').returns('test');
    // navigationMock.expects('contactUrl').returns('test@cartodb.com');
