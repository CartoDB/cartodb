...
cdb.admin.CreateTableDialog = cdb.ui.common.Dialog.extend({
  ...
  */
  ...
  initialize: function() {
    ...
    _.extend(this.options, {
      ...
      modal_type: "creation",
      extensions_allowed: ['csv', 'xls', 'xlsx', 'zip', 'kml', 'geojson', 'json', 'ods', 'kmz', 'gpx', 'tar', 'gz', 'tgz', 'osm', 'bz2', 'tif', 'tiff'],
      width: 600
    });
  ...
  render_content: function() {
    ...
    var $upload = $content.find("div.uploader")
      , uploader = this.uploader = new qq.FileUploader({
        ...
        allowedExtensions: this.options.extensions_allowed,
  ...
  */
  ...
  /*+
   * Eliminate all the pending bindings
   */
  _reClean: function() {
