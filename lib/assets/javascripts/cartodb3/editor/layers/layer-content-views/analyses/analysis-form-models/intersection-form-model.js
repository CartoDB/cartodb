...
module.exports = BaseAnalysisFormModel.extend({
  initialize: function () {
    ...
    var nodeDefModel = this._layerDefinitionModel.findAnalysisDefinitionNodeModel(this.get('target'));
    ...
    this.on('change:target', this._fetchColumns, this);
  ...
  _fetchColumns: function () {
    this._columnOptions.refresh(this.get('target'));
  },
