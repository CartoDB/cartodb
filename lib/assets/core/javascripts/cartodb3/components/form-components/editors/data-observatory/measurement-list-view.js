...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    this._showNumberFiltersApplied();
    return this;
  },

  _initCollection: function () {
    var filtersApplied = this._getFiltersApplied();
  ...
  _getFiltersApplied: function () {
    return _.map(this._filtersCollection.getSelected(), function (mdl) {
      return mdl.getValue();
    });
  },

  _showNumberFiltersApplied: function () {
    var filtersApplied = this._filtersCollection.getSelected().length;
    var label = '';
    if (filtersApplied > 0) {
      if (filtersApplied === 1) {
