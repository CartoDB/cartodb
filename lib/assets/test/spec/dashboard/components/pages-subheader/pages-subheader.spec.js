...
describe('dashboard/components/pages-subheader/pages-subheader', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(view.$el.html()).toContain('<li class="SideMenu-typeItem"><a href="/dashboard/connected_apps" class="SideMenu-typeLink ">Connected Apps</a></li>');
    ...
    describe('page is Connected Apps', function () {
      it('should render properly', function () {
        ...
        expect(view.$el.html()).toContain('<li class="SideMenu-typeItem"><a href="/dashboard/connected_apps" class="SideMenu-typeLink is-selected">Connected Apps</a></li>');
      });
    });
