  ...
  cdb.admin.mod.CategoryWizard = cdb.admin.mod.SimpleWizard.extend({
    ...
    initialize: function() {
      ...
      this.cartoProperties.bind('change:type', function () {
        if (this.cartoProperties.get('type') !== this.type) {
          this._currentProperty = '';
        }
      }, this);
    ...
    _showLoader: function() {
      ...
      if (this._currentProperty !== property || !this.categories.size()) {
        this.loader.show();
      }
    },
    ...
    _getMetadata: function() {
      ...
      // Set new categories only when property was changed
      if (this._currentProperty !== property || !this.categories.size()) {
