...
describe('new_dashboard/header_view', function() {
  beforeEach(function() {
    var $el = $('<div>' +
      ...
      '<a id="header-breadcrumbs-dropdown" href="#">User breadcrumbs dropdown</a>' +
    '</div>');
  ...
  describe('.click #breadcrumbs-settings-dropdown', function() {
    ...
    it('should create a breadcrumbs dropdown with expected params', function() {
      ...
      expect(viewToBeInstantiatedWith.template_base).toEqual('new_dashboard/header/breadcrumbs_dropdown');
    ...
    it('should clean up dropdown view after the dropdown is hidden', function() {
      ...
      expect(this.breadcrumbsDropdownMock.options.target.unbind).toHaveBeenCalledWith('click');
    });
