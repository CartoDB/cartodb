...
(function() {
  ...
  cdb.admin.mod.InfowindowPane = cdb.core.View.extend({
    ...
    _setupTemplates: function() {
      ...
      this.template = _.template('<ul class="fields"></ul> <div class="all"> <a href="#switch" class="right selectall switch enabled"> <span class="handle"></span> </a> <span class="label lighter right">all</span> </div>');
  ...
  cdb.admin.mod.InfowindowTitlePane = cdb.core.View.extend({
    ...
    _setupTemplates: function() {
      ...
      this.template = _.template("title");
  ...
  cdb.admin.mod.InfowindowHTMLPane = cdb.core.View.extend({
  ...
  cdb.admin.mod.InfoWindow = cdb.core.View.extend({
    ...
    _setupPane: function() {
      ...
      this.pane = new cdb.ui.common.TabPane({
        el: this.$el.find(".panel_content .wrapper .content")
      });
