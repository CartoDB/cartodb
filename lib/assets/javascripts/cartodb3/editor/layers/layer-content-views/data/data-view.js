...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._codemirrorModel.bind('change:content', function () {
      var cleanedContent = this._codemirrorModel.get('content').replace(/;/g, '');
      this._codemirrorModel.set('content', cleanedContent, { silent: true });
    }, this);
  ...
  _parseSQL: function () {
    ...
    var isSameQuery = currentQuery.toLowerCase() === appliedQuery.toLowerCase();
