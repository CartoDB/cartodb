...
describe('components/modals/add-widgets/create-tuples-items', function () {
  beforeEach(function () {
    ...
    analysisDefinitionNodesCollection.at(3).analysisTableModel = new AnalysisTableModel({}, {
      configModel: configModel
    });
    ...
    a1.analysisTableModel.columnsCollection.reset([
      {
        name: 'cartodb_id',
        type: 'number'
      }, {
    ...
    b1.analysisTableModel.columnsCollection.reset([
      {
        name: 'cartodb_id',
        type: 'number'
      }, {
