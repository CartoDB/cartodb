...
describe('components/modals/add-layer/navigation-view', function () {
  ...
  it('should render correctly', function () {
    ...
    expect(this.view.$('.js-typeItem').length).toBe(3);
  });
  ...
  it('should disable connect-dataset option when user Professional and is out of datasets quota', function () {
    this.createModel.set('listing', 'datasets');
    this.userModel.set('account_type', 'Professional');
  ...
  it('should disable create empty dataset option when user Professional and is out of datasets quota', function () {
    spyOn(this.createModel, 'createFromScratch');
    this.createModel.set('listing', 'datasets');
    this.userModel.set('account_type', 'Professional');
    this.userModel.set('table_quota', 40);
