...
var WidgetDefinitionsCollection = require('cartodb3/data/widget-definitions-collection');
var AnalysisFormModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/base-analysis-form-model');
...
var AreaOfInfluenceFormModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/area-of-influence-form-model');
var CategoryWidgetOptionModel = require('cartodb3/components/modals/add-widgets/category/category-option-model');
var FilterByNodeColumnFormModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/filter-by-node-column');
var TableModel = require('cartodb3/data/table-model');
var AnalysisSourceOptionsModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-source-options-model');
var analyses = require('cartodb3/data/analyses');
