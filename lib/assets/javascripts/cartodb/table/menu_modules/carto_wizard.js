(function() {
  ...
  var ChoroplethWizard = SimpleWizard.extend({
    ...
    error_msg: {
      NO_CONTENT_MSG: _t('You have to create a numeric column in order to start with your cloropeth map')
    },
    ...
    render: function() {
      ...
      var $wrapper =    $("<div>").addClass("wrapper")
        , $content =    $("<div>").addClass("content")
        , $no_columns = $("<div>").addClass("no_content").text(this.error_msg.NO_CONTENT_MSG)
    ...
    _checkNumberColumns: function($el) {
      ...
      // Check if choropleth vis is active and trigger change
      if (this._parent && this._parent.activePane == "choropleth") {
        // Refresh styles
      }
    }
