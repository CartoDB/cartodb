...
const VisualizationModel = Backbone.Model.extend({
  ...
  isVisualization: function () {
    return VISUALIZATON_TYPES.includes(this.get('type'));
  },
  ...
  isPubliclyAvailable: function (privacyStatus) {
    return privacyStatus === this._privacyOptions.password ||
           privacyStatus === this._privacyOptions.link ||
           privacyStatus === this._privacyOptions.public;
  }
});
