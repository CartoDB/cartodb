...
var EditorMapView = require('cartodb3/editor/editor-map-view');
...
var editorPaneTemplate = require('cartodb3/editor/editor-pane.tpl');
var editorPaneIconItemTemplate = require('cartodb3/editor/editor-pane-icon.tpl');
...
var BuilderOnboardingLauncher = require('cartodb3/components/onboardings/builder/launcher');
...
var ImporterManager = require('cartodb3/components/background-importer/background-importer');
var BackgroundPollingModel = require('cartodb3/data/editor-background-polling-model');
...
// var WebGLMetrics = require('cartodb3/components/metrics/webgl-metrics');
var FeedbackButtonView = require('cartodb3/editor/feedback/feedback-button-view');
var SettingsOptions = require('cartodb3/data/map-settings');
var SettingsView = require('cartodb3/editor/editor-settings-view');
var OverlaysCollection = require('cartodb3/data/overlays-definition-collection');
var MapcapsCollection = require('cartodb3/data/mapcaps-collection');
var PrivacyCollection = require('cartodb3/components/modals/publish/privacy-collection');
var CreatePrivacyOptions = require('cartodb3/components/modals/publish/create-privacy-options');
var UserGroupFetcher = require('cartodb3/data/users-group-fetcher');
var State = require('cartodb3/data/state-definition-model');
var LegendDefinitionsCollection = require('cartodb3/data/legends/legend-definitions-collection');
var LegendsState = require('cartodb3/data/legends/legends-state');
