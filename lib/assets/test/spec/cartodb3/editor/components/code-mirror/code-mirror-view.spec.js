...
var CodeMirrorView = require('../../../../../../javascripts/cartodb3/editor/components/code-mirror/code-mirror-view.js');
describe('editor/components/code-mirror/code-mirror-view', function () {
  var view;
  ...
  it('should render properly', function () {
    ...
    expect(view.$('.js-info').html()).toContain('CMD + S');
  });
  ...
  it('should bind change:readonly properly', function () {
    ...
    expect(view.$('.js-info').attr('style')).toContain('display: none');
