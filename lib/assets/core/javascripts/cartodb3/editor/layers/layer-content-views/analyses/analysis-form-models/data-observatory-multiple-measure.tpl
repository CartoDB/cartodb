<form>
  <div class="Editor-HeaderInfo">
    ...
    <div class="Editor-HeaderInfo-inner CDB-Text" data-fields="source,area">
      ...
      <p class="CDB-Text u-upperCase CDB-FontSize-small u-altTextColor u-bSpace--m"><%= linkContent %><%- _t('editor.layers.analysis-form.data-observatory.header.description') %></p>
    </div>
  </div>
