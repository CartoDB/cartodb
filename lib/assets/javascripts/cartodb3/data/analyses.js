...
var AggregateIntersectionFormModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/aggregate-intersection-form-model');
var FilterIntersectionFormModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/filter-intersection-form-model');
...
var UnknownTypeFormModel = require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/unknown-type-form-model');
var MergeAnalysisOptionModel = require('cartodb3/components/modals/add-analysis/analysis-option-models/merge-analysis-option-model');
...
var MAP = {
  'aggregate-intersection': {
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/aggregate-intersection.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/intersect.tpl')
  },
  'bounding-box': {
    title: _t('analyses.bounding-box.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/group-points-form-model'),
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/group-points.tpl'),
  ...
  'buffer': {
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/area-of-influence.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/aoi.tpl'),
    genericType: 'area-of-influence'
  },
  'centroid': {
    title: _t('analyses.centroid.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/centroid-form-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/centroid.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/centroid.tpl'),
  ...
  'convex-hull': {
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses//group-points.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/group-points.tpl'),
    animationParams: {
  ...
  'data-observatory-measure': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/data-observatory-measure-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/data-observatory-measure.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/data-observatory-measure.tpl'),
    genericType: 'data-observatory-measure'
  },
  'data-observatory-multiple-measures': {
    title: _t('analyses.data-observatory-measure.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/data-observatory-multiple-measure-model'),
    modalTitle: _t('components.modals.add-analysis.option-types.data-observatory-measure.title'),
    modalDesc: _t('components.modals.add-analysis.option-types.data-observatory-measure.desc'),
    modalCategory: 'create_clean',
    modalLink: 'https://carto.com/learn/guides/analysis/enrich-from-data-observatory',
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/data-observatory-multiple-measure.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/data-observatory-measure.tpl'),
    genericType: 'data-observatory-multiple-measures'
  },
  'filter-by-node-column': {
    title: _t('analyses.filter-by-node-column.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/filter-by-node-column'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/filter-by-node-column.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/filter-by-layer.tpl'),
    animationParams: {
  ...
  'filter-category': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/filter-form-model'),
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/filter.tpl'),
    genericType: 'filter'
  },
  'filter-range': {
    title: _t('analyses.filter.short-title'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/filter.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/filter-by-column-value.tpl'),
    genericType: 'filter'
  },
  'georeference-city': {
    title: _t('analyses.georeference.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/georeference-form-model'),
    checkIfEnabled: function (configModel) {
      return checkIfInternalGeocodingIsEnabled(configModel);
    },
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/georeference.tpl'),
  ...
  'georeference-placeholder': {
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/georeference.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/georeference.tpl'),
    genericType: 'georeference'
  },
  ...
  'intersection': {
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/intersection.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/filter-by-polygon.tpl')
  },
  'kmeans': {
    title: _t('analyses.kmeans.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/kmeans-form-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/kmeans.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/kmeans.tpl'),
    animationParams: {
  ...
  'line-to-single-point': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/connect-with-lines-form-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/connect-with-lines.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/connect-with-lines.tpl'),
  ...
  'merge': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/merge-form-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/merge.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/join-two-columns.tpl')
  },
  'moran': {
    title: _t('analyses.moran-cluster.short-title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/moran-form-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/moran.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/outliers.tpl')
  },
  'routing-sequential': {
  ...
  'sampling': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/sampling-form-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/sampling.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/sampling.tpl'),
    animationParams: {
  ...
  'spatial-markov-trend': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/spatial-markov-trend-model'),
    ...
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/spatial-markov-trend.tpl'),
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/predict-trends.tpl')
  },
  'trade-area': {
    title: _t('analyses.area-of-influence.short-title'),
    FormModel: AreaOfInfluenceFormModel,
  ...
  'closest': {
    ...
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/closest-form-model'),
    ...
    animationTemplate: require('cartodb3/components/modals/add-analysis/animation-templates/closest.tpl'),
    onboardingTemplate: require('cartodb3/components/onboardings/analysis/analyses/closest.tpl')
  },
  'deprecated-sql-function': {
    title: _t('editor.layers.analysis-form.deprecated-sql-function.title'),
    FormModel: require('cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/deprecated-sql-function-form-model'),
