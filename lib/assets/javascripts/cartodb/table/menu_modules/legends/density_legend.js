...
cdb.admin.mod.DensityLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _calculateItems: function() {
    ...
    items.push(new cdb.geo.ui.LegendItemModel({ legend_type: "choropleth", type: "text", name: "Less",  sync: this.leftSync, value: this.leftLabel }));
    items.push(new cdb.geo.ui.LegendItemModel({ legend_type: "choropleth", type: "text", name: "More", sync: this.rightSync, value: this.rightLabel }));
