...
(function (window, document) {
  ...
  var redirectUsers = function (userData) {
    redirector.redirectOrgUsers(userData.organization, userData.username, window.location);
    redirector.redirectToLoginIfAnotherIsLogged(userData.username, window.location);
  };
