...
describe('data/feature-definition-model', function () {
  ...
  describe('.save', function () {
    ...
    describe('when save succeeds', function () {
      ...
      it('should update the id of the feature when creating a new row', function () {
        this.feature.unset('id');
      ...
      it('should NOT update the id of the feature when updating an existing row', function () {
        expect(this.feature.id).toEqual('12345');
