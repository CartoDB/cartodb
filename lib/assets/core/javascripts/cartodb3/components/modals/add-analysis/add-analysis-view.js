...
module.exports = CoreView.extend({
  ...
  _initOptions: function () {
    var isTVTLayer = this._layerDefinitionModel.isTVTLayer();
    ...
    var modelsAttrs = _.reduce(Object.keys(this._analysisOptions), function (memo, category) {
      ...
      categoryDef.analyses.forEach(function (d) {
        ...
        if (isTVTLayer && (d.nodeAttrs.isTVTanalysis || d.nodeAttrs.isTVTanalysis === void 0) || !isTVTLayer && !d.nodeAttrs.isTVTanalysis) {
          memo.push(_.extend({}, d, { category: category, type: type }));
        }
      }, this);
