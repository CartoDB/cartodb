...
module.exports = BaseDialog.extend({
  ...
  _generateImageFilename: function () {
    filename = (self.table.vis.get('name') + ' by ' + self.table.user.nameOrUsername() + ' ' + moment(new Date()).format('MM DD YYYY hh mm ss'));
  ...
  generateImage: function(url) {
    ...
    var callback = function(url) {
      this._showResult({ 
        ...
        displayedLink: url.substring(0, 255), 
        filename: self._generateImageFilename()
      });
    };
