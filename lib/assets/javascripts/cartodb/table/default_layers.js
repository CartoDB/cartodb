...
'CartoDB': [{
    url: 'http://basemaps-staging-{s}.cartocdn.com/light_nolabels/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    name: 'Positron',
    ...
    labels: {
      url: 'http://basemaps-staging-{s}.cartocdn.com/light_only_labels/{z}/{x}/{y}.png'
    }
  }, {
    url: 'http://basemaps-staging-{s}.cartocdn.com/dark_nolabels/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    name: '',
    ...
    attribution: '© <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors © <a href="https://carto.com/about-carto/">CARTO</a>',
    labels: {
      url: 'http://basemaps-staging-{s}.cartocdn.com/dark_only_labels/{z}/{x}/{y}.png'
    }
  }, {
    url: 'http://basemaps-staging-{s}.cartocdn.com/light_all/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    ...
    url: 'http://basemaps-staging-{s}.cartocdn.com/dark_all/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 18,
    ...
    url: 'https://basemaps-staging-{s}.cartocdn.com/base-antique/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
    ...
    url: 'https://basemaps-staging-{s}.cartocdn.com/base-eco/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
    ...
    url: 'https://basemaps-staging-{s}.cartocdn.com/base-flatblue/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
    ...
    url: 'https://basemaps-staging-{s}.cartocdn.com/base-midnight/{z}/{x}/{y}.png',
    subdomains: 'abcd',
    minZoom: 0,
    maxZoom: 10,
