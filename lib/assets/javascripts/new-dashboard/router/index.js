...
import LDS from 'new-dashboard//pages/Data/LDS';
...
// Hooks
import { mapsBeforeEnter, datasetsBeforeEnter, LDSBeforeEnter } from 'new-dashboard/router/hooks/check-navigation';
...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        {
          path: 'location_data_streams',
          name: 'location_data_streams',
          component: LDS,
          meta: {
            title: () => 'Location Data Streams | CARTO'
          },
          beforeEnter: LDSBeforeEnter
        },
        {
          path: ':filter?',
          component: Datasets,
