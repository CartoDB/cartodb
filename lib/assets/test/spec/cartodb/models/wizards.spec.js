  ...
  describe('active', function() {
    ...
    describe('.changeLayerStyle', function() {
      ...
      it('should update the sql, cartoCSS and metadata of the layer', function() {
        ...
        var wadusGenerator = function simple_polygon_generator(table, props, changed, callback) {
          callback('cartoCSS', 'metadata', 'sql');
        }
        wizard_properties.cartoStylesGeneration.registerGenerator('wadus', wadusGenerator);
      ...
      it('should update the sql, cartoCSS and metadata of the layer', function() {
        ...
        expect(layer.get('tile_style_custom')).toEqual(false);
        expect(layer.get('tile_style')).toEqual("/** wadus visualization */\n\ncartoCSS");
        expect(layer.get('query_wrapper')).toEqual(null);
        expect(layer.get('query_generated')).toEqual(false);
      })
