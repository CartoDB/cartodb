...
// var template = require('./modal-export.tpl');
...
//
//     this.querySchemaModel.bind('change:status', this.render, this);
//     this.add_related_model(this.querySchemaModel);
//   },
//
//   render: function () {
//     var columnTypes = this.querySchemaModel.columnsCollection.pluck('type');
//     var hasGeometry = _.contains(columnTypes, 'geometry');
//
//     if (hasGeometry) {
//       this.$el.html(
//         template({
...
//           formats: FORMATS,
//           url: this.configModel.get('base_url'),
//           isGeoreferenced: hasGeometry
//         })
//       );
//     } else {
//       this._renderLoadingContent('Checking georeferences…');
//     }
//
//     return this;
//   },
...
//     return {
//       filename: this.tableModel.get('name'),
...
//     if (this.tableModel.getGeometryType()) {
