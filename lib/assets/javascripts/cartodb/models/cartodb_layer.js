cdb.admin.CartoDBLayer = cdb.geo.CartoDBLayer.extend({
  ...
  parse: function(data, xhr) {
    ...
    if (this._saving && !this.isNew()) {
      console.log("discard layer");
      return c;
    }
    ...
    if (data.options.wizard_properties === undefined || !data.options.wizard_properties.type) {
      data.options.wizard_properties = { type: "polygon" };
    }
