...
var InputRangeContentView = require('../input-ramp/input-ramp-content-view');
...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function () {
    ...
    var stackViewCollection = new Backbone.Collection([{
      ...
      createStackView: function (stackLayoutModel, opts) {
        return self._createInputRangeContentView(stackLayoutModel, opts).bind(self);
      }
    }, {
      createStackView: function (stackLayoutModel, opts) {
  ...
  _createInputRangeContentView: function (stackLayoutModel, opts) {
    var view = new InputRangeContentView({
