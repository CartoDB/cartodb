...
describe('editor/components/modals/add-basemap/wms/wms-model', function () {
  ...
  describe('.fetchLayers', function () {
    beforeEach(function () {
      ...
      spyOn(this.model.wmsLayersCollection, 'fetch');
    ...
    it('should fetch layers from given URL', function () {
      ...
      // expect(this.model.wmsLayersCollection.fetch.calls.argsFor(0)[1]).toEqual(jasmine.any(Function));
    });
    ...
    describe('when fetch is done', function () {
      describe('when there are layers', function () {
        beforeEach(function () {
          ...
          // this.model.wmsLayersCollection.fetch.calls.argsFor(0)[1]();
        });
