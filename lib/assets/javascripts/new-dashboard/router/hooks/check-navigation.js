...
// export function kuvizBeforeEnter (to, from, next) {
//   store.dispatch('kuvizs/fetchVisualizations', to, from, next);
//   next();
// }


export function kuvizBeforeEnter (to, from, next) {
  store.dispatch('kuvizs/resetFilters');
  checkFilters('kuvizs', 'kuvizs', to, from, next);
}
