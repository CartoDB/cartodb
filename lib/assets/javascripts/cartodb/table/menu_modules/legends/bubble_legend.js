...
cdb.admin.mod.BubbleLegend = cdb.admin.mod.CustomLegend.extend({
  ...
  _calculateItems: function() {
    ...
    items.push(new cdb.geo.ui.LegendItemModel({ name: "Left label",  type: "text",  value: "< " + min }));
    items.push(new cdb.geo.ui.LegendItemModel({ name: "Right Label", type: "text",  value: max + " >" }));
