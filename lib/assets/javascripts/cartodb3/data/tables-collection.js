...
module.exports = Backbone.Collection.extend({
  ...
  // Required for idAttribute to be available for .get() to work (used internally)
  model: TableModel,
  ...
  url: function () {
    ...
    // flagged as not fetched (see parse method), so one need to check for this flag where a table is wanted, to make
    // sure it's fetched where necessary.
    var version = this._configModel.urlVersion('visualizations');
