<div class="Modal-header">
  <div class="Modal-headerContainer">
    ...
    <h3 class="CDB-Text CDB-Size-medium u-altTextColor"><a data-type="upload_file" href="#/upload" class="js-addIcon"><%= _t('dashboard.views.organization.icon_picker.upload_icons') %></a></h3>
  </div>
</div>
