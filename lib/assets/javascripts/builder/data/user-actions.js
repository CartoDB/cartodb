...
module.exports = function (params) {
  ...
  return {
    ...
    moveLayer: async function (d) {
      ...
      for (const layerDefModel of layerDefinitionsCollection.models) {
        var nodeDefModel = layerDefModel.getAnalysisDefinitionNodeModel();
        if (nodeDefModel) {
          await analysisDefinitionsCollection.saveAnalysisForLayer(layerDefModel);
        }
      }
