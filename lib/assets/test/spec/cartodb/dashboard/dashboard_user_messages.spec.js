describe("cdb.admin.dashboard.Messages", function() {
  ...
  it("should replace the last custom message", function() {
    ...
    view.addMessage("upgraded", { account_type: "a" });
    view.addMessage("upgraded", { account_type: "b" });
    view.addMessage("upgraded", { account_type: "c" });

    waits(500);

    runs(function() {
      expect(view.$el.find("li").text()).toEqual('Great! Welcome to your brand new c CartoDB. Now we love you even more than before ;)x');
    });
