...
module.exports = cdb.core.View.extend({
  ...
  render: function () {
    ...
    this.$el.html(this.template({
      ...
      name: this.mapOwnerUser.nameOrUsername(),
  ...
  _initModels: function () {
    ...
    this.moreVisualizations = this.showVisualizations
      ? _setMoreVisualizations(this.visualizations)
      : [];
  }
});
...
function _setMoreVisualizations (visualizations) {
  return _.map(visualizations, function (visualization) {
    visualization.updatedAt = moment(visualization.updated_at).fromNow();
    visualization.publicMapUrl = visualization.permission.owner.base_url + '/' + visualization.map_id + '/public_map';
    visualization.username = visualization.permission.owner.username;
