var ChangeLockViewModel = require('../../../../../javascripts/cartodb/dashboard/dialogs/change_lock_view_model');
var cdb = require('cartodb.js');
var $ = require('jquery');

describe('dashboard/dialogs/change_lock_view_model', function() {
  beforeEach(function() {
    this.models = [
