...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    // cartodb.js set this in window context
  ...
  _getStaticMapURL: function () {
    var getStaticImageURL = this._visDefinitionModel.get('staticImageURLTemplate');
    return getStaticImageURL({
      zoom: this._visDefinitionModel.get('visMetadata').zoom,
  ...
  _downloadImage: function (dataUri) {
    ...
    var visMetadata = this._visDefinitionModel.get('visMetadata');
    var link = document.createElement('a');
    document.body.appendChild(link);

    link.download = visMetadata.title + '.' + format;
    link.href = dataUri;
    link.target = '_blank';
    link.click();
  ...
  _hasGoogleMapsBasemap: function () {
    return this._visDefinitionModel.get('visMetadata').provider === 'googlemaps';
  },
