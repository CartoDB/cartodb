                    ...
                    process=function(element, collection) {
                        ...
                        if (element.is("option")) {
                            if (query.matcher(term, element.attr('alias') ? element.attr('alias') : element.text(), element)) {
                                collection.push({id:element.attr("value"), text:element.text(), element: element.get(), css: element.attr("class"), alias: (element.attr('alias') && element.attr('alias') !== 'null') ? element.attr('alias') : undefined});
                            }
    ...
    $.fn.select2.defaults = {
        ...
        formatSelection: function (data, container) {
            if (data) {
                ...
                if (data.element && data.element.attr && data.element.attr('alias') && data.element.attr('alias') !== 'null') {
