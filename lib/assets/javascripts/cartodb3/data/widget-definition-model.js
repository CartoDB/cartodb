  ...
  parse: function (r) {
    ...
    if (!_.isEmpty(r.style)) {
      if (r.style.auto_style) {
        attrs.auto_style_definition = r.style.auto_style.definition && r.style.auto_style.definition.fill;
        attrs.auto_style_allowed = r.style.auto_style.allowed;
      }
      attrs.widget_style_definition = r.style.widget_style.definition.fill;
    }
  ...
  toJSON: function () {
    ...
    if (this.get('widget_style_definition')) {
      o.style = {
        widget_style: {
          definition: {
            fill: this.get('widget_style_definition')
          }
        }
      };
      ...
      if (this.get('auto_style_definition')) {
        ...
        o.style.auto_style.definition = {
          fill: autoStyleDefinition
        };
      }
    }
