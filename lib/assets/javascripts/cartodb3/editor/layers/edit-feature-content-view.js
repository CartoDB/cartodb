...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this._featureModel.bind('featureDestroyed', this._onFeatureDestroyed, this);
    this._featureModel.bind('saveFeature', this._onSaveFeature, this);
    this._featureModel.bind('featureSaved', this._onFeatureSaved, this);
    this._featureModel.bind('featureFailed', this._onFeatureFailed, this);
  ...
  _onDestroyFeature: function () {
    ...
    this.notification = Notifier.addNotification({
      id: NOTIFICATION_ID,
      status: 'loading',
      info: '_onDestroyFeature',
      closable: false
    });
  },

  _onFeatureDestroyed: function () {
    this.notification.set({
      id: NOTIFICATION_ID,
      status: 'success',
      info: '_onFeatureDestroyed',
      closable: true
    });
  },
  ...
  _onFeatureSaved: function () {
    this.render();

    this.notification.set({
      id: NOTIFICATION_ID,
      status: 'success',
      info: '_onFeatureSaved',
      closable: true
    });
  },

  _onFeatureFailed: function () {
    this.notification.set({
      id: NOTIFICATION_ID,
      status: 'error',
      info: '_onFeatureFailed',
      closable: true
    });
  },
