...
import Catalogue from 'new-dashboard/pages/Data/Catalogue';
import CatalogueDetail from 'new-dashboard/pages/Data/CatalogueDetail';
...
// Hooks
import { mapsBeforeEnter, datasetsBeforeEnter, catalogueDetailBeforeEnter } from 'new-dashboard/router/hooks/check-navigation';
...
const router = new Router({
  ...
  routes: [
    ...
    {
      path: '/datasets/catalogue/:id',
      name: 'catalogue_detail',
      component: CatalogueDetail,
      meta: {
        title: () => 'Detail Dataset Catalogue | CARTO'
      },
      beforeEnter: catalogueDetailBeforeEnter
    },
    {
      path: '/search/:query',
      name: 'search',
