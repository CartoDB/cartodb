...
function generateStyle(styleDef, geometryType) {

  var css = '';
  if (geometryType === 'point' && styleDef.animated && styleDef.animated.enabled) {
    css += 'Map {\n';
...
StyleManager.prototype = {
  ...
  _initBinds: function() {
    ...
    this.layerDefinitionsCollection.each(function(layerDef) {
      layerDef.style.bind('change', self.generate, self);
    });
  },
