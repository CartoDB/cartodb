...
shared_examples_for "user models" do
  ...
  describe 'User#remaining data observatory snapshot quota' do
    ...
    it 'takes into account data observatory requests performed by the org users' do
      usage_metrics_1 = CartoDB::ObservatorySnapshotUsageMetrics.new(organization_user_1.username, organization.name, @mock_redis)
      usage_metrics_2 = CartoDB::ObservatorySnapshotUsageMetrics.new(organization_user_2.username, organization.name, @mock_redis)
      ...
      organization_user_1.remaining_obs_snapshot_quota.should == 300
      organization_user_2.remaining_obs_snapshot_quota.should == 300
    end
  end
  ...
  describe 'User#remaining data observatory general quota' do
    ...
    it 'takes into account data observatory requests performed by the org users' do
      usage_metrics_1 = CartoDB::ObservatoryGeneralUsageMetrics.new(organization_user_1.username, organization.name, @mock_redis)
      usage_metrics_2 = CartoDB::ObservatoryGeneralUsageMetrics.new(organization_user_2.username, organization.name, @mock_redis)
      ...
      organization_user_1.remaining_obs_general_quota.should == 300
      organization_user_2.remaining_obs_general_quota.should == 300
    end
  end
