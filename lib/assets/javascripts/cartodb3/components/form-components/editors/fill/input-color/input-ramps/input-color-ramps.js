...
module.exports = CoreView.extend({
  ...
  _setupModel: function () {
    ...
    } else if (QUANTIFICATION_REFERENCE[this.model.get('quantification')]) {
      this.model.set('quantification', QUANTIFICATION_REFERENCE[this.model.get('quantification')]);
    }
