cdb.admin.NoGeoRefDataDialog = cdb.admin.BaseDialog.extend({
  ...
  initialize: function() {
    _.extend(this.options, {
      ...
      content: 'Your data does not appear to have been georeferenced. This means that nothing will display on the map until you georeference or add inn that data manually.',
