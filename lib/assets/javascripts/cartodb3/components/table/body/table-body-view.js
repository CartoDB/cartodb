...
var ContextMenuView = require('cartodb3/components/context-menu/context-menu-view');
var CustomListCollection = require('cartodb3/components/custom-list/custom-list-collection');
var addTableRowOperation = require('cartodb3/components/table/operations/table-add-row');
var removeTableRowOperation = require('cartodb3/components/table/operations/table-remove-row');
var editCellOperation = require('cartodb3/components/table/operations/table-edit-cell');
var ConfirmationModalView = require('cartodb3/components/modals/confirmation/modal-confirmation-view');
var TablePaginatorView = require('cartodb3/components/table/paginator/table-paginator-view');
var tableBodyTemplate = require('./table-body.tpl');
var renderLoading = require('cartodb3/components/loading/render-loading');
var ErrorView = require('cartodb3/components/error/error-view');
var tableNoRowsTemplate = require('./table-no-rows.tpl');
var EditorsServiceModel = require('cartodb3/components/table/editors/editors-service-model');
var EditorsModel = require('cartodb3/components/table/editors/types/editor-model');
var errorParser = require('cartodb3/helpers/error-parser');
var magicPositioner = require('cartodb3/helpers/magic-positioner');
var checkAndBuildOpts = require('cartodb3/helpers/required-opts');

var EDITORS_MAP = {
  string: require('cartodb3/components/table/editors/types/editor-string-view'),
  number: require('cartodb3/components/table/editors/types/editor-base-view'),
  boolean: require('cartodb3/components/table/editors/types/editor-boolean-view'),
  date: require('cartodb3/components/table/editors/types/editor-date-view'),
  default: require('cartodb3/components/table/editors/types/editor-string-view')
};
