  ...
  describe("layers", function() {
    ...
    describe('.moveLayer', function() {
      ...
      it('should save layers', function(done) {
        ...
        sinon.stub(tileLayer, "save").yieldsTo("success");
        sinon.stub(layer1, "save").yieldsTo("success");
        sinon.stub(layer2, "save").yieldsTo("success");
        ...
        setTimeout(function() {
          expect(tileLayer.save.called).toBeTruthy();
          expect(layer1.save.called).toBeTruthy();
          expect(layer2.save.called).toBeTruthy();
          done();
        }, 100);
      })
    })
