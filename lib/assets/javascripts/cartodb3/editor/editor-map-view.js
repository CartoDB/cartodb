...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    // WidgetsService.trackWidgetEdition('editWidget', this._onEditWidget, this);
  },
  ...
  _onEditWidget: function (widgetDefModel) {
    this.stackLayoutModel.nextStep(widgetDefModel, 'widget-content');
  },
