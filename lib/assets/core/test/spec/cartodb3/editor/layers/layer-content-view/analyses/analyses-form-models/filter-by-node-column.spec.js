...
var FilterFormModel = require('../../../../../../../../javascripts/cartodb3/editor/layers/layer-content-views/analyses/analysis-form-models/filter-by-node-column');
...
describe('editor/layers/layer-content-views/analyses/analysis-form-models/filter-by-node-column', function () {
  ...
  beforeEach(function () {
    ...
    jasmine.Ajax.stubRequest(new RegExp('.*api/v2/sql.*'))
      .andReturn({
        status: 200,
        responseText: '{"rows":[],"fields":{"cartodb_id":{"type":"number"},"numero_de_finca":{"type":"string"}}}'
      });
  ...
  describe('type filter by node column', function () {
    ...
    describe('._validateFilterColumn', function () {
      it('should validate column types match', function (done) {
        var self = this;
        ...
        setTimeout(function () {
          expect(JSON.stringify(self.model._validateFilterColumn('numero_de_finca', formValues)))
