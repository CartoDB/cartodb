...
module.exports = cdb.core.Model.extend({
  ...
  defaults: {
    step: 'upload',
    state: '',
    shouldRedirectAfterComplete: true
  },
  ...
  shouldRedirectAfterComplete: function() {
    return this.get('state') === 'complete' &&
      this.get('shouldRedirectAfterComplete') &&
      this.imp.get('tables_created_count') === 1 &&
      this.imp.get('service_name') !== 'twitter_search';
  },
