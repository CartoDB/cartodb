...
describe('dashboard/components/pages-subheader/pages-subheader', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(view.$el.html()).toContain('<a class="Filters-link" href="' + BILLING_LINK + '">');
      expect(view.$el.html()).toContain('<span class="bar-2 " style="width: 2%"></span>');
      expect(view.$el.html()).toContain('<span class="CDB-Text CDB-Size-medium u-altTextColor">15.62MB of 1GB</span>');
      ...
      expect(view.$el.html()).toContain('<li class="SideMenu-typeItem"><a href="/your_apps" class="SideMenu-typeLink ">API keys</a></li>');
      expect(view.$el.html()).toContain('<a href="mailto:support@carto.com">Contact support</a>');
    ...
    describe('page is API keys', function () {
      it('should render properly', function () {
        ...
        expect(view.$el.html()).toContain('<li class="SideMenu-typeItem"><a href="/your_apps" class="SideMenu-typeLink is-selected">API keys</a></li>');
      });
    });
  });
  ...
  describe('is inside org', function () {
    beforeEach(function () {
      ...
      user.organization = new cdb.core.Model({
        name: 'carto'
      });
      user.organization.owner = new cdb.core.Model({
    ...
    describe('.render', function () {
      it('should render properly', function () {
        ...
        expect(view.$el.html()).not.toContain('<li class="SideMenu-typeItem"><a href="' + BILLING_LINK + '" class="SideMenu-typeLink">Billing</a></li>');
        expect(view.$el.html()).toContain('<a href="mailto:owner@carto.com">Contact your org. admin</a>');
      });
    });

    describe('is org owner', function () {
      beforeEach(function () {
        user.isOrgOwner = function () { return true; };
      });
      ...
      describe('.render', function () {
        it('should render properly', function () {
          ...
          expect(view.$el.html()).toContain('<a href="mailto:enterprise-support@carto.com">Contact your VIP support</a>');
        });
      });
    });
