...
module.exports = {
  task: function () {
      ...
      module: {
        rules: [
          ...
          },
          {
            ...
            loader: 'babel-loader',
            include: [
              path.resolve(path.resolve('.'), 'lib/assets/core/javascripts/carto-node'),
              path.resolve(path.resolve('.'), 'lib/assets/core/test/spec/carto-node'),
    ...
    cfg.dashboard_specs = {
      ...
      output: {
        path: path.resolve(path.resolve('.'), '.grunt'),
        filename: '[name].dashboard-specs.js'
      },
      module: {
        rules: [
          {
