        ...
        if(column[1] !== 'header') {
          ...
          .bind('georeference', function(column) {
            ...
            if (!this.options.geocoder.isGeocoding() && !this.model.isSync()) {
              ...
              dlg.bind('geocodingChosen', function() {
                console.log(arguments, this.options.geocoder);
                console.log("TODO!!!!! start doing anything!");
              }, this);
    ...
    cdb.admin.TableTab = cdb.core.View.extend({
      ...
      _initBinds: function() {
        ...
        this.geocoder.bind('geocodingComplete geocodingError geocodingCanceled', function() {
          if (this.model.data) this.model.data().fetch();
        }, this);
