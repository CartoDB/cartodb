...
const TRIAL_ACCOUNTS = ['PERSONAL30', 'Professional'];
...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    if (TRIAL_ACCOUNTS.indexOf(accountType) > -1) {
      const trialEndsAt = moment('2019-05-25T11:08:27.943Z');
      const createdAt = moment(this._userModel.get('created_at'));
      const trialDays = trialEndsAt.diff(createdAt, 'days');
