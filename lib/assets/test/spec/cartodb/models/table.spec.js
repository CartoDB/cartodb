...
describe("admin table", function() {
  ...
  describe("cbd.admin.CartoDBTableMetadata", function() {
    ...
    it("altertable", function() {
      ...
      expect(t.alterTable('vacuum full')).toEqual(false);
      expect(t.alterTable('exPlain     Analyze select * from test')).toEqual(false);
      expect(t.alterTable('grant update on foo to jerry')).toEqual(false);
      expect(t.alterTable('revoke update on foo from jerry')).toEqual(false);
      expect(t.alterTable('reindex public.foo')).toEqual(false);
      expect(t.alterTable('cluster public.foo using foo_gidx')).toEqual(false);
    ...
    it("altertabledata", function() {
      var t = cdb.admin.CartoDBTableMetadata;
      expect(t.alterTableData('vacuum full')).toEqual(false);
