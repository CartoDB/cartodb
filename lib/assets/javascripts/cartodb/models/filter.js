...
cdb.admin.models.Filter = cdb.core.Model.extend({
  ...
  getSQLConditionForDate: function() {
    ...
    var lowerDate = moment(lower).format("YYYY-MM-DD HH:mm:ss").toString();
    var upperDate = moment(upper).format("YYYY-MM-DD HH:mm:ss").toString();
    var upperDateWithOffset = moment(upper + 1000).format("YYYY-MM-DD HH:mm:ss").toString();
