...
module.exports = function (params) {
  ...
  return {
    ...
    deleteLayer: function (id) {
      ...
      var nodeDefModel = layerToDelete.getAnalysisDefinitionNodeModel();
      var linkedNodesList = nodeDefModel.letter() === layerToDelete.get('letter')
        ? nodeDefModel.linkedListBySameLetter() // => e.g. [b2,b1]
        : [];
