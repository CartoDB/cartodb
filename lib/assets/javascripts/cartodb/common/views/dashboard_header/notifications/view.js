...
module.exports = cdb.core.View.extend({
  ...
  _generateCollection: function() {
    ...
    if (d.remainingQuota <= 0) {
      arr.push({
        iconFont: 'CDB-IconFont-closeLimits',
    ...
    for (var n = 0; n < window.organization_notifications.length; n++) {
      var notification = window.organization_notifications[n].received_notification;
      var icon = notification.icon || 'CDB-IconFont-alert'
