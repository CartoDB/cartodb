          ...
          begin
            ...
            if visualization
              if visualization.update_remote_data(
                  ...
                  dataset['source'], dataset['attributions'], dataset['name_alias'], dataset['exportable'], dataset['export_geom'])
                visualization.store
                updated += 1
              else
                not_modified += 1
              ...
              visualization = Member.remote_member(
                ...
                dataset['description'], dataset['tags'], dataset['license'],
                dataset['source'], dataset['attributions'], dataset['name_alias'], dataset['exportable'], dataset['export_geom']).store
              added += 1
            end
