...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    if (this._isLayerEmpty()) {
      ...
      var noGeometryTooltip = new TipsyTooltipView({
        el: this.$el.find('.js-nogeometrylayer'),
        gravity: 'w',
        title: function () {
          return _t('editor.layers.layer.empty-layer');
        }
      });
      this.addView(noGeometryTooltip);
    }
  ...
  _isLayerEmpty: function () {
    return this._queryGeometryModel.isFetched() && !this._queryGeometryHasGeom() && !this._needsGeocoding();
  },
