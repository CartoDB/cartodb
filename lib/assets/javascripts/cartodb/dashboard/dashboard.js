...
$(function() {
  ...
  cdb.admin.dashboard.Dashboard = cdb.core.View.extend({
    ...
    _index: function() {
      ...
      this.tables.options.set({ q: "", tags: "", per_page: this.tables._PREVIEW_TABLES_PER_PAGE, type: "table" });
    ...
    _tables: function(page) {
      ...
      // Tables
      this.tables.options.set({ q: "", page: page || 1, tags: "", per_page: this.tables._TABLES_PER_PAGE, type: "table" });
      this.tablesView.showLoader();
    ...
    _search: function(opts) {
      ...
      if (model == 'visualizations') {
        ...
        this.tablesView.showDefaultTitle(true);
        this.tables.options.set({ q: q, page: page || 1, tags: "", per_page: this.tables._TABLES_PER_PAGE, type: "table" });
        this.tablesView.showLoader();
        this.tablesView.model.set("padding", true);
    ...
    _tag: function(opts) {
      ...
      if (model == 'visualizations') {
        ...
        this.tablesView.showDefaultTitle(true);
        this.tables.options.set({ q: "", page: page || 1, tags: tag, per_page: this.tables._TABLES_PER_PAGE, type: "table" });
        this.tablesView.showLoader();
        this.tablesView.model.set("padding", true);
