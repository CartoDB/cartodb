...
var CategoriesListItemView = require('builder/components/input-color/input-qualitative-ramps/categories-list/list-item-view/categories-list-item-view');
var inputColorCategoriesListItemTemplate = require('builder/components/input-color/input-qualitative-ramps/categories-list/list-item-view/categories-list-item.tpl');
...
describe('components/form-components/editors/fill/input-color/input-qualitative-ramps/categories-list/list-item-view/categories-list-item-view', function () {
  beforeEach(function () {
    this.model = new CustomListItemModel({
      label: 'hello',
      val: '#FFF',
      image: 'https://s3.dualstack.us-east-1.amazonaws.com/com.cartodb.users-assets.production/maki-icons/star-stroked-18.svg'
    });
