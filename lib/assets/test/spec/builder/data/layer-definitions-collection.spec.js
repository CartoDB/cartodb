...
describe('data/layer-definitions-collection', function () {
  ...
  describe('.save', function () {
    beforeEach(function () {
      ...
      layer1 = new Backbone.Model({ id: 'layer1', type: 'Tiled' });
      layer2 = new Backbone.Model({ id: 'layer2', type: 'CartoDB' });
      layer3 = new Backbone.Model({ id: 'layer3', type: 'CartoDB' });
  ...
  describe('.findPrimaryParentLayerToAnalysisNode', function () {
    beforeEach(function () {
      b1 = analysisDefinitionNodesCollection.add({
        id: 'b1',
        type: 'buffer',
        params: {
          radius: 3,
