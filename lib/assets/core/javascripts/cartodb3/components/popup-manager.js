...
Manager.prototype = {
  ...
  onChangeMutation: function (mutations) {
    _.each(mutations, function (mutation) {
      ...
      if (id === this.id) {
        // this reposition comes from changes in popup's height
        // if it doesn't incur in a resize, we want to maintain
        // position (on top or bottom) when reposition to avoid jumps
