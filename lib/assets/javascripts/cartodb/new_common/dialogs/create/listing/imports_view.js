...
var TabsNavigation = require('new_common/dialogs/create/listing/import_tabs_navigation_view');
...
module.exports = cdb.core.View.extend({
  ...
  _genTabs: function() {
    ...
    // Create navigation
    var tabsNavigation = new TabsNavigation({
      el: this.$('.ImportOptions-tabsList')
    });
    tabsNavigation.render();
    this.addView(tabsNavigation);
  },
  ...
  _setOption: function() {
    ...
    this.createModel.set('importOption', this._DEFAULT_IMPORT);
  },
  ...
  _onTabChange: function(tabName) {
    ...
    if (upload) {
      ...
      this.createModel.set('importOption', tabName);  
    } else {
