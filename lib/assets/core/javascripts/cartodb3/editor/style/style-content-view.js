...
var TableViewModel = require('../../components/table/table-view-model');
...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    if (this._hasError()) {
      ...
      if (this._queryGeometryModel.hasValue()) {
        ...
        if (this._rowsCollection && this._rowsCollection.length > 0) {
  ...
  _onStyleChanged: function () {
    ...
    this._styleModel.removeStylesPreAutoStyle();
