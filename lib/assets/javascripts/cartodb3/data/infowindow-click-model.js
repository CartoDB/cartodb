...
module.exports = InfowindowDefinitionModel.extend({
  ...
  TEMPLATES: {
    ...
    custom_infowindow_light: fs.readFileSync(__dirname + '/../mustache-templates/infowindows_custom/infowindow_light.jst.mustache', 'utf8'),
    custom_infowindow_dark: fs.readFileSync(__dirname + '/../mustache-templates/infowindows_custom/infowindow_dark.jst.mustache', 'utf8'),
    custom_infowindow_light_header_blue: fs.readFileSync(__dirname + '/../mustache-templates/infowindows_custom/infowindow_light_header_blue.jst.mustache', 'utf8'),
    custom_infowindow_header_with_image: fs.readFileSync(__dirname + '/../mustache-templates/infowindows_custom/infowindow_header_with_image.jst.mustache', 'utf8')
  },
  ...
  setDefault: function () {
    this.setTemplate('infowindow_light');
  }
