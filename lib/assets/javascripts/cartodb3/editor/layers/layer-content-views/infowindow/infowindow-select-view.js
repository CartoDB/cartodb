...
module.exports = cdb.core.View.extend({
  ...
  _compileTemplate: function (template_name) {
    ...
    var fields = _.map(this._layerInfowindowModel.attributes.fields, function (field) {
      return _.clone(field);
    });
    var data = this._layerInfowindowModel.get('content') ? this._layerInfowindowModel.get('content').data : {};
    ...
    var values = {};
    _.each(this._layerInfowindowModel.get('fields'), function (pair) {
  ...
  _sanitizeField: function (attr, template_name, pos) {
    ...
    var alternative_name = this._layerInfowindowModel.getAlternativeName(attr.title);

    if (attr.name && alternative_name) {
      // Alternative title
      attr.name = alternative_name;
    } else if (attr.name) {
