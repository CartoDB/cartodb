...
const EditableDescription = require('dashboard/components/editable-fields/editable-description.js');
...
describe('dashboard/components/editable-fields/editable-description', function () {
  var model, view;
  ...
  describe('if the field is editable', function () {
    ...
    it('should render a button and edit and save the field when empty', function () {
      ...
      // Hit enter
      view.$('.js-field-input').trigger(keyPressEvent(13));
    ...
    it('should cancel edition if esc is pressed', function () {
      ...
      type(view.$('.js-field-input'), 'wadus');
      view.$('.js-field-input').trigger(keyPressEvent(27));
    ...
    it('should introduce new lines if cmd+enter is pressed', function () {
      ...
      type(view.$('.js-field-input'), 'wadus');
      view.$('.js-field-input').trigger(keyPressEvent(13, true));
