  ...
  cdb.admin.StartNoTables = cdb.core.View.extend({
    ...
    template: '<iframe id="video" src="http://player.vimeo.com/video/<%= url %>?api=1&amp;player_id=video" width="100%" height="100%" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>',
