...
dist/cartodb.core.js:  vendor/underscore-min.js vendor/mustache.js vendor/reqwest.min.js src/api/core_lib.js src/api/sql.js
	...
	cat vendor/reqwest.min.js src/api/sql.js src/api/tiles.js >> dist/cartodb.core.uncompressed.js
