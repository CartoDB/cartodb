...
var ExportMapModel = require('../../../../../../../javascripts/cartodb3/data/export-map-definition-model');
var ExportView = require('../../../../../../../javascripts/cartodb3/editor/components/modals/export-map/modal-export-map-view');
var templateExportMapDownload = require('../../../../../../../javascripts/cartodb3/editor/components/modals/export-map/export-map-download.tpl')
...
describe('editor/components/modals/export-map/modal-export-map-view', function () {
  ...
  describe('render', function () {
    it('should render confirmation view if state is undefined', function () {
      ...
      expect(this.view.$el.html()).toContain(this.visDefinitionModel.get('name'));
    });
