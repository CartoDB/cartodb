...
describe('editor/widgets/widgets-form/widgets-form-view', function () {
  ...
  describe('._getFilteredDataTypes', function () {
    ...
    it('should not include time-series in carousel options if there is a time-series widget', function () {
      var filteredDataTypes = this.view1._getFilteredDataTypes();
      expect(filteredDataTypes.length).toBe(3); // carousel options
    });

    it('should include time-series in carousel options if it is a time-series widget', function () {
      var filteredDataTypes = this.view2._getFilteredDataTypes();
      expect(filteredDataTypes.length).toBe(4); // carousel options
    });
  });
