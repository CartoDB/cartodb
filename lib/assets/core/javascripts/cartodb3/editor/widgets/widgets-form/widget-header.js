...
module.exports = CoreView.extend({
  ...
  render: function () {
    var widgetTitle = this._model.get('title');

    this.$el.html(
      template({
        title: widgetTitle,
        source: this._model.get('source'),
  ...
  _renameWidget: function () {
    ...
    if (newName !== '' && newName !== this._model.get('title')) {
      this._model.set({title: newName});
      this._userActions.saveWidget(this._model);
  ...
  _confirmDeleteWidget: function () {
    WidgetsService.removeWidget(this._model);
  },
