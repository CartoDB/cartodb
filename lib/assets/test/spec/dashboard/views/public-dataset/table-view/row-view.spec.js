...
const VisualizationModel = require('fixtures/dashboard/visualization-model.fixture');
const configModel = require('fixtures/dashboard/config-model.fixture');

// This test need things that are not migrated yet, or won't be migrated

// describe('RowView', function () {
//   let tableview, view, model, sqlView;

//   beforeEach(function () {
//     model = new CartoDBTableMetadata({
//       name: 'test',
