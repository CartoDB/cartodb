  ...
  cdb.admin.dashboard.Dashboard = cdb.core.View.extend({
    ...
    */
    ...
    _index: function() {
      ...
      this.filterView.setQuery();
      this.filterView.model.set("visible", false);
    ...
    _search: function(opts) {
      ...
      this.filterView.model.set("visible", true);
      this.filterView.setQuery(q);
    ...
    _setupSearchView: function() {
      ...
      this.filterView.bind('search', this._onSearch, this);
    },
    ...
    _initViews: function() {
      ...
      this.posts_widget = new cdb.admin.PostsWidget({
        tables:         this.tables,
        visualizations: this.visualizations
      });
      this.$('header h1').append(this.posts_widget.render().el);
      this.addView(this.posts_widget);
