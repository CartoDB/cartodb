...
var InputColorCategories = require('../../../../../../../../../javascripts/cartodb3/components/form-components/editors/fill/input-color/input-qualitative-ramps/main-view');
...
describe('components/form-components/editors/fill/input-color/input-qualitative-ramps/main-view', function () {
  ...
  it('should only display ".js-prevStep" element when the stackLayout is in the step 0.', function () {
    pending('IMPLEMENT ME');
  });

  // TODO: Investigate this: whats the expected behaviour?
