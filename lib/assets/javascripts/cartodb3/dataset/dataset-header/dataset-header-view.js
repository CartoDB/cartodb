...
module.exports = CoreView.extend({
  ...
  _deleteDataset: function () {
    ...
    var affectedVisData = this._tableModel.get('dependent_visualizations');
    ...
    this._modals.create(function (modalModel) {
      return new ConfirmationModalView({
        ...
        renderOpts: {
          ...
          visibleAffectedVis: self._prepareVisibleAffectedVisForTemplate(affectedVisData.slice(0, AFFECTED_VIS_COUNT))
        },
        runAction: function () {
