...
module.exports = Router.extend({
  ...
  routes: {
    ...
    // Imported datasets
    'datasets/imported':                      '_changeRouteToDatasets',

    // Datasets categorized
    'datasets/category/:cat':                 '_changeRouteToDatasets',
  ...
  _changeRouteToDatasets: function(page) {
    ...
    var imported = this._doesCurrentUrlContain('datasets/imported');
    var category = this._doesCurrentUrlContain('datasets/category');
  ...
  _changeRouteToMaps: function(page) {
    ...
    this.model.set({
      ...
      tag:            '',
      shared:         shared ? 'only' : 'no',
      locked:         locked ? 'true' : ((shared || liked) ? 'false' : 'always'),
      liked:          liked,
      library:        false,
      deepInsights:   false
    });
