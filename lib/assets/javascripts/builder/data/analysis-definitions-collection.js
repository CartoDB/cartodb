...
module.exports = Backbone.Collection.extend({
   ...
   */
  saveAnalysisForLayer: function (layerDefModel, saveContainedNodes = true) {
    ...
    this.each(function (analysisDefModel) {
      if (saveContainedNodes && analysisDefModel.containsNode(nodeDefModel) || !saveContainedNodes && analysisDefModel.isNode(nodeDefModel)) {
