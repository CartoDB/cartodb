...
module.exports = _.defaults({
  ...
  DEFAULT_FILL_COLOR: '#FAD66B',
  DEFAULT_POINT_FILL_COLOR: '#f85621',
  DEFAULT_LINE_STROKE_COLOR: '#2158f8',
    ...
    if (geometryType !== 'line') {
      return {
        fill: {
          ...
          // 'image': null,
          'color': {
            fixed:  geometryType === 'point' ? this.DEFAULT_POINT_FILL_COLOR :this.DEFAULT_FILL_COLOR,
  ...
  _getStrokeAttrs: function (geometryType) {
    return {
      stroke: {
        'size': {
          fixed: geometryType === 'point' ? 0.5: 2
        },

        'color': {
          fixed: geometryType !== 'line' ? this.DEFAULT_STROKE_COLOR : this.DEFAULT_LINE_STROKE_COLOR,
          opacity: 1
        }
      }
    };
