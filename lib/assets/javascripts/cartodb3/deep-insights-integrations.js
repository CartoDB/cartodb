...
var F = function (opts) {
  ...
  this._analysisDefinitionsCollection.on('reset', this._onAnalysisDefinitionReset, this);
  this._analysisDefinitionsCollection.on('add change:node_id sync', this._analyseDefinition, this);
  this._analysisDefinitionsCollection.on('remove', this._onAnalysisDefinitionRemoved, this);
...
F.prototype._onAnalysisDefinitionReset = function () {
  this._analysisDefinitionsCollection.each(this._analyseDefinition, this);
};

F.prototype._onAnalysisDefinitionRemoved = function (m) {
  var id = m.get('node_id');
  var node = this.vis().analysis.findNodeById(id);
  if (node) {
    node.remove();
  }
};
...
F.prototype._analyseDefinition = function (m) {
  ...
  this.vis().analysis.analyse(attrs);
};
