...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this.USER_SAVED; // flag to indicate if the user saved the node and avoid triggering the onboarding model if they didn't. It should be set to undefined, to appear the first time the analysis is saved
