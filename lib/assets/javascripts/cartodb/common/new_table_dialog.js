...
/*
  ...
  TODO with matallo:
    - Check basemap dialog.

  Dialog tabs: -> href and li with this option -> done
  Setup a tab from the beginning
  ...
  - Check drag mamufas file extension.
  - Open tab using options of the dialog.
  ...
  // Set active tab if it was specified
    // if not will show file option
    // this.model.set('option', this.options.option || 'file')
