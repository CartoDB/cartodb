cdb.admin.overlays.Text = cdb.core.View.extend({
  ...
  _savePosition: function(editable) {
    ...
    var rightPosition  = r - this.$el.width();
    var bottomPosition = b - this.$el.height();
    ...
    var landscapeDominantSide = x <= rightPosition ? "left" : "right";
    var portraitDominantSide  = y <= bottomPosition ? "top" : "bottom";
