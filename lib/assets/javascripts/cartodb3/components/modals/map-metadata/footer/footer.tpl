...
<div class="CreateDialog-footerInner ">
  ...
  <div class="CreateDialog-footerActions js-footerActions">
    <button class="js-save CDB-Button CDB-Button--primary <%- canFinish ? '' : 'is-disabled' %>">
      <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-medium u-upperCase"><%- _t('components.modals.maps-metadata.save-btn') %></span>
    </button>
  </div>
</div>
