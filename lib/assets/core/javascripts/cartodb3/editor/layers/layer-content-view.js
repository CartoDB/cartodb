...
module.exports = CoreView.extend({
  ...
  _renderContextButtons: function () {
    ...
    $('.js-showMap').on('click', this._onMapClick);
    $('.js-showTable').on('click', this._onTableClick);
  ...
  _destroyContextButtons: function () {
    $('.js-showMap').off('click', this._onMapClick);
    $('.js-showTable').off('click', this._onTableClick);
  ...
  _hasGeom: function () {
    return !!this._getQueryGeometryModel().hasValue();
  },
