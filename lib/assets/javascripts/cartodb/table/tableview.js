    ...
    cdb.admin.TableView = cdb.ui.common.Table.extend({
      ...
      initialize: function() {
         ...
         this.model.data().bind('newPage', this.newPage, this);
          ...
          _.bindAll(this, "render", "addEmptyRow", "_checkEmptyTable", "rowChanged", "rowSynched", "rowFailed");
          window.a = this;
...
//              console.log(realPos, tableHeight, tableHeight - realPos);
        ...
        this._models[0].bind('remove', this._checkEmptyTable);
      ...
      */
      addEmptyRow: function() {
        this._models[0].table.data().addRow({ at: 0});
        this.cleanEmptyTableInfo();
      },
