...
// Hooks
import {mapsBeforeEnter, datasetsBeforeEnter, trialExpiredBeforeEnter} from 'new-dashboard/router/hooks/check-navigation';
...
const router = new Router({
  ...
  routes: [
    ...
    // },
    {
      ...
      meta: {
        title: () => 'Trial Expired | CARTO'
      },
      beforeEnter: trialExpiredBeforeEnter
    },
    {
      path: '/solutions',
      name: 'solutions',
