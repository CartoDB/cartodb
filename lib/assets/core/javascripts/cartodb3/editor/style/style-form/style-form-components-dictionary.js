...
module.exports = {
  'fill': function (params) {
    ...
    var isPolygonGeometry = params.queryGeometryModel && params.queryGeometryModel.get('simple_geom') === 'polygon';
    var color = {};
    var size = {
      min: 1,
      max: 45,
    ...
    if (_.contains(StylesFactory.getAggregationTypes(), params.styleType) || isPolygonGeometry) {
