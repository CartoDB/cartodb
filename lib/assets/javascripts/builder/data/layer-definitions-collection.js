...
module.exports = Backbone.Collection.extend({
  ...
  _updateBaseLayer: function (basemapAttrs, opts) {
    ...
    this._updateUrlTemplaIfHighResolution(newBaseLayerAttrs);
  ...
  _updateLabelsLayer: function (newBaseLayerAttrs, opts) {
    ...
    this._updateUrlTemplaIfHighResolution(newAttrs);
  ...
  _updateUrlTemplaIfHighResolution: function (attrs) {
    if (this._isHdpi() && attrs.urlTemplate && attrs.urlTemplate2x) {
      attrs.urlTemplate = attrs.urlTemplate2x;
    }
  },
