    ...
    _createHelpDialog: function() {
      ...
      var HelpDialog = cdb.admin.BaseDialog.extend({
        render_content: function() {
          return "<p>This template allows you to add an image to your infowindow.</p><p>The image URLs will need to be stored as a column in your table. Next, you will need to drag the URL field to the top of your infowindow and then select 'Header with image'.</p>";
        },
      });
