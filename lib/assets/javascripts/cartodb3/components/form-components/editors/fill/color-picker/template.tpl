...
<div class="ColorPicker-inputs">
  <div class="ColorPicker-inputWrapper">
    <input type="text" class="CDB-InputText ColorPicker-input js-hex" />
    <span class="ColorPicker-inputLabel u-upperCase">HEX</span>
  </div>
  <div class="ColorPicker-inputWrapper">
    <input type="text" class="CDB-InputText ColorPicker-input js-r" />
    <span class="ColorPicker-inputLabel u-upperCase">R</span>
  </div>
  <div class="ColorPicker-inputWrapper">
    <input type="text" class="CDB-InputText ColorPicker-input js-g" />
    <span class="ColorPicker-inputLabel u-upperCase">G</span>
  </div>
  <div class="ColorPicker-inputWrapper">
    <input type="text" class="CDB-InputText ColorPicker-input js-b" />
