...
var ParserCSSLegacy = require('../../helpers/parser-css-legacy');
...
module.exports = CoreView.extend({
  ...
  _saveCartoCSS: function (cb) {
    ...
    if (this._userModel.featureEnabled('dot_properties')) {
      parser = new ParserCSS(content, this._layerDefinitionModel.isTorqueLayer());
    } else {
      parser = new ParserCSSLegacy(content);
    }
