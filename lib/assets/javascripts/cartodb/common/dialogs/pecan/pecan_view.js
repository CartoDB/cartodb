...
module.exports = cdb.core.View.extend({
  ...
  _EXCLUDED_COLUMNS: [
    ...
    'shape_length', 'shape_area', 'objectid', 'id', 'country', 'state', 'created_at', 'updated_at',
    'latdd', 'longdd', 'iso2', 'iso3', 'x', 'y', 'x_coord', 'y_coord', 'xcoord', 'ycoord',
    'cartodb_georef_status','scalerank', 'strokweig', 'area_sqkm', 'region', 'subregion', 'funcstat',
