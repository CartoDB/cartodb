...
describe('SearchSuggestions.vue', () => {
  ...
  describe('Methods', () => {
    ...
    describe('getActiveSuggestion', () => {
      it('should get active suggestion after pressing twice the arrow down key', () => {
        const searchSuggestions = createSearchSuggestions();
        searchSuggestions.vm.keydownDown();
        searchSuggestions.vm.keydownDown();
        const activeSuggestion = searchSuggestions.vm.getActiveSuggestion();
    ...
    describe('keydownDown', () => {
      it('should set as active the next item in the suggestion list', () => {
        const searchSuggestions = createSearchSuggestions();
        searchSuggestions.vm.keydownDown();
        expect(searchSuggestions.vm.activeSuggestion).toEqual(0);
      });
    });
    ...
    describe('keydownUp', () => {
      it('should set as active the previous item in the suggestion list', () => {
        ...
        expect(searchSuggestions.vm.activeSuggestion).toEqual(2);
      });
    });
    ...
    describe('resetActiveSuggestion', () => {
      it('should reset the active item to the initial state', () => {
        ...
        searchSuggestions.vm.resetActiveSuggestion();
        expect(searchSuggestions.vm.activeSuggestion).toEqual(-1);
      });
    });
    ...
    describe('updateActiveSuggestion', () => {
      it('should update the active element to the third search suggestion', () => {
        const searchSuggestions = createSearchSuggestions();
        searchSuggestions.vm.udpateActiveSuggestion(2);
        expect(searchSuggestions.vm.activeSuggestion).toEqual(2);
      });
    });
  });
