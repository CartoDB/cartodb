...
cdb.forms.Color = cdb.core.View.extend({
  ...
  _createPicker: function() {
    this.color_picker = new cdb.admin.ColorPicker({
      ...
      // Color applied in color picker
      cdb.god.trigger('mixpanel', "Applying color with color picker", {
        color:    color,
  ...
  _openImagePicker: function(e) {
    ...
    this.image_picker.bind('fileChosen', function(url) {
      ...
      // URL applied in color picker
      cdb.god.trigger('mixpanel', "Applying background url as " + this.image_kind, {
        url:      url,
        property: this.image_kind
      });
    }, this);
  },
  ...
  _openColorPicker: function(e) {
    ...
    if (this.color_picker) this._unbindColorPicker();
