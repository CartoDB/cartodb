...
var MEASUREMENT_BY_ID = "select numer_id, numer_name, numer_description, numer_type, numer_aggregate, numer_tags FROM OBS_GetAvailableNumerators((SELECT ST_SetSRID(ST_Extent(the_geom), 4326) FROM ({{{ query }}}) q), {{{ area }}}) WHERE numer_id = '{{{ measurement }}}'";
