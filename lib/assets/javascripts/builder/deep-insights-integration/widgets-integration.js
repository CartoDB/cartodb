...
module.exports = {
  ...
  _onWidgetAutoStyleChanged: function (model) {
    ...
    if (!this.onLayerChange) {
      this.onLayerChange = _.debounce(function () {
    ...
    if (isAutoStyleApplied) {
      ...
      layerDefModel.on('change:autoStyle change:cartocss', this.onLayerChange, this);
    } else {
      layerDefModel.off(null, this.onLayerChange);
