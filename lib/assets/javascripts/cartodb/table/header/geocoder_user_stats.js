  ...
  cdb.admin.GeocoderStats = cdb.core.View.extend({
    ...
    _TEXTS: {
      ...
      not_enough_hard: _t('You don\'t have enough geocoding credits to geocode the entire table this month. <strong>Only <%= quota - monthly_use %> row<%= quota - monthly_use > 1 ? "s" : "" %> will be geocoded</strong>, <a href="<%= upgrade_url %>">need more</a>?.'),
