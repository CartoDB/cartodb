      ...
      return _.extend(
        {
          ...
          state: step === "import" ? this.imp.get('state') : '',
          content_guessing: step === "import" ? this.imp.get('content_guessing') : '',
          type_guessing: step === "import" ? this.imp.get('type_guessing') : '',
          server: step === "import" ? this.imp.get('server') : '',
          service_name: step === "import" ? this.imp.get('service_name') : '',
          host: step === "import" ? this.imp.get('host') : '',
          upload_host: step === "import" ? this.imp.get('upload_host') : '',
          resque_ppid: step === "import" ? this.imp.get('resque_ppid') : '',
