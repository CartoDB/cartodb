<div class="IntermediateInfo">
  <div class="Dialog-header Modal-header js-header">
    ...
    <h2 class="CDB-Text CDB-Size-large u-bSpace u-errorTextColor"><%- _t('components.modals.dataset-metadata.error.title') %></h2>
        ...
        <ul class="Modal-actions is-narrow">
          <li class="Modal-actions-button">
            <button class="CDB-Button CDB-Button--primary js-back">
              <span class="CDB-Button-Text CDB-Text is-semibold CDB-Size-medium u-upperCase"><%- _t('components.modals.dataset-metadata.back-btn') %></span>
            </button>
          </li>
        </ul>
      </div>
