...
module.exports = function (params) {
  ...
  return {
    ...
    createAnalysisNode: function (nodeAttrs, layerDefModel) {
      ...
      ResetStylePerNode(nodeDefModel, layerDefModel);
    ...
    deleteAnalysisNode: function (nodeId) {
      ...
      if (oldNodeStyle) {
        ...
        ResetStylePerNode(primarySourceNode, layerDefModel);
      }
      layerDefModel.save();
      analysisDefinitionsCollection.saveAnalysisForLayer(layerDefModel);
    ...
    createLayerForAnalysisNode: function (nodeId, cfg) {
      ...
      var onNewLayerSaved = function (layer, resetStyles) {
        if (resetStyles) {
          ResetStylePerNode(layer.getAnalysisDefinitionNodeModel(), layer, true);
        }
      ...
      if (prevLayer) {
        if (nodeDefModel.hasPrimarySource()) {
          ...
          ResetStylePerNode(prevLayer.getAnalysisDefinitionNodeModel(), prevLayer, true);
