...
describe('helpers/reset-style-per-node', function () {
  ...
  describe('when queryGeometryModel and querySchemaModel are ready', function () {
    ...
    describe('fetch models', function () {
      ...
      xit('should not fetch geometry model if it is not fetching or it is available', function () {
        expect(nodeDefModel.queryGeometryModel.fetch).not.toHaveBeenCalled();
      });

      xit('should not fetch schema model if it is not fetching or it is available', function () {
        expect(nodeDefModel.querySchemaModel.fetch).not.toHaveBeenCalled();
      });
    });
    ...
    describe('when queryGeometryModel and querySchemaModel are fetched', function () {
      beforeEach(function () {
        spyOn(nodeDefModel.querySchemaModel, 'isInFinalState').and.returnValue(true);
        spyOn(nodeDefModel.queryGeometryModel, 'isInFinalState').and.returnValue(true);
