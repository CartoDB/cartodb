...
var label_halo_properties = {
  ...
  form: {
    ...
    'text-halo-radius': { type: 'number', value: 1, min: 0, max:10}
  }
};
...
cdb.admin.forms.bubble_form = [
  column, // Select column
  {
     ...
     form: {
       'radius_min': { type: 'number', value: 3, min:0, max:100 },
       'radius_max': { type: 'number', value: 10, min:0, max:100 }
     },
     text: '- to -'
  },
  {
  ...
  },
  {
     name: 'Bubble stroke',
     form: {
       'marker-line-width': { type: 'number', value: 2, min:0, max:100 },
       'marker-line-color': { type: 'color', value: '#FFF' },
