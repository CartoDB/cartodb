...
cdb.admin.VisualizationPaginator = cdb.core.View.extend({
  ...
  console.log('rendering');
    ...
    if (per_page == 3) {
      ...
      if (current_page - 1 > 0) $ul.append('<li><a href="' + (current_page - 1)+ '" class="prev button grey page"></a></li>');
      else $ul.append('<li><a href="#" class="prev button grey page disabled"></a></li>')
      ...
      if (current_page < total_pages) $ul.append('<li><a href="' + (current_page + 1)+ '" class="next button grey page"></a></li>');
      else $ul.append('<li><a href="#" class="next button grey page disabled"></a></li>')
