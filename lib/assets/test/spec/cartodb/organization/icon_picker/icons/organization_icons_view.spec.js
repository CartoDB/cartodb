var IconPickerView = require('../../../../../../javascripts/cartodb/organization/icon_picker/icons/organization_icons_view.js');
...
describe('organization/icon_picker/icons/organization_icons_view', function () {
  ...
  describe('_hideActions', function () {
    it('should hide all actions', function () {
      ...
      expect(this.view._hide).toHaveBeenCalledWith('.js-selectAllIcons');
      expect(this.view._hide).toHaveBeenCalledWith('.js-deselectAllIcons');
      expect(this.view._hide).toHaveBeenCalledWith('.js-deleteIcons');
      expect(this.view._hide).toHaveBeenCalledWith('.js-iconsInfo');
      expect(this.view._hide).toHaveBeenCalledWith('.js-viewAllIcons');
    });
  });
