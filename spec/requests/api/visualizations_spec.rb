...
describe Api::Json::VisualizationsController do
  ...
  describe 'index endpoint' do
    ...
    it 'tests exclude_shared and only_shared filters' do
      ...
      table = create_table(privacy: CartoDB::Table::Privacy::PUBLIC, name: "table#{rand(9999)}_1", user_id: user_1.id)
      u1_t_1_id = table.table_visualization.id
      u1_t_1_perm_id = table.table_visualization.permission.id

      table = create_table(privacy: CartoDB::Table::Privacy::PUBLIC, name: "table#{rand(9999)}_2", user_id: user_2.id)
    ...
    it 'tests totals calculations' do
      ...
      table = create_table(privacy: CartoDB::Table::Privacy::PUBLIC, name: "table_#{rand(9999)}_1_1", user_id: user_1.id)
      u1_t_1_id = table.table_visualization.id

      table = create_table(privacy: CartoDB::Table::Privacy::PUBLIC, name: "table_#{rand(9999)}_2_2", user_id: user_2.id)
      u2_t_1_id = table.table_visualization.id
