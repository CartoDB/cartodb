...
var LocaleHelper = require('../../../../helpers/locale');
...
var getNotificationMessage = function (type) {
  var prefix = 'notifications.sql.';
  var key = prefix + type;
  var result = LocaleHelper.linkify(key);
  return result || _t('notifications.sql.errors.unknown');
};
...
module.exports = DatasetBaseView.extend({
  ...
  _runQuery: function (query, callback) {
    ...
    var errorSQL = function (err) {
      ...
      var error = getNotificationMessage(type);
