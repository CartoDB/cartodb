...
module.exports = CoreView.extend({
  ...
  _getSimpleGeometryType: function () {
    if (this._querySchemaModel.get('status') === 'fetching') return '';
  ...
  render: function () {
    ...
    var m = this.model;
    var self = this;
    var geometryTemplate = this._getGeometryTemplate(this._getSimpleGeometryType());
  ...
  _getGeometryTemplate: function (geometry) {
    ...
    switch (geometry) {
      case 'line':
        template = geometryLinesTemplate;
        break;
      case 'point':
        template = geometryPointsTemplate;
        break;
      case 'polygon':
        template = geometryPolygonsTemplate;
        break;
      default:
        template = geometryNoneTemplate;
    }
