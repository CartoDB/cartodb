...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _setupShareOverlay: function(type, data) {
    ...
    var widget = this.share = new cdb.admin.widgets[type]({
      model: data,
      map: this.map
    });
  ...
  _setupLoaderWidget: function(type, data) {

    var widget = this.loader = new cdb.admin.widgets[type]({
      model: data,
      map: this.map
    });
  ...
  _setupFullScreenOverlay: function(type, data) {
    ...
    var widget = this.fullscreen = new cdb.admin.widgets[type]({
      model: data,
      mapView: this.mapView
    });
  ...
  _setupZoomOverlay: function(type, data) {
    ...
    var widget = this.zoom = new cdb.admin.widgets[type]({
      model: data,
      map: this.map
    });
  ...
  _setupHeaderOverlay: function(type, data) {
    ...
    var widget = this.header = new cdb.admin.widgets[type]({
      model: data,
      map: this.map
    });
  ...
  _setupSearchOverlay: function(type, data) {
    ...
    var widget = this.search = new cdb.admin.widgets[type]({
      model: data,
      map: this.map
    });
  ...
  _setupZoomInfoOverlay: function(type, data) {
    ...
    var widget = this.zoomInfo = new cdb.admin.widgets[type]({
      model: data,
      map: this.map
    });
  ...
  _renderOverlay:  function(delayed_animation, data) {
    ...
    switch(type) {
      ...
      case 'Loader':     widget = this._setupLoaderWidget(type, data);          break;
      case 'ZoomInfo':   widget = this._setupZoomInfoOverlay(type, data);       break;
      case 'Share':      widget = this._setupShareOverlay(type, data);          break;
      case 'Zoom':       widget = this._setupZoomOverlay(type, data);           break;
      case 'Fullscreen': widget = this._setupFullScreenOverlay(type, data);     break;
      case 'Title':      widget = this._setupHeaderOverlay(type, data);         break;
      case 'Search':     widget = this._setupSearchOverlay(type, data);         break;

      // Default
      case 'Text':       widget = new cdb.admin.widgets[type]({ model: data }); break;
      case 'Image':      widget = new cdb.admin.widgets[type]({ model: data }); break;
