...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._geometryModel = this._analysisDefinitionNodeModel.geometryModel;
    this._geometryModel.on('change', this.render, this);
  ...
  _renderCategory: function (category) {
    var view = new AnalysisCategoryView({
      ...
      simpleGeometryType: this._geometryModel.get('simple_geom')
    });
    this.addView(view);
  ...
  _isFetchingGeometry: function () {
    return this._geometryModel.get('status') === 'fetching';
  },
