...
const navigateThroughRouter = require('cartodb3/helpers/navigate-through-router');
...
module.exports = AdminDropdownMenu.extend({
  ...
  initialize: function (options) {
    ...
    // this.elder('initialize'); // TODO: What's this?
  },

  render: function () {
    var dashboardUrl = this.model.viewUrl().dashboard(); // TODO: Add to required opts?
