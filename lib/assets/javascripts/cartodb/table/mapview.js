...
*/
  ...
  _positionOverlay: function(overlay_model) {
    ...
    else if (type === 'zoom_info')      this._positionZoomInfoOverlay(overlay_model);
  ...
  _positionHeaderOverlay: function(overlay_model) {
    ...
    if ( this.headerMessageIsVisible) overlay_model.set("y", 20);
  ...
  _positionLoaderOverlay: function(overlay_model) {
    ...
    else if (this.headerMessageIsVisible) overlay_model.set("y", this._getHeaderHeight() + 40);
