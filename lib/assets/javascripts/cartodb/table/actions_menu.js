  ...
  cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
    ...
    events: {
      'click .title_bar':      '_toggleTitleLayer',
    ...
    initialize: function() {
      ...
      // View bindings
      _.bindAll(this, '_toggleTitleLayer', '_togglePanel', '_changeTitle', '_sortStart', '_sortChange', '_sortBeforeStop', '_sortLayers',
    ...
    *******/
    ...
    _toggleTitleLayer: function() {
      // Activate/deactivate title layer
      if (this.$('.title_layer').hasClass('open')){
        this._hideTitleLayer();
      } else {
        this._showTitleLayer();
      }
    },
    ...
    _hideTitleLayer: function() {
      ...
      this.$('.title_layer_contents').empty();
    },

    _showTitleLayer: function() {
      var $title = this.$('.title_layer');
      // Close table tabs
      this.hide();
      this.$('.layer_panel').css({ height: 66 });
      // Populate and show title tab space
      $title.animate({
          height: '70%'
        }, this.animation_time);
      $title.addClass('open');
