...
var CategoriesListItemView = require('builder/components/form-components/editors/fill/input-color/input-categories/categories-list/categories-list-item-view');
var inputColorCategoriesListItemTemplate = require('builder/components/form-components/editors/fill/input-color/input-categories/input-color-categories-list-item.tpl');
