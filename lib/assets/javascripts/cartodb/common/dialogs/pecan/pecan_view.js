...
module.exports = BaseDialog.extend({
  ...
  _analyzeStats: function(name, stats) {
    ...
    if (stats.type === "string" && (distinctPercentage < 25 || distinctPercentage > 75)) {
      console.log("%c" + name + ' rejected because the distinctPercentage > 75% || distinctPercentage < 25%: ' + distinctPercentage, "font-weight: bold; color:red;");
      return false;
    }
