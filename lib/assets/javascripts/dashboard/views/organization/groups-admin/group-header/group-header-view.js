...
const pluralizeString = require('dashboard/helpers/pluralize-string');
...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    if (isNewGroup) {
      ...
      templateData.editUrl = this.options.urls.edit;
      templateData.usersUrl = this.options.urls.users;
      ...
      if (!this.options.urls.users.isCurrent) {
        templateData.backUrl = this.options.urls.users;
      }
    }
