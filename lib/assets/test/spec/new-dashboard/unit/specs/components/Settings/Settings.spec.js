...
describe('Settings.vue', () => {
  ...
  it('should hide filter from dropdown when there are no entries', () => {
    const settingsDropdown = createSettingsDropdown({
      section: 'maps',
      filter: 'mine',
      order: 'updated_at',
  ...
  describe('Methods', () => {
    ...
    describe('setOrder', () => {
      const settingsDropdown = createSettingsDropdown();
      const filterElement = settingsDropdown.find('.section:nth-child(2) .type:nth-child(2) .element:nth-child(2)');
