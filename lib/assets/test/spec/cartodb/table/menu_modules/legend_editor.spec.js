...
describe('cdb.admin.mod.LegendEditor ', function() {
  ...
  var legendEditor, availableLegends, view, dataLayer, legendModel, table, wizardProperties, properties, intensity_properties;
  ...
  it('should update color items when the wizard changes', function() {
    ...
    expect(view.$el.find(".category li span.field .form_color span.color").css("background-color")).toEqual("red");
  ...
  it('should generate the custom legend from the category legend', function() {
    ...
    expect(view.$el.find(".custom li span.field .form_color span.color").css("background-color")).toEqual("red");
  ...
  it('should restore the state of the custom legend pane', function() {
    ...
    dataLayer.set("wizard_properties", { type: "intensity", properties: intensity_properties })
    expect(view.model.get("type")).toEqual("intensity");
    expect(view.$el.find(".custom").css("display")).toEqual("none");
  ...
  it('shouldn\'t change the type of the legend when the wizard changes and the user has decided not to have a legend', function() {
...
describe('cdb.admin.mod.LegendEditor: choropleth', function() {
  ...
  var legendEditor, availableLegends, view, dataLayer, legendModel, table, wizardProperties, properties;
