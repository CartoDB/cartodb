    ...
    _createHelpDialog: function() {
      ...
      var HelpDialog = cdb.admin.BaseDialog.extend({
        render_content: function() {
          return "<p>This template allows you to add an image to your infowindow. You will only need to put in the first place of the customization list, a column with URL’s to the images that you want.</p>" +
            "<p>We higly recommend you to preproccess those images in order to improve your map experience.";
        },
      });
