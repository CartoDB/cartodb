...
function cluster_sql(table, zoom, props) {
...
function cluster_generator(table, props, changed, callback) {
  ...
  var cluster_sql_gen = cluster_sql(table, props.zoom, props);

  simple_polygon_generator(table, carto_props, changed, function(css) {

    css = "#" + table.get('name') + "{\n";
    css += "  marker-width: 12;\n";
    css += "  marker-fill: #5CA2D1;\n";
    css += "  marker-opacity: 0.6;\n";
    css += "  marker-line-width: 0;\n";
    css += "  marker-allow-overlap: true;\n";
    css += "  marker-comp-op: dst-atop;\n";
    css += "  [src = 'smalls'] { marker-width: 20; } \n";
    css += "  [src = 'mids'] { marker-width: 44;} \n";
    css += "  [src = 'bigs'] { marker-width: 64; } \n";
    css += "  [zoom>11]{marker-width: 52;}\n";
    css += "}\n";
    css += "#" + table.get('name') + "::labels { \n";
    css += "  text-size: 0; \n";
    css += "  text-fill: black; \n";
    css += "  text-opacity: 0.8;\n";
    css += "  text-name: [points_count]; \n";
    css += "  text-face-name: 'DejaVu Sans Book'; \n";
    css += "  text-halo-fill: #fff; \n";
    css += "  text-halo-radius: 0; \n";
    css += "  [src = 'smalls'] { text-size: 18; text-halo-radius: 1; } \n";
    css += "  [src = 'mids'] { text-size: 26; text-halo-radius: 1; } \n";
    css += "  [src = 'bigs'] { text-size: 32; text-halo-radius: 1; } \n";
    css += "  text-allow-overlap: true;\n";
    css += "  [zoom>11]{text-size: 36;}\n";
    css += "}\n";

    callback(css, [1.1885840899668e-8, 1.1885840899668e-8, 4.75433635986719e-8], cluster_sql_gen);
