...
module.exports = cdb.core.View.extend({
  ...
  _enableSearchUI: function(enable) {
    // Hide all default items
    this.$('.Filters-typeItem').toggle(!enable);
    this.$('.Filters-order').toggle(!enable);
    // …except for the search enabler that should always be visible
    this.$('.js-search-enabler').toggle(true);
