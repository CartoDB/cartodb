...
module.exports = Backbone.Collection.extend({
  ...
  url: function () {
    ...
    return baseUrl + '/api/v3/maps/' + this._vizId + '/widgets';
  },
  ...
  addWidget: function (widgetModel, attrs) {
    ...
    var addWidgetPromise = new Promise(function (resolve, reject) {
  ...
  updateWidgetsOrderAsync: function () {
    ...
    this.save(null, {
      wait: true,
      success: function (response) {
        this.trigger('successUpdateWidgetsOrder', response);
      }.bind(this),
      error: function (response, error) {
