...
module.exports = CoreView.extend({
  ...
  _showPrivacy: function () {
    return this._isInsideOrg()
      ? this._hasPublishedMaps()
      : this._isPrivacyEnabled() || this._hasPublishedMaps();
  },

  _isPrivacyEnabled: function () {
    return this._userModel.isPrivacyEnabled();
  },

  _isInsideOrg: function () {
    return this._userModel.isInsideOrg();
  },

  _hasPublishedMaps: function () {
  ...
  _initBinds: function () {
    this.listenToOnce(this._mapcapsCollection, 'add', this.render);
  },
