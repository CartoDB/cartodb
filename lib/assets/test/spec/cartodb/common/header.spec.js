describe("Table/Visualization Header tests", function() {
  ...
  xit("should render the privacy", function() {
    expect($(this.header.el).find('.status').html()).toEqual('PUBLIC')
  })

  xit("should update the privacy when changed", function() {
    this.vis.set('privacy', 'public');
    expect($(this.header.el).find('.status').html()).toEqual('public')
  })

  xit("should add the privacy class on the status selector link", function() {
    this.vis.set('privacy', 'public');
    expect($(this.header.el).find('.status').hasClass('public')).toBeTruthy();
  })

  xit("should remove the previous privacy class when the status change", function() {
    this.vis.set('privacy', 'public');
