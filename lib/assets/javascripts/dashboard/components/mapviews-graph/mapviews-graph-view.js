  ...
  render: function () {
    ...
    svg.selectAll('.bar')
      ...
      .attr('data-tooltip', function (d) {
        return Utils.formatNumber(d.mapviews) + ' ' +
          _t('dashboard.components.mapviews_graph.mapviews_graph_view.mapview_count', {smart_count: d.mapviews}) +
          (d.today ? (_t('today')) : (_t('on') + d.when));
      })
