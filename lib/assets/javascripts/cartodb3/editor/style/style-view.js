...
module.exports = CoreView.extend({
  ...
  _cancelApplyStyles: function () {
    ...
    var generated = StyleGenerator.generateStyle(this._layerDefinitionModel.styleModel.toJSON(), simpleGeometryType, {
      zoom: 11 // this.map.get('zoom')
    });
    ...
    this._codemirrorModel.set('content', generated.cartoCSS);
