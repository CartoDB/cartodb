...
(function() {
   ...
   */
  var ToggleTable = cdb.core.View.extend({
    ...
    show: function() {
      ...
      this.$el.find("> .content").fadeIn(250, function() {
    ...
    hide: function() {
      ...
      this.$el.find("> .content").fadeOut(250, function() {
  ...
  cdb.admin.dashboard.ToggleTable = ToggleTable;
