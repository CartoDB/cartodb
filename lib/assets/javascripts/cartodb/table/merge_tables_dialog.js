...
cdb.admin.MergeTablesDialog = cdb.admin.BaseDialog.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_onKeyUp", "_checkKeyColumns", "_onChangeState", "_onChangeDescriptionTitle", "_onChangeEnableNext", "_onChangeEnableBack", "_loadState", "_onNextClick", "_onBackClick", "_onRadioClick", "_onToggleMergeFlavorList", "_onToggleTableSelector", "_onTableSelected", "_mergeMethodSelected", "_merge", "_importCopy", "_onMergeSuccess", "_onMergeError");
  ...
  _loadState: function() {
    ...
    alreadyActivated = this.model.get("already_activated"),
    enableNext       = false;
