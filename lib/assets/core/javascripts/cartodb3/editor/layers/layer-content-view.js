...
var AnalysisService = require('./layer-content-views/analyses/analyses-service');
...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    AnalysisService.setLayerId(this._layerDefinitionModel.get('id'));
    ...
    var tabPaneTabs = [{
      ...
      createContentView: function () {
        ...
        return new LayerContentAnalysesView({
          ...
          onboardings: self._onboardings,
          builderNotifications: self._builderNotifications
        });
      }
    }, {
