...
module.exports = Backbone.Collection.extend({
  ...
  saveAnalysisForLayer: function (layerDefModel) {
    ...
    var belongsToLayer = nodeDefModel.letter() === layerDefModel.get('letter');
    ...
    if (analysisDefModel) {
      if (belongsToLayer) {
        ...
        analysisDefModel.destroy(); // source belong to another layer, so delete the analysis since its no longer needed
      }
    } else if (belongsToLayer) {
