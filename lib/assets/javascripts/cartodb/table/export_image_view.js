...
cdb.admin.ExportImageView = cdb.core.View.extend({
  ...
  _showOverlays: function() {
    this.options.mapView.$(".header").show();
    this.options.mapView.$(".leaflet-control-attribution").show();
    this.options.mapView.$(".cartodb-fullscreen").show();
    this.options.mapView.$(".cartodb-timeslider").show();
    this.options.mapView.$(".cartodb-legend-stack").show();
    this.options.mapView.$(".cartodb-layer-selector-box").show();
  ...
  _hideOverlays: function() {
    this.options.mapView.$(".header").hide();
    this.options.mapView.$(".leaflet-control-attribution").hide();
    this.options.mapView.$(".cartodb-timeslider").hide();
    this.options.mapView.$(".cartodb-legend-stack").hide();
    this.options.mapView.$(".cartodb-layer-selector-box").hide();
