...
module.exports = BaseDialog.extend({
  ...
  _onSkipClick: function(e) {
    ...
    var skipPencanDialog = 'pecan_' + this.options.user.get("username") + "_" + this.vis.tableMetadata().id;
  ...
  _setWizardProperties: function() { // TODO: hack, we should find a way to remove this
    ...
    this.layer.wizard_properties.unbind("load", this._setWizardProperties, this);
    if (properties) {
      this.layer.wizard_properties.set({ metadata: properties.metadata, property: properties.property });
    }
    this.close();
  },
