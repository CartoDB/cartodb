var View = require('../../../../../javascripts/cartodb/organization/icons/delete_icons_dialog_view');

describe('organization/icons/delete_icons_dialog_view', function () {
  describe('render', function () {
    it('should render properly when several icons', function () {
      ...
      expect(view.$('.Dialog-header p').text()).toContain('icons');
    });
    ...
    it('should render properly when only 1 icon', function () {
      ...
      expect(view.$('.Dialog-header p').text()).toContain('icon');
      expect(view.$('.Dialog-header p').text()).not.toContain('icons');
    });
