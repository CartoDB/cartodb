var CreateHeaderView = require('../../../../../../javascripts/cartodb/new_common/dialogs/create/create_header');
var CreateModel = require('../../../../../../javascripts/cartodb/new_common/dialogs/create/create_model');

describe('new_dashboard/dialogs/create/create_header_view', function() {
  beforeEach(function() {
  ...
  describe("type map", function() {
    ...
    it('should render correctly when option is preview', function() {
      this.model.set('option', 'preview');
      expect(this.view.$('.CreateDialog-headerStep:eq(1)').hasClass('is-selected')).toBeTruthy();
      expect(this.view.$('.CreateDialog-headerStep:eq(0)').find('.Dialog-headerIconBadge').length).toBe(1);
