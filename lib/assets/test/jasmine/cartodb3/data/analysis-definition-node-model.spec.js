...
describe('cartodb3/data/analysis-definition-node-model', function () {
  ...
  describe('.canBeDeletedByUser', function () {
    ...
    it('should return true if its a source node', function () {
      expect(this.a0.canBeDeletedByUser()).toBe(true);
      expect(this.b0.canBeDeletedByUser()).toBe(true);
    });

    it('should return true if its primary source belong to same letter group', function () {
      expect(this.b1.canBeDeletedByUser()).toBe(true);
      expect(this.c1.canBeDeletedByUser()).toBe(false);
    });
  });
});
