...
var PermissionModel = require('../../../data/permission-model');
var ShareView = require('../share-organization/share-org-view');
...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    // this._permission = new PermissionModel(null, {
    //   configModel: this._configModel,
    //   userModel: this._userModel
    // });

    // this._permission.fetch();

    this._permission = this._visDefinitionModel.getPermissionModel();
  ...
  render: function () {
    ...
    if (this._hasError()) {
      ...
      this.$el.html(template({
        ...
        belongsToOrg: this._userModel.isInsideOrg()
      }));
  ...
  _onShare: function () {
    ...
    this._modals.create(function (modalModel) {
      return new ShareView({
        ...
        onBack: self._onBack,
        currentUserId: self._userModel.id,
        visDefinitionModel: self._visDefinitionModel,
        organization: self._userModel._organizationModel,
