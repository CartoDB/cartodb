...
cdb.admin.GeoreferenceDialog = cdb.admin.BaseDialog.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_renderStats", "_onCountrySelected", "_onColumnSelected", "_onAdmSelected", "_onChangeCountry", "_onAdmGetSuccess",
    ...
    this.model.set({
      ...
      this.$el.find(".foot").slideUp(250, function() {
        ...
        self.$el.find(".inner").animate({ height: self.model.get("originalHeight"), left: 0 }, { easing: "easeOutQuad", duration: 200, complete: function() {
          ...
          self.$el.find(".aside").show();
          self.$el.find(".aside").animate({ left: 570, opacity: 1 }, { easing: "easeOutQuad", duration: 200 });
  ...
  _showChooseGeometryTypeStep: function() {
    ...
    this.$el.find(".aside").animate({ left: 970, opacity: 0 }, { easing: "easeOutQuad", duration: 200, complete: function() {
      $(this).hide();
    }});
...
j },
  ...
  _renderStats: function() {
    ...
    this.$content.find('.aside').append(this.geocoder_stats.render().el);
