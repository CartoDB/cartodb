var OnboardingViewModel = require('../../../../../javascripts/cartodb3/components/onboardings/onboarding-view-model');

fdescribe('components/onboardings/onboarding-view-model', function () {
  beforeEach(function () {
    ...
    this.model = new OnboardingViewModel({
      createContentView: this.createContentView
    });
  });

  it('should allow show/hide onboarding', function () {
