...
module.exports = {
  ...
  Arcgis: {
    ...
    options: {
      ...
      service_name: 'arcgis',
      acceptSync: true,
      formTemplate: 'new_common/views/create/listing/import_types/data_form_arcgis',
      headerTemplate: 'new_common/views/create/listing/import_types/data_header_arcgis'
    }
  },
  Salesforce: {
    className: ImportDataView,
