  ...
  initialize: function() {
    ...
    this.form_data = [{
        ...
        form: {
          ...
          'box-padding': { type: 'simple_number', value: 5, min: 5, max: 50, inc: 1, label: "P" }
        }
      }, {
        name: 'Line',
        form: {
        ...
        name: 'Zoom (min-max)',
        form: {
          'min-zoom':  { type: 'simple_number', value: minZoomLevel, min: minZoomLevel, max: maxZoomLevel, inc: 1 },
          'max-zoom':  { type: 'simple_number', value: maxZoomLevel, min: minZoomLevel, max: maxZoomLevel, inc: 1 },
        }
      }];
  },
