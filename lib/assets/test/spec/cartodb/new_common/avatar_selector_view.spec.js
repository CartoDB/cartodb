...
var AvatarSelector = require('../../../../javascripts/cartodb/new_common/avatar_selector_view');
var AssetModel = require('../../../../javascripts/cartodb/new_common/asset_model.js')


describe('new_common/avatar_selector_view', function() {
  beforeEach(function() {
  ...
  it('should render properly', function() {
    expect(this.view.$('.Form-avatarPreviewImage').length).toBe(1);
  ...
  it('should enable input and remove loader when upload fails', function(done) {
    ...
    setTimeout(function() {
      ...
      expect(self.view.$('.Form-rowInfoText--error').length).toBe(1);
      done();
    },100);
  });
  ...
  it('should enable input and remove loader when upload is completed', function(done) {
    ...
    setTimeout(function() {
      ...
      expect(self.view.$('.Form-rowInfoText--error').length).toBe(0);
