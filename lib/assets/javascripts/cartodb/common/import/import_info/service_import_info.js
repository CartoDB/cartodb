  ...
  cdb.admin.ServiceImportInfo = cdb.admin.ImportInfo.extend({
    ...
    _TEXTS: {
      ...
      oauth:    _t('A popup will appear in order to log in this service. \
                    When the proccess is finished, the list of your available files will appear.'),
      error:    _t('Maybe your browser is blocking popups, there was an error trying to get your service token or you didn\'t \
