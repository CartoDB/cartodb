...
module.exports = cdb.core.Model.extend({
  ...
  reset: function() {
    ...
    leftColumns.comparator = this._columnsSortComparator;
    leftColumns.each(function(column) {
      column.set('selected', true);
    });
    leftColumns.sort();

    var rightColumns = this.get('rightColumns');
    rightColumns.comparator = this._columnsSortComparator;
    rightColumns.each(function(column) {
