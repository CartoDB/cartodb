...
var DATA_SERVICES = require('builder/components/code-mirror/data-services.js');
...
describe('components/code-mirror/code-mirror-view', function () {
  ...
  describe('Data Services warning', function () {
    beforeEach(function () {
      this.createView();
    });

    it('should show the data services warning if any data services function is present in the editor content', function () {
      this.view.editor.setValue(DATA_SERVICES[0]);
      expect(this.view.$('.CodeMirror-warning').length).toBe(1);
    });

    it('should hide the data services warning if the content changes', function () {
      this.view.editor.setValue(DATA_SERVICES[0]);
      expect(this.view.$('.CodeMirror-warning').length).toBe(1);

      this.view.editor.setValue('empty');
      expect(this.view.$('.CodeMirror-warning').length).toBe(0);
    });
  });
