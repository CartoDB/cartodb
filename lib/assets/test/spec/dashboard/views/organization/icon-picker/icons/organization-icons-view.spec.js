const IconPickerView = require('dashboard/views/organization/icon-picker/icons/organization-icons-view');
...
describe('organization/icon-picker/icons/organization-icons-view', function () {
  ...
  describe('._renderAllIcons', function () {
    it('should call _addIconElement for each collection member', function () {
      ...
      expect(this.view._addIconElement).toHaveBeenCalledWith(1, 0, [1, 2, 3]);
      expect(this.view._addIconElement).toHaveBeenCalledWith(2, 1, [1, 2, 3]);
      expect(this.view._addIconElement).toHaveBeenCalledWith(3, 2, [1, 2, 3]);
    });
  });
  ...
  describe('_openDeleteIconsDialog', function () {
    it('should show modal with right number of icons to delete and call `_deleteIcons` on OK', function () {
      ...
      var okButton = document.querySelector('.Dialog-footer button.js-submit');
  ...
  describe('_onProcessRunningChanged', function () {
    ...
    it('should hide spinner and running message if process is running', function () {
      var cidTrigger = null;
      this.view._iconCollection.on('refreshCollection', function (data) {
        if (data.cid) {
          cidTrigger = data.cid;
        }
      });
