...
module.exports = cdb.core.View.extend({
  ...
  _initViews: function() {
    this._cityView = this._createSelectView('column_name', true);
    this._adminRegionView = this._createSelectView('region');
    this._countryView = this._createSelectView('location');
  },
