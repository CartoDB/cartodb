...
describe('data/analysis-definition-node-model', function () {
  ...
  describe('.cloneTree', function () {
    ...
    it('should throw error on bad input', function () {
      expect(function () { a0.cloneTree(); }).toThrowError(/required/);
      expect(function () { a0.cloneTree(null); }).toThrowError(/required/);
      expect(function () { a0.cloneTree(undefined); }).toThrowError(/required/);
      expect(function () { a0.cloneTree(true); }).toThrowError(/required/);
      expect(function () { a0.cloneTree({}); }).toThrowError(/required/);
    });

    describe('when given a source node', function () {
      beforeEach(function () {
        this.g0 = a0.cloneTree('g');
      });
    ...
    describe('when called on a node which sources all belong to same letter', function () {
      beforeEach(function () {
        ...
        this.newTreeHeadNode = this.a2.cloneTree('h');
      });
    ...
    describe('when given a node which sub-tree belongs to other letter', function () {
      beforeEach(function () {
        ...
        this.newTreeHeadNode = this.c2.cloneTree('h');
      });
