...
module.exports = CoreView.extend({
  ...
  _loadLogo: function () {
    ...
    // Using an absolute image works in IE, no security error
    // but the final image is blank
    var svg = 'http://www.fulcrumapp.com/assets/img/integrations/logo_CARTO_negative_90.png';

    // var svg = 'data:image/svg+xml;base64,' + window.btoa(data);
    var deferred = $.Deferred();
    ...
    image.onload = function () {
      ...
      // IE raises "Unexpected call to method or property access." sometimes.
      // See http://stackoverflow.com/questions/25214395/unexpected-call-to-method-or-property-access-while-drawing-svg-image-onto-canvas
      // setTimeout(function () {
