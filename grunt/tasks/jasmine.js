...
module.exports = {
  task: function() {
    return {
      ...
      // Specs for source files that are shared for all bundles
      'src-browserify': {
        src: [], // src files are required in the *.spec.js files
        options: {
          keepRunner: true,
      ...
      core: {
        ...
        options: {
          ...
          vendor: vendor,
          specs: '<%= config.tmp %>/core-specs.js', // generated by browserify:core-specs
          summary: true,
          display: 'short'
        }
      },
      ...
      standard: {
        ...
        options: {
          keepRunner: true,
          outfile: 'test/SpecRunner-standard.html',
          vendor: vendor,
          specs: '<%= config.tmp %>/standard-specs.js', // generated by browserify:core-specs
          summary: true,
          display: 'short'
        }
      },
