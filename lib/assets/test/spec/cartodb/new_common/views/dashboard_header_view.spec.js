...
describe('new_common/views/dashboard_header_view', function() {
  ...
  describe('.click .js-settings-dropdown', function() {
    ...
    it('should create a settings dropdown with expected params', function() {
      ...
      expect(viewToBeInstantiatedWith).toEqual(jasmine.objectContaining({ router: this.router }));
      expect(viewToBeInstantiatedWith).toEqual(jasmine.objectContaining({ template_base: 'new_common/views/dashboard_header/settings_dropdown' }));
      expect(viewToBeInstantiatedWith.target[0]).toEqual(this.view.$('.js-settings-dropdown')[0]);
    });
  ...
  describe('.click .js.breadcrumb-dropdown', function() {
    ...
    it('should create a breadcrumbs dropdown with expected params', function() {
      ...
      expect(viewToBeInstantiatedWith).toEqual(jasmine.objectContaining({ model: this.user }));
      expect(viewToBeInstantiatedWith).toEqual(jasmine.objectContaining({ router: this.router }));
      expect(viewToBeInstantiatedWith).toEqual(jasmine.objectContaining({ template_base: 'new_common/views/dashboard_header/breadcrumbs/dropdown' }));
      expect(viewToBeInstantiatedWith.target[0]).toEqual(this.view.$('.js-breadcrumb-dropdown')[0]);
    });
