(function() {
  ...
  var SelectorView = cdb.core.View.extend({
    ...
    render: function() {
      ...
      if (this.options.column_type == 'boolean') {
        ...
        pretty_bucket = this._cleanString(this.model.get("bucket"));
      }
  ...
  cdb.admin.mod.SelectorFilter = cdb.core.View.extend({
    ...
    _onApply: function(e) {
      ...
      var t = this.$textarea.find("textarea").val()
    ...
    render: function() {
      ...
      this.$el.html(this.getTemplate('table/menu_modules/filters/templates/selection')({
        ...
        short_legend: this._cleanString(this.model.escape('column'), 15),
    ...
    _showListView: function() {
      ...
      if (c >= 5) {
        this._showScrollers();
        this.$el.find(".scrollers").show();
        this._toggleShadow("top", 0);
        this._toggleShadow("bottom", 1);
      } else {
        this._hideScrollers();
        this.$el.find(".scrollers").hide(250);
      }
