...
module.exports = BaseDialog.extend({
  ...
  render_content: function() {
    ...
    if (currentStep) {
      ...
      currentStep.bind('change:goDirectlyToNextStep', this._onChangeGoDirectlyToNextStep, this);
    ...
    if (currentStep) {
      if (this._step) {
        this._step.clean();
        this.removeView(this._step);
      }
      this._step = currentStep.createView();
      $el.find('.js-details').append(this._step.render().$el);
      this.addView(this._step);
    } else {
  ...
  _next: function() {
    ...
    this.model.get('currentStep').unbind('change:goDirectlyToNextStep');
