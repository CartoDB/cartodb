...
describe Carto::Api::UserPresenter do
  ...
  def compare_data(original_old_data, new_data, org_user = false, mobile_sdk_enabled = false)
    ...
    new_data[:multifactor_authentication_configured].should == old_data[:multifactor_authentication_configured]
  ...
  def add_new_keys(user_poro)
    ...
    new_poro[:multifactor_authentication_configured] = false
    new_poro
  end
