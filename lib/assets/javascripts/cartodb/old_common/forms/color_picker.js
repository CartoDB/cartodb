  ...
  cdb.admin.ColorPicker = cdb.admin.DropdownMenu.extend({
    ...
    _bindAdvancedPicker: function() {
      this.$('.slider').on('mousemove', this._onPickerMouseMove);
      this.$('.picker').on('mousemove', this._onPickerMouseMove);
      this.$('.picker').on('mouseup',   this._onPickerMouseUp);
      this.$('.slider').on('mouseup',   this._onPickerMouseUp);
    },

    _destroyAdvancedPicker: function() {
      this.$('.slider').off('mousemove', this._onPickerMouseMove);
      this.$('.picker').off('mousemove', this._onPickerMouseMove);
      this.$('.picker').off('mouseup',   this._onPickerMouseUp);
      this.$('.slider').off('mouseup',   this._onPickerMouseUp);
    },
