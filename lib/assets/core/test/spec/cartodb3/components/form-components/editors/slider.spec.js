...
describe('components/form-components/editors/slider', function () {
  ...
  describe('render', function () {
    ...
    it('disabled', function () {
      ...
      expect(this.view.$('.js-slider').hasClass('ui-slider-disabled')).toBe(true);
    });

    it('empty labels', function () {
      this.view = new Backbone.Form.editors.Slider({
        labels: [],
        schema: {}
      });
      ...
      expect(this.view.$('.js-slider').hasClass('ui-slider-disabled')).toBe(true);
      expect(this.view.$('.js-tick').length).toBe(5);
      expect(this.view.$('.js-label').text()).toBe('form-components.editors.slide.no-values');
    });
  });
