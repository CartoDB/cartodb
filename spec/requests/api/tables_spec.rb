...
describe "Tables API" do
  ...
  describe 'GET /api/v1/tables/:id' do
    it 'returns table attributes' do
      table = create_table(
        user_id:      @user.id,
        name:         'My table #1',
        privacy:      TableStorage::PRIVACY_PRIVATE,
  ...
  context "when having some tables" do
    before(:each) do
      @table1 = create_table user_id: @user.id,         name: 'My table #1', privacy: TableStorage::PRIVACY_PRIVATE, tags: "tag 1, tag 2,tag 3, tag 3", description: 'Testing is awesome'
      @table2 = create_table user_id: @user.id,         name: 'My table #2', privacy: TableStorage::PRIVACY_PRIVATE
      @table3 = create_table user_id: @another_user.id, name: 'Another table #3', privacy: TableStorage::PRIVACY_PRIVATE
      @table4 = create_table user_id: @user.id,         name: 'My table #3', privacy: TableStorage::PRIVACY_PRIVATE, tags: "tag 1"
    end
  ...
  it "deletes a table of the user currently logged in" do
    table1 = create_table :user_id => @user.id, :name => 'My table #1', :privacy => TableStorage::PRIVACY_PRIVATE, :tags => "tag 1, tag 2,tag 3, tag 3"
  ...
  it "doesn't delete a table of another user" do
    another_user = create_user
    table1 = create_table :user_id => another_user.id, :name => 'My table #1', :privacy => TableStorage::PRIVACY_PRIVATE, :tags => "tag 1, tag 2,tag 3, tag 3"
  ...
  it "updates a table and sets the lat and long columns" do
    table = Table.new :privacy => TableStorage::PRIVACY_PRIVATE, :name => 'Madrid Bars',
