...
module.exports = cdb.core.View.extend({
  ...
  events: {
    'submit .Filters-searchForm':  '_submitSearch',
    'click .Filters-searchLink':   '_onSearchClick',
    'click .Filters-cleanSearch':  '_onCleanSearchClick',
    'click .Filters-searchForm':   'killEvent',
    'click .js-deselect_all':               '_unselectAll',
    'click .js-select_all':                 '_selectAll',
    'click .Filters-orderLink':    '_changeOrder',
    'click .js-delete':            '_openDeleteItemsDialog',
    'click a.Filters-typeLink':     handleAHref
  },
  ...
  _onSearchClick: function(e) {
    ...
    this.$('.Filters-searchInput').focus();
  },
  ...
  _submitSearch: function(e) {
    if (e) e.preventDefault();
    this._navigateToUrl({
      search: this.$('.Filters-searchInput').val().trim()
    });
  },
  ...
  _changeOrder: function(e) {
    ...
    var $el = $(e.target).closest('.Filters-orderLink');
