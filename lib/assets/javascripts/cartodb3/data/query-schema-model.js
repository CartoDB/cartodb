...
var removeDoubleQuotesFrom = function (str) {
...
module.exports = Backbone.Model.extend({
  ...
  hasDefaultQueryFor: function (tableName) {
    ...
    var sanitisedQuery = removeDoubleQuotesFrom(this.get('query'));
    var defaultQueryForTableName = DEFAULT_TABLE_QUERY_TEMPLATE({ tableName: removeDoubleQuotesFrom(tableName) });
    return sanitisedQuery.toLowerCase() === defaultQueryForTableName.toLowerCase();
  },
