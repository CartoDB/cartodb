  ...
  _showChooseGeometryTypeStep: function() {
    ...
    this.$el.find(".inner").animate({ height: 178, left: -550 }, { easing: "easeOutQuad", duration: 200, complete: function() {
      ...
      setTimeout(function() {
        ...
        if (polygonsEnabled && !pointsEnabled) self.styles.model.set("geometry_type", "polygon");
        else if (!polygonsEnabled && pointsEnabled) self.styles.model.set("geometry_type", "point");
        else self.styles.model.set("geometry_type", "point");
