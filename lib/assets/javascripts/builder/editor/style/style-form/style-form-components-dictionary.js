...
var StyleFormFill = require('builder/editor/style/style-form/style-form-dictionary/fill'); // TODO delete

var StyleFormLabelsAttribute = require('builder/editor/style/style-form/style-form-dictionary/labels-attribute');
var StyleFormLabelsFill = require('builder/editor/style/style-form/style-form-dictionary/labels-fill'); // TODO delete
...
var StyleFormLabelsHalo = require('builder/editor/style/style-form/style-form-dictionary/labels-halo'); // TODO delete
...
var StyleFormStroke = require('builder/editor/style/style-form/style-form-dictionary/stroke'); // TODO delete
...
module.exports = {
  'aggregation-dataset': function (params) { return StyleFormAggregationDataset.generate(params); },
  'aggregation-size': function (params) { return StyleFormAggregationSize.generate(params); },
  'aggregation-value': function (params) { return StyleFormAggregationValue.generate(params); },

  'animated-attribute': function (params) { return StyleFormAnimatedAttribute.generate(params); },
  'animated-enabled': function (params) { return StyleFormHidden.generate(params); },
  'animated-duration': function (params) { return StyleFormAnimatedDuration.generate(params); },
  'animated-overlap': function (params) { return StyleFormAnimatedOverlap.generate(params); },
  'animated-resolution': function (params) { return StyleFormAnimatedResolution.generate(params); },
  'animated-steps': function (params) { return StyleFormAnimatedSteps.generate(params); },
  'animated-trails': function (params) { return StyleFormAnimatedTrails.generate(params); },

  'blending': function (params) { return StyleFormBlending.generate(params); },

  'fill': function (params) { return StyleFormFill.generate(params); },
  'fillSize': function (params) { return StyleFormFillSize.generate(params); },
  'fillColor': function (params) { return StyleFormFillColor.generate(params); },

  'labels-enabled': function (params) { return StyleFormHidden.generate(params); },
  'labels-attribute': function (params) { return StyleFormLabelsAttribute.generate(params); },
  'labels-fill': function (params) { return StyleFormLabelsFill.generate(params); },
  'labels-fill-size': function (params) { return StyleFormLabelsFillSize.generate(params); },

  'labels-font': function (params) { return StyleFormLabelsFont.generate(params); },
  'labels-halo': function (params) { return StyleFormLabelsHalo.generate(params); },
  'labels-halo-size': function (params) { return StyleFormLabelsHaloSize.generate(params); },

  'labels-offset': function (params) { return StyleFormLabelsOffset.generate(params); },
  'labels-overlap': function (params) { return StyleFormLabelsOverlap.generate(params); },
  'labels-placement': function (params) { return StyleFormLabelsPlacement.generate(params); },

  'stroke': function (params) { return StyleFormStroke.generate(params); },
  'strokeSize': function (params) { return StyleFormStrokeSize.generate(params); },
  'strokeColor': function (params) { return StyleFormStrokeColor.generate(params); },

  'style': function (params) { return StyleFormStyle.generate(params); }
};
