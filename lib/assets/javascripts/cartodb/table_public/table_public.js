...
$(function() {
  ...
  var TablePublic = cdb.core.View.extend({
    ...
    initialize: function() {
      ...
      this._initViews();
      // init data
      // var sql = 'select *, -1 as the_geom, -1 as the_geom_webmercator from ' + this.table.get('name');
    ...
    _initModels: function() {
      ...
      // this.sqlView.options.attributes.skipfields = 'the_geom';
    ...
    _initDataLayer: function() {
      ...
      this.table.bind('change:dataSource', function() {
        var sql = 'select *, -1 as the_geom from ' + this.get('name');
        if(this.isInSQLView()) {
      ...
      var sql = 'select *, -1 as the_geom from ' + this.table.get('name');
