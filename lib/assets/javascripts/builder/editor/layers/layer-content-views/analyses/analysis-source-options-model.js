...
module.exports = Backbone.Model.extend({
  ...
  createSourceNodeUnlessExisting: function (val) {
    ...
    if (tableModel) {
      ...
      // FIXME: obtain username and in-org status and build default query here with proper table name qualification
      // but note that we can't rely on the tableName being qualified with the user name here
