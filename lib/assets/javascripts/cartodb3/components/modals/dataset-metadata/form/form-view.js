...
module.exports = CoreView.extend({
  ...
  _addInputView: function (key, view, placeholder, container) {
    var obj = '_' + view;
  ...
  _addNameView: function () {
    this._addInputView('name', 'nameInput', _t('components.modals.dataset-metadata.form.name-placeholder'), this.$('.js-name-field'));
  },
