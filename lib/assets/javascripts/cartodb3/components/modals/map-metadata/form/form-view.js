...
module.exports = CoreView.extend({
  ...
  _addTagsView: function () {
    this._taglistView = new Backbone.Form.editors.Taglist({
      ...
      model: this._visMetadataModel,
      schema: {
        options: this._visDefinitionModel.get('tags') || []
      }
    });
  ...
  _onPrivacyClick: function () {
    this._onPrivacyAction();
  },

  _removeBinds: function () {
    this._inputView && this._inputView.off('blur', this._commitView, this);
    this._textareaView && this._textareaView.off('blur', this._commitView, this);
    this._taglistView && this._taglistView.off('blur', this._commitView, this);
  },
