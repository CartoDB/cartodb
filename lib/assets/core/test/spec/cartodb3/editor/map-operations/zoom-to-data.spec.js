...
describe('map-operations/zoom-to-data', function () {
  ...
  it('should not show notifications if notifications are disabled', function () {
    var stateModel = {
      setBounds: function () {}
    };
    ...
    // Notification shown while loading
    expect(Notifier.getCollection().models[0]).toBeUndefined();
  ...
  it('should not show error notifications if notifications are disabled and call fails', function () {
    var stateModel = {};
