    ...
    beforeEach(function() {
      ...
      vis = new cdb.admin.Visualization({
        ...
        permission: {
          owner: {
            username: 'rambo',
            base_url: 'http://team.cartodb.com/u/rambo'
          },
          acl: [
          {
            type: 'user',
            ...
            entity: {
              username: 'charly',
              base_url: 'http://team.cartodb.com/u/charly'
            }
          }
          ]
        },
    ...
    describe('.viewUrl', function() {
      describe('when vis is a dataset', function() {
        ...
        it('should return a new dataset URL', function() {
          expect(vis.viewUrl().toString()).toEqual('http://team.cartodb.com/u/rambo/tables/rambo.test_table');
        });

        describe('when given a current user', function() {
          it('should return the URL from perspective of owner', function() {
            expect(vis.viewUrl(vis.permission.owner).toString()).toEqual('http://team.cartodb.com/u/rambo/tables/rambo.test_table');
          });
          ...
          it('should return the URL from the perspective of shared user', function() {
            ...
            expect(vis.viewUrl(userSharingVis).toString()).toEqual('http://team.cartodb.com/u/charly/tables/rambo.test_table');
          });
          ...
          it('should return the URL from the perspective of owner if do not have read access', function() {
            var otherUser = new cdb.admin.User({
              id: 123,
              base_url: 'http://team.cartodb.com/u/current-user',
              username: 'current-user'
            });
            expect(vis.viewUrl(otherUser).toString()).toEqual('http://team.cartodb.com/u/rambo/tables/rambo.test_table');
          });
        });
      });
      ...
      describe('when vis is a map', function() {
        ...
        it('should return a new map URL', function() {
          expect(vis.viewUrl().toString()).toEqual('http://team.cartodb.com/u/rambo/viz/abc-123');
        });
        ...
        describe('when given a other current user (e.g. a shared map)', function() {
          ...
          it('should return the URL from the perspective of the current user', function() {
            expect(vis.viewUrl(this.userSharingVis).toString()).toEqual('http://team.cartodb.com/u/charly/viz/rambo.abc-123');
          });
        });
      });
    });
