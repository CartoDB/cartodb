...
cdb.forms.Spinner = cdb.core.View.extend({
  ...
  _showSlider: function(ev) {
    ...
    cdb.god.unbind("closeDialogs", this.spinner_slider.hideAndClean, this.spinner_slider);
    ...
    if (!this.spinner_slider.el.parentElement) {
      ...
      cdb.god.bind("closeDialogs", this.spinner_slider.hideAndClean, this.spinner_slider);
      cdb.god.bind("closeDialogs:color", this.spinner_slider.hideAndClean, this.spinner_slider);
    } else {
      this.spinner_slider.hideAndClean();
    }
  }
});
