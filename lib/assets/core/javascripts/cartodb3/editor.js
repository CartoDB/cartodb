...
var handleAnalysesRoute = require('./routes/handle-analyses-route');
var handleModalsRoute = require('./routes/handle-modals-route');
...
Router.init({
  modals: modals,
  editorModel: editorModel,
  routeChangeAction: function (routeModel) {
