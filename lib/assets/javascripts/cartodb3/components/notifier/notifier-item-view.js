...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    // In dataset we don't have vis
    if (this._visDefinitionModel !== undefined) {
      this._visDefinitionModel.on('vis:reload', this._triggerVisReload, this);
  ...
  _triggerVisReload: function () {
    this._notifierModel.trigger('vis:reload');
  },

  _triggerVisError: function () {
    this._notifierModel.trigger('vis:error', this._vis.get('error'));
  },
