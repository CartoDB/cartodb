...
module.exports = CoreView.extend({
  ...
  _initScrollBinding: function () {
    $('.Table').on(this._hideContextMenu);
    this.$('.js-tbody').on(this._hideContextMenu);
  },
  ...
  _initEditorScrollBinding: function () {
    $('.Table').on('scroll',this._closeEditor);
    this.$('.js-tbody').on('scroll', this._closeEditor);
  },

  _destroyEditorScrollBinding: function () {
    $('.Table').off('scroll', this._closeEditor);
    this.$('.js-tbody').off('scroll', this._closeEditor);
  },
