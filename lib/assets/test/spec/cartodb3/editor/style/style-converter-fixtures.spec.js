  ...
  },
  {
    ...
    result: {
      point: {
        ...
        sql: 'select *, (CASE WHEN "columnA" = 1 THEN 1 WHEN "columnA" = 2 THEN 2 WHEN "columnA" = 3 THEN 3 WHEN "columnA" = 4 THEN 4 WHEN "columnA" = 5 THEN 5 WHEN "columnA" = 6 THEN 6 WHEN "columnA" = 7 THEN 7 WHEN "columnA" = 8 THEN 8 WHEN "columnA" = 9 THEN 9 WHEN "columnA" = 10 THEN 10 WHEN "columnA" = 11 THEN 11  ELSE 1  END) as value FROM (<%= sql %>) __wrapped',
        type: 'torque'
      }
    }
  },
