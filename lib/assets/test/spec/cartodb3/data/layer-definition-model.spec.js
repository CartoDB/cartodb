  ...
  describe('for a layer with an infowindow', function () {
    ...
    describe('infowindow/tooltip reset', function () {
      beforeEach(function () {
        ...
        this.model.tooltipModel.clearFields = function () {};
        this.model.tooltipModel.setTemplate = function () {};
        this.model.infowindowModel = new Backbone.Model();
        this.model.infowindowModel.setTemplate = function () {};
        this.model.infowindowModel.clearFields = function () {};

        spyOn(this.model.tooltipModel, 'clearFields');
        spyOn(this.model.tooltipModel, 'setTemplate');
        spyOn(this.model.infowindowModel, 'clearFields');
        spyOn(this.model.infowindowModel, 'setTemplate');
      ...
      it('should reset infowindow/tooltip template and fields if style model type is aggregated', function () {
        ...
        expect(this.model.infowindowModel.setTemplate).not.toHaveBeenCalled();
        expect(this.model.tooltipModel.setTemplate).not.toHaveBeenCalled();
        this.styleModel.set('type', 'squares');
        expect(this.model.infowindowModel.setTemplate).toHaveBeenCalled();
        expect(this.model.tooltipModel.setTemplate).toHaveBeenCalled();
      });
