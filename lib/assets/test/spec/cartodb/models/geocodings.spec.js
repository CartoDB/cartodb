...
describe("Geocodings", function() {
  ...
  it("should save and trigger event when model cancels geocoding", function() {
    var changed = false;
    this.geocoder.set({
      id: 666,
      formatter: '{name}',
  ...
  it("should trigger event when model resets geocoding", function() {
    var changed = false;
    this.geocoder.set({
      id: 666,
      formatter: '{name}',
