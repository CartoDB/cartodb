...
var LegendDefinitionModel = require('../../../../../javascripts/cartodb3/data/legends/legend-torque-definition-model');
...
describe('data/legends/legend-torque-defintion-model', function () {
  ...
  it('should toJSON properly', function () {
    ...
    expect(attrs.definition.categories[2].title).toBe(null);
  });
