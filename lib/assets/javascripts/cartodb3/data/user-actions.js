  ...
  return {
    saveAnalysis: function (analysisFormModel) {
      ...
      if (nodeDefModel) {
        ...
        MetricsTracker.track('Updated analysis', analysisFormModel.attributes);
      } else {
    ...
    createAnalysisNode: function (nodeAttrs, layerDefModel) {
      ...
      MetricsTracker.track('Added analysis', nodeDefModel.attributes);
    ...
    deleteAnalysisNode: function (nodeId) {
      ...
      MetricsTracker.track('Removed analysis', {
        id: nodeDefModel.id
      });
