...
var ImportBigQueryView = require('./imports/import_bigquery_view');
...
module.exports = {
  ...
  BigQuery: {
    ...
    enabled: function (config) { return !!config.get('oauth_bigquery'); },
  ...
  Arcgis: {
    ...
    enabled: function (config) { return config.get('arcgis_enabled'); },
  ...
  Salesforce: {
    ClassName: ImportDataView,
    enabled: function (config) { return config.get('salesforce_enabled'); },
