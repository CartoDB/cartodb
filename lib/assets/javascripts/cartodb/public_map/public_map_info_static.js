...
function _setMoreVisualizations (visualizations) {
  return _
    ...
    .map(_addVisualizationData)
}

function _addVisualizationData (visualization) {
  return _.extend(visualization, {
    updatedAt: moment(visualization.updated_at).fromNow(),
    publicMapUrl: visualization.permission.owner.base_url + '/' + visualization.map_id + '/public_map',
    username: visualization.permission.owner.username
  })
}
