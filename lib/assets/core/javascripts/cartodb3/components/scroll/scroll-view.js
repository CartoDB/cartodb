...
module.exports = CoreView.extend({
  ...
  //   this._interval = window.requestAnimationFrame(_.bind(this._onResize, this));
  // },
  ...
  //     max = this._contentContainer().get(0).scrollWidth;
  //   } else {
  //     max = this._contentContainer().get(0).scrollHeight;
  //   }

  //   if (max !== this._maxScroll) {
  //     this._maxScroll = max;
  //     this._checkShadows();
  //   }
