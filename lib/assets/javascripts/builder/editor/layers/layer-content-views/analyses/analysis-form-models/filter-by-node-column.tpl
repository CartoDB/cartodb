  ...
  <div class="Editor-HeaderInfo">
    ...
    <div class="Editor-HeaderInfo-inner CDB-Text" data-fields="source,filter_source">
      <div class="Editor-HeaderInfo-title u-bSpace--m">
        <h2 class="CDB-Text CDB-HeaderInfo-titleText CDB-Size-large"><%- _t('editor.layers.analysis-form.link-layer-step-one-title') %></h2>
      </div>
      <div class="Editor-HeaderInfo-subtitle u-bSpace--m">
        <%= linkContent %><p class="CDB-Text CDB-FontSize-small u-upperCase u-altTextColor"><%- _t('editor.layers.analysis-form.link-layer-desc') %></p>
      </div>
    </div>
  </div>
