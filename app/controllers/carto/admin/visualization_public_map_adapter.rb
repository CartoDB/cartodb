...
class Carto::Admin::VisualizationPublicMapAdapter
  ...
  delegate [ :type_slide?, :has_permission?, :derived?, :organization, :organization?, :id, :likes, :password_protected?, :varnish_key, :related_tables, :is_password_valid?, :get_auth_tokens, :table, :name, :overlays, :created_at, :description, :tags, :mapviews, :geometry_types, :privacy ] => :visualization
