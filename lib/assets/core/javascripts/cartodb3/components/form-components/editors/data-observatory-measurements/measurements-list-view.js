...
var statusTemplate = require('./measurements-list-states.tpl');
...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this.listenTo(this._measurementsCollection.state, 'change:status', this._renderListSection);
  },
  ...
  _filterResults: function (keyword) {
    ...
    if (keyword === '') {
      items = this._promoteSelected(filtered.slice(0, this.options.maxItems));
    } else {
