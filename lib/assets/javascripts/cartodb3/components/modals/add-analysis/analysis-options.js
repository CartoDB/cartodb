...
var disabledAnalysesForCustomInstalls = [
 ...
 */
module.exports = function (alsoGenerateFromCamshaftReference, isCustomInstall) {
  var categories = {
    create_clean: {
      title: _t('analysis-category.create-clean'),
      analyses: generateCreateCleanAnalysesOptions(isCustomInstall)
    },
  ...
  if (alsoGenerateFromCamshaftReference) {
    ...
    categories['generated'] = {
      ...
      analyses: Object
        ...
        .map(function (type) {
          if (isCustomInstall && _.contains(disabledAnalysesForCustomInstalls, type)) {
            return false;
          }
...
function generateCreateCleanAnalysesOptions (isCustomInstall) {
  var analyses = [
    {
      nodeAttrs: {
