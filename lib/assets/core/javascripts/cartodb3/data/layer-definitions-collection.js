...
module.exports = Backbone.Collection.extend({
  ...
  findNonGeoreferencedLayer: function (callback, layerDefinitionModel) {
    if (!layerDefinitionModel) {
      layerDefinitionModel = this.at(this.getTopDataLayerIndex());
    }
    ...
    var canBeGeoreferencedLayer = function () {
      if (layerDefinitionModel.canBeGeoreferenced()) {
        ...
        var layerIndex = this.indexOf(layerDefinitionModel);
        var nextLayerDefinitionModel = this.at(layerIndex - 1);
        nextLayerDefinitionModel && this.findNonGeoreferencedLayer(callback, nextLayerDefinitionModel);
      }
    }.bind(this);
