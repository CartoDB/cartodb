  ...
  cdb.common.CreateDialog.Uploader = cdb.core.View.extend({
    ...
    _generateImportData: function() {
      ...
      // Url?
      if (this.model.get('upload').type === "url") {
      ...
      if (this.model.get('upload').type === "service" ) {
        d = {
          ...
          service_item_id:  this.model.get('upload').service_item_id
        }
      }
        ...
        success: function(m) {
          ...
          var upload = _.extend(
            self.model.get('upload'),{
              item_queue_id: m.get('item_queue_id')
            }
          );
