    ...
    svg.selectAll(".bar")
      ...
      .enter().append("rect")
        ...
        .attr('data-title', function(d) {
          return Utils.formatNumber(d.mapviews) + ' ' + pluralizeString('mapview', d.mapviews) + ' on ' + d.when
        })
        ...
        .on('mouseover', function(d) {
          ...
          d3.select(this).attr('class', 'MapviewsGraph-bar on-hover');
        })
        .on('mouseout', function(d) {
          ...
          d3.select(this).attr('class', 'MapviewsGraph-bar');
        });
