...
module.exports = cdb.core.View.extend({
  ...
  _initBindings: function() {
    ...
    this.model.bind('change:category', this._onChangeCat, this);
  },
  ...
  _renderVisualizations: function() {
    ...
    this.collection.each(function(item) {
      ...
      var el = template({
        ...
        datasetSize: this._getDatasetSize(item.get('external_source')['size']),
        geomType: this._getGeometryType(item.get('external_source')['geometry_types']),
  ...
  _onChangeCat: function() {
    this.$('.js-dropdownLabel').text(this._DROPDOWN_TEXT[this.model.get('category')]);
  ...
  _onClickAdministrative: function(e) {
    this.killEvent(e);
    this._selectCat('administrative-regions');
  },

  _onClickCultural: function(e) {
    this.killEvent(e);
    this._selectCat('cultural-datasets');
  },

  _onClickPhysical: function(e) {
    this.killEvent(e);
    this._selectCat('physical-datasets');
  },

  _onClickHistoric: function(e) {
    this.killEvent(e);
    this._selectCat('historic');
  },

  _onClickBuilding: function(e) {
    this.killEvent(e);
    this._selectCat('building-footprints');
  },

  _onClickCensus: function(e) {
    this.killEvent(e);
    this._selectCat('us-census');
  }
