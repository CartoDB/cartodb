...
cdb.admin.GeoreferenceDialog = cdb.admin.BaseDialog.extend({
  ...
  _geocodeWorld: function(column_name, country_code, geometry_type) {

    alert('You need to defined the kind')
    ...
    if (this.hasContent) {
      ...
      switch (option) {
        ...
        case 2:
          ...
          else if (adm == "countries")                 this._geocodeWorld(adm, column, country, geometry_type);
