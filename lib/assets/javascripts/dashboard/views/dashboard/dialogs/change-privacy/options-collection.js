...
const ALL_OPTIONS = [{
  ...
  iconFontType: 'unlock',
  title: 'Public',
  desc: _t('dashboard.views.dashboard.dialogs.change_privacy.public_desc'),
  alwaysEnable: true
}, {
  privacy: 'LINK',
  ...
  iconFontType: 'unlock',
  title: 'With link',
  desc: _t('dashboard.views.dashboard.dialogs.change_privacy.link_desc')
}, {
  privacy: 'PASSWORD',
  illustrationType: 'alert',
  iconFontType: 'unlockWithEllipsis',
  title: 'Password-protected',
  desc: _t('dashboard.views.dashboard.dialogs.change_privacy.passwd_desc')
}, {
  privacy: 'PRIVATE',
  illustrationType: 'negative',
  iconFontType: 'lock',
  title: 'Private',
  desc: _t('dashboard.views.dashboard.dialogs.change_privacy.private_desc')
}];
