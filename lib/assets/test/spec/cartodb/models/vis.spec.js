  ...
  describe("Visualization model", function() {
    ...
    describe('.sharedWith', function() {
      beforeEach(function() {
        this.sharedWith = function() {
      ...
      describe('given at least shared with one other user', function() {
        ...
        it('should return an array containing the entities the visualization is shared with', function() {
          expect(this.sharedWith.length).toEqual(1);
          expect(this.sharedWith[0].get('username')).toEqual('charly');
        });
      });
      ...
      describe('given that model is not shared with anyone', function() {
        ...
        it('should return an empty array', function() {
          expect(this.sharedWith()).toEqual([]);
        });
      });
    });

    describe('.tableMetadata', function() {
      describe('given vis model represents a table', function() {
        beforeEach(function() {
      ...
      describe('given vis model represents a visualization', function() {
        beforeEach(function() {
          vis.set('type', 'derived');
        });

        it('should raise an error informing developer that this method should not have been called in the first place', function() {
          expect(function() {
            vis.tableMetadata();
          }).toThrow();
        });
