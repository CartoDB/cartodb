var $ = require('jquery');
var LikesView = require('../../../../javascripts/dashboard/common/likes/like-view');
var LikeModel = require('../../../../javascripts/dashboard/data/like-model');
var ConfigModel = require('../../../../javascripts/dashboard/data/config-model');

describe('dashboard/common/likes-view', function () {
  beforeEach(function () {
