...
var UserNotificationView = require('./user_notification/user_notification_view');
var UserNotificationModel = require('./user_notification/user_notification_model');
...
$(function() {
  cdb.init(function() {
    ...
    if (currentUser.get('actions').builder_enabled && _.isEmpty(window.dashboard_notifications)) {
