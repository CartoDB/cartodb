...
(function() {
  ...
  var Button = cdb.core.View.extend({
    ...
    render: function() {
      ...
      this.$el.append('<div class="error"><div class="errorLabel"><div class="symbol"><div class="space"></div></div></div><div class="errorBar"></div></div>');
      // Add tipsy
      this.$el.tipsy({
        gravity: "e",
        fade: true,
  ...
  cdb.admin.RightMenu = cdb.core.View.extend({
    ...
    addClassToButton: function(buttonType, className) {
      this.getButtonByClass(buttonType).addClass(className);
    },
    /**
    ...
    removeClassFromButton: function(buttonType, className) {
      this.getButtonByClass(buttonType).removeClass(className);
    },
