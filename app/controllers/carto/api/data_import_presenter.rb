    ...
    class DataImportPresenter
      ...
      def get_error_text
        if @data_import.error_code.nil?
          ...
          @data_import.error_code.blank? ? CartoDB::IMPORTER_ERROR_CODES[99_999] : CartoDB::IMPORTER_ERROR_CODES[@data_import.error_code]
        end
      end
      ...
      def get_warnings
        ...
        unless @data_import.rejected_layers.nil?
        ...
        warnings.merge!(JSON.parse(@data_import.runner_warnings)) unless @data_import.runner_warnings.nil?
