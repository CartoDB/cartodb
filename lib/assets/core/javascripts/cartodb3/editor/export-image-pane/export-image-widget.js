...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    ...
    this._resize = _.debounce(this._onResizeWindow.bind(this), 50);
  ...
  _onResizeWindow: function (e) {
    if (e.target === window) {
      var coordinates = mapView.latLngToContainerPoint({ // eslint-disable-line
  ...
  _updateHelpers: function () {
    ...
    var canvasWidth = mapView.$el.width(); // eslint-disable-line
    var canvasHeight = mapView.$el.height(); // eslint-disable-line
  ...
  _calcCenter: function () {
    ...
    return mapView.containerPointToLatLng({ x: x, y: y }); // eslint-disable-line
  },
