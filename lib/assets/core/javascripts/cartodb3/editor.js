...
window._widow = function (s) {
  return window._t(s).replace(/ ([^ ]*)$/, '&nbsp;$1');
}
...
// FOR THE CODE REVIEW - This is useful for development but MUST BE DELETED
window.notis = onboardingNotification;
