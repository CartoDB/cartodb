...
const actions = [
  { name: 'Edit info', event: 'editInfo', shouldShow: true },
  { name: 'Change Privacy', event: 'changePrivacy', shouldShow: true },
  { name: 'Manage Tags', event: 'manageTags', shouldShow: true },
  { name: 'Duplicate map', event: 'duplicateMap', shouldShow: true },
  { name: 'Lock Map', event: 'lockMap', shouldShow: true },
  { name: 'Delete Map', event: 'deleteMap', isDestructive: true, shouldShow: true }
];
