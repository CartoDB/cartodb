...
module.exports = cdb.core.View.extend({
  ...
  _initBinds: function() {
    ...
    this._iconCollection.on('remove', this._onIconRemovedFromCollection, this);
    this._iconCollection.on('add', this._onIconAddedToCollection, this);
  },

  _onIconRemovedFromCollection: function () {
    console.log('An icon was removed from collection.');
  },

  _onIconAddedToCollection: function () {
    console.log('An icon was add to collection.');
  },
