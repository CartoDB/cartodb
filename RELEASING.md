...
```
git flow release start 3.12.11
```
...
```
git commit -am "Files changed for version 3.12.11"
```
...
```
http://libs.cartocdn.com.s3.amazonaws.com/cartodb.js/v3/3.12.11/cartodb.js
http://libs.cartocdn.com/cartodb.js/v3/3.12.11/cartodb.js
...
```
git flow release finish 3.12.11
git push --all
git push --tags
```
...
For example, if we are in 3.12.11 and we want to go back to 3.12.11

```
git checkout 3.12.11
grunt build
grunt publish
```
