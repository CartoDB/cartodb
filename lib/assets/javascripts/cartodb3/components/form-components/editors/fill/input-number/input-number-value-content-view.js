...
var DEFAULT_QUANTIFICATION_METHOD_INDEX = 0;

var BINS = ['2', '3', '4', '5', '6', '7'];
var DEFAULT_BIN_INDEX = 3; // select '5' as the default bin size
...
module.exports = CoreView.extend({
  ...
  _setupModel: function () {
    ...
    if (!this.model.get('quantification')) {
      options.quantification = QUANTIFICATION_METHODS[DEFAULT_QUANTIFICATION_METHOD_INDEX];
    }

    if (!this.model.get('bins')) {
      options.bins = BINS[DEFAULT_BIN_INDEX];
    }
