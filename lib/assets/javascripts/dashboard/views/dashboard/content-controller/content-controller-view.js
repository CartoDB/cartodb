...
// const FiltersView = require('./filters_view');
// const ListView = require('./list_view');
// const ContentResult = require('./content_result_view');
// const OnboardingView = require('./onboarding_view');
// const ContentFooterView = require('./content_footer/view');
// const LoadingLibraryView = require('./datasets/loading_library_view');
...
module.exports = CoreView.extend({
  ...
  _initBindings: function () {
    ...
    this.listenTo(this.collection, 'reset', this._onDataFetched);
  ...
  _onDataFetched: function () {
    ...
    const tag = this.router.model.get('tag');
    const q = this.router.model.get('q');
    const shared = this.router.model.get('shared');
    const liked = this.router.model.get('liked');
    const locked = this.router.model.get('locked');
    const library = this.router.model.get('library');
