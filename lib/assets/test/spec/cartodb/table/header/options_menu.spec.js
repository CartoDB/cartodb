describe("Header options menu", function() {
  ...
  it("should show geocoding and append-mode options disabled if table is synced in table mode", function() {
    cartodb_layer.table.synchronization.set('id', 'test');
    options_menu.render();
    expect(options_menu.$el.find("li:contains('Georeference')").hasClass('disabled')).toBeTruthy();
    expect(options_menu.$el.find("li:contains('Append data')").hasClass('disabled')).toBeTruthy();
  });
