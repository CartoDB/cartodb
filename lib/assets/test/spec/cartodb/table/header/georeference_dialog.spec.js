describe("cdb.admin.GeoreferenceDialog", function() {
  ...
  it("should render properly options list", function() {
    ...
    expect(view.$('ul.options > li[data-option="1"] a:eq(0)').text()).toBe("You have one or more columns with addresses");
    expect(view.$('ul.options > li[data-option="2"] a:eq(0)').text()).toBe("You have a column idenfiying administrative regions");
  });
