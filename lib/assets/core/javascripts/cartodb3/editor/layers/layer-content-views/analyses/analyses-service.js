...
module.exports = (function () {
  return {
    init: function (opts) {
      ...
      this._notAppliedAnalyses = new Backbone.Collection();
    },
    ...
    saveAnalysis: function (attrs) {
      this._notAppliedAnalyses.remove(attrs.id);
      return this._notAppliedAnalyses.add(attrs, { at: 0 });
    },

    getNotApplied: function () {
      return this._notAppliedAnalyses;
    }
  };
})();
