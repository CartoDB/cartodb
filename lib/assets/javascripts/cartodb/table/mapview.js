...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  _showGMapsDeprecationDialog: function() {
    ...
    var dialog = new cdb.admin.BaseDialog({ 
      ...
      description: "We're removing the support for the Google Maps basemaps in our platform. Since this visualization uses a Google Maps basemap, if you click 'Ok' we'll automatically replace it with a similar one provided by Leaflet.",
