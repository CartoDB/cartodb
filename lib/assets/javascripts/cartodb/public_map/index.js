...
var client = CartoApiClient.AuthenticatedClient;
    ...
    function getVisualization (password) {
      ...
      client.getVisualization(vizID, params)
        ...
        .catch(function (error) {
          if (error && error.errors_cause && error.errors_cause === 'privacy_password') {
            showPasswordProtectedForm();
          } else if (error && error.errors === 'Visualization not viewable') {
            showForbiddenView();
          }
        });
    }
