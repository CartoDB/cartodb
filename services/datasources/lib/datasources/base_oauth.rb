...
module CartoDB
  module Datasources
    class BaseOAuth < Base
      ...
      CALLBACK_STATE_DATA_PLACEHOLDER = '__user__service__'.freeze
      ...
      def service_name_for_user(service_name, _user)
        service_name
      end
      ...
      def get_auth_url(_use_callback_flow=true)
