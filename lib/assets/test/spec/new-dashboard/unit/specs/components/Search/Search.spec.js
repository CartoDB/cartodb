  ...
  describe('Methods', () => {
    ...
    describe('onKeydownDown', () => {
      it('should call keydownDown of search suggestions', () => {
        ...
        searchComponent.vm.onKeydownDown();
    ...
    describe('onKeydownUp', () => {
      it('should call keydownUp of search suggestions', () => {
        ...
        searchComponent.vm.onKeydownUp();
    ...
    describe('onKeydownEnter', () => {
      it('should call keydownEnter of search suggestions', () => {
        const routerPushSpy = jest.fn();
        const searchComponent = createSearchComponent({
          data () {
            return {
        ...
        spyOn(searchComponent.vm.$refs.searchSuggestions, 'getActiveSuggestion');
        searchComponent.vm.onKeydownEnter();

        expect(searchComponent.vm.$refs.searchSuggestions.getActiveSuggestion).toHaveBeenCalled();
        expect(routerPushSpy).toHaveBeenCalledWith({
          name: 'search',
          params: {
            query: 'Query text'
