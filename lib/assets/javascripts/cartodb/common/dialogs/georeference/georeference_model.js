...
module.exports = cdb.core.Model.extend({
  ...
  changedSelectedTab: function(newTab) {
    ...
    this.set('showForceAllRows', !newTab.HIDE_FORCE_ALL_ROWS);
    if (newTab.HIDE_FORCE_ALL_ROWS) {
      // If should not dispaly the toggle then reset the state too
      this.get('geocodeStuff').set('forceAllRows', false);
    }
  },
  ...
  toggleForceAllRows: function() {
    var m = this.get('geocodeStuff');
