<form class="Form js-form">
  <div class="Form-row">
    ...
    <div class="Form-rowData Form-rowData--longer">
      <input type="text" class="Form-input Form-input--longer has-submit js-textInput" value="" placeholder="Paste here your ArcGIS Server&trade; table URL" />
  ...
  <div class="Form-row">
    ...
    <div class="Form-rowData Form-rowData--longer">
      <p class="Form-rowInfoText Form-rowInfoText--centered Form-rowInfoText--smaller Form-rowInfoText--block">
