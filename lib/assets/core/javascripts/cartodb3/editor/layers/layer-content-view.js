...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var needsGeocoding = this._layerDefinitionModel.canBeGeoreferenced() || this._layerDefinitionModel.isEmpty();
    ...
    var tabPaneTabs = [{
      ...
      createContentView: function () {
        ...
        if (self._layerDefinitionModel.canBeGeoreferenced()) {
