var BreadcrumbsDropdownView = require('new_dashboard/header/breadcrumbs_dropdown_view');
var Backbone = require('backbone');

describe('new_dashboard/header/breadcrumbs_dropdown_view', function() {
  beforeEach(function() {
    ...
    this.view = new BreadcrumbsDropdownView({
      ...
      template_base: 'new_dashboard/header/breadcrumbs_dropdown'
    });
  ...
  it('should have rendered a URL for maps', function() {
    expect(this.html).toContain('href="/foobar-prefix/dashboard/maps"');
  });

  it('should have rendered a URL for datasets', function() {
    expect(this.html).toContain('href="/foobar-prefix/dashboard/datasets"');
  });

  it('should have rendered a URL for locked datasets', function() {
    expect(this.html).toContain('href="/foobar-prefix/dashboard/datasets/locked"');
  });

  it('should have rendered a URL for locked maps', function() {
    expect(this.html).toContain('href="/foobar-prefix/dashboard/maps/locked"');
  });
