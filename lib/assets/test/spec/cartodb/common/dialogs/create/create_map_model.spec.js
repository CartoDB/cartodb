  ...
  describe('.createMap', function() {
    ...
    describe('when selected non-remote datasets', function() {
      ...
      it('should create the new map directly if save succeeds', function() {
        ...
        var url = new cdb.common.MapUrl({ base_url: 'https://cartodb.com/user/pepe/viz/abc-123' });
        ...
        expect(this.model._redirectTo).toHaveBeenCalledWith('https://cartodb.com/user/pepe/viz/abc-123/map');
      });
