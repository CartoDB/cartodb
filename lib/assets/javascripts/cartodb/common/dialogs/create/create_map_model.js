...
var VisualizationTemplatesCollection = require('./listing/templated_workflows/visualization_templates_collection');
...
module.exports = cdb.core.Model.extend({
  ...
  defaults: {
    ...
    option: 'templates',
    currentImport: null,
    visualizationTemplateStep: null,
    tableIdsArray: [],
  ...
  _initModels: function() {
    ...
    this.visTemplatesCollection = new VisualizationTemplatesCollection();
  ...
  _initBinds: function() {
    ...
    this.visTemplatesCollection.bind('change:selected', function(mdl) {
      this.set('visualizationTemplateStep', 0);
    }, this);
  ...
  // Get visualization templates collection
  getVisualizationTemplates: function() {
    return this.visTemplatesCollection;
  },

  isTemplatedWorkflowStarted: function() {
    return this.getOption() === "listing" && this.get('visualizationTemplateStep') !== null
  },

  nextTemplatedWorkflow: function() {
