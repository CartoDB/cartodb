  ...
  describe('column-options', function () {
    beforeEach(function () {
      this._makeClick = function () {
        this.view.$('.js-columnOptions').trigger('click');
      }.bind(this);
      this.view.render();
    });
    ...
    describe('actions', function () {
      ...
      it('should change table-view-model when order is changed', function () {
        ...
        this._menuView.$('.js-asc').trigger('click');
      ...
      it('should start editing when rename option is clicked', function () {
        ...
        this._menuView.$('[data-val="rename"]').trigger('click');
      ...
      it('should change column type when change option and type is clicked', function () {
        ...
        this._menuView.$('[data-val="change"]').trigger('click');
        this._menuView.$('.Table-columnTypeMenu .js-listItem:eq(0)').trigger('click');
      ...
      it('should add a new column when change create is clicked', function () {
        ...
        this._menuView.$('[data-val="create"]').trigger('click');
      ...
      it('should remove column when remove option is clicked', function () {
        ...
        this._menuView.$('[data-val="delete"]').trigger('click');
  ...
  describe('rename', function () {
    beforeEach(function () {
      ...
      this._makeDblClick = function () {
        this.view.$('.js-attribute').trigger('dblclick');
      }.bind(this);
    });
