...
module.exports = cdb.core.View.extend({
  ...
  _initBinds: function() {
    this._viewModel.bind('change', this._renderNavigation, this);
    if (this.router) {
  ...
  _renderNavigation: function() {
    var contentType = this._viewModel.get("model").get("content_type");
    if (!(contentType === "maps" || contentType === "datasets")) {
      return;
    }
    this.$('.Header-navigationToggleItem').removeClass("selected");
    this.$('.Header-navigationToggleItem.' + contentType).addClass("selected");
  },
