...
var IFRAME_SRC = 'https://carto.com/google_plus';
...
describe('account/account_form_view', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$el.html()).toContain('<form accept-charset="UTF-8" action="/account" method="post">');
      ...
      expect(this.view.$el.html()).toContain('<span class="FormAccount-button--deleteAccount CDB-Size-medium js-deleteAccount">Delete my account and all my data</span>');
    });
  });
  ...
  describe('is inside org', function () {
    ...
    describe('is auth username password enabled', function () {
      beforeEach(function () {
        this.user.isAuthUsernamePasswordEnabled = function () { return true; };
      });
    ...
    describe('is org owner', function () {
      ...
      it('should render properly', function () {
        ...
        expect(this.view.$el.html()).toContain('<p class="FormAccount-rowInfoText CDB-Size-medium"><a href="' + PLAN_URL + '" class="FormAccount-link">View details</a></p>');
      });
    });
  });
  ...
  describe('iframe src', function () {
    beforeEach(function () {
      this.view._getIframeSrc = function () { return IFRAME_SRC; };
    });
  ...
  describe('._getIframeSrc', function () {
    it('should return iframe src', function () {
      expect(this.view._getIframeSrc()).toBeUndefined();

      this.view._iframeSrc = IFRAME_SRC;

      expect(this.view._getIframeSrc()).toBe(IFRAME_SRC);
    });
  });
