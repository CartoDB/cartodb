...
cdb.admin.MergeTablesDialog = cdb.admin.BaseDialog.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_onKeyUp", "_checkKeyColumns", "_onChangeState", "_onChangeDescriptionTitle", "_onChangeEnableNext", "_onChangeEnableBack", "_loadState", "_onNextClick", "_onBackClick", "_onRadioClick", "_onToggleMergeFlavorList", "_onToggleTableSelector", "_tableSelected");
    ...
    this.model.set("show_table_name_form",   false);
  ...
  _onNextClick: function() {
    ...
    this.model.set("previous_state", this.model.get("state"));
  ...
  _loadState: function() {
    ...
    if (state == 0) {
      ...
      this.model.set("title", _t("Merge with another table"));
    ...
    if (stepName == "merge_tables_regular_2" || stepName == "merge_tables_spatial_2") {
      ...
      this.model.set("show_merge_flavor_list", false);
      this.model.set("show_table_selector",    false);
      this.model.set("show_table_name_form",   true);

      this.model.set("title", "Name for your merge table");
      this.model.set("description_title", "");
  ...
  _onToggleTableNameForm: function() {
    ...
    if (this.model.get("show_table_name_form")) {
      this.$tableNameForm.slideDown(250);
    } else {
      this.$tableNameForm.slideUp(250);
    }
  ...
  */
  ...
  _startMerging: function() {
    var self = this
    , data = {
      table_name: this.get("merge_name"),
