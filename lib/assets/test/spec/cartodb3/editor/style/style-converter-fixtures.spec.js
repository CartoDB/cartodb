...
module.exports = [
  {
    ...
    style: {
      ...
      properties: {
        fill: {
          'color': {
            attribute: 'numbers',
            range: ['#CCCCCC', '#5B3F95', '#1D6996', '#129C63', '#73AF48', '#EDAD08', '#E17C05', '#C94034', '#BA0040', '#8E1966', '#6F3072'],
            domain: ['Others', 'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten'],
            opacity: 0.4
          }
        }
      }
    ...
    result: {
      point: {
        cartocss: '#layer {\nmarker-fill: ramp([numbers], (#5B3F95, #1D6996, #129C63, #73AF48, #EDAD08, #E17C05, #C94034, #BA0040, #8E1966, #6F3072, #CCCCCC), (one, two, three, four, five, six, seven, eight, nine, ten));\nmarker-fill-opacity: 0.4;\nmarker-allow-overlap: true;\n}',
        type: 'CartoDB'
      }
    }
  }, {
      ...
      properties: {
        fill: {
          'color': {
            attribute: 'numbers',
            range: ['#CCCCCC', '#5B3F95', '#1D6996', '#129C63', '#73AF48', '#EDAD08', '#E17C05', '#C94034', '#BA0040', '#8E1966', '#6F3072'],
            domain: ['_', 'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten'],
            opacity: 0.4
          }
        }
      }
  ...
  },
  {
    ...
    result: {
      point: {
        ...
        sql: 'select *, (CASE WHEN "columnA" = 2 THEN 2 WHEN "columnA" = 3 THEN 3 WHEN "columnA" = 4 THEN 4 WHEN "columnA" = 5 THEN 5 WHEN "columnA" = 6 THEN 6 WHEN "columnA" = 7 THEN 7 WHEN "columnA" = 8 THEN 8 WHEN "columnA" = 9 THEN 9 WHEN "columnA" = 10 THEN 10 WHEN "columnA" = 11 THEN 11  ELSE 1  END) as value FROM (<%= sql %>) __wrapped',
        type: 'torque'
      }
    }
  },
