...
var InputColorCategories = require('cartodb3/components/form-components/editors/fill/input-color/input-categories/input-color-categories');
  ...
  describe('with nulls', function () {
    beforeEach(function () {
      this.model = new Backbone.Model({
        ...
        attribute: 'winner',
        images: ['http://image.com/pic1.jpg', 'http://image.com/pic2.jpg', 'http://image.com/pic3.jpg']
      });
    ...
    it('should render properly', function () {
      ...
      expect(this.view.model.get('images')).toEqual(['http://image.com/pic1.jpg', 'http://image.com/pic2.jpg', 'http://image.com/pic3.jpg']);
