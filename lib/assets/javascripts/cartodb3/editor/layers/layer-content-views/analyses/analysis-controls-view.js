...
module.exports = CoreView.extend({
  ...
  initialize: function (opts) {
    ...
    this._analysisNode = opts.analysisNode || this._formModel;
  ...
  _canSave: function () {
    // we use this._analysisNode = opts.analysisNode || this._formModel;
    // so this._analysisNode.isDone() could be undefined
    // we use the getter method instead
    var status = this._analysisNode.get('status');
    var isAnalysisDone = status === 'ready' || status === 'failed';
