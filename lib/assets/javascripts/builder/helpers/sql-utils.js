...
module.exports = {
  ...
  getDefaultSQL: function (tableName, userName, inOrganization, nonOrgUserSchema = '') {
    return this.getDefaultSQLFromTableName(TableNameUtils.getQualifiedTableName(tableName, userName, inOrganization, nonOrgUserSchema));
  },
