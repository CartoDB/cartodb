...
var LayerHeaderView = require('cartodb3/editor/layers/layer-header-view');
var LayerDefinitionModel = require('cartodb3/data/layer-definition-model');
var ConfigModel = require('cartodb3/data/config-model');
var SyncModel = require('cartodb3/data/synchronization-model');
...
describe('editor/layers/layer-header-view', function () {
  function createView (options) {
    ...
    this.layerDefinitionModel.isDone = function () {
      return true;
    };
    ...
    this.queryGeometryModel.isDone = function () {
      return false;
    };
    ...
    var FakeNodeModel = function (tableModel, synced, syncModel) {
      ...
      if (tableModel) {
        ...
        this.tableModel.isOwner = function () {
          return true;
        };
      }
    };
  ...
  describe('.render', function () {
    ...
    it('should show warning icon when there is no geometry', function () {
      ...
      createView._isLayerEmpty = function () {
        return true;
      };
  ...
  describe('._createSyncInfo', function () {
    it('should create SyncInfoView object with proper table and sync models', function () {
      ...
      var nodeModel = new FakeNodeModel({
        id: 765
      }, true, syncModel);
