...
var FeatureDefinitionModel = Backbone.Model.extend({
  ...
  isReadOnly: function () {
    return this.isSync() || !this.hasWriteAccess();
  },

  isSync: function () {
    return this._tableNodeModel && this._tableNodeModel.isSync();
  },

  hasWriteAccess: function () {
    var permissionModel = this._tableNodeModel && this._tableNodeModel.getPermissionModel();
