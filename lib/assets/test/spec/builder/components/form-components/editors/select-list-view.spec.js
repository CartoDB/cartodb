...
var SelectListView = require('cartodb3/components/form-components/editors/select/select-list-view');
var ItemTemplate = require('cartodb3/components/custom-list/custom-list-item.tpl');
