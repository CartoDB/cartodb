  ...
  cdb.admin.NameVisualization = cdb.admin.BaseDialog.extend({
    ...
    _TEXTS: {
      _TITLE:       _t('Save your visualization'),
      _DESCRIPTION: _t('A visualization is a mix of layers, styles and sql. Your visualizations are now accesible from your dashboard.'),
      _BLANK_ERROR: _t('The visualization name can\'t be blank')
    },
    ...
    initialize: function() {
      ...
      _.extend(this.options, {
        ...
        width: 450,
        error_messages: {
          blank: this._TEXTS._BLANK_ERROR
        }
      });
    ...
    render_content: function() {
      ...
      this.template = cdb.templates.getTemplate('table/header/views/name_visualization_dialog');
