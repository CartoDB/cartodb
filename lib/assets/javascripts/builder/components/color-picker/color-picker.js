...
module.exports = CoreView.extend({
  ...
  _onChangeColor: function () {
    ...
    utils.stripHTML(this.$('.js-hex').val(this.model.get('hex')));
    utils.stripHTML(this.$('.js-r').val(this.model.get('r')));
    utils.stripHTML(this.$('.js-g').val(this.model.get('g')));
    utils.stripHTML(this.$('.js-b').val(this.model.get('b')));
    utils.stripHTML(this.$('.js-a').val(this.model.get('opacity')));
  },

  _onChangeOpacity: function () {
    var opacity = +utils.stripHTML(this.$('.js-a').val());
  ...
  _onChangeColorValue: function (e) {
    ...
    var r = +utils.stripHTML(this.$('.js-r').val());
    var g = +utils.stripHTML(this.$('.js-g').val());
    var b = +utils.stripHTML(this.$('.js-b').val());
  ...
  _onChangeHex: function (e) {
    ...
    var hex = utils.stripHTML(this.$('.js-hex').val());
