...
module.exports = BaseAnalysisFormModel.extend({
  ...
  _getFormatFieldNames: function () {
    var fields = FIELDS_FOR_TYPE[this.get('type')];
    console.log(fields);
    return fields;
  },
  ...
  getTemplateData: function () {
    console.log(this._getFormFieldNames());
    return {
  ...
  _getFieldValidator: function (fieldName) {
    console.log(fieldName, this.get('type'), FIELD_VALIDATORS[this.get('type')][fieldName]);
