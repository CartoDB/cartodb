...
const GroupsRouter = require('./groups_admin/router');
const GroupsMainView = require('./groups_admin/groups_main_view');
const OrganizationGroupsCollection = require('dashboard/organization-users-collection');
