...
describe('new_dashboard/dialogs/delete_items/view', function() {
  ...
  describe('given items are shared with other users', function() {
    beforeEach(function () {
      ...
      spyOn(this.collection.at(0), 'sharedWith').and.returnValue([
        newUser({ id: 1 }),
        newUser({ id: 2 })
      ]);
      spyOn(this.collection.at(1), 'sharedWith').and.returnValue([
        newUser({ id: 3 }),
        newUser({ id: 4 }),
        newUser({ id: 5 })
      ]);
      // This one should not be used
      spyOn(this.collection.at(2), 'sharedWith').and.returnValue([
        newUser({ id: 6 })
      ]);
