...
cdb.admin.GeometryEditor = cdb.core.View.extend({
  ...
  _showStopEdit: function(row) {
    ...
    var edit_confirmation = new cdb.admin.BaseDialog({
      title: "This geometry is too big to edit in browser",
      description: "Editing this feature could freeze your browser. We encourage you to edit this geometry through the API.",
