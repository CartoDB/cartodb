var BreadcrumbsDropdownView = require('../../../../../../../javascripts/cartodb/new_common/views/dashboard_header/breadcrumbs/dropdown_view');
...
describe('new_common/views/dashboard_header/breadcrumbs/dropdown_view', function() {
  ...
  it('should have rendered a URL for datasets', function() {
    expect(this.innerHTML()).toMatch('href="http://pepe.cartodb.com/dashboard/datasets"');
  });

  it('should have rendered a URL for locked datasets', function() {
    expect(this.innerHTML()).toMatch('href="http://pepe.cartodb.com/dashboard/datasets/locked"');
  });

  it('should have rendered a URL for locked maps', function() {
    expect(this.innerHTML()).toMatch('href="http://pepe.cartodb.com/dashboard/maps/locked"');
  });
  ...
  describe('click on any link', function() {
    ...
    describe('given a normal click', function() {
      ...
      it('should call navigate on the route with the href value', function() {
        expect(this.args[0]).toMatch('http://pepe.cartodb.com/dashboard/maps');
      });
