...
var QueryColumnModel = require('cartodb3/data/query-column-model');
var addColumnOperation = require('cartodb3/components/table/operations/table-add-column');
var renameColumnOperation = require('cartodb3/components/table/operations/table-rename-column');
var changeColumnTypeOperation = require('cartodb3/components/table/operations/table-change-column-type');
var removeTableColumnOperation = require('cartodb3/components/table/operations/table-remove-column');
