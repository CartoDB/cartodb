  ...
  cdb.admin.GeocodingDialog.Pane.DefaultGeocoder = cdb.admin.GeocodingDialog.Pane.extend({
    ...
    _initBinds: function() {
      ...
      this.model.bind('change:location',  this._onLocationChange, this);
    ...
    _onLocationChange: function() {
      ...
      // Location is valid?
      if (location === "") {
        this.available_geometries.set('available_geometries',[]);
        return false;
      }

      // If it is a free text
      if (isText) {
    ...
    _checkOkButton: function() {
      var enabled = this.model.get('column_name') && this.model.get('location');
    ...
    _onOkClick: function(e) {
      ...
      if (this.model.get('column_name') && this.model.get('location')) {
        var step = this.model.get('step');
