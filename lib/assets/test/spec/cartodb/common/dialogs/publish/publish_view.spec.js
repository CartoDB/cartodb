...
describe('common/dialogs/publish/publish_view', function() {
  beforeEach(function() {
    ...
    spyOn(this.vis, 'embedURL').and.returnValue('https://carto.com/user/pepe/viz/abc-123/embed_map');
    spyOn(this.vis, 'vizjsonURL').and.returnValue('https://carto.com/user/pepe/api/v2/viz/abc-123/viz.json');
    spyOn(this.vis, 'publicURL').and.returnValue('https://carto.com/user/pepe/api/v2/viz/abc-123/public_map');
  ...
  describe('when map is private', function() {
    ...
    describe('when clicking any change privacy link', function() {
      beforeEach(function() {
        ...
        this.view.$el.find('.js-change-privacy').trigger('click');
      });
  ...
  describe('when map is not private', function() {
    ...
    it('should render the embed option', function() {
      expect(this.innerHTML()).toContain('iframe width=&quot;100%&quot; height=&quot;520&quot; frameborder=&quot;0&quot; src=&quot;https://carto.com/user/pepe/viz/abc-123/embed_map&quot; allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen');
    });

    it('should render the dev cartodb.js option', function() {
      expect(this.innerHTML()).toContain('https://carto.com/user/pepe/api/v2/viz/abc-123/viz.json');
    });
