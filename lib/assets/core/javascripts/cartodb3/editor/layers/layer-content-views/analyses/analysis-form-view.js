...
module.exports = CoreView.extend({
  ...
  _onChangeAnalysisFormView: function (data) {
    ...
    this._formView.model.set(this._formView.getValue());

    setTimeout(function () {
      // To avoid race condition of running this function against a new form view
      var formId = self._formView.cid;
      self._showAnalysisFormErrors(formId);
    }, 0);
  },
