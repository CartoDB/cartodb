...
module.exports = Backbone.Model.extend({
  ...
  _getMonthLabel: function(monthVal) {
    var month = _.findWhere(MONTHS, { val: monthVal });

    return month.label;
  },

  getFormattedDate: function () {
    var date = moment(this.get('year') + '-' + this._getMonthLabel(this.get('month')) + '-' + this.get('day') + ' ' + this.get('time') + 'Z');
