  ...
  cdb.admin.mod.InfoWindow = cdb.admin.Module.extend({
    ...
    initialize: function() {
      ...
      this.model.bind('change:template', this._activePane)
    ...
    render: function() {
      ...
      //   this.$(".panel_content").css({ top: "80px" });
      ...
      //   }
      //   this.$(".tip").addClass("_help");
      // }, this);

      // this.help.bind("hide", function() {
      //   this.$(".panel_content").css({ top: "61px" });
      //     this.$(".tip").removeClass("_help");
      // }, this);

      
      // this.$(".menu").append(this.help.render().$el);
      ...
      this.custom_scroll = new cdb.admin.CustomScrolls({
        el:     this.$(".panel_content div.wrapper"),
        parent: this.$(".panel_content")
      });
    ...
    _activePane: function(tabName, tabView) {
      tabName = tabName || this.infowindow_panes.activeTab;
      tabView = tabView || this.infowindow_panes.getActivePane();
