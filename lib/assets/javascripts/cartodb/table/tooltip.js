...
cdb.admin.Tooltip = cdb.geo.ui.Tooltip.extend({
  ...
  _changeFieldsOrder: function() {
    this.setColumnsOrder(this.model.get('fields').map(function(c) { return c.name; } ));
  },
