cdb.admin.widgets.Title = cdb.admin.widgets.Text.extend({
  ...
  _onChangeShowTitleOrDescription: function() {
    ...
    if (extra["show_title"])       this.trigger("show_title", this);
    else this.trigger("hide_title", this);

    if (extra["show_description"]) this.trigger("show_description", this);
    else this.trigger("hide_description", this);

    if (!extra["show_title"] && !extra["show_description"]) this.trigger("hidden", this);
