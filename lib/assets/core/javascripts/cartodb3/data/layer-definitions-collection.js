...
module.exports = Backbone.Collection.extend({
  ...
  isBaseLayerAdded: function (layer) {
    ...
    if (layerTypesAndKinds.isTiledType(myType)) {
      myName = me.name || me.options.name;
      itsName = other.name || other.options.name;
      var myTemplate = me.urlTemplate || me.options.urlTemplate;
      var itsTemplate = other.urlTemplate || other.options.urlTemplate;
      var myCategory = me.category || me.options.category;
      var itsCategory = other.category || other.options.category;
    ...
    if (layerTypesAndKinds.isCartoDBType(myType)) {
      myName = me.name || me.options.name;
      itsName = other.name || other.options.name;
      var myBaseType = me.baseType || me.options.baseType;
      var itsBaseType = other.baseType || other.options.baseType;
      var myStyle = me.style || me.options.style;
      var itsStyle = other.style || other.options.style;

      return myName === itsName && myBaseType === itsBaseType && myStyle === itsStyle;
    }

    if (layerTypesAndKinds.isPlainType(myType)) {
      var myColor = me.color || me.options.color;
      var itsColor = other.color || other.options.color;
