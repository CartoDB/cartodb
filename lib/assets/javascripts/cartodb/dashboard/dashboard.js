...
$(function() {
  ...
  var Dashboard = cdb.core.View.extend({
    ...
    _initViews: function() {
      ...
      var toggleTable = this.toggleTable = new cdb.admin.dashboard.ToggleTable({
        el:      this.$el.find("section.tables"),
        kind:   "tables",
        config:  this.options.config
      });

      var toggleVisualization = this.toggleVisualization = new cdb.admin.dashboard.ToggleTable({
