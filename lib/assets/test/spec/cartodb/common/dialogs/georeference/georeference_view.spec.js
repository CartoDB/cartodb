...
describe('common/dialog/georeference/georeference_view', function() {
  ...
  describe('when geocodeData changes on a tab model', function() {
    beforeEach(function() {
      ...
      spyOn(this.view.model, 'decorateGeocodeData').and.callThrough();
    ...
    it('should decorate the geocode data with more expected things before trigger event', function() {
      expect(this.view.model.decorateGeocodeData).toHaveBeenCalled();
      expect(this.view.model.decorateGeocodeData).toHaveBeenCalledWith(this.geocodeData);
    });
