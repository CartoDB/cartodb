...
var AnalysesView = require('./layer-content-views/analyses/analyses-view');
var StyleView = require('cartodb3/editor/style/style-view');
...
var TablesCollection = require('cartodb3/data/tables-collection');
...
var ChangeViewButtonsTemplate = require('./change-view-buttons.tpl');
...
module.exports = CoreView.extend({
  ...
  _renderLayerTabPaneView: function () {
    ...
    var isDisabled = canBeGeoreferenced || (isEmpty && !hasAnalyses) || analysisFailed;
    var isDataEmpty = self._isDataEmpty();
    ...
    var tabPaneTabs = [{
      ...
      disabled: isEmpty && !analysisFailed && !hasAnalyses,
      onClick: function () {
        if (hasAnalyses) {
          return Router.goToAnalysisNode(layerId, this._getAnalysisDefinitionNodeModel().get('id'));
        }

        Router.goToAnalysisTab(layerId);
      }.bind(this),
      createContentView: function () {
  ...
  _isLayerEmpty: function () {
    ...
    return (analysisDefinitionNodeModel.isReadOnly() ||
      !this._layerDefinitionModel.get('visible'));
  },

  _isDataEmpty: function () {
    return this.model.isDataEmpty();
  },
  ...
  _renderContextButtons: function () {
    ...
    $('.CDB-Dashboard-canvas .CDB-Map-canvas').append(
      ChangeViewButtonsTemplate({
        ...
        isLayerEmpty: this._isLayerEmpty()
      })
    );
    ...
    this._addContextButtonsTooltips();
  },

  _addContextButtonsTooltips: function () {
