...
describe('editor/layers/layer-content-view/layer-content-analyses-view', function () {
  ...
  describe('when a new form model is added', function () {
    beforeEach(function () {
      ...
      spyOn(BaseAnalysisFormModel.prototype, 'save').and.returnValue(true);
    });

    describe('which is valid with the defaults', function () {
      beforeEach(function () {
        BaseAnalysisFormModel.prototype.isValid.and.returnValue(true);
      ...
      it('should save it immediately', function () {
        expect(BaseAnalysisFormModel.prototype.save).toHaveBeenCalled();
      });
    });

    describe('which is not valid with the defaults alone', function () {
      beforeEach(function () {
        BaseAnalysisFormModel.prototype.isValid.and.returnValue(false);
        this.analysisFormsCollection.addHead({
          id: 'a1',
          type: 'buffer',
          source: 'a0'
      ...
      it('should not save it immediately', function () {
