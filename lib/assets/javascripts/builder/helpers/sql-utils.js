...
module.exports = {
  ...
  getDefaultSQL: function (tableName, userName, inOrganization, forceSchema=false) {
    return this.getDefaultSQLFromTableName(TableNameUtils.getQualifiedTableName(tableName, userName, inOrganization, forceSchema));
  },
