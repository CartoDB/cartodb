...
describe('editor/style/style-manager', function () {
  ...
  describe('track changes', function () {
    ...
    it('should change alphamarker url based on asset host', function () {
      ...
      this.configModel.set('app_assets_base_url', 'https://cartodb-libs.global.ssl.fastly.net/cartodbui/assets/unversioned');
      ...
      this.configModel.set('app_assets_base_url', 'http://user.localhost:lan:3000/assets/unversioned');
