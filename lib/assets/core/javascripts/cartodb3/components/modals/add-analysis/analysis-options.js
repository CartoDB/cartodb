...
module.exports = function (Analyses, userModel, configModel) {
  var categories = {
    create_clean: {
      ...
      analyses: Analyses.getAnalysesByModalCategory('create_clean', configModel)
    },
    data_transformation: {
      title: _t('analysis-category.data-transformation'),
      analyses: Analyses.getAnalysesByModalCategory('data_transformation', configModel)
    },
    analyze_predict: {
      title: _t('analysis-category.analyze-predict'),
      analyses: Analyses.getAnalysesByModalCategory('analyze_predict', configModel)
    }
  };
