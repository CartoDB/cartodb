...
describe("admin table", function() {
  ...
  describe("cbd.admin.CartoDBTableMetadata", function() {
    ...
    describe('.duplicateDataForNewImport', function() {
      describe('when table is in SQL view', function() {
        beforeEach(function() {
          spyOn(table, 'isInSQLView').and.returnValue(true);
          this.results = table.duplicateDataForNewImport('foobar');
        });

        it('should the new table name', function() {
          expect(this.results).toEqual(jasmine.objectContaining({ table_name: 'foobar' }));
        });

        it('should return an object with SQL', function() {
          expect(this.results).toEqual(jasmine.objectContaining({ sql: 'select * from testTable' }));
        });
      });
      ...
      describe('when table is not in SQL view', function() {
        ...
        it('should return an object with SQL', function() {
          expect(this.results).toEqual(jasmine.objectContaining({ table_copy: 'testTable' }));
        });
      });
    });
