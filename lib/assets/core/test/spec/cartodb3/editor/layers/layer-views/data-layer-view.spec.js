...
describe('editor/layers/data-layer-view', function () {
  ...
  describe('when layer doesn\'t have a geom', function () {
    describe('.render', function () {
      it('should render properly', function () {
        ...
        this.view.render();
        expect(_.size(this.view._subviews)).toBe(4); // [inlineEditor, georeferenceTooltip, toggleTooltip, toggleMenuTooltip]
      });
    });
  });
  ...
  it('should render warning icon when layer doesn\'t have geometry', function () {
    expect(this.view.$('.js-warningIcon').length).toBe(0);
    spyOn(this.view, '_queryGeometryHasGeom').and.returnValue(false);
    this.view.render();
    expect(this.view.$('.js-warningIcon').length).toBe(1);
    expect(this.view.$('.js-warningIcon').data('tipsy')).not.toBeUndefined();
  });
  ...
  describe('._isTorque', function () {
    it('should call model.isTorqueLayer', function () {
