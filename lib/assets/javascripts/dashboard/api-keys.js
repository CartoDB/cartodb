...
const UserNotificationView = require('./components/user-notification/user-notification_view');
const UserNotificationModel = require('../common/user-notification/user-notification-model');
