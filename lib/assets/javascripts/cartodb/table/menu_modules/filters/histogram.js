  ...
  cdb.admin.mod.Filter = cdb.core.View.extend({
    ...
    _checkEmpty: function() {
      ...
      _renderRange: function() {
        ...
        if (lower) lower = lower.toPrecision( Math.round(lower).toString().length + 2);
        if (upper) upper = upper.toPrecision( Math.round(upper).toString().length + 2);
      ...
      _updateBounds:function(bounds) {
        ...
        if (bounds) {
          ...
          lower = this.model.fitToBucket(lower);
          upper = this.model.fitToBucket(upper) + this.model.get('bucket_size');
      ...
      _barChart: function() {
        ...
        function chart(div) {
          ...
          function barPath(h, i) {
            ...
            while (++i < n) {
              d = h[i];
              path.push("M", x(i), ",", height, "V", y(d), "h", barWidth, "V", height);
            }
