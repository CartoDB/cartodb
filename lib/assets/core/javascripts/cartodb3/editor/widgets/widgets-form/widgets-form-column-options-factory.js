...
F.prototype.isColumnOfType = function (columnName, type) {
  var column = this._querySchemaModel.columnsCollection.models.find(function (column) {
    return column.get('name') === columnName;
  });

  return column && column.get('type') === type;
};
