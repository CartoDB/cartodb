...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    ...
    var styleDescription = (this._widgetDefinitionModel.get('type') === 'formula') ? _t('editor.widgets.widgets-form.style.description') : _t('editor.widgets.widgets-form.style.define');
