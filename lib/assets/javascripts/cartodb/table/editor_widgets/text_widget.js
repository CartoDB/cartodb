...
cdb.admin.widgets.Text = cdb.core.View.extend({
  ...
  template_name: 'table/views/widgets/text',
  ...
  _onMouseUp: function(e) {
    ...
    if (y == 0 && this.model.get("extra").portraitDirection == "bottom") oldY = y;
    if (x == 0 && this.model.get("extra").landscapeDirection == "right") oldX = x;

    if (oldX === x && y === oldY || x == 0 && this.model.get("extra").landscapeDirection == "right" && y === oldY || y == 0 && this.model.get("extra").portraitDirection == "bottom" && oldX === x) {
      ...
      console.log(extra.portraitDirection, extra.landscapeDirection);
