...
$(function() {
  ...
  var DashboardRouter = Backbone.Router.extend({
    ...
    tag: function(model, tag, page) {
      ...
      this._select(model);
      dashboard.startView.model.set("path", model);
      ...
      if (model == 'visualizations') {
        ...
        dashboard.visualizations.options.set({ page: page || 1, tags: tag, per_page: dashboard.visualizations._ITEMS_PER_PAGE, type: "derived" });
