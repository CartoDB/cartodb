...
var ShareModel = require('../../../../../../../javascripts/cartodb/new_common/dialogs/change_privacy/share/share_model');

describe('new_common/dialogs/change_privacy/share/share_model', function() {
  beforeEach(function() {
  ...
  describe('.organizationUsers', function() {
    ...
    describe('when no search is present', function() {
      it('should return other users in the organization', function() {
