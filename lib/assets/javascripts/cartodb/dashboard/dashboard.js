...
$(function() {
  ...
  var DashboardRouter = Backbone.Router.extend({
    ...
    index: function() {
      ...
      dashboard.visualizations.options.set("per_page", 3)
      ...
      // fetch tables
      dashboard.tables.options.set("per_page", 5)
    ...
    tables: function() {
      ...
      // Tables
      dashboard.tables.options.set("per_page", dashboard.tables._TABLES_PER_PAGE);
      dashboard.tables.fetch();
    ...
    visualizations: function() {
      ...
      // Visualizations
      dashboard.visualizations.options.set("per_page", dashboard.visualizations._VISUALIZATIONS_PER_PAGE);
      dashboard.tables.fetch();
