...
module.exports = Backbone.Model.extend({
  ...
  isEmpty: function () {
    return this.getAnalysisDefinitionNodeModel().queryRowsCollection.isEmpty();
  },

  isDone: function () {
    return this.getAnalysisDefinitionNodeModel().queryRowsCollection.isDone();
  },

  canBeGeoreferenced: function () {
    var analysisDefinitionNodeModel = this.getAnalysisDefinitionNodeModel();
    return !this.hasGeocodingAnalysisApplied() &&
  ...
  fetchQueryRowsIfRequired: function () {
    ...
    if (!this.hasGeocodingAnalysisApplied() &&
      !analysisDefinitionNodeModel.queryGeometryModel.hasValue() &&
      !analysisDefinitionNodeModel.isCustomQueryApplied() &&
