...
var VisualizationFetchModel = require('cartodb3/data/visualizations-fetch-model');
var TablesCollection = require('cartodb3/data/visualizations-collection');
  ...
  _addNewLayer: function (tableModel, empty) {
    ...
    this._userActions.createLayerFromTable(tableModel, {
      success: function (model) {
        ...
        MetricsTracker.track('Created Layer', {
          empty: !!empty,
