...
describe('components/onboardings/georeference/georeference-view', function () {
  ...
  describe('.render', function () {
    it('should render properly', function () {
      ...
      expect(this.view.$('.Onboarding-contentWrapper').hasClass('is-step0')).toBe(true);
      expect(this.view.$('.Onboarding-contentBody').hasClass('is-step0')).toBe(true);
      expect(this.view.$('.Onboarding-contentWrapper').hasClass('js-step')).toBe(true);
      expect(this.view.$('.Onboarding-contentBody').hasClass('js-step')).toBe(true);
      ...
      expect(html.indexOf('style-onboarding.georeference.data') > -1).toBe(true);
    });
  });
