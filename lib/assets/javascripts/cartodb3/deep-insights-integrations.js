...
F.prototype._onLayerDefinitionMoved = function (m, at, c) {
  if (!m) throw new Error('moved layer model not provided');
  if (!at) throw new Error('at position provided');
...
F.prototype._createLayer = function (m, opts) {
  ...
  if (!this._analysisDefinitionsCollection.findByNodeId(attrs.source)) {
