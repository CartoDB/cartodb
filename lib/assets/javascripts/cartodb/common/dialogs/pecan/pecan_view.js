...
module.exports = cdb.core.View.extend({
  ...
  _EXCLUDED_COLUMNS: [
    ...
    'latdd', 'longdd', 'iso2', 'iso3', 'x', 'y', 'x_coord', 'y_coord',
    'xcoord', 'ycoord', 'cartodb_georef_status'
  ],
  ...
  _check: function() {
    ...
    var hasRows       = this.options.row_count > 0 && this.options.row_count < this._MAX_ROWS;

    var col_count = _(this.query_schema).size();
    var hasColumns = col_count > 0 && col_count < this._MAX_COLS;

    console.log("Row count: " + this.options.row_count + ". Col count: " + col_count);
