...
module.exports = cdb.core.View.extend({
  ...
  _openAddAnalysis: function (layerDefinitionModel) {
    ...
    var analysisDefinitionsCollection = this._analysisDefinitionsCollection;
    var nodesCollection = this._analysisDefinitionNodesCollection;
    ...
    this._modals.create(function (modalModel) {
      return new AddAnalysisView({
        ...
        analysisDefinitionNodeModel: nodesCollection.get(sourceId)
      });
    });
  },
