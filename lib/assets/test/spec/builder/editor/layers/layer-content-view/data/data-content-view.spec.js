...
describe('editor/layers/layers-content-view/data/data-content-view', function () {
  ...
  var createViewFn = function (options) {
    ...
    isDataFilteredPromise = fakePromise(layerDefinitionModel, 'isDataFiltered');
    canBeGeoreferencedPromise = fakePromise(layerDefinitionModel, 'canBeGeoreferenced');
