...
describe('editor/layers/layer-header-view', function () {
  ...
  describe('._getNodeModel', function () {
    it('should return node model', function () {
      spyOn(this.view._layerDefinitionModel, 'getAnalysisDefinitionNodeModel');

      this.view._getNodeModel();

      expect(this.view._layerDefinitionModel.getAnalysisDefinitionNodeModel).toHaveBeenCalled();
    });
  });
