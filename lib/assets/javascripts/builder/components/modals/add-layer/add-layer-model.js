...
module.exports = Backbone.Model.extend({
  ...
  showPrivacyToggler: function () {
    var hiddenDueToBusinessRule = false;
    if (this.get('activeImportPane') === 'twitter') {
      hiddenDueToBusinessRule = !this._userModel.get('twitter').customized_config;
    }

    var hasToBeShowed = this._atImportPane() && !hiddenDueToBusinessRule;
