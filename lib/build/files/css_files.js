...
module.exports = css_files = {
  ...
  dashboard: [
    '<%= assets_dir %>/stylesheets/plugins/select2.css',
    ...
    '<%= assets_dir %>/stylesheets/old_elements/custom_objects.css',
    '<%= assets_dir %>/stylesheets/old_elements/old_elements/dropdown.css',
