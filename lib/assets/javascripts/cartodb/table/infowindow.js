    ...
    _createHelpDialog: function() {
      ...
      var HelpDialog = cdb.admin.BaseDialog.extend({
        render_content: function() {
          return "<p>This template allows you to add an image to your infowindow. You will only need to put a column with the URL of the image in the first position of the customization field list.</p>" +
            "<p>We strongly recommend you to preproccess those images in order to improve your map experience.</p>";
        },
      });
