  ...
  cdb.admin.mod.InfowindowFieldItem = cdb.core.View.extend({
    ...
    template: _.template('<span class="ellipsis"><%- typeof(syncName) !== "undefined" ? syncName : (alias !== null) ? alias : fieldName %></span><div class="input"></div>'),

    initialize: function() {
      this.fieldName = this.options.field.name;
      this.fieldTitle = this.options.field.title;
      this.position  = this.options.position;
      this.alias = this.options.field.alias;
    },
    ...
    _renderField: function() {
      this.fieldModel = new cdb.core.Model({ title: this.model.getAlternativeName(this.fieldName) || this.alias || this.fieldName });
