...
describe('account/account_content_view', function () {
  ...
  describe('._showSuccess', function () {
    it('should set flash message', function () {
      ...
      var response = {};
      this.view._showSuccess(null, response);

      expect(this.view._setFlashMessage).toHaveBeenCalledWith(response, 'account.flash_messages.save_changes.success', 'success');
    });
  });
  ...
  describe('._showErrors', function () {
    it('should set flash message', function () {
      ...
      var response = {};
      this.view._showErrors(null, response);

      expect(this.view._setFlashMessage).toHaveBeenCalledWith(response, 'account.flash_messages.save_changes.error', 'error');
    });
  });
