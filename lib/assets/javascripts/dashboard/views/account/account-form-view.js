...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    if (this._renderModel.get('isLoading')) {
      ...
      this.$el.html(template({
        ...
        mfaFeatureFlagEnabled: this._userModel.featureEnabled('mfa'),
        mfaEnabled: this._getField('multifactor_authentication_configured')
      }));
  ...
  _onToggleMfa: function (event) {
    ...
    this._mfaLabel().innerHTML = newLabel;
  },  
  ...
  _mfaStatus: function () {
    return document.querySelector('.js-toggle-mfa').checked;
  },

  _mfaLabel: function () {
    return document.querySelector('.js-mfa-label');
  }
});
