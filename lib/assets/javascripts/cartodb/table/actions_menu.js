...
cdb.admin.ActionsMenu = cdb.admin.RightMenu.extend({
    ...
    setDataLayer: function(dataLayer) {
      ...
      var infowindow = new cdb.admin.mod.InfoWindow({
       ...
       window.mod_filters = filters;

       this.bind("end_narrow", filters._loadScroll, this); // load the scroll when the panel is open
       sql.bind('queryApplied', filters.removeFilters, filters);
