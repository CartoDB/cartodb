...
var Infowindow = CoreView.extend({
  ...
  DEFAULT_TEMPLATE: require('builder/deep-insights-integration/infowindows/templates/infowindow-default-template.tpl'),
  ...
  _initBinds: function () {
    ...
    // TODO this.listenTo(this.model, 'change:template', this._updateTemplate, this);

    // TODO this.listenTo(this._mapView, 'zoomstart', function () {
    //   this.hide(true);
    // });
    //
    // TODO this.listenTo(this._mapView, 'zoomend', function () {
    //   this.show();
    // });
  },
  ...
  render: function () {
    ...
    if (template) {
      ...
      var obj = _.extend({ // FIXME add color for infowindow_color template
        content: {
          fields: fields,
          data: data
        }
