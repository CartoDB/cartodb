...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_renderOverlays", "_renderOverlay", "_fetchOverlays", "_addOverlays", "_bindMapOptions", "_bindOverlays");
  ...
  _fetchOverlays: function(overlays) {

    var self = this;

    _.each(overlays, function(overlay) {

      overlay.urlRoot = self.overlays.url;
  ...
  _onResetOverlays: function(overlays) {
    ...
    if (overlays.models.length > 0) {
      self._fetchOverlays(overlays.models);
    }
