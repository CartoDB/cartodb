...
cdb.editor = {
  ...
  ImportsCollection: require('./new_dashboard/background_importer/imports_collection'),
  BackgroundImporterModel: require('./editor/background_importer_model'),
  BackgroundImporterView: require('./new_dashboard/background_importer/background_importer_view')
};
