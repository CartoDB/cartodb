...
var InputColorRamps = require('./input-quantitative-ramps/input-color-ramps');
...
module.exports = CoreView.extend({
  ...
  _initViews: function () {
    var stackViewCollection = new Backbone.Collection([
      ...
      {
        createStackView: this._createInputColorRamps.bind(this)
      },
      {
        createStackView: this._createInputColorCategories.bind(this)
      }
    ]);
