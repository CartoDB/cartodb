...
describe('new_dashboard/datasets/datasets_item', function() {
  ...
  it('should render the URL to dataset, from the perspective of current user', function() {
    ...
    expect(this.innerHTML()).toContain('http://team.cartodb.com/u/pepe/tables/paco.my_dataset');
  });
  ...
  it('should render an editable field with the description', function() {
    ...
    this.renderView();
    expect(this.view.$('.DatasetsList-itemDescription.EditableDescription').length).toBe(1);
  ...
  it('should render an editable field with the tags', function() {
    ...
    this.renderView();
    expect(this.view.$('.DatasetsList-itemTags.EditableTags').length).toBe(1);
    expect(this.view.$('.DefaultTags .DefaultTags-item').length).toBe(1);
    expect(this.view.$('.DefaultTags .DefaultTags-item')[0].textContent.trim()).toEqual('tag1');
  });
