...
module.exports = CoreView.extend({
  ...
  _initBinds: function () {
    this._syncModel.bind('change:state', this.render, this);
  ...
  _initViews: function () {
    ...
    if (this._syncModel.id && this.$('.js-syncState').length) {
  ...
  _onSuccessDestroyMap: function (modalModel) {
    window.location = this._configModel.get('base_url') + '/dashboard';
  },

  _onErrorDestroyMap: function (modalModel) {
    modalModel.destroy();
  },
