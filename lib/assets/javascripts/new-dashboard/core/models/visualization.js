...
export function getURL (visualizationData, models) {
  const isKuviz = visualizationData.type === 'kuviz';
  if (isKuviz) return visualizationData.url;
  ...
  const isBuilderVisualization = visualizationData.type === 'derived' || typeof visualizationData.type === 'undefined';
