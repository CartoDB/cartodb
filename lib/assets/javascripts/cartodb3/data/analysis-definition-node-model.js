...
module.exports = Backbone.Model.extend({
  ...
  initialize: function (attrs, opts) {
    ...
    this.querySchemaModel = new QuerySchemaModel(this.pick('simple_geom'), {
      configModel: opts.configModel
    });

    this.listenTo(this.querySchemaModel, 'change:simple_geom', this._onQuerySchemaSimpleGeomChanged);
  },
  ...
  isValidAsInputForType: function (analysisType) {
    ...
    var geometry = this.querySchemaModel.get('simple_geom');
    return geometry
  ...
  _onQuerySchemaSimpleGeomChanged: function (m, simpleGeom) {
    this.set('simple_geom', simpleGeom);
  }
