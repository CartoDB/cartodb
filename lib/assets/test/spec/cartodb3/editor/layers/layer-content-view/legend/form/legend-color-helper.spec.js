var LegendColorHelper = require('../../../../../../../../javascripts/cartodb3/editor/layers/layer-content-views/legend/form/legend-color-helper');

describe('editor/layers/layer-content-views/legend/form/legend-color-helper', function () {
  it('should return collection category items properly', function () {
    ...
    expect(categories[0].name).toBe('Others');
    expect(categories[3].fill.color.fixed).toBe('#129C63');
    expect(categories[3].name).toBe('\'L12\'');
    expect(categories[10].fill.color.fixed).toBe('#6F3072');
    expect(categories[10].name).toBe('\'L9\'');
  });
  ...
  it('should return collection category items properly for choropleth style', function () {
    ...
    expect(categories.length).toBe(11);
    expect(categories[0].fill.color.fixed).toBe('#555');
    expect(categories[0].name).toBe('editor.legend.legend-form.untitled');
    expect(categories[3].fill.color.fixed).toBe('#129C63');
    expect(categories[3].name).toBe('editor.legend.legend-form.untitled');
    expect(categories[10].fill.color.fixed).toBe('#6F3072');
    expect(categories[10].name).toBe('editor.legend.legend-form.untitled');
  });
