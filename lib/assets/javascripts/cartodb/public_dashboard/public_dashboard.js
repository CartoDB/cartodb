  ...
  $(function() {
    ...
    var PublicDashboard = cdb.core.View.extend({
      ...
      events: {
        'click .datasets h2 a':       '_onDatasetClick',
        'click .visualizations h2 a': '_onVisClick',
      ...
      _onVisClick: function(e) {
        // If user is logged, visiting his/her own profile and click over the avatar, 
        // send him/her to the private view
        if (this.model.get('username') === this.options.user_name) {
          var location = $(e.target).attr('href');
